"""Read-only Doosan advisory endpoint backed by the AWS collector snapshot."""
...
doosan_price_widget_bp = Blueprint("doosan_price_widget", __name__)

_ACCESS_KEY_ENV = "KORSTOCKSCAN_DOOSAN_WIDGET_ACCESS_KEY"
_SHARED_ACCESS_KEY_ENV = "KORSTOCKSCAN_SAMSUNG_WIDGET_ACCESS_KEY"
_ACCESS_KEY_FILE_ENV = "KORSTOCKSCAN_DOOSAN_WIDGET_ACCESS_KEY_FILE"
_SHARED_ACCESS_KEY_FILE_ENV = "KORSTOCKSCAN_SAMSUNG_WIDGET_ACCESS_KEY_FILE"
_ACCESS_KEY_HEADER = "X-KORStockScan-Widget-Key"
_SNAPSHOT_PATH_ENV = "KORSTOCKSCAN_DOOSAN_WIDGET_SNAPSHOT_PATH"
...
@doosan_price_widget_bp.get("/api/widget/doosan-price")
def get_doosan_price():

# Swing Lifecycle Audit - 2026-07-15
...
- panic_state: `NORMAL`
- panic_active_sim_probe: `{'active_positions': 2, 'profit_sample': 0, 'avg_unrealized_profit_rate_pct': None, 'win_rate_pct': None, 'wins': 0, 'losses': 0, 'flat': 0}`
- panic_origin_outcome: `{'blocked_gatekeeper_reject': {'count': 1, 'avg_profit_rate_pct': None}, 'unknown': {'count': 1, 'avg_profit_rate_pct': None}}`
...
- stale_missing_reason_counts_by_group: `{'exit': {'micro_missing': 14}}`
...
- orderbook_micro_reason_counts_by_group: `{'exit': {'micro_estimator_true_ofi_primary': 14}}`
- observer_missing_reason_counts_by_group: `{'exit': {'UNKNOWN': 14}}`
- source_quality_status_counts_by_group: `{'exit': {'UNKNOWN': 14}}`
- ws_quote_source_counts_by_group: `{'exit': {'UNKNOWN': 14}}`
- ws_quote_stale_counts_by_group: `{'exit': {'UNKNOWN': 14}}`
- entry_micro_state_counts: `{}`
- scale_in_micro_state_counts: `{}`
- exit_micro_state_counts: `{'bearish': 2, 'neutral': 4, 'bullish': 8}`
...
| `swing_exit_post_sell_attribution` | `exit` | `swing_trailing_stop_time_stop` | 10 | `ready` |
...
| `swing_exit_ofi_qi_smoothing` | `holding_exit` | `swing_exit_ofi_qi_smoothing` | 14 | `ready` |

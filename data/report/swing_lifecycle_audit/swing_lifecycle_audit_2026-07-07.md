# Swing Lifecycle Audit - 2026-07-07
...
- panic_active_sim_probe: `{'active_positions': 7, 'profit_sample': 4, 'avg_unrealized_profit_rate_pct': -0.1854, 'win_rate_pct': 25.0, 'wins': 1, 'losses': 3, 'flat': 0}`
- panic_origin_outcome: `{'blocked_gatekeeper_reject': {'count': 1, 'avg_profit_rate_pct': None}, 'blocked_swing_score_vpw': {'count': 1, 'avg_profit_rate_pct': None}, 'market_regime_prior_observed': {'count': 1, 'avg_profit_rate_pct': None}, 'unknown': {'count': 4, 'avg_profit_rate_pct': -0.1854}}`
...
| --- | ---: | ---: |
| `holding_flow_ofi_smoothing_applied` | 23 | 13 |
...
- stale_missing_reason_counts: `{'micro_missing': 23}`
- stale_missing_reason_combination_counts: `{'micro_missing': 23}`
- stale_missing_reason_combination_unique_record_counts: `{'micro_missing': 3}`
- stale_missing_reason_counts_by_group: `{'exit': {'micro_missing': 23}}`
- stale_missing_reason_unique_record_counts_by_group: `{'exit': {'micro_missing': 3}}`
- stale_missing_group_counts: `{'exit': 23}`
...
- orderbook_micro_reason_counts_by_group: `{'exit': {'ready': 23}}`
- observer_missing_reason_counts_by_group: `{'exit': {'ok': 23}}`
- source_quality_status_counts_by_group: `{'exit': {'UNKNOWN': 23}}`
- ws_quote_source_counts_by_group: `{'exit': {'UNKNOWN': 23}}`
- ws_quote_stale_counts_by_group: `{'exit': {'UNKNOWN': 23}}`
- entry_micro_state_counts: `{}`
- scale_in_micro_state_counts: `{}`
- exit_micro_state_counts: `{'neutral': 23}`
- exit_smoothing_action_counts: `{'NO_CHANGE': 23}`
...
| `swing_holding_mfe_mae_defer` | `holding` | `swing_holding_flow_defer` | 13 | `instrumentation_gap` |
...
| `swing_exit_ofi_qi_smoothing` | `holding_exit` | `swing_exit_ofi_qi_smoothing` | 23 | `ready` |

# Swing Lifecycle Audit - 2026-06-26
...
| `sell_order_blocked_market_closed` | 4 | 4 |
| `sell_order_failed` | 7 | 1 |
| `sell_order_sent` | 7 | 7 |
...
- stale_missing_reason_counts_by_group: `{'exit': {'micro_missing': 37, 'micro_not_ready': 4, 'state_insufficient': 4}}`
...
- orderbook_micro_reason_counts_by_group: `{'exit': {'ready': 33, 'insufficient_samples': 4}}`
- observer_missing_reason_counts_by_group: `{'exit': {'ok': 37}}`
- source_quality_status_counts_by_group: `{'exit': {'UNKNOWN': 37}}`
- ws_quote_source_counts_by_group: `{'exit': {'UNKNOWN': 37}}`
- ws_quote_stale_counts_by_group: `{'exit': {'UNKNOWN': 37}}`
- entry_micro_state_counts: `{}`
- scale_in_micro_state_counts: `{}`
- exit_micro_state_counts: `{'neutral': 33, 'insufficient': 4}`
...
| `swing_holding_mfe_mae_defer` | `holding` | `swing_holding_flow_defer` | 14 | `ready` |
...
| `swing_exit_ofi_qi_smoothing` | `holding_exit` | `swing_exit_ofi_qi_smoothing` | 37 | `ready` |

# Swing Lifecycle Audit - 2026-07-13
...
- panic_active_sim_probe: `{'active_positions': 1, 'profit_sample': 0, 'avg_unrealized_profit_rate_pct': None, 'win_rate_pct': None, 'wins': 0, 'losses': 0, 'flat': 0}`
- panic_origin_outcome: `{'blocked_gatekeeper_reject': {'count': 1, 'avg_profit_rate_pct': None}}`
...
| --- | ---: | ---: |
| `holding_flow_ofi_smoothing_applied` | 3 | 3 |
| `sell_order_sent` | 5 | 5 |
...
- stale_missing_reason_counts: `{'micro_missing': 3}`
- stale_missing_reason_combination_counts: `{'micro_missing': 3}`
- stale_missing_reason_combination_unique_record_counts: `{}`
- stale_missing_reason_counts_by_group: `{'exit': {'micro_missing': 3}}`
- stale_missing_reason_unique_record_counts_by_group: `{}`
- stale_missing_group_counts: `{'exit': 3}`
...
- orderbook_micro_reason_counts_by_group: `{'exit': {'micro_estimator_true_ofi_primary': 3}}`
- observer_missing_reason_counts_by_group: `{'exit': {'UNKNOWN': 3}}`
- source_quality_status_counts_by_group: `{'exit': {'UNKNOWN': 3}}`
- ws_quote_source_counts_by_group: `{'exit': {'UNKNOWN': 3}}`
- ws_quote_stale_counts_by_group: `{'exit': {'UNKNOWN': 3}}`
- entry_micro_state_counts: `{}`
- scale_in_micro_state_counts: `{}`
- exit_micro_state_counts: `{'bullish': 3}`
- exit_smoothing_action_counts: `{'NO_CHANGE': 3}`
...
| `swing_holding_mfe_mae_defer` | `holding` | `swing_holding_flow_defer` | 3 | `instrumentation_gap` |
| `swing_scale_in_avg_down_pyramid` | `scale_in` | `swing_pyramid_trigger` | 0 | `hold_sample` |
| `swing_exit_post_sell_attribution` | `exit` | `swing_trailing_stop_time_stop` | 5 | `ready` |
...
| `swing_exit_ofi_qi_smoothing` | `holding_exit` | `swing_exit_ofi_qi_smoothing` | 3 | `ready` |

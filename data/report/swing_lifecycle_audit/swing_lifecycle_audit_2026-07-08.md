# Swing Lifecycle Audit - 2026-07-08
...
- stale_missing_reason_counts_by_group: `{'exit': {'micro_missing': 19}}`
- stale_missing_reason_unique_record_counts_by_group: `{'exit': {'micro_missing': 5}}`
...
- orderbook_micro_reason_counts_by_group: `{'exit': {'ready': 19}}`
- observer_missing_reason_counts_by_group: `{'exit': {'ok': 19}}`
- source_quality_status_counts_by_group: `{'exit': {'UNKNOWN': 19}}`
- ws_quote_source_counts_by_group: `{'exit': {'UNKNOWN': 19}}`
- ws_quote_stale_counts_by_group: `{'exit': {'UNKNOWN': 19}}`
- entry_micro_state_counts: `{}`
- scale_in_micro_state_counts: `{}`
- exit_micro_state_counts: `{'neutral': 19}`
...
| `swing_exit_ofi_qi_smoothing` | `holding_exit` | `swing_exit_ofi_qi_smoothing` | 19 | `ready` |

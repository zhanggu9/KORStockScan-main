# Swing Lifecycle Audit - 2026-07-16
...
| --- | ---: | ---: |
| `holding_flow_ofi_smoothing_applied` | 2 | 2 |
| `sell_order_sent` | 1 | 1 |
...
- stale_missing_reason_counts: `{'micro_missing': 2}`
- stale_missing_reason_combination_counts: `{'micro_missing': 2}`
- stale_missing_reason_combination_unique_record_counts: `{}`
- stale_missing_reason_counts_by_group: `{'exit': {'micro_missing': 2}}`
- stale_missing_reason_unique_record_counts_by_group: `{}`
- stale_missing_group_counts: `{'exit': 2}`
...
- orderbook_micro_reason_counts_by_group: `{'exit': {'micro_estimator_true_ofi_primary': 2}}`
- observer_missing_reason_counts_by_group: `{'exit': {'UNKNOWN': 2}}`
- source_quality_status_counts_by_group: `{'exit': {'UNKNOWN': 2}}`
- ws_quote_source_counts_by_group: `{'exit': {'UNKNOWN': 2}}`
- ws_quote_stale_counts_by_group: `{'exit': {'UNKNOWN': 2}}`
- entry_micro_state_counts: `{}`
- scale_in_micro_state_counts: `{}`
- exit_micro_state_counts: `{'bullish': 2}`
- exit_smoothing_action_counts: `{'NO_CHANGE': 2}`
...
| `swing_holding_mfe_mae_defer` | `holding` | `swing_holding_flow_defer` | 2 | `instrumentation_gap` |
| `swing_scale_in_avg_down_pyramid` | `scale_in` | `swing_pyramid_trigger` | 0 | `hold_sample` |
| `swing_exit_post_sell_attribution` | `exit` | `swing_trailing_stop_time_stop` | 1 | `ready` |
...
| `swing_exit_ofi_qi_smoothing` | `holding_exit` | `swing_exit_ofi_qi_smoothing` | 2 | `ready` |

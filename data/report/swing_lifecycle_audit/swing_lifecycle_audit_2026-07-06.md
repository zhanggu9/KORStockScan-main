# Swing Lifecycle Audit - 2026-07-06
...
- panic_state: `NORMAL`
- panic_active_sim_probe: `{'active_positions': 4, 'profit_sample': 1, 'avg_unrealized_profit_rate_pct': 0.4688, 'win_rate_pct': 100.0, 'wins': 1, 'losses': 0, 'flat': 0}`
- panic_origin_outcome: `{'blocked_gatekeeper_reject': {'count': 1, 'avg_profit_rate_pct': None}, 'blocked_swing_score_vpw': {'count': 1, 'avg_profit_rate_pct': None}, 'market_regime_prior_observed': {'count': 1, 'avg_profit_rate_pct': None}, 'unknown': {'count': 1, 'avg_profit_rate_pct': 0.4688}}`
...
- stale_missing_reason_counts_by_group: `{'exit': {'micro_missing': 11}}`
...
- orderbook_micro_reason_counts_by_group: `{'exit': {'ready': 11}}`
- observer_missing_reason_counts_by_group: `{'exit': {'ok': 11}}`
- source_quality_status_counts_by_group: `{'exit': {'UNKNOWN': 11}}`
- ws_quote_source_counts_by_group: `{'exit': {'UNKNOWN': 11}}`
- ws_quote_stale_counts_by_group: `{'exit': {'UNKNOWN': 11}}`
- entry_micro_state_counts: `{}`
- scale_in_micro_state_counts: `{}`
- exit_micro_state_counts: `{'neutral': 11}`
...
| `swing_exit_ofi_qi_smoothing` | `holding_exit` | `swing_exit_ofi_qi_smoothing` | 11 | `ready` |

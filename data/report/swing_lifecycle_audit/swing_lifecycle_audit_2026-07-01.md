# Swing Lifecycle Audit - 2026-07-01
...
- panic_state: `NORMAL`
- panic_active_sim_probe: `{'active_positions': 7, 'profit_sample': 4, 'avg_unrealized_profit_rate_pct': -0.6102, 'win_rate_pct': 25.0, 'wins': 1, 'losses': 3, 'flat': 0}`
- panic_origin_outcome: `{'blocked_gatekeeper_reject': {'count': 1, 'avg_profit_rate_pct': None}, 'blocked_swing_score_vpw': {'count': 1, 'avg_profit_rate_pct': None}, 'market_regime_prior_observed': {'count': 1, 'avg_profit_rate_pct': None}, 'unknown': {'count': 4, 'avg_profit_rate_pct': -0.6102}}`
...
| `sell_order_blocked_market_closed` | 20 | 6 |
| `sell_order_failed` | 1 | 1 |
| `sell_order_sent` | 28 | 27 |
...
- stale_missing_reason_counts_by_group: `{'exit': {'micro_missing': 57, 'micro_not_ready': 49, 'state_insufficient': 49, 'observer_unhealthy': 32}}`
- stale_missing_reason_unique_record_counts_by_group: `{'exit': {'micro_missing': 11, 'micro_not_ready': 8, 'state_insufficient': 8, 'observer_unhealthy': 4}}`
...
- orderbook_micro_reason_counts_by_group: `{'exit': {'insufficient_samples': 46, 'ready': 8, 'missing_best_qty': 3}}`
- observer_missing_reason_counts_by_group: `{'exit': {'ok': 25, 'missing_quote': 1, 'missing_trade': 29, 'missing_quote_and_trade': 2}}`
- source_quality_status_counts_by_group: `{'exit': {'UNKNOWN': 57}}`
- ws_quote_source_counts_by_group: `{'exit': {'UNKNOWN': 57}}`
- ws_quote_stale_counts_by_group: `{'exit': {'UNKNOWN': 57}}`
- entry_micro_state_counts: `{}`
- scale_in_micro_state_counts: `{}`
- exit_micro_state_counts: `{'insufficient': 49, 'neutral': 8}`
...
| `swing_holding_mfe_mae_defer` | `holding` | `swing_holding_flow_defer` | 12 | `ready` |
| `swing_scale_in_avg_down_pyramid` | `scale_in` | `swing_pyramid_trigger` | 0 | `hold_sample` |
| `swing_exit_post_sell_attribution` | `exit` | `swing_trailing_stop_time_stop` | 34 | `ready` |
...
| `swing_exit_ofi_qi_smoothing` | `holding_exit` | `swing_exit_ofi_qi_smoothing` | 57 | `ready` |

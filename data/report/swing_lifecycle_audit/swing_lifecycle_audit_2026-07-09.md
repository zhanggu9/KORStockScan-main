# Swing Lifecycle Audit - 2026-07-09
...
- panic_state: `NORMAL`
- panic_active_sim_probe: `{'active_positions': 3, 'profit_sample': 0, 'avg_unrealized_profit_rate_pct': None, 'win_rate_pct': None, 'wins': 0, 'losses': 0, 'flat': 0}`
- panic_origin_outcome: `{'blocked_gatekeeper_reject': {'count': 1, 'avg_profit_rate_pct': None}, 'blocked_swing_score_vpw': {'count': 1, 'avg_profit_rate_pct': None}, 'market_regime_prior_observed': {'count': 1, 'avg_profit_rate_pct': None}}`
...
| --- | ---: | ---: |
| `holding_flow_ofi_smoothing_applied` | 6 | 5 |
| `sell_order_sent` | 6 | 6 |
...
- stale_missing_reason_counts: `{'micro_missing': 6}`
- stale_missing_reason_combination_counts: `{'micro_missing': 6}`
- stale_missing_reason_combination_unique_record_counts: `{'micro_missing': 1}`
- stale_missing_reason_counts_by_group: `{'exit': {'micro_missing': 6}}`
- stale_missing_reason_unique_record_counts_by_group: `{'exit': {'micro_missing': 1}}`
- stale_missing_group_counts: `{'exit': 6}`
...
- orderbook_micro_reason_counts_by_group: `{'exit': {'ready': 6}}`
- observer_missing_reason_counts_by_group: `{'exit': {'ok': 6}}`
- source_quality_status_counts_by_group: `{'exit': {'UNKNOWN': 6}}`
- ws_quote_source_counts_by_group: `{'exit': {'UNKNOWN': 6}}`
- ws_quote_stale_counts_by_group: `{'exit': {'UNKNOWN': 6}}`
- entry_micro_state_counts: `{}`
- scale_in_micro_state_counts: `{}`
- exit_micro_state_counts: `{'neutral': 6}`
- exit_smoothing_action_counts: `{'NO_CHANGE': 6}`
...
| `swing_holding_mfe_mae_defer` | `holding` | `swing_holding_flow_defer` | 5 | `instrumentation_gap` |
...
| `swing_exit_ofi_qi_smoothing` | `holding_exit` | `swing_exit_ofi_qi_smoothing` | 6 | `ready` |

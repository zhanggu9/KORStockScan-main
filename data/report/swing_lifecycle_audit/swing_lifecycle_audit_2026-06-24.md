# Swing Lifecycle Audit - 2026-06-24
...
- panic_state: `NORMAL`
- panic_active_sim_probe: `{'active_positions': 6, 'profit_sample': 3, 'avg_unrealized_profit_rate_pct': -0.6816, 'win_rate_pct': 33.3, 'wins': 1, 'losses': 2, 'flat': 0}`
- panic_origin_outcome: `{'blocked_gatekeeper_reject': {'count': 1, 'avg_profit_rate_pct': None}, 'blocked_swing_score_vpw': {'count': 1, 'avg_profit_rate_pct': None}, 'market_regime_prior_observed': {'count': 1, 'avg_profit_rate_pct': None}, 'unknown': {'count': 3, 'avg_profit_rate_pct': -0.6816}}`
...
| `sell_order_blocked_market_closed` | 7 | 3 |
| `sell_order_sent` | 4 | 4 |
...
- stale_missing_reason_counts_by_group: `{'exit': {'micro_missing': 30}}`
...
- orderbook_micro_reason_counts_by_group: `{'exit': {'ready': 30}}`
- observer_missing_reason_counts_by_group: `{'exit': {'ok': 30}}`
- source_quality_status_counts_by_group: `{'exit': {'UNKNOWN': 30}}`
- ws_quote_source_counts_by_group: `{'exit': {'UNKNOWN': 30}}`
- ws_quote_stale_counts_by_group: `{'exit': {'UNKNOWN': 30}}`
- entry_micro_state_counts: `{}`
- scale_in_micro_state_counts: `{}`
- exit_micro_state_counts: `{'bearish': 2, 'neutral': 28}`
...
| `swing_holding_mfe_mae_defer` | `holding` | `swing_holding_flow_defer` | 21 | `ready` |
...
| `swing_exit_ofi_qi_smoothing` | `holding_exit` | `swing_exit_ofi_qi_smoothing` | 30 | `ready` |

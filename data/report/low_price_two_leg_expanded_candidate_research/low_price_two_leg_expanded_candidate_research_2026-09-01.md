# Expanded lower-price entry-spot research — 2026-09-01

Source-only clean-baseline expanding calibration / latest 16-day holdout. No machine or live session was added.

Window: `2026-06-05~2026-09-01`; trading dates `61`; calibration `45`; holdout `16`.

Recommendation status: `recommendations_ready`; profiles: `6`.
...
| new_symbol | 007660 | 이수페타시스 | late_morning | no_robust_calibration_candidate_do_not_promote | N/A | 12 | 23 | 0 | None | -0.004809 |
...
| new_symbol | 120110 | 코오롱인더 | morning | holdout_failed_keep_baseline | 09:10~09:59; L30; DD1.25; NL0.2 | 10 | 20 | 0 | 0.162319 | 0.162319 |
| new_symbol | 120110 | 코오롱인더 | late_morning | holdout_failed_keep_baseline | 10:00~10:59; L30; DD1.25; NL0.2 | 13 | 23 | 0 | 0.139088 | 0.139088 |
| new_symbol | 120110 | 코오롱인더 | midday | holdout_positive_not_better_keep_baseline | 13:15~13:54; L30; DD1.25; NL0.2 | 2 | 4 | 0 | 0.166972 | 0.166972 |
| new_symbol | 120110 | 코오롱인더 | afternoon | holdout_positive_not_better_keep_baseline | 14:00~14:40; L30; DD1.25; NL0.2 | 6 | 11 | 0 | 0.143588 | 0.143588 |
...
| existing_symbol_time_extension | 080220 | 제주반도체 | late_morning | holdout_positive_not_better_keep_baseline | 10:00~10:59; L30; DD1.25; NL0.2 | 10 | 20 | 0 | 0.060858 | 0.060858 |
...
| existing_symbol_time_extension | 080220 | 제주반도체 | afternoon | holdout_failed_keep_baseline | 14:00~14:40; L30; DD1.25; NL0.2 | 10 | 15 | 4 | 0.041224 | 0.041224 |
...
| existing_symbol_time_extension | 017670 | SK텔레콤 | midday | holdout_pass_source_only_early_candidate | 13:15~13:54; L20; DD0.5; NL0.05 | 9 | 15 | 1 | 0.006911 | 0.004186 |
| existing_symbol_time_extension | 079160 | CJ CGV | morning | holdout_pass_source_only_early_candidate | 09:40~09:59; L15; DD0.5; NL0.75 | 15 | 24 | 4 | 0.141318 | 0.134992 |
...
| existing_symbol_time_extension | 181710 | NHN | midday | holdout_positive_not_better_keep_baseline | 13:15~13:54; L30; DD1.25; NL0.2 | 7 | 13 | 0 | 0.087198 | 0.087198 |
...
| existing_symbol_logic_improvement | 475150 | SK이터닉스 | midday | holdout_failed_keep_baseline | 13:30~13:39; L60; DD0.75; NL0.35 | 4 | 5 | 1 | 0.343099 | 0.343099 |
| existing_symbol_logic_improvement | 006800 | 미래에셋증권 | morning | holdout_failed_keep_baseline | 09:35~09:44; L30; DD1.75; NL0.75 | 2 | 4 | 0 | 0.337635 | 0.337635 |
...
| existing_symbol_logic_improvement | 042660 | 한화오션 | late_morning | holdout_pass_source_only_early_candidate | 10:05~10:14; L30; DD0.75; NL0.75 | 9 | 15 | 2 | 0.214359 | 0.184136 |
| existing_symbol_logic_improvement | 035720 | 카카오 | morning | holdout_failed_keep_baseline | 09:20~09:39; L15; DD0.75; NL0.35 | 9 | 10 | 7 | 0.179033 | 0.179033 |
...
| existing_symbol_logic_improvement | 035720 | 카카오 | late_morning | holdout_positive_not_better_keep_baseline | 10:05~10:24; L15; DD0.5; NL0.05 | 9 | 12 | 2 | 0.223076 | 0.223076 |
...
| existing_symbol_logic_improvement | 010140 | 삼성중공업 | morning | holdout_failed_keep_baseline | 09:20~09:29; L20; DD1.75; NL0.75 | 4 | 2 | 0 | 0.091814 | 0.091814 |
| existing_symbol_logic_improvement | 034020 | 두산에너빌리티 | late_morning | holdout_failed_keep_baseline | 10:15~10:34; L45; DD1.5; NL0.05 | 2 | 3 | 0 | 0.236474 | 0.236474 |
...
| existing_symbol_logic_improvement | 028050 | 삼성E&A | late_morning | holdout_positive_not_better_keep_baseline | 10:05~10:14; L45; DD1.0; NL0.75 | 8 | 14 | 0 | 0.199692 | 0.199692 |
...
| existing_symbol_logic_improvement | 111770 | 영원무역 | afternoon | holdout_failed_keep_baseline | 14:30~14:39; L45; DD0.5; NL0.75 | 13 | 17 | 5 | 0.206691 | 0.206691 |
...
| existing_symbol_logic_improvement | 111770 | 영원무역 | morning | holdout_failed_keep_baseline | 09:20~09:39; L20; DD0.5; NL0.5 | 16 | 28 | 0 | 0.046007 | 0.046007 |
| existing_symbol_logic_improvement | 079160 | CJ CGV | late_morning | holdout_positive_not_better_keep_baseline | 10:00~10:09; L15; DD0.5; NL0.35 | 9 | 11 | 2 | 0.338282 | 0.338282 |
...
| existing_symbol_logic_improvement | 181710 | NHN | afternoon | holdout_positive_not_better_keep_baseline | 14:00~14:40; L60; DD1.0; NL0.75 | 8 | 12 | 2 | 0.281943 | 0.281943 |
...
| existing_symbol_logic_improvement | 181710 | NHN | late_morning | holdout_failed_keep_baseline | 10:30~10:49; L30; DD0.5; NL0.5 | 8 | 13 | 0 | 0.275245 | 0.275245 |
| existing_symbol_logic_improvement | 137310 | 에스디바이오센서 | morning | holdout_positive_not_better_keep_baseline | 09:30~09:39; L15; DD0.5; NL0.75 | 13 | 21 | 4 | 0.358899 | 0.358899 |
...
| existing_symbol_logic_improvement | 017670 | SK텔레콤 | morning | holdout_positive_not_better_keep_baseline | 09:10~09:29; L30; DD0.5; NL0.75 | 6 | 11 | 1 | 0.21271 | 0.21271 |
...
| existing_symbol_logic_improvement | 028670 | 팬오션 | late_morning | holdout_pass_source_only_early_candidate | 10:05~10:14; L45; DD1.75; NL0.5 | 6 | 9 | 2 | 0.370495 | 0.135464 |

## Target-date cumulative logic attribution

- `hanwha_ocean_late_morning`: candidate-only signal `2026-09-01T10:06:00+09:00`; completed `2` leg; held `0`; EV `0.261095`%.

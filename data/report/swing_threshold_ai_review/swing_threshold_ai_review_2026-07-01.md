# Swing Threshold AI Review - 2026-07-01
...
| --- | --- | --- | --- | --- | --- |
| `swing_model_floor` | `selection` | `hold_sample` | `unavailable` | state=-, value=None | accepted=False, reason=ai_unavailable |
| `swing_selection_top_k` | `selection` | `hold_sample` | `unavailable` | state=-, value=None | accepted=False, reason=ai_unavailable |

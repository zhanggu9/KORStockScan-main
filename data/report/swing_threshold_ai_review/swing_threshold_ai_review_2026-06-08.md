# Swing Threshold AI Review - 2026-06-08
...
| --- | --- | --- | --- | --- | --- |
| `swing_model_floor` | `selection` | `freeze` | `unavailable` | state=adjust_up, value=0.4 | accepted=True, reason=- |
| `swing_selection_top_k` | `selection` | `freeze` | `unavailable` | state=adjust_down, value=2 | accepted=True, reason=- |
| `swing_gatekeeper_accept_reject` | `entry` | `freeze` | `unavailable` | state=freeze, value=None | accepted=True, reason=- |
| `swing_gatekeeper_reject_cooldown` | `entry` | `freeze` | `unavailable` | state=hold, value=7200 | accepted=True, reason=- |
| `swing_market_regime_sensitivity` | `entry` | `freeze` | `unavailable` | state=adjust_up, value=strict_entry_observe | accepted=False, reason=missing_numeric_bounds_for_value_proposal |

# AI Score Optimization Backtest - 2026-07-31
...
[
  {
    ...
    "source_reports": [
      ...
      "/home/ubuntu/KORStockScan/data/report/rising_missed_intraday_feedback/rising_missed_intraday_feedback_2026-07-30.json",
      "/home/ubuntu/KORStockScan/data/report/rising_missed_intraday_feedback/rising_missed_intraday_feedback_2026-07-31.json"
    ],
    "stage": "scale_in",
    "target_env_keys": [],
    "threshold_version": "rising_missed_first_touch_avgdown_decision_gate:2026-07-31:v1",
    ...
    "ai_score_optimization_source_path": "/home/ubuntu/KORStockScan/data/report/rising_missed_first_touch_calibration/rising_missed_first_touch_calibration_2026-07-31.json"
  },
  {
    "actual_order_submitted": false,
    "allowed_runtime_apply": false,
    ...
    "source_metrics": {
      ...
      "correctly_blocked_count": 84,
      "correctly_blocked_rate": 0.37668161434977576,
      "label_counts": [
        {
          "count": 86,
        ...
        "by_effective_venue": [
          {
            "allowed_runtime_apply": false,
            "effective_venue": "KRX",
            "notional_weighted_ev_pct": -0.2479,
            "runtime_effect": false,
            "sample_count": 7,
            "sample_floor": 20,
      ...
      "one_share_pyramid_avg_opportunity_cost_pct": 0.6576233183856502,
      "post_probe_real_outcome_observation": {
        ...
        "realized_winner_zero_fill_count": 5,
        "runtime_confirmation_source_quality_disputed_count": 1,
        "runtime_effect": false,
        "sample_floor": 20,
        "sample_floor_met": false,
      ...
      "post_probe_reprice_observation": {
        ...
        "equal_weight_avg_profit_pct": null,
        "forbidden_uses": [
          "intraday_threshold_mutation",
          "intraday_runtime_apply",
          "hard_safety_relaxation",
        ...
        "learning_sample_floor": 1,
        "learning_update_policy": "one_mature_leg_reprice_outcome_updates_cumulative_judgment_quality",
        ...
        "source_quality_gate": "complete_post_probe_resolver_profile_action_previous_resolved_price_and_valid_real_terminal_outcome",
        "state": "hold_sample",
        "window_policy": "clean_baseline_cumulative_closed_real_post_probe_reprice_outcomes"
      },
      "profit_threshold_grid": [
        {
          "avg_incremental_exit_profit_pct": 0.04251700680272106,
          "avg_missed_upside_after_threshold_pct": 1.3835374149659863,
          "eligible_count": 147,
          "eligible_rate": 0.6591928251121076,
          "label_counts": [
            {
              "count": 68,
              "label": "pyramid_overheat_or_reversal_risk"
          ...
          "loss_or_flat_rate": 0.4217687074829932,
          "min_profit_pct": 0.8,
          "positive_exit_count": 85,
          "positive_exit_rate": 0.5782312925170068,
          "source_row_count": 223
        },
        {
          "avg_incremental_exit_profit_pct": 0.05303703703703701,
          "avg_missed_upside_after_threshold_pct": 1.4021481481481481,
          "eligible_count": 135,
          "eligible_rate": 0.6053811659192825,
          "label_counts": [
            {
              "count": 66,
              "label": "pyramid_overheat_or_reversal_risk"
          ...
          "loss_or_flat_rate": 0.3925925925925926,
          "min_profit_pct": 0.9,
          "positive_exit_count": 82,
          "positive_exit_rate": 0.6074074074074074,
          "source_row_count": 223
        },
        {
          "avg_incremental_exit_profit_pct": 0.19766129032258062,
          "avg_missed_upside_after_threshold_pct": 1.4224999999999999,
          "eligible_count": 124,
          "eligible_rate": 0.5560538116591929,
          "label_counts": [
            {
              "count": 61,
              "label": "pyramid_overheat_or_reversal_risk"
        ...
        {
          "avg_incremental_exit_profit_pct": 0.17529914529914523,
          "avg_missed_upside_after_threshold_pct": 1.4052136752136752,
          "eligible_count": 117,
          "eligible_rate": 0.5246636771300448,
          "label_counts": [
            {
              "count": 59,
              "label": "pyramid_overheat_or_reversal_risk"
          ...
          "loss_or_flat_rate": 0.4188034188034188,
          "min_profit_pct": 1.1,
          "positive_exit_count": 68,
          "positive_exit_rate": 0.5811965811965812,
          "source_row_count": 223
        },
        {
          "avg_incremental_exit_profit_pct": 0.17174311926605507,
          "avg_missed_upside_after_threshold_pct": 1.4048623853211009,
          "eligible_count": 109,
          "eligible_rate": 0.48878923766816146,
          "label_counts": [
            {
              "count": 55,
              "label": "pyramid_overheat_or_reversal_risk"
          ...
          "loss_or_flat_rate": 0.41284403669724773,
          "min_profit_pct": 1.2,
          "positive_exit_count": 64,
          "positive_exit_rate": 0.5871559633027523,
          "source_row_count": 223
        },
        {
          "avg_incremental_exit_profit_pct": 0.2196078431372549,
          "avg_missed_upside_after_threshold_pct": 1.3981372549019606,
          "eligible_count": 102,
          "eligible_rate": 0.45739910313901344,
          "label_counts": [
            {
              "count": 51,
              "label": "pyramid_overheat_or_reversal_risk"
          ...
          "loss_or_flat_rate": 0.4215686274509804,
          "min_profit_pct": 1.3,
          "positive_exit_count": 59,
          "positive_exit_rate": 0.5784313725490197,
          "source_row_count": 223
        },
        {
          ...
          "eligible_count": 100,
          "eligible_rate": 0.4484304932735426,
          "label_counts": [
            {
              "count": 50,
              "label": "pyramid_overheat_or_reversal_risk"
        ...
        },
        {
          ...
          "eligible_count": 94,
          "eligible_rate": 0.42152466367713004,
          "label_counts": [
            {
              "count": 46,
              "label": "pyramid_overheat_or_reversal_risk"
        ...
        },
        {
          ...
          "eligible_count": 86,
          "eligible_rate": 0.38565022421524664,
          "label_counts": [
            {
              "count": 44,
              "label": "pyramid_would_have_helped"
        ...
        },
        {
          ...
          "eligible_count": 79,
          "eligible_rate": 0.3542600896860987,
          "label_counts": [
            {
              "count": 41,
              "label": "pyramid_would_have_helped"
        ...
        },
        {
          ...
          "eligible_count": 75,
          "eligible_rate": 0.336322869955157,
          "label_counts": [
            {
              "count": 37,
              "label": "pyramid_would_have_helped"
        ...
        },
        {
          ...
          "eligible_count": 70,
          "eligible_rate": 0.31390134529147984,
          "label_counts": [
            {
              "count": 35,
              "label": "pyramid_would_have_helped"
        ...
        },
        {
          ...
          "eligible_count": 61,
          "eligible_rate": 0.273542600896861,
          "label_counts": [
            {
              "count": 30,
              "label": "pyramid_would_have_helped"
        ...
        },
        {
          ...
          "eligible_count": 56,
          "eligible_rate": 0.25112107623318386,
          "label_counts": [
            {
              "count": 29,
              "label": "pyramid_would_have_helped"
        ...
        },
        {
          ...
          "eligible_count": 48,
          "eligible_rate": 0.21524663677130046,
          "label_counts": [
            {
              "count": 26,
              "label": "pyramid_would_have_helped"
        ...
        },
        {
          ...
          "eligible_count": 44,
          "eligible_rate": 0.19730941704035873,
          "label_counts": [
            {
              "count": 25,
              "label": "pyramid_would_have_helped"
        ...
        },
        {
          ...
          "eligible_count": 42,
          "eligible_rate": 0.18834080717488788,
          "label_counts": [
            {
              "count": 25,
              "label": "pyramid_would_have_helped"
        ...
        },
        {
          ...
          "eligible_count": 39,
          "eligible_rate": 0.17488789237668162,
          "label_counts": [
            {
              "count": 23,
              "label": "pyramid_would_have_helped"
      ...
      "recommended_action": "hold_sample",
      "recommended_action_reason": "source_quality_not_pass",
      "recovered_or_extended_count": 53,
      "recovered_or_extended_rate": 0.23766816143497757,
      "reversal_or_flat_count": 86,
      "reversal_or_flat_rate": 0.38565022421524664,
      "sample_count": 223,
      "source_quality_pass": false
    },
    "source_quality_blocked": "source_quality_not_pass",
    ...
    "source_reports": [
      ...
      "/home/ubuntu/KORStockScan/data/report/scalping_pyramid_intraday_feedback/scalping_pyramid_intraday_feedback_2026-07-30.json",
      "/home/ubuntu/KORStockScan/data/report/scalping_pyramid_intraday_feedback/scalping_pyramid_intraday_feedback_2026-07-31.json"
    ],
    "stage": "scale_in",
    "target_env_keys": [],
    "threshold_version": "scalping_pyramid_quality_gate:2026-07-31:v1",
    "same_stage_owner_stage": "scale_in",
    "sample_floor_passed": false,
    "apply_block_reason": "source_quality_blocked",
    "ai_score_optimization_source_report_type": "scalping_pyramid_quality_calibration",
    "ai_score_optimization_source_path": "/home/ubuntu/KORStockScan/data/report/scalping_pyramid_quality_calibration/scalping_pyramid_quality_calibration_2026-07-31.json"
  }
]
```

# Postclose DONE Controller - 2026-07-02

- status: `done`
- final_verifier_status: `warning`
- root_cause: `active_sim_priority_preopen_handoff_pending,ai_watching_score_smoothing_diagnostic_followup_open,quote_consistency_required_fields_excluded,quote_consistency_source_missing,swing_active_arm_priority_preopen_handoff_pending,swing_active_arm_priority_runtime_observation_missing,active_or_hypothesis_preopen_handoff_pending`

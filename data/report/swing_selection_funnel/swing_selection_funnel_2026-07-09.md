# Swing Selection Funnel Report - 2026-07-09
...
- `holding_flow_ofi_smoothing_applied` 가온칩스(399720): 2
- `holding_flow_ofi_smoothing_applied` 칩스앤미디어(094360): 1
- `holding_flow_ofi_smoothing_applied` 에이디테크놀로지(200710): 1
- `holding_flow_ofi_smoothing_applied` 금호건설(002990): 1

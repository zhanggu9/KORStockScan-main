# Lifecycle AI Context Attribution - 2026-08-18

- authority: `postclose_context_attribution_only`
- runtime_effect: `False`
- context eligible/applied/skipped: `519` / `519` / `0`
...
| --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | --- |
| `entry` | `519` | `519` | `0` | `0.3931` | `0` | `None` | `None` | `-0.0748` | `observational_only_pending_outcome` |

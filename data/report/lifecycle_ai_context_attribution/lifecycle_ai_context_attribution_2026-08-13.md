# Lifecycle AI Context Attribution - 2026-08-13

- authority: `postclose_context_attribution_only`
- runtime_effect: `False`
- context eligible/applied/skipped: `422` / `422` / `0`
...
| --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | --- |
| `entry` | `422` | `422` | `0` | `0.4716` | `0` | `None` | `None` | `-0.0199` | `observational_only_pending_outcome` |

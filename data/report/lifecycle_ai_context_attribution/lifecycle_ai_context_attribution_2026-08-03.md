# Lifecycle AI Context Attribution - 2026-08-03

- authority: `postclose_context_attribution_only`
- runtime_effect: `False`
- context eligible/applied/skipped: `791` / `791` / `0`
...
| --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | --- |
| `entry` | `791` | `791` | `0` | `0.3919` | `0` | `None` | `None` | `-0.0757` | `observational_only_pending_outcome` |

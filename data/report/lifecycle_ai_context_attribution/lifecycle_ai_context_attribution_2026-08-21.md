# Lifecycle AI Context Attribution - 2026-08-21

- authority: `postclose_context_attribution_only`
- runtime_effect: `False`
- context eligible/applied/skipped: `348` / `348` / `0`
...
| --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | --- |
| `entry` | `348` | `348` | `0` | `0.5345` | `0` | `None` | `None` | `0.0241` | `observational_only_pending_outcome` |

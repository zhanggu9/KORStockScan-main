# Lifecycle AI Context Attribution - 2026-07-10

- authority: `postclose_context_attribution_only`
- runtime_effect: `False`
- context eligible/applied/skipped: `316` / `316` / `0`
...
| --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | --- |
| `entry` | `316` | `316` | `0` | `0.7373` | `0` | `None` | `None` | `0.1661` | `observational_only_pending_outcome` |

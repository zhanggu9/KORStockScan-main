# Lifecycle AI Context Attribution - 2026-07-01

- authority: `postclose_context_attribution_only`
- runtime_effect: `False`
- context eligible/applied/skipped: `251` / `251` / `0`
...
| --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | --- |
| `entry` | `251` | `251` | `0` | `0.0837` | `0` | `None` | `None` | `-0.2914` | `observational_only_pending_outcome` |

# Lifecycle AI Context Attribution - 2026-08-04

- authority: `postclose_context_attribution_only`
- runtime_effect: `False`
- context eligible/applied/skipped: `644` / `644` / `0`
...
| --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | --- |
| `entry` | `644` | `644` | `0` | `0.0047` | `0` | `None` | `None` | `-0.3467` | `observational_only_pending_outcome` |

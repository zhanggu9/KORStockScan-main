# Lifecycle AI Context Attribution - 2026-08-24

- authority: `postclose_context_attribution_only`
- runtime_effect: `False`
- context eligible/applied/skipped: `459` / `459` / `0`
...
| --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | --- |
| `entry` | `459` | `459` | `0` | `0.4444` | `0` | `None` | `None` | `-0.0389` | `observational_only_pending_outcome` |

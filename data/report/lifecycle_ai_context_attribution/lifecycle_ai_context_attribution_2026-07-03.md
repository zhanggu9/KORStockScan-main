# Lifecycle AI Context Attribution - 2026-07-03

- authority: `postclose_context_attribution_only`
- runtime_effect: `False`
- context eligible/applied/skipped: `231` / `231` / `0`
...
| --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | --- |
| `entry` | `231` | `231` | `0` | `0.0346` | `0` | `None` | `None` | `-0.3258` | `observational_only_pending_outcome` |

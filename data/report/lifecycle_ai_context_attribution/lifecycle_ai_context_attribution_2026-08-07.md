# Lifecycle AI Context Attribution - 2026-08-07

- authority: `postclose_context_attribution_only`
- runtime_effect: `False`
- context eligible/applied/skipped: `573` / `573` / `0`
...
| --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | --- |
| `entry` | `573` | `573` | `0` | `0.2496` | `0` | `None` | `None` | `-0.1753` | `observational_only_pending_outcome` |

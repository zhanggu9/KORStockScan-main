# Lifecycle AI Context Attribution - 2026-06-19

- authority: `postclose_context_attribution_only`
- runtime_effect: `False`
- context eligible/applied/skipped: `864` / `864` / `0`
...
| --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | --- |
| `entry` | `864` | `864` | `0` | `0.0509` | `0` | `None` | `None` | `-0.3144` | `observational_only_pending_outcome` |

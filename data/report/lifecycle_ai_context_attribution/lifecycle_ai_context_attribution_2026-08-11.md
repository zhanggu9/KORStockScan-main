# Lifecycle AI Context Attribution - 2026-08-11

- authority: `postclose_context_attribution_only`
- runtime_effect: `False`
- context eligible/applied/skipped: `435` / `435` / `0`
...
| --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | --- |
| `entry` | `435` | `435` | `0` | `0.423` | `0` | `None` | `None` | `-0.0539` | `observational_only_pending_outcome` |

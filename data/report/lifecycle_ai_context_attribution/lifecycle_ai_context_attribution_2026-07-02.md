# Lifecycle AI Context Attribution - 2026-07-02

- authority: `postclose_context_attribution_only`
- runtime_effect: `False`
- context eligible/applied/skipped: `428` / `428` / `0`
...
| --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | --- |
| `entry` | `428` | `428` | `0` | `0.1145` | `0` | `None` | `None` | `-0.2698` | `observational_only_pending_outcome` |

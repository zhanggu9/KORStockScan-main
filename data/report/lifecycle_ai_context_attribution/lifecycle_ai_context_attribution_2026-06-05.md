# Lifecycle AI Context Attribution - 2026-06-05

- authority: `postclose_context_attribution_only`
- runtime_effect: `False`
- context eligible/applied/skipped: `3179` / `3179` / `0`
...
| --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | --- |
| `entry` | `3179` | `3179` | `0` | `0.9868` | `0` | `None` | `None` | `0.3408` | `observational_only_pending_outcome` |

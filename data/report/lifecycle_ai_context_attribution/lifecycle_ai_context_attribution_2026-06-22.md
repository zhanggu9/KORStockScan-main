# Lifecycle AI Context Attribution - 2026-06-22

- authority: `postclose_context_attribution_only`
- runtime_effect: `False`
- context eligible/applied/skipped: `744` / `744` / `0`
...
| --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | --- |
| `entry` | `744` | `744` | `0` | `0.1169` | `0` | `None` | `None` | `-0.2682` | `observational_only_pending_outcome` |

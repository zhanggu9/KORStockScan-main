# Lifecycle AI Context Attribution - 2026-08-26

- authority: `postclose_context_attribution_only`
- runtime_effect: `False`
- context eligible/applied/skipped: `536` / `536` / `0`
...
| --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | --- |
| `entry` | `536` | `536` | `0` | `None` | `0` | `None` | `None` | `0.0` | `observational_only_pending_outcome` |

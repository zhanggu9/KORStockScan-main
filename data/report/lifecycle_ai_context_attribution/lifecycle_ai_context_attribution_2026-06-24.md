# Lifecycle AI Context Attribution - 2026-06-24

- authority: `postclose_context_attribution_only`
- runtime_effect: `False`
- context eligible/applied/skipped: `1020` / `1020` / `0`
...
| --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | --- |
| `entry` | `1020` | `1020` | `0` | `None` | `0` | `None` | `None` | `0.0` | `observational_only_pending_outcome` |

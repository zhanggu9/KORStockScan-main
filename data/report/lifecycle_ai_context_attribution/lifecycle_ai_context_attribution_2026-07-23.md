# Lifecycle AI Context Attribution - 2026-07-23

- authority: `postclose_context_attribution_only`
- runtime_effect: `False`
- context eligible/applied/skipped: `108` / `108` / `0`
...
| --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | --- |
| `entry` | `108` | `108` | `0` | `0.0093` | `0` | `None` | `None` | `-0.3435` | `observational_only_pending_outcome` |

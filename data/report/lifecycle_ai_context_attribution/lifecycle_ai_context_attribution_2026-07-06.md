# Lifecycle AI Context Attribution - 2026-07-06

- authority: `postclose_context_attribution_only`
- runtime_effect: `False`
- context eligible/applied/skipped: `382` / `382` / `0`
...
| --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | --- |
| `entry` | `382` | `382` | `0` | `0.1021` | `0` | `None` | `None` | `-0.2785` | `observational_only_pending_outcome` |

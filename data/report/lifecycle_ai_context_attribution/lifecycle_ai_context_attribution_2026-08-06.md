# Lifecycle AI Context Attribution - 2026-08-06

- authority: `postclose_context_attribution_only`
- runtime_effect: `False`
- context eligible/applied/skipped: `884` / `884` / `0`
...
| --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | --- |
| `entry` | `884` | `884` | `0` | `0.0` | `0` | `None` | `None` | `-0.35` | `observational_only_pending_outcome` |

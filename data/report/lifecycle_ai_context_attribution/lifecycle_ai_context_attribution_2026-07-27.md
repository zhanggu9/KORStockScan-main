# Lifecycle AI Context Attribution - 2026-07-27

- authority: `postclose_context_attribution_only`
- runtime_effect: `False`
- context eligible/applied/skipped: `40` / `40` / `0`
...
| --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | --- |
| `entry` | `40` | `40` | `0` | `None` | `0` | `None` | `None` | `0.0` | `observational_only_pending_outcome` |

# Lifecycle AI Context Attribution - 2026-06-08

- authority: `postclose_context_attribution_only`
- runtime_effect: `False`
- context eligible/applied/skipped: `2421` / `2421` / `0`
...
| --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | --- |
| `entry` | `2421` | `2421` | `0` | `0.3143` | `0` | `None` | `None` | `-0.13` | `observational_only_pending_outcome` |

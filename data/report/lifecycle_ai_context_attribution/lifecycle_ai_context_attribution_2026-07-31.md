# Lifecycle AI Context Attribution - 2026-07-31

- authority: `postclose_context_attribution_only`
- runtime_effect: `False`
- context eligible/applied/skipped: `538` / `538` / `0`
...
| --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | --- |
| `entry` | `538` | `538` | `0` | `0.0074` | `0` | `None` | `None` | `-0.3448` | `observational_only_pending_outcome` |

# Lifecycle AI Context Attribution - 2026-07-20

- authority: `postclose_context_attribution_only`
- runtime_effect: `False`
- context eligible/applied/skipped: `37` / `37` / `0`
...
| --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | --- |
| `entry` | `37` | `37` | `0` | `None` | `0` | `None` | `None` | `0.0` | `observational_only_pending_outcome` |

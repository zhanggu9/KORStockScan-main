# Lifecycle AI Context Attribution - 2026-06-25

- authority: `postclose_context_attribution_only`
- runtime_effect: `False`
- context eligible/applied/skipped: `1226` / `1226` / `0`
...
| --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | --- |
| `entry` | `1226` | `1226` | `0` | `0.0661` | `0` | `None` | `None` | `-0.3037` | `observational_only_pending_outcome` |

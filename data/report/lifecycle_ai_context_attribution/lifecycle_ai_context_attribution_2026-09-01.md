# Lifecycle AI Context Attribution - 2026-09-01

- authority: `postclose_context_attribution_only`
- runtime_effect: `False`
- context eligible/applied/skipped: `401` / `401` / `0`
...
| --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | --- |
| `entry` | `401` | `401` | `0` | `0.3342` | `0` | `None` | `None` | `-0.1161` | `observational_only_pending_outcome` |

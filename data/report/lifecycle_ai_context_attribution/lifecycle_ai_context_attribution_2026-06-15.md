# Lifecycle AI Context Attribution - 2026-06-15

- authority: `postclose_context_attribution_only`
- runtime_effect: `False`
- context eligible/applied/skipped: `3101` / `3101` / `0`
...
| --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | --- |
| `entry` | `3101` | `3101` | `0` | `0.0339` | `0` | `None` | `None` | `-0.3263` | `observational_only_pending_outcome` |

# Lifecycle AI Context Attribution - 2026-06-09

- authority: `postclose_context_attribution_only`
- runtime_effect: `False`
- context eligible/applied/skipped: `3869` / `3869` / `0`
...
| --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | --- |
| `entry` | `3869` | `3869` | `0` | `0.0607` | `0` | `None` | `None` | `-0.3075` | `observational_only_pending_outcome` |

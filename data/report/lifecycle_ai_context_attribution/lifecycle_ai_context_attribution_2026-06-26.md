# Lifecycle AI Context Attribution - 2026-06-26

- authority: `postclose_context_attribution_only`
- runtime_effect: `False`
- context eligible/applied/skipped: `1285` / `1285` / `0`
...
| --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | --- |
| `entry` | `1285` | `1285` | `0` | `0.0654` | `0` | `None` | `None` | `-0.3042` | `observational_only_pending_outcome` |

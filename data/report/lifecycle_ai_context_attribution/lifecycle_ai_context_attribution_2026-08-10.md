# Lifecycle AI Context Attribution - 2026-08-10

- authority: `postclose_context_attribution_only`
- runtime_effect: `False`
- context eligible/applied/skipped: `561` / `561` / `0`
...
| --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | --- |
| `entry` | `561` | `561` | `0` | `0.4759` | `0` | `None` | `None` | `-0.0169` | `observational_only_pending_outcome` |

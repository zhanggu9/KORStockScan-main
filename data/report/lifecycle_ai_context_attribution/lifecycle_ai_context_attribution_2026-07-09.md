# Lifecycle AI Context Attribution - 2026-07-09

- authority: `postclose_context_attribution_only`
- runtime_effect: `False`
- context eligible/applied/skipped: `85` / `85` / `0`
...
| --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | --- |
| `entry` | `85` | `85` | `0` | `0.6824` | `0` | `None` | `None` | `0.1277` | `observational_only_pending_outcome` |

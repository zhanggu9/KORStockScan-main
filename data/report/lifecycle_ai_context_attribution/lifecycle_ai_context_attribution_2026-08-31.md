# Lifecycle AI Context Attribution - 2026-08-31

- authority: `postclose_context_attribution_only`
- runtime_effect: `False`
- context eligible/applied/skipped: `537` / `537` / `0`
...
| --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | --- |
| `entry` | `537` | `537` | `0` | `0.365` | `0` | `None` | `None` | `-0.0945` | `observational_only_pending_outcome` |

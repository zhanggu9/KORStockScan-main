# Lifecycle AI Context Attribution - 2026-06-10

- authority: `postclose_context_attribution_only`
- runtime_effect: `False`
- context eligible/applied/skipped: `2743` / `2743` / `0`
...
| --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | --- |
| `entry` | `2743` | `2743` | `0` | `0.2884` | `0` | `None` | `None` | `-0.1481` | `observational_only_pending_outcome` |

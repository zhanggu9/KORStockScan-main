# Lifecycle AI Context Attribution - 2026-07-14

- authority: `postclose_context_attribution_only`
- runtime_effect: `False`
- context eligible/applied/skipped: `63` / `63` / `0`
...
| --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | --- |
| `entry` | `63` | `63` | `0` | `0.7619` | `0` | `None` | `None` | `0.1833` | `observational_only_pending_outcome` |

# Lifecycle AI Context Attribution - 2026-07-16

- authority: `postclose_context_attribution_only`
- runtime_effect: `False`
- context eligible/applied/skipped: `53` / `53` / `0`
...
| --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | --- |
| `entry` | `53` | `53` | `0` | `0.0377` | `0` | `None` | `None` | `-0.3236` | `observational_only_pending_outcome` |

# Lifecycle AI Context Attribution - 2026-06-11

- authority: `postclose_context_attribution_only`
- runtime_effect: `False`
- context eligible/applied/skipped: `3488` / `3488` / `0`
...
| --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | --- |
| `entry` | `3488` | `3488` | `0` | `None` | `0` | `None` | `None` | `0.0` | `observational_only_pending_outcome` |

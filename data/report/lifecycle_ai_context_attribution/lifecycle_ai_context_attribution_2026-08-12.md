# Lifecycle AI Context Attribution - 2026-08-12

- authority: `postclose_context_attribution_only`
- runtime_effect: `False`
- context eligible/applied/skipped: `553` / `553` / `0`
...
| --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | --- |
| `entry` | `553` | `553` | `0` | `0.3635` | `0` | `None` | `None` | `-0.0955` | `observational_only_pending_outcome` |

# Lifecycle AI Context Attribution - 2026-06-17

- authority: `postclose_context_attribution_only`
- runtime_effect: `False`
- context eligible/applied/skipped: `3332` / `3332` / `0`
...
| --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | --- |
| `entry` | `3332` | `3332` | `0` | `0.0381` | `0` | `None` | `None` | `-0.3233` | `observational_only_pending_outcome` |

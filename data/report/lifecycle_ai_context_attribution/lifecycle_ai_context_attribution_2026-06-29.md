# Lifecycle AI Context Attribution - 2026-06-29

- authority: `postclose_context_attribution_only`
- runtime_effect: `False`
- context eligible/applied/skipped: `913` / `913` / `0`
...
| --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | --- |
| `entry` | `913` | `913` | `0` | `0.1062` | `0` | `None` | `None` | `-0.2757` | `observational_only_pending_outcome` |

# Lifecycle AI Context Attribution - 2026-08-27

- authority: `postclose_context_attribution_only`
- runtime_effect: `False`
- context eligible/applied/skipped: `526` / `526` / `0`
...
| --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | --- |
| `entry` | `526` | `526` | `0` | `0.2814` | `0` | `None` | `None` | `-0.153` | `observational_only_pending_outcome` |

# Lifecycle AI Context Attribution - 2026-06-23

- authority: `postclose_context_attribution_only`
- runtime_effect: `False`
- context eligible/applied/skipped: `909` / `909` / `0`
...
| --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | --- |
| `entry` | `909` | `909` | `0` | `0.1067` | `0` | `None` | `None` | `-0.2753` | `observational_only_pending_outcome` |

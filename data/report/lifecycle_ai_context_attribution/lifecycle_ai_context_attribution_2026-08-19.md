# Lifecycle AI Context Attribution - 2026-08-19

- authority: `postclose_context_attribution_only`
- runtime_effect: `False`
- context eligible/applied/skipped: `361` / `361` / `0`
...
| --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | --- |
| `entry` | `361` | `361` | `0` | `0.5263` | `0` | `None` | `None` | `0.0184` | `observational_only_pending_outcome` |

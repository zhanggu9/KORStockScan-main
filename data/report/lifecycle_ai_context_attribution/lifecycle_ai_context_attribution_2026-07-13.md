# Lifecycle AI Context Attribution - 2026-07-13

- authority: `postclose_context_attribution_only`
- runtime_effect: `False`
- context eligible/applied/skipped: `94` / `94` / `0`
...
| --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | --- |
| `entry` | `94` | `94` | `0` | `None` | `0` | `None` | `None` | `0.0` | `observational_only_pending_outcome` |

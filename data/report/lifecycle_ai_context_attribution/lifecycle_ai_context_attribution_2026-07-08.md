# Lifecycle AI Context Attribution - 2026-07-08

- authority: `postclose_context_attribution_only`
- runtime_effect: `False`
- context eligible/applied/skipped: `568` / `568` / `0`
...
| --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | --- |
| `entry` | `568` | `568` | `0` | `0.6778` | `0` | `None` | `None` | `0.1245` | `observational_only_pending_outcome` |

# Lifecycle AI Context Attribution - 2026-06-18

- authority: `postclose_context_attribution_only`
- runtime_effect: `False`
- context eligible/applied/skipped: `1805` / `1805` / `0`
...
| --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | --- |
| `entry` | `1805` | `1805` | `0` | `0.0992` | `0` | `None` | `None` | `-0.2806` | `observational_only_pending_outcome` |

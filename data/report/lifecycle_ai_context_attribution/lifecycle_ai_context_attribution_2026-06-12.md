# Lifecycle AI Context Attribution - 2026-06-12

- authority: `postclose_context_attribution_only`
- runtime_effect: `False`
- context eligible/applied/skipped: `3587` / `3587` / `0`
...
| --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | --- |
| `entry` | `3587` | `3587` | `0` | `0.7812` | `0` | `None` | `None` | `0.1968` | `observational_only_pending_outcome` |

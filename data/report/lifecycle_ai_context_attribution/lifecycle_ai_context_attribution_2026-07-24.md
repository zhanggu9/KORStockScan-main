# Lifecycle AI Context Attribution - 2026-07-24

- authority: `postclose_context_attribution_only`
- runtime_effect: `False`
- context eligible/applied/skipped: `23` / `23` / `0`
...
| --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | --- |
| `entry` | `23` | `23` | `0` | `None` | `0` | `None` | `None` | `0.0` | `observational_only_pending_outcome` |

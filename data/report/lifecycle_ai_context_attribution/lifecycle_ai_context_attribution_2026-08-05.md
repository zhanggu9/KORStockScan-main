# Lifecycle AI Context Attribution - 2026-08-05

- authority: `postclose_context_attribution_only`
- runtime_effect: `False`
- context eligible/applied/skipped: `715` / `715` / `0`
...
| --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | --- |
| `entry` | `715` | `715` | `0` | `0.0014` | `0` | `None` | `None` | `-0.349` | `observational_only_pending_outcome` |

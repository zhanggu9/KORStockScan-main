# Lifecycle AI Context Attribution - 2026-07-07

- authority: `postclose_context_attribution_only`
- runtime_effect: `False`
- context eligible/applied/skipped: `351` / `351` / `0`
...
| --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | --- |
| `entry` | `351` | `351` | `0` | `0.0171` | `0` | `None` | `None` | `-0.338` | `observational_only_pending_outcome` |

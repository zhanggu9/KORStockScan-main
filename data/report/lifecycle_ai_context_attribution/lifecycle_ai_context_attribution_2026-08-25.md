# Lifecycle AI Context Attribution - 2026-08-25

- authority: `postclose_context_attribution_only`
- runtime_effect: `False`
- context eligible/applied/skipped: `492` / `492` / `0`
...
| --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | --- |
| `entry` | `492` | `492` | `0` | `0.4878` | `0` | `None` | `None` | `-0.0085` | `observational_only_pending_outcome` |

# Rising Missed Classifier Prior - 2026-08-18
...
- bounded_probe_exploration_candidate_count: 0
...
- entry_score_parent=-|entry_source_parent=-|source_signature=BID_IMBALANCE_SURGE,NEW_HIGH_CONFIRMATION,OPEN_TOP,PREV_CLOSE_GAINER,PRICE_JUMP_START,VI_TRIGGERED,VOLUME_SURGE_POSITIVE|liquidity_bucket=-|strength_bucket=-|overbought_bucket=-|chosen_action=- | recommendation=hold_sample | confidence=low | window=None | reason=insufficient_positive_rolling_prior
...
- entry_score_parent=-|entry_source_parent=-|source_signature=BID_IMBALANCE_SURGE,OPEN_TOP,PREV_CLOSE_GAINER,PRICE_JUMP_START,VI_TRIGGERED|liquidity_bucket=-|strength_bucket=-|overbought_bucket=-|chosen_action=- | recommendation=loss_filter | confidence=medium | window=None | reason=counterfactual_avoided_loser_exceeds_missed_winner
...
- tp1_selector|tp1_micro_ws_unavailable | assessment=hold_loss_dominant | sample=394 | target_first=19 | adverse_first=63 | payoff_proxy=-0.049239
- tp1_selector|rising_missed_tp1_nxt_fast_tape_confirmation_required | assessment=hold_loss_dominant | sample=347 | target_first=20 | adverse_first=62 | payoff_proxy=-0.050144
- tp1_selector|rising_missed_tp1_lane_not_eligible | assessment=hold_loss_dominant | sample=179 | target_first=14 | adverse_first=49 | payoff_proxy=-0.089944
- tp1_selector|rising_missed_tp1_hard_negative_evidence | assessment=hold_loss_dominant | sample=45 | target_first=7 | adverse_first=20 | payoff_proxy=-0.108889
- latency_block|latency_state_danger | assessment=hold_loss_dominant | sample=43 | target_first=4 | adverse_first=31 | payoff_proxy=-0.383721
- tp1_selector|rising_missed_tp1_insufficient_positive_support | assessment=hold_loss_dominant | sample=30 | target_first=3 | adverse_first=9 | payoff_proxy=-0.08
- tp1_selector|rising_missed_tp1_ai_state_blocked | assessment=hold_loss_dominant | sample=29 | target_first=5 | adverse_first=11 | payoff_proxy=-0.041379
- tp1_selector|rising_missed_tp1_wait_confirmation_pending | assessment=hold_loss_dominant | sample=20 | target_first=4 | adverse_first=8 | payoff_proxy=-0.02
- rising_missed_tick_speed_entry_block|tick_acceleration_ratio_lt_1 | assessment=hold_loss_dominant | sample=9 | target_first=2 | adverse_first=5 | payoff_proxy=-0.1

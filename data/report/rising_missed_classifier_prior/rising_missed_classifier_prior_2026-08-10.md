# Rising Missed Classifier Prior - 2026-08-10

- generated_at: 2026-08-10T21:56:31+09:00
...
- recommendation_counts: {"hold_sample": 41, "loss_filter": 18, "positive_prior": 8, "recheck_prior": 1, "source_quality_blocked": 1}
...
- entry_score_parent=-|entry_source_parent=-|source_signature=BID_IMBALANCE_SURGE,OPEN_TOP,PREV_CLOSE_GAINER,PRICE_JUMP_START,VOLUME_SURGE_POSITIVE|liquidity_bucket=-|strength_bucket=-|overbought_bucket=-|chosen_action=- | recommendation=hold_sample | confidence=low | window=None | reason=insufficient_positive_rolling_prior
...
- entry_score_parent=-|entry_source_parent=-|source_signature=BID_IMBALANCE_SURGE,OPEN_TOP,PREV_CLOSE_GAINER|liquidity_bucket=-|strength_bucket=-|overbought_bucket=-|chosen_action=- | recommendation=hold_sample | confidence=low | window=None | reason=counterfactual_missed_winner_waiting_rolling_confirmation
...
- entry_score_parent=-|entry_source_parent=-|source_signature=LOW_REBOUND_RISING_MISSED,NEW_HIGH_CONFIRMATION|liquidity_bucket=-|strength_bucket=-|overbought_bucket=-|chosen_action=- | recommendation=hold_sample | confidence=low | window=None | reason=insufficient_positive_rolling_prior
...
- entry_score_parent=-|entry_source_parent=-|source_signature=LOW_REBOUND_RISING_MISSED,REALTIME_RANK_START,VALUE_TOP|liquidity_bucket=-|strength_bucket=-|overbought_bucket=-|chosen_action=- | recommendation=hold_sample | confidence=low | window=None | reason=counterfactual_missed_winner_waiting_rolling_confirmation
- entry_score_parent=-|entry_source_parent=-|source_signature=LOW_REBOUND_RISING_MISSED,VI_TRIGGERED,VOLUME_SURGE_POSITIVE|liquidity_bucket=-|strength_bucket=-|overbought_bucket=-|chosen_action=- | recommendation=loss_filter | confidence=medium | window=None | reason=counterfactual_avoided_loser_exceeds_missed_winner
...
- entry_score_parent=-|entry_source_parent=-|source_signature=NEW_HIGH_CONFIRMATION,PREV_CLOSE_GAINER,PRICE_JUMP_START,VOLUME_SURGE_POSITIVE|liquidity_bucket=-|strength_bucket=-|overbought_bucket=-|chosen_action=- | recommendation=loss_filter | confidence=medium | window=None | reason=counterfactual_avoided_loser_exceeds_missed_winner

## Blocker Outcome Priors

- tp1_selector|rising_missed_tp1_lane_not_eligible | assessment=bounded_probe_exploration_candidate | sample=95 | target_first=11 | adverse_first=20 | payoff_proxy=0.003158
- tp1_selector|rising_missed_tp1_wait_confirmation_pending | assessment=bounded_probe_exploration_candidate | sample=11 | target_first=2 | adverse_first=2 | payoff_proxy=0.109091
- rising_missed_tick_speed_entry_block|tick_acceleration_ratio_lt_1 | assessment=bounded_probe_exploration_candidate | sample=3 | target_first=2 | adverse_first=0 | payoff_proxy=0.866667
- tp1_selector|tp1_micro_ws_unavailable | assessment=hold_loss_dominant | sample=244 | target_first=10 | adverse_first=36 | payoff_proxy=-0.05
- tp1_selector|rising_missed_tp1_nxt_fast_tape_confirmation_required | assessment=hold_loss_dominant | sample=229 | target_first=14 | adverse_first=32 | payoff_proxy=-0.018341
...
- tp1_selector|rising_missed_tp1_insufficient_positive_support | assessment=hold_loss_dominant | sample=26 | target_first=3 | adverse_first=7 | payoff_proxy=-0.038462
- tp1_selector|rising_missed_tp1_hard_negative_evidence | assessment=hold_loss_dominant | sample=21 | target_first=3 | adverse_first=10 | payoff_proxy=-0.147619

# Holding/Exit Decision Matrix - 2026-07-23

## 판정

- matrix_version: `holding_exit_decision_matrix_v1_2026-07-23`
...
- per_action_samples: `{'exit_only': 153, 'avg_down_wait': 9, 'pyramid_wait': 0}`
- proxy_sample_snapshots: `708`
- proxy_joined_candidates: `208`
- proxy_actions_present: `['hold_defer', 'exit_only', 'avg_down_wait', 'pyramid_wait']`
- proxy_missing_actions: `[]`
- proxy_per_action_samples: `{'hold_defer': 508, 'exit_only': 514, 'avg_down_wait': 385, 'pyramid_wait': 119}`
...
| --- | --- | --- | ---: | ---: | ---: | ---: | --- | --- | --- |
| price_bucket | price_10k_30k | no_clear_edge | -0.563 | - | 21 | 0.4286 | False | pyramid_wait | candidate_weight_source |
| price_bucket | price_30k_70k | no_clear_edge | - | - | - | - | False | avg_down_wait,pyramid_wait | insufficient_sample |
| price_bucket | price_gte_70k | no_clear_edge | -1.0332 | - | 11 | 0.4545 | False | avg_down_wait,pyramid_wait | candidate_weight_source |
| price_bucket | price_lt_10k | no_clear_edge | -0.1981 | - | 17 | 0.3529 | False | pyramid_wait | candidate_weight_source |
| volume_bucket | volume_2m_10m | no_clear_edge | -0.3652 | - | 17 | 0.2941 | False | avg_down_wait,pyramid_wait | candidate_weight_source |
| volume_bucket | volume_500k_2m | no_clear_edge | -0.5019 | - | 21 | 0.3333 | False | pyramid_wait | candidate_weight_source |
| volume_bucket | volume_gte_10m | no_clear_edge | - | - | - | - | False | pyramid_wait | insufficient_sample |
| volume_bucket | volume_lt_500k | no_clear_edge | -1.2207 | - | 8 | 0.625 | False | pyramid_wait | candidate_weight_source |
...
| time_bucket | time_0930_1030 | no_clear_edge | -0.5707 | - | 8 | 0.25 | False | pyramid_wait | candidate_weight_source |
| time_bucket | time_1030_1400 | no_clear_edge | -0.275 | - | 25 | 0.36 | False | pyramid_wait | candidate_weight_source |
| time_bucket | time_1400_1530 | no_clear_edge | - | - | - | - | False | avg_down_wait,pyramid_wait | insufficient_sample |
| time_bucket | time_outside_regular | no_clear_edge | -0.6565 | - | 15 | 0.4667 | False | pyramid_wait | candidate_weight_source |

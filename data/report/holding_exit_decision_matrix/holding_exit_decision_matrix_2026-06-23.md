# Holding/Exit Decision Matrix - 2026-06-23

## 판정

- matrix_version: `holding_exit_decision_matrix_v1_2026-06-23`
...
- per_action_samples: `{'exit_only': 33, 'avg_down_wait': 0, 'pyramid_wait': 3}`
- proxy_sample_snapshots: `2666`
- proxy_joined_candidates: `16`
- proxy_actions_present: `['hold_defer', 'exit_only', 'avg_down_wait', 'pyramid_wait']`
- proxy_missing_actions: `[]`
- proxy_per_action_samples: `{'hold_defer': 2517, 'exit_only': 991, 'avg_down_wait': 1444, 'pyramid_wait': 395}`
...
| price_bucket | price_gte_70k | no_clear_edge | -1.9776 | - | 5 | 0.8 | False | avg_down_wait,pyramid_wait | defensive_only_high_loss_rate |
...
| time_bucket | time_1030_1400 | no_clear_edge | -1.0393 | - | 8 | 0.5 | False | avg_down_wait | candidate_weight_source |

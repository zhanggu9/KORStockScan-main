# Holding/Exit Decision Matrix - 2026-07-28

## 판정

- matrix_version: `holding_exit_decision_matrix_v1_2026-07-28`
...
- per_action_samples: `{'exit_only': 132, 'avg_down_wait': 9, 'pyramid_wait': 0}`
- proxy_sample_snapshots: `154`
- proxy_joined_candidates: `102`
- proxy_actions_present: `['hold_defer', 'exit_only', 'avg_down_wait', 'pyramid_wait']`
- proxy_missing_actions: `[]`
- proxy_per_action_samples: `{'hold_defer': 79, 'exit_only': 82, 'avg_down_wait': 64, 'pyramid_wait': 18}`
...
| --- | --- | --- | ---: | ---: | ---: | ---: | --- | --- | --- |
| price_bucket | price_10k_30k | no_clear_edge | -0.4183 | - | 20 | 0.45 | False | pyramid_wait | candidate_weight_source |
| price_bucket | price_30k_70k | no_clear_edge | - | - | - | - | False | avg_down_wait,pyramid_wait | insufficient_sample |
| price_bucket | price_gte_70k | no_clear_edge | -0.7641 | - | 17 | 0.3529 | False | avg_down_wait,pyramid_wait | candidate_weight_source |
| price_bucket | price_lt_10k | no_clear_edge | -1.388 | - | 6 | 0.5 | False | pyramid_wait | candidate_weight_source |
| volume_bucket | volume_2m_10m | no_clear_edge | -0.6365 | - | 5 | 0.4 | False | avg_down_wait,pyramid_wait | candidate_weight_source |
| volume_bucket | volume_500k_2m | no_clear_edge | -0.3831 | - | 23 | 0.3043 | False | pyramid_wait | candidate_weight_source |
| volume_bucket | volume_gte_10m | no_clear_edge | - | - | - | - | False | pyramid_wait | insufficient_sample |
| volume_bucket | volume_lt_500k | no_clear_edge | -1.465 | - | 11 | 0.7273 | False | pyramid_wait | defensive_only_high_loss_rate |
...
| time_bucket | time_1030_1400 | no_clear_edge | -0.3788 | - | 13 | 0.3077 | False | pyramid_wait | candidate_weight_source |
| time_bucket | time_1400_1530 | no_clear_edge | - | - | - | - | False | avg_down_wait,pyramid_wait | insufficient_sample |
| time_bucket | time_outside_regular | no_clear_edge | -0.5543 | - | 24 | 0.4167 | False | pyramid_wait | candidate_weight_source |

# Holding/Exit Decision Matrix - 2026-08-07

## 판정

- matrix_version: `holding_exit_decision_matrix_v1_2026-08-07`
...
- per_action_samples: `{'exit_only': 72, 'avg_down_wait': 6, 'pyramid_wait': 0}`
- proxy_sample_snapshots: `76`
- proxy_joined_candidates: `0`
- proxy_actions_present: `['hold_defer', 'exit_only', 'avg_down_wait', 'pyramid_wait']`
- proxy_missing_actions: `[]`
- proxy_per_action_samples: `{'hold_defer': 74, 'exit_only': 74, 'avg_down_wait': 69, 'pyramid_wait': 5}`
...
| --- | --- | --- | ---: | ---: | ---: | ---: | --- | --- | --- |
| price_bucket | price_10k_30k | no_clear_edge | -0.3143 | - | 12 | 0.3333 | False | pyramid_wait | candidate_weight_source |
| price_bucket | price_30k_70k | no_clear_edge | - | - | - | - | False | avg_down_wait,pyramid_wait | insufficient_sample |
| price_bucket | price_gte_70k | no_clear_edge | -0.3029 | - | 7 | 0.2857 | False | avg_down_wait,pyramid_wait | candidate_weight_source |
...
| volume_bucket | volume_500k_2m | no_clear_edge | -0.28 | - | 11 | 0.4545 | False | avg_down_wait,pyramid_wait | candidate_weight_source |
| volume_bucket | volume_lt_500k | no_clear_edge | 0.0091 | - | 10 | 0.1 | False | pyramid_wait | candidate_weight_source |
| time_bucket | time_0900_0930 | no_clear_edge | -1.0084 | - | 5 | 0.4 | False | avg_down_wait,pyramid_wait | candidate_weight_source |
| time_bucket | time_0930_1030 | no_clear_edge | 0.1008 | - | 11 | 0.1818 | False | pyramid_wait | candidate_weight_source |
| time_bucket | time_1030_1400 | no_clear_edge | - | - | - | - | False | avg_down_wait,pyramid_wait | insufficient_sample |
| time_bucket | time_outside_regular | no_clear_edge | 0.0715 | - | 6 | 0.3333 | False | avg_down_wait,pyramid_wait | candidate_weight_source |

...
- per_action_samples: `{'exit_only': 57, 'avg_down_wait': 0, 'pyramid_wait': 6}`
...
| --- | --- | --- | ---: | ---: | ---: | ---: | --- | --- | --- |
| price_bucket | price_10k_30k | no_clear_edge | -0.3751 | - | 8 | 0.5 | False | avg_down_wait | candidate_weight_source |
| price_bucket | price_gte_70k | no_clear_edge | -0.6441 | - | 11 | 0.5455 | False | avg_down_wait | candidate_weight_source |
| volume_bucket | volume_2m_10m | no_clear_edge | -0.3693 | - | 8 | 0.375 | False | avg_down_wait | candidate_weight_source |
| volume_bucket | volume_500k_2m | no_clear_edge | -0.4881 | - | 7 | 0.4286 | False | avg_down_wait,pyramid_wait | candidate_weight_source |
...
| time_bucket | time_0930_1030 | no_clear_edge | -0.1903 | - | 6 | 0.3333 | False | avg_down_wait | candidate_weight_source |
| time_bucket | time_1030_1400 | no_clear_edge | -0.5215 | - | 12 | 0.5833 | False | avg_down_wait | candidate_weight_source |

# Holding/Exit Decision Matrix - 2026-08-13

## 판정

- matrix_version: `holding_exit_decision_matrix_v1_2026-08-13`
...
- proxy_sample_snapshots: `982`
- proxy_joined_candidates: `231`
- proxy_actions_present: `['hold_defer', 'exit_only', 'avg_down_wait', 'pyramid_wait']`
- proxy_missing_actions: `[]`
- proxy_per_action_samples: `{'hold_defer': 971, 'exit_only': 975, 'avg_down_wait': 898, 'pyramid_wait': 77}`

# Holding/Exit Decision Matrix - 2026-08-28

## 판정

- matrix_version: `holding_exit_decision_matrix_v1_2026-08-28`
...
- per_action_samples: `{'exit_only': 75, 'avg_down_wait': 0, 'pyramid_wait': 0}`
- proxy_sample_snapshots: `513`
- proxy_joined_candidates: `143`
- proxy_actions_present: `['hold_defer', 'exit_only', 'avg_down_wait', 'pyramid_wait']`
- proxy_missing_actions: `[]`
- proxy_per_action_samples: `{'hold_defer': 508, 'exit_only': 510, 'avg_down_wait': 451, 'pyramid_wait': 59}`
...
| --- | --- | --- | ---: | ---: | ---: | ---: | --- | --- | --- |
| price_bucket | price_10k_30k | no_clear_edge | -0.8125 | - | 15 | 0.2667 | False | avg_down_wait,pyramid_wait | candidate_weight_source |
| price_bucket | price_30k_70k | no_clear_edge | - | - | - | - | False | avg_down_wait,pyramid_wait | insufficient_sample |
| price_bucket | price_gte_70k | no_clear_edge | -1.0448 | - | 8 | 0.375 | False | avg_down_wait,pyramid_wait | candidate_weight_source |
...
| volume_bucket | volume_500k_2m | no_clear_edge | -0.794 | - | 7 | 0.2857 | False | avg_down_wait,pyramid_wait | candidate_weight_source |
| volume_bucket | volume_lt_500k | no_clear_edge | -0.7397 | - | 12 | 0.25 | False | avg_down_wait,pyramid_wait | candidate_weight_source |
...
| time_bucket | time_0930_1030 | no_clear_edge | -0.2504 | - | 5 | 0.2 | False | avg_down_wait,pyramid_wait | candidate_weight_source |
| time_bucket | time_1030_1400 | no_clear_edge | -0.4938 | - | 10 | 0.2 | False | avg_down_wait,pyramid_wait | candidate_weight_source |
| time_bucket | time_1400_1530 | no_clear_edge | -1.8954 | - | 7 | 0.5714 | False | avg_down_wait,pyramid_wait | candidate_weight_source |

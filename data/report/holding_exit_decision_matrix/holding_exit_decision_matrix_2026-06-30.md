# Holding/Exit Decision Matrix - 2026-06-30

## 판정

- matrix_version: `holding_exit_decision_matrix_v1_2026-06-30`
...
- per_action_samples: `{'exit_only': 153, 'avg_down_wait': 3, 'pyramid_wait': 3}`
- proxy_sample_snapshots: `7191`
- proxy_joined_candidates: `1330`
- proxy_actions_present: `['hold_defer', 'exit_only', 'avg_down_wait', 'pyramid_wait']`
- proxy_missing_actions: `[]`
- proxy_per_action_samples: `{'hold_defer': 7011, 'exit_only': 640, 'avg_down_wait': 4777, 'pyramid_wait': 1957}`
...
| --- | --- | --- | ---: | ---: | ---: | ---: | --- | --- | --- |
| price_bucket | price_10k_30k | no_clear_edge | -1.0364 | - | 13 | 0.6154 | False | avg_down_wait,pyramid_wait | candidate_weight_source |
| price_bucket | price_30k_70k | no_clear_edge | -1.295 | - | 11 | 0.5455 | False | avg_down_wait,pyramid_wait | candidate_weight_source |
| price_bucket | price_gte_70k | no_clear_edge | -0.4719 | - | 24 | 0.375 | True | - | candidate_weight_source |
| price_bucket | price_lt_10k | no_clear_edge | - | - | - | - | False | avg_down_wait,pyramid_wait | insufficient_sample |
| volume_bucket | volume_2m_10m | no_clear_edge | -1.8862 | - | 5 | 1 | False | avg_down_wait,pyramid_wait | defensive_only_high_loss_rate |
| volume_bucket | volume_500k_2m | no_clear_edge | -0.4994 | - | 16 | 0.5625 | False | pyramid_wait | candidate_weight_source |
| volume_bucket | volume_gte_10m | no_clear_edge | - | - | - | - | False | avg_down_wait,pyramid_wait | insufficient_sample |
| volume_bucket | volume_lt_500k | no_clear_edge | -0.4471 | - | 21 | 0.3333 | False | avg_down_wait,pyramid_wait | candidate_weight_source |
| volume_bucket | volume_unknown | no_clear_edge | -2.5499 | - | 6 | 0.5 | False | avg_down_wait | candidate_weight_source |
| time_bucket | time_0900_0930 | no_clear_edge | - | - | - | - | False | avg_down_wait,pyramid_wait | insufficient_sample |
| time_bucket | time_0930_1030 | no_clear_edge | -0.7066 | - | 12 | 0.25 | True | - | candidate_weight_source |
| time_bucket | time_1030_1400 | no_clear_edge | -0.925 | - | 9 | 0.3333 | False | avg_down_wait,pyramid_wait | candidate_weight_source |
| time_bucket | time_1400_1530 | no_clear_edge | -1.4822 | - | 5 | 0.8 | False | avg_down_wait,pyramid_wait | defensive_only_high_loss_rate |
| time_bucket | time_outside_regular | no_clear_edge | -1.0839 | - | 24 | 0.5833 | False | avg_down_wait,pyramid_wait | candidate_weight_source |

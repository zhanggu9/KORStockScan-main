# Holding/Exit Decision Matrix - 2026-08-10

## 판정

- matrix_version: `holding_exit_decision_matrix_v1_2026-08-10`
...
- per_action_samples: `{'exit_only': 33, 'avg_down_wait': 6, 'pyramid_wait': 0}`
- proxy_sample_snapshots: `549`
- proxy_joined_candidates: `0`
- proxy_actions_present: `['hold_defer', 'exit_only', 'avg_down_wait', 'pyramid_wait']`
- proxy_missing_actions: `[]`
- proxy_per_action_samples: `{'hold_defer': 541, 'exit_only': 544, 'avg_down_wait': 498, 'pyramid_wait': 46}`
...
| --- | --- | --- | ---: | ---: | ---: | ---: | --- | --- | --- |
| price_bucket | price_10k_30k | no_clear_edge | -0.6779 | - | 7 | 0.2857 | False | pyramid_wait | candidate_weight_source |
...
| volume_bucket | volume_500k_2m | no_clear_edge | -1.0534 | - | 5 | 0.4 | False | avg_down_wait,pyramid_wait | candidate_weight_source |
| volume_bucket | volume_gte_10m | no_clear_edge | - | - | - | - | False | avg_down_wait,pyramid_wait | insufficient_sample |
| volume_bucket | volume_lt_500k | no_clear_edge | - | - | - | - | False | pyramid_wait | insufficient_sample |
| time_bucket | time_0900_0930 | no_clear_edge | - | - | - | - | False | avg_down_wait,pyramid_wait | insufficient_sample |
| time_bucket | time_0930_1030 | no_clear_edge | -0.9483 | - | 5 | 0.2 | False | pyramid_wait | candidate_weight_source |

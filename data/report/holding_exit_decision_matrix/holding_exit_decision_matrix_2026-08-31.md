# Holding/Exit Decision Matrix - 2026-08-31

## 판정

- matrix_version: `holding_exit_decision_matrix_v1_2026-08-31`
...
| --- | --- | --- | ---: | ---: | ---: | ---: | --- | --- | --- |
| price_bucket | price_10k_30k | no_clear_edge | -0.1363 | - | 11 | 0.1818 | False | avg_down_wait,pyramid_wait | candidate_weight_source |
| price_bucket | price_30k_70k | no_clear_edge | - | - | - | - | False | avg_down_wait,pyramid_wait | insufficient_sample |
| price_bucket | price_gte_70k | no_clear_edge | -0.6654 | - | 6 | 0.3333 | False | avg_down_wait,pyramid_wait | candidate_weight_source |
| volume_bucket | volume_2m_10m | no_clear_edge | - | - | - | - | False | avg_down_wait,pyramid_wait | insufficient_sample |
| volume_bucket | volume_500k_2m | no_clear_edge | -0.3782 | - | 12 | 0.25 | False | avg_down_wait,pyramid_wait | candidate_weight_source |
...
| time_bucket | time_1030_1400 | no_clear_edge | -0.6144 | - | 6 | 0.1667 | False | avg_down_wait,pyramid_wait | candidate_weight_source |

# Holding/Exit Decision Matrix - 2026-06-26

## 판정

- matrix_version: `holding_exit_decision_matrix_v1_2026-06-26`
...
- per_action_samples: `{'exit_only': 42, 'avg_down_wait': 3, 'pyramid_wait': 0}`
- proxy_sample_snapshots: `2073`
- proxy_joined_candidates: `74`
- proxy_actions_present: `['hold_defer', 'exit_only', 'avg_down_wait', 'pyramid_wait']`
- proxy_missing_actions: `[]`
- proxy_per_action_samples: `{'hold_defer': 1985, 'exit_only': 527, 'avg_down_wait': 1072, 'pyramid_wait': 739}`
...
| price_bucket | price_30k_70k | no_clear_edge | -1.4954 | - | 5 | 1 | False | avg_down_wait,pyramid_wait | defensive_only_high_loss_rate |
| price_bucket | price_gte_70k | no_clear_edge | - | - | - | - | False | pyramid_wait | insufficient_sample |
...
| volume_bucket | volume_500k_2m | no_clear_edge | -1.2007 | - | 6 | 0.8333 | False | pyramid_wait | defensive_only_high_loss_rate |

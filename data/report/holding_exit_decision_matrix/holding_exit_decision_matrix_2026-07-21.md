# Holding/Exit Decision Matrix - 2026-07-21

## 판정

- matrix_version: `holding_exit_decision_matrix_v1_2026-07-21`
...
- per_action_samples: `{'exit_only': 99, 'avg_down_wait': 6, 'pyramid_wait': 9}`
- proxy_sample_snapshots: `528`
- proxy_joined_candidates: `218`
- proxy_actions_present: `['hold_defer', 'exit_only', 'avg_down_wait', 'pyramid_wait']`
- proxy_missing_actions: `[]`
- proxy_per_action_samples: `{'hold_defer': 525, 'exit_only': 527, 'avg_down_wait': 474, 'pyramid_wait': 53}`
...
| --- | --- | --- | ---: | ---: | ---: | ---: | --- | --- | --- |
| price_bucket | price_10k_30k | no_clear_edge | -0.8699 | - | 12 | 0.5 | False | avg_down_wait | candidate_weight_source |
| price_bucket | price_30k_70k | no_clear_edge | - | - | - | - | False | pyramid_wait | insufficient_sample |
| price_bucket | price_gte_70k | no_clear_edge | - | - | - | - | False | avg_down_wait | insufficient_sample |
| price_bucket | price_lt_10k | no_clear_edge | -0.0554 | - | 17 | 0.4118 | False | pyramid_wait | candidate_weight_source |
| volume_bucket | volume_2m_10m | no_clear_edge | -0.4831 | - | 17 | 0.4118 | False | avg_down_wait,pyramid_wait | candidate_weight_source |
| volume_bucket | volume_500k_2m | no_clear_edge | -0.7136 | - | 9 | 0.4444 | True | - | candidate_weight_source |
| volume_bucket | volume_gte_10m | no_clear_edge | -0.1831 | - | 6 | 0.6667 | True | - | defensive_only_high_loss_rate |
...
| time_bucket | time_0930_1030 | no_clear_edge | -0.1652 | - | 5 | 0.2 | False | avg_down_wait | candidate_weight_source |
| time_bucket | time_1030_1400 | no_clear_edge | -0.514 | - | 15 | 0.4 | True | - | candidate_weight_source |
| time_bucket | time_1400_1530 | no_clear_edge | -0.1865 | - | 8 | 0.5 | False | avg_down_wait,pyramid_wait | candidate_weight_source |
| time_bucket | time_outside_regular | no_clear_edge | -1.3228 | - | 5 | 1 | False | pyramid_wait | defensive_only_high_loss_rate |

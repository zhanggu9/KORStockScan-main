# Holding/Exit Decision Matrix - 2026-06-19

## 판정

- matrix_version: `holding_exit_decision_matrix_v1_2026-06-19`
...
- per_action_samples: `{'exit_only': 36, 'avg_down_wait': 0, 'pyramid_wait': 3}`
- proxy_sample_snapshots: `1068`
- proxy_joined_candidates: `77`
- proxy_actions_present: `['hold_defer', 'exit_only', 'avg_down_wait', 'pyramid_wait']`
- proxy_missing_actions: `[]`
- proxy_per_action_samples: `{'hold_defer': 942, 'exit_only': 215, 'avg_down_wait': 578, 'pyramid_wait': 300}`
...
| price_bucket | price_gte_70k | no_clear_edge | -2.0467 | - | 5 | 0.8 | False | avg_down_wait,pyramid_wait | defensive_only_high_loss_rate |
...
| volume_bucket | volume_500k_2m | no_clear_edge | -1.899 | - | 5 | 0.8 | False | avg_down_wait | defensive_only_high_loss_rate |
...
| time_bucket | time_1030_1400 | no_clear_edge | -1.1163 | - | 9 | 0.6667 | False | avg_down_wait | defensive_only_high_loss_rate |

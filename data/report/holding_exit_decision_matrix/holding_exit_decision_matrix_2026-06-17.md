# Holding/Exit Decision Matrix - 2026-06-17

## 판정

- matrix_version: `holding_exit_decision_matrix_v1_2026-06-17`
...
- per_action_samples: `{'exit_only': 21, 'avg_down_wait': 0, 'pyramid_wait': 3}`
- proxy_sample_snapshots: `10899`
- proxy_joined_candidates: `0`
- proxy_actions_present: `['hold_defer', 'exit_only', 'avg_down_wait', 'pyramid_wait']`
- proxy_missing_actions: `[]`
- proxy_per_action_samples: `{'hold_defer': 10732, 'exit_only': 2568, 'avg_down_wait': 6820, 'pyramid_wait': 2230}`
...
| --- | --- | --- | ---: | ---: | ---: | ---: | --- | --- | --- |
| price_bucket | price_10k_30k | no_clear_edge | -1.6688 | - | 5 | 0.8 | False | avg_down_wait | defensive_only_high_loss_rate |
...
| time_bucket | time_1030_1400 | no_clear_edge | - | - | - | - | False | avg_down_wait | insufficient_sample |

# Holding/Exit Decision Matrix - 2026-06-12

## 판정

- matrix_version: `holding_exit_decision_matrix_v1_2026-06-12`
...
- per_action_samples: `{'exit_only': 126, 'avg_down_wait': 0, 'pyramid_wait': 6}`
- proxy_sample_snapshots: `7966`
- proxy_joined_candidates: `27`
- proxy_actions_present: `['hold_defer', 'exit_only', 'avg_down_wait', 'pyramid_wait']`
- proxy_missing_actions: `[]`
- proxy_per_action_samples: `{'hold_defer': 7669, 'exit_only': 1152, 'avg_down_wait': 6048, 'pyramid_wait': 1452}`
...
| --- | --- | --- | ---: | ---: | ---: | ---: | --- | --- | --- |
| price_bucket | price_10k_30k | no_clear_edge | -0.547 | - | 9 | 0.4444 | False | avg_down_wait | candidate_weight_source |
| price_bucket | price_gte_70k | no_clear_edge | -0.68 | - | 33 | 0.5152 | False | avg_down_wait | candidate_weight_source |
| volume_bucket | volume_2m_10m | no_clear_edge | -0.4506 | - | 22 | 0.4091 | False | avg_down_wait | candidate_weight_source |
| volume_bucket | volume_500k_2m | no_clear_edge | -0.7941 | - | 12 | 0.5 | False | avg_down_wait,pyramid_wait | candidate_weight_source |
| volume_bucket | volume_gte_10m | no_clear_edge | - | - | - | - | False | avg_down_wait,pyramid_wait | insufficient_sample |
| volume_bucket | volume_unknown | no_clear_edge | -1.0145 | - | 5 | 0.6 | False | avg_down_wait | candidate_weight_source |
| time_bucket | time_0930_1030 | no_clear_edge | -0.5628 | - | 10 | 0.4 | False | avg_down_wait | candidate_weight_source |
| time_bucket | time_1030_1400 | no_clear_edge | -0.4761 | - | 26 | 0.5 | False | avg_down_wait | candidate_weight_source |
| time_bucket | time_1400_1530 | no_clear_edge | -1.3724 | - | 6 | 0.6667 | False | avg_down_wait,pyramid_wait | defensive_only_high_loss_rate |

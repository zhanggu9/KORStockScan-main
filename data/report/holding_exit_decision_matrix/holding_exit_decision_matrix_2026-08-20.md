# Holding/Exit Decision Matrix - 2026-08-20

## 판정

- matrix_version: `holding_exit_decision_matrix_v1_2026-08-20`
...
- per_action_samples: `{'exit_only': 63, 'avg_down_wait': 0, 'pyramid_wait': 3}`
- proxy_sample_snapshots: `1086`
- proxy_joined_candidates: `559`
- proxy_actions_present: `['hold_defer', 'exit_only', 'avg_down_wait', 'pyramid_wait']`
- proxy_missing_actions: `[]`
- proxy_per_action_samples: `{'hold_defer': 1074, 'exit_only': 1077, 'avg_down_wait': 901, 'pyramid_wait': 176}`
...
| --- | --- | --- | ---: | ---: | ---: | ---: | --- | --- | --- |
| price_bucket | price_10k_30k | no_clear_edge | -0.9613 | - | 13 | 0.3077 | False | avg_down_wait,pyramid_wait | candidate_weight_source |
...
| price_bucket | price_lt_10k | no_clear_edge | -0.1379 | - | 5 | 0.2 | False | avg_down_wait,pyramid_wait | candidate_weight_source |
| volume_bucket | volume_2m_10m | no_clear_edge | -0.9961 | - | 12 | 0.3333 | False | avg_down_wait,pyramid_wait | candidate_weight_source |
...
| time_bucket | time_1030_1400 | no_clear_edge | -0.4001 | - | 15 | 0.1333 | False | avg_down_wait | candidate_weight_source |

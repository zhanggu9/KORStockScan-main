# Holding/Exit Decision Matrix - 2026-06-10

## 판정

- matrix_version: `holding_exit_decision_matrix_v1_2026-06-10`
...
- per_action_samples: `{'exit_only': 138, 'avg_down_wait': 0, 'pyramid_wait': 3}`
- proxy_sample_snapshots: `12690`
- proxy_joined_candidates: `133`
- proxy_actions_present: `['hold_defer', 'exit_only', 'avg_down_wait', 'pyramid_wait']`
- proxy_missing_actions: `[]`
- proxy_per_action_samples: `{'hold_defer': 12298, 'exit_only': 3157, 'avg_down_wait': 8169, 'pyramid_wait': 2027}`
...
| --- | --- | --- | ---: | ---: | ---: | ---: | --- | --- | --- |
| price_bucket | price_10k_30k | no_clear_edge | -0.5531 | - | 7 | 0.2857 | False | avg_down_wait,pyramid_wait | candidate_weight_source |
| price_bucket | price_30k_70k | no_clear_edge | - | - | - | - | False | avg_down_wait,pyramid_wait | insufficient_sample |
| price_bucket | price_gte_70k | no_clear_edge | -0.8003 | - | 38 | 0.5526 | False | avg_down_wait | candidate_weight_source |
| volume_bucket | volume_2m_10m | no_clear_edge | -0.4473 | - | 22 | 0.4091 | False | avg_down_wait,pyramid_wait | candidate_weight_source |
| volume_bucket | volume_500k_2m | no_clear_edge | -0.8364 | - | 14 | 0.5 | False | avg_down_wait,pyramid_wait | candidate_weight_source |
...
| volume_bucket | volume_unknown | no_clear_edge | -1.1783 | - | 6 | 0.6667 | False | avg_down_wait | defensive_only_high_loss_rate |
| time_bucket | time_0930_1030 | no_clear_edge | -0.9456 | - | 12 | 0.5 | False | avg_down_wait | candidate_weight_source |
| time_bucket | time_1030_1400 | no_clear_edge | -0.5243 | - | 28 | 0.5 | False | avg_down_wait,pyramid_wait | candidate_weight_source |
| time_bucket | time_1400_1530 | no_clear_edge | -1.3519 | - | 6 | 0.6667 | False | avg_down_wait,pyramid_wait | defensive_only_high_loss_rate |

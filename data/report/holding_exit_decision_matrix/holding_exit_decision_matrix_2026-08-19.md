# Holding/Exit Decision Matrix - 2026-08-19

## 판정

- matrix_version: `holding_exit_decision_matrix_v1_2026-08-19`
...
- per_action_samples: `{'exit_only': 48, 'avg_down_wait': 0, 'pyramid_wait': 0}`
- proxy_sample_snapshots: `59`
- proxy_joined_candidates: `1`
- proxy_actions_present: `['hold_defer', 'exit_only', 'avg_down_wait', 'pyramid_wait']`
- proxy_missing_actions: `[]`
- proxy_per_action_samples: `{'hold_defer': 44, 'exit_only': 50, 'avg_down_wait': 46, 'pyramid_wait': 4}`
...
| --- | --- | --- | ---: | ---: | ---: | ---: | --- | --- | --- |
| price_bucket | price_10k_30k | no_clear_edge | -0.9897 | - | 14 | 0.3571 | False | avg_down_wait,pyramid_wait | candidate_weight_source |
...
| volume_bucket | volume_2m_10m | no_clear_edge | -1.566 | - | 6 | 0.5 | False | avg_down_wait,pyramid_wait | candidate_weight_source |
...
| time_bucket | time_1030_1400 | no_clear_edge | -1.5473 | - | 8 | 0.375 | False | avg_down_wait,pyramid_wait | candidate_weight_source |
| time_bucket | time_1400_1530 | no_clear_edge | -0.6644 | - | 5 | 0.4 | False | avg_down_wait,pyramid_wait | candidate_weight_source |

# Holding/Exit Decision Matrix - 2026-07-20

## 판정

- matrix_version: `holding_exit_decision_matrix_v1_2026-07-20`
...
- per_action_samples: `{'exit_only': 96, 'avg_down_wait': 6, 'pyramid_wait': 9}`
- proxy_sample_snapshots: `948`
- proxy_joined_candidates: `346`
- proxy_actions_present: `['hold_defer', 'exit_only', 'avg_down_wait', 'pyramid_wait']`
- proxy_missing_actions: `[]`
- proxy_per_action_samples: `{'hold_defer': 923, 'exit_only': 932, 'avg_down_wait': 654, 'pyramid_wait': 273}`
...
| --- | --- | --- | ---: | ---: | ---: | ---: | --- | --- | --- |
| price_bucket | price_10k_30k | no_clear_edge | -0.7138 | - | 13 | 0.3077 | False | avg_down_wait | candidate_weight_source |
...
| price_bucket | price_lt_10k | no_clear_edge | -0.0222 | - | 15 | 0.3333 | False | pyramid_wait | candidate_weight_source |
| volume_bucket | volume_2m_10m | no_clear_edge | -0.7633 | - | 12 | 0.25 | True | - | candidate_weight_source |
| volume_bucket | volume_500k_2m | no_clear_edge | -1.0356 | - | 6 | 0.3333 | False | avg_down_wait | candidate_weight_source |
| volume_bucket | volume_gte_10m | no_clear_edge | -0.2224 | - | 7 | 0.5714 | False | pyramid_wait | candidate_weight_source |
| volume_bucket | volume_lt_500k | no_clear_edge | -0.221 | - | 7 | 0.4286 | False | avg_down_wait,pyramid_wait | candidate_weight_source |
...
| time_bucket | time_1030_1400 | no_clear_edge | -0.2277 | - | 14 | 0.2143 | True | - | candidate_weight_source |
| time_bucket | time_1400_1530 | no_clear_edge | -0.7709 | - | 8 | 0.5 | False | avg_down_wait,pyramid_wait | candidate_weight_source |
| time_bucket | time_outside_regular | no_clear_edge | -1.1366 | - | 6 | 0.8333 | False | pyramid_wait | defensive_only_high_loss_rate |

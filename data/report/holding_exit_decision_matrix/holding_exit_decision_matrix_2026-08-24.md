# Holding/Exit Decision Matrix - 2026-08-24

## 판정

- matrix_version: `holding_exit_decision_matrix_v1_2026-08-24`
...
- per_action_samples: `{'exit_only': 108, 'avg_down_wait': 3, 'pyramid_wait': 3}`
- proxy_sample_snapshots: `990`
- proxy_joined_candidates: `17`
- proxy_actions_present: `['hold_defer', 'exit_only', 'avg_down_wait', 'pyramid_wait']`
- proxy_missing_actions: `[]`
- proxy_per_action_samples: `{'hold_defer': 426, 'exit_only': 978, 'avg_down_wait': 958, 'pyramid_wait': 20}`
...
| --- | --- | --- | ---: | ---: | ---: | ---: | --- | --- | --- |
| price_bucket | price_10k_30k | no_clear_edge | -0.6243 | - | 23 | 0.3478 | False | pyramid_wait | candidate_weight_source |
| price_bucket | price_30k_70k | no_clear_edge | - | - | - | - | False | exit_only,avg_down_wait | insufficient_sample |
| price_bucket | price_gte_70k | no_clear_edge | -0.9651 | - | 5 | 0.2 | False | avg_down_wait,pyramid_wait | candidate_weight_source |
| price_bucket | price_lt_10k | no_clear_edge | -0.6952 | - | 8 | 0.25 | False | avg_down_wait,pyramid_wait | candidate_weight_source |
| volume_bucket | volume_2m_10m | no_clear_edge | -0.9316 | - | 11 | 0.2727 | False | avg_down_wait,pyramid_wait | candidate_weight_source |
| volume_bucket | volume_500k_2m | no_clear_edge | -0.0319 | - | 10 | 0.3 | True | - | candidate_weight_source |
| volume_bucket | volume_gte_10m | no_clear_edge | -1.5646 | - | 5 | 0.4 | False | avg_down_wait,pyramid_wait | candidate_weight_source |
| volume_bucket | volume_lt_500k | no_clear_edge | -0.125 | - | 6 | 0.1667 | False | avg_down_wait,pyramid_wait | candidate_weight_source |
...
| time_bucket | time_0930_1030 | no_clear_edge | -0.6535 | - | 10 | 0.3 | False | avg_down_wait,pyramid_wait | candidate_weight_source |
| time_bucket | time_1030_1400 | no_clear_edge | -0.2775 | - | 21 | 0.2381 | True | - | candidate_weight_source |

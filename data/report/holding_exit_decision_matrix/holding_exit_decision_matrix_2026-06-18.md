# Holding/Exit Decision Matrix - 2026-06-18

## 판정

- matrix_version: `holding_exit_decision_matrix_v1_2026-06-18`
...
- per_action_samples: `{'exit_only': 39, 'avg_down_wait': 0, 'pyramid_wait': 3}`
- proxy_sample_snapshots: `10698`
- proxy_joined_candidates: `118`
- proxy_actions_present: `['hold_defer', 'exit_only', 'avg_down_wait', 'pyramid_wait']`
- proxy_missing_actions: `[]`
- proxy_per_action_samples: `{'hold_defer': 10481, 'exit_only': 2276, 'avg_down_wait': 6772, 'pyramid_wait': 1740}`
...
| --- | --- | --- | ---: | ---: | ---: | ---: | --- | --- | --- |
| price_bucket | price_10k_30k | no_clear_edge | -1.3677 | - | 7 | 0.5714 | False | avg_down_wait,pyramid_wait | candidate_weight_source |
...
| time_bucket | time_1030_1400 | no_clear_edge | -1.6291 | - | 7 | 0.7143 | False | avg_down_wait | defensive_only_high_loss_rate |

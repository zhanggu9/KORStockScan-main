# Holding/Exit Decision Matrix - 2026-08-04

## 판정

- matrix_version: `holding_exit_decision_matrix_v1_2026-08-04`
...
- per_action_samples: `{'exit_only': 111, 'avg_down_wait': 6, 'pyramid_wait': 0}`
- proxy_sample_snapshots: `1246`
- proxy_joined_candidates: `1562`
- proxy_actions_present: `['hold_defer', 'exit_only', 'avg_down_wait', 'pyramid_wait']`
- proxy_missing_actions: `[]`
- proxy_per_action_samples: `{'hold_defer': 1234, 'exit_only': 1242, 'avg_down_wait': 1159, 'pyramid_wait': 83}`
...
| --- | --- | --- | ---: | ---: | ---: | ---: | --- | --- | --- |
| price_bucket | price_10k_30k | no_clear_edge | -0.7114 | - | 13 | 0.3846 | False | pyramid_wait | candidate_weight_source |
| price_bucket | price_30k_70k | no_clear_edge | - | - | - | - | False | avg_down_wait,pyramid_wait | insufficient_sample |
| price_bucket | price_gte_70k | no_clear_edge | -0.3518 | - | 15 | 0.2 | False | avg_down_wait,pyramid_wait | candidate_weight_source |
| price_bucket | price_lt_10k | no_clear_edge | -0.145 | - | 5 | 0.2 | False | avg_down_wait,pyramid_wait | candidate_weight_source |
| volume_bucket | volume_2m_10m | no_clear_edge | -1.3796 | - | 6 | 0.6667 | False | pyramid_wait | defensive_only_high_loss_rate |
| volume_bucket | volume_500k_2m | no_clear_edge | -0.9074 | - | 18 | 0.3889 | False | avg_down_wait,pyramid_wait | candidate_weight_source |
| volume_bucket | volume_gte_10m | no_clear_edge | - | - | - | - | False | avg_down_wait,pyramid_wait | insufficient_sample |
| volume_bucket | volume_lt_500k | no_clear_edge | -0.2335 | - | 11 | 0.1818 | False | pyramid_wait | candidate_weight_source |
| time_bucket | time_0900_0930 | no_clear_edge | -1.0528 | - | 6 | 0.3333 | False | avg_down_wait,pyramid_wait | candidate_weight_source |
| time_bucket | time_0930_1030 | no_clear_edge | 0.0688 | - | 15 | 0.1333 | False | pyramid_wait | candidate_weight_source |
...
| time_bucket | time_outside_regular | no_clear_edge | -1.0754 | - | 12 | 0.4167 | False | avg_down_wait,pyramid_wait | candidate_weight_source |

# Holding/Exit Decision Matrix - 2026-07-24

## 판정

- matrix_version: `holding_exit_decision_matrix_v1_2026-07-24`
...
- per_action_samples: `{'exit_only': 165, 'avg_down_wait': 9, 'pyramid_wait': 0}`
- proxy_sample_snapshots: `158`
- proxy_joined_candidates: `52`
- proxy_actions_present: `['hold_defer', 'exit_only', 'avg_down_wait', 'pyramid_wait']`
- proxy_missing_actions: `[]`
- proxy_per_action_samples: `{'hold_defer': 71, 'exit_only': 158, 'avg_down_wait': 143, 'pyramid_wait': 15}`
...
| --- | --- | --- | ---: | ---: | ---: | ---: | --- | --- | --- |
| price_bucket | price_10k_30k | no_clear_edge | -0.5193 | - | 22 | 0.4091 | False | pyramid_wait | candidate_weight_source |
| price_bucket | price_30k_70k | no_clear_edge | - | - | - | - | False | avg_down_wait,pyramid_wait | insufficient_sample |
| price_bucket | price_gte_70k | no_clear_edge | -0.8467 | - | 14 | 0.4286 | False | avg_down_wait,pyramid_wait | candidate_weight_source |
| price_bucket | price_lt_10k | no_clear_edge | -0.1921 | - | 17 | 0.3529 | False | pyramid_wait | candidate_weight_source |
| volume_bucket | volume_2m_10m | no_clear_edge | -0.4271 | - | 15 | 0.3333 | False | avg_down_wait,pyramid_wait | candidate_weight_source |
| volume_bucket | volume_500k_2m | no_clear_edge | -0.8362 | - | 16 | 0.375 | False | avg_down_wait,pyramid_wait | candidate_weight_source |
| volume_bucket | volume_gte_10m | no_clear_edge | -0.1486 | - | 9 | 0.3333 | False | pyramid_wait | candidate_weight_source |
| volume_bucket | volume_lt_500k | no_clear_edge | -0.6946 | - | 14 | 0.5 | False | pyramid_wait | candidate_weight_source |
...
| time_bucket | time_0930_1030 | no_clear_edge | -0.5613 | - | 8 | 0.25 | False | pyramid_wait | candidate_weight_source |
| time_bucket | time_1030_1400 | no_clear_edge | -0.2182 | - | 28 | 0.3214 | False | pyramid_wait | candidate_weight_source |
| time_bucket | time_1400_1530 | no_clear_edge | - | - | - | - | False | avg_down_wait,pyramid_wait | insufficient_sample |
| time_bucket | time_outside_regular | no_clear_edge | -0.65 | - | 15 | 0.4667 | False | pyramid_wait | candidate_weight_source |

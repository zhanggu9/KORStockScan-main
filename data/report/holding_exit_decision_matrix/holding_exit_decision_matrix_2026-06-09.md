# Holding/Exit Decision Matrix - 2026-06-09

## 판정

- matrix_version: `holding_exit_decision_matrix_v1_2026-06-09`
...
- per_action_samples: `{'exit_only': 108, 'avg_down_wait': 0, 'pyramid_wait': 0}`
- proxy_sample_snapshots: `10401`
- proxy_joined_candidates: `124`
- proxy_actions_present: `['hold_defer', 'exit_only', 'avg_down_wait', 'pyramid_wait']`
- proxy_missing_actions: `[]`
- proxy_per_action_samples: `{'hold_defer': 10169, 'exit_only': 2790, 'avg_down_wait': 5309, 'pyramid_wait': 2416}`
...
| --- | --- | --- | ---: | ---: | ---: | ---: | --- | --- | --- |
| price_bucket | price_10k_30k | no_clear_edge | -1.3159 | - | 5 | 0.4 | False | avg_down_wait,pyramid_wait | candidate_weight_source |
| price_bucket | price_30k_70k | no_clear_edge | - | - | - | - | False | avg_down_wait,pyramid_wait | insufficient_sample |
| price_bucket | price_gte_70k | no_clear_edge | -1.044 | - | 30 | 0.5667 | False | avg_down_wait,pyramid_wait | candidate_weight_source |
| volume_bucket | volume_2m_10m | no_clear_edge | -1.0023 | - | 19 | 0.5263 | False | avg_down_wait,pyramid_wait | candidate_weight_source |
| volume_bucket | volume_500k_2m | no_clear_edge | -1.2889 | - | 11 | 0.5455 | False | avg_down_wait,pyramid_wait | candidate_weight_source |
...
| time_bucket | time_0930_1030 | no_clear_edge | -1.5613 | - | 8 | 0.625 | False | avg_down_wait,pyramid_wait | candidate_weight_source |
| time_bucket | time_1030_1400 | no_clear_edge | -0.7443 | - | 22 | 0.5 | False | avg_down_wait,pyramid_wait | candidate_weight_source |
| time_bucket | time_1400_1530 | no_clear_edge | -1.5291 | - | 6 | 0.6667 | False | avg_down_wait,pyramid_wait | defensive_only_high_loss_rate |

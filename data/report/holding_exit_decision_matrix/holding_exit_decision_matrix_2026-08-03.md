# Holding/Exit Decision Matrix - 2026-08-03

## 판정

- matrix_version: `holding_exit_decision_matrix_v1_2026-08-03`
...
- per_action_samples: `{'exit_only': 111, 'avg_down_wait': 0, 'pyramid_wait': 0}`
- proxy_sample_snapshots: `647`
- proxy_joined_candidates: `0`
- proxy_actions_present: `['hold_defer', 'exit_only', 'avg_down_wait', 'pyramid_wait']`
- proxy_missing_actions: `[]`
- proxy_per_action_samples: `{'hold_defer': 613, 'exit_only': 617, 'avg_down_wait': 567, 'pyramid_wait': 50}`
...
| --- | --- | --- | ---: | ---: | ---: | ---: | --- | --- | --- |
| price_bucket | price_10k_30k | no_clear_edge | -0.714 | - | 13 | 0.3846 | False | avg_down_wait,pyramid_wait | candidate_weight_source |
| price_bucket | price_30k_70k | no_clear_edge | - | - | - | - | False | avg_down_wait,pyramid_wait | insufficient_sample |
| price_bucket | price_gte_70k | no_clear_edge | -0.4095 | - | 17 | 0.2353 | False | avg_down_wait,pyramid_wait | candidate_weight_source |
| price_bucket | price_lt_10k | no_clear_edge | - | - | - | - | False | avg_down_wait,pyramid_wait | insufficient_sample |
| volume_bucket | volume_2m_10m | no_clear_edge | -1.4414 | - | 7 | 0.5714 | False | avg_down_wait,pyramid_wait | candidate_weight_source |
| volume_bucket | volume_500k_2m | no_clear_edge | -0.4247 | - | 19 | 0.3684 | False | avg_down_wait,pyramid_wait | candidate_weight_source |
| volume_bucket | volume_gte_10m | no_clear_edge | - | - | - | - | False | avg_down_wait,pyramid_wait | insufficient_sample |
| volume_bucket | volume_lt_500k | no_clear_edge | -1.0911 | - | 10 | 0.3 | False | avg_down_wait,pyramid_wait | candidate_weight_source |
| time_bucket | time_0900_0930 | no_clear_edge | - | - | - | - | False | avg_down_wait,pyramid_wait | insufficient_sample |
| time_bucket | time_0930_1030 | no_clear_edge | 0.0633 | - | 9 | 0.1111 | False | avg_down_wait,pyramid_wait | candidate_weight_source |
...
| time_bucket | time_outside_regular | no_clear_edge | -0.954 | - | 22 | 0.4091 | False | avg_down_wait,pyramid_wait | candidate_weight_source |

# Holding/Exit Decision Matrix - 2026-06-24

## 판정

- matrix_version: `holding_exit_decision_matrix_v1_2026-06-24`
...
- per_action_samples: `{'exit_only': 45, 'avg_down_wait': 0, 'pyramid_wait': 3}`
- proxy_sample_snapshots: `1792`
- proxy_joined_candidates: `110`
- proxy_actions_present: `['hold_defer', 'exit_only', 'avg_down_wait', 'pyramid_wait']`
- proxy_missing_actions: `[]`
- proxy_per_action_samples: `{'hold_defer': 1720, 'exit_only': 279, 'avg_down_wait': 1290, 'pyramid_wait': 368}`
...
| price_bucket | price_gte_70k | no_clear_edge | -2.0173 | - | 5 | 0.8 | False | avg_down_wait,pyramid_wait | defensive_only_high_loss_rate |
...
| volume_bucket | volume_lt_500k | no_clear_edge | -2.5419 | - | 6 | 0.8333 | False | avg_down_wait,pyramid_wait | defensive_only_high_loss_rate |
...
| time_bucket | time_1030_1400 | no_clear_edge | -1.2492 | - | 10 | 0.6 | False | avg_down_wait | candidate_weight_source |

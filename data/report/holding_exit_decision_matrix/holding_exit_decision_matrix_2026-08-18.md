# Holding/Exit Decision Matrix - 2026-08-18

## 판정

- matrix_version: `holding_exit_decision_matrix_v1_2026-08-18`
...
- proxy_sample_snapshots: `788`
- proxy_joined_candidates: `98`
- proxy_actions_present: `['hold_defer', 'exit_only', 'avg_down_wait', 'pyramid_wait']`
- proxy_missing_actions: `[]`
- proxy_per_action_samples: `{'hold_defer': 773, 'exit_only': 781, 'avg_down_wait': 742, 'pyramid_wait': 39}`
...
| --- | --- | --- | ---: | ---: | ---: | ---: | --- | --- | --- |
| price_bucket | price_10k_30k | no_clear_edge | -0.7519 | - | 12 | 0.3333 | False | avg_down_wait,pyramid_wait | candidate_weight_source |
...
| volume_bucket | volume_2m_10m | no_clear_edge | -1.0728 | - | 8 | 0.5 | False | avg_down_wait,pyramid_wait | candidate_weight_source |
...
| time_bucket | time_1030_1400 | no_clear_edge | -1.3634 | - | 6 | 0.3333 | False | avg_down_wait,pyramid_wait | candidate_weight_source |
| time_bucket | time_1400_1530 | no_clear_edge | -0.5426 | - | 5 | 0.4 | False | avg_down_wait,pyramid_wait | candidate_weight_source |

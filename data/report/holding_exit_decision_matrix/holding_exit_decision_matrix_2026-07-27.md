# Holding/Exit Decision Matrix - 2026-07-27

## 판정

- matrix_version: `holding_exit_decision_matrix_v1_2026-07-27`
...
- per_action_samples: `{'exit_only': 111, 'avg_down_wait': 9, 'pyramid_wait': 0}`
- proxy_sample_snapshots: `19`
- proxy_joined_candidates: `36`
- proxy_actions_present: `['hold_defer', 'exit_only', 'avg_down_wait', 'pyramid_wait']`
- proxy_missing_actions: `[]`
- proxy_per_action_samples: `{'hold_defer': 18, 'exit_only': 19, 'avg_down_wait': 3, 'pyramid_wait': 16}`
...
| --- | --- | --- | ---: | ---: | ---: | ---: | --- | --- | --- |
| price_bucket | price_10k_30k | no_clear_edge | -0.4417 | - | 14 | 0.5 | False | pyramid_wait | candidate_weight_source |
| price_bucket | price_30k_70k | no_clear_edge | - | - | - | - | False | avg_down_wait,pyramid_wait | insufficient_sample |
| price_bucket | price_gte_70k | no_clear_edge | -0.8403 | - | 14 | 0.3571 | False | avg_down_wait,pyramid_wait | candidate_weight_source |
| price_bucket | price_lt_10k | no_clear_edge | -0.7411 | - | 8 | 0.5 | False | pyramid_wait | candidate_weight_source |
| volume_bucket | volume_2m_10m | no_clear_edge | -0.5541 | - | 6 | 0.5 | False | avg_down_wait,pyramid_wait | candidate_weight_source |
| volume_bucket | volume_500k_2m | no_clear_edge | -0.7313 | - | 14 | 0.3571 | False | avg_down_wait,pyramid_wait | candidate_weight_source |
| volume_bucket | volume_gte_10m | no_clear_edge | -0.4637 | - | 6 | 0.3333 | False | pyramid_wait | candidate_weight_source |
| volume_bucket | volume_lt_500k | no_clear_edge | -1.0424 | - | 10 | 0.6 | False | pyramid_wait | candidate_weight_source |
...
| time_bucket | time_0930_1030 | no_clear_edge | - | - | - | - | False | pyramid_wait | insufficient_sample |
| time_bucket | time_1030_1400 | no_clear_edge | -0.4652 | - | 15 | 0.3333 | False | pyramid_wait | candidate_weight_source |
| time_bucket | time_1400_1530 | no_clear_edge | - | - | - | - | False | avg_down_wait,pyramid_wait | insufficient_sample |
| time_bucket | time_outside_regular | no_clear_edge | -0.4044 | - | 14 | 0.4286 | False | pyramid_wait | candidate_weight_source |

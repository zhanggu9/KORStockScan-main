# Holding/Exit Decision Matrix - 2026-08-26

## 판정

- matrix_version: `holding_exit_decision_matrix_v1_2026-08-26`
...
- proxy_sample_snapshots: `1394`
- proxy_joined_candidates: `9`
- proxy_actions_present: `['hold_defer', 'exit_only', 'avg_down_wait', 'pyramid_wait']`
- proxy_missing_actions: `[]`
- proxy_per_action_samples: `{'hold_defer': 1385, 'exit_only': 1389, 'avg_down_wait': 1350, 'pyramid_wait': 39}`
...
| --- | --- | --- | ---: | ---: | ---: | ---: | --- | --- | --- |
| price_bucket | price_10k_30k | no_clear_edge | -0.5889 | - | 27 | 0.3333 | False | pyramid_wait | candidate_weight_source |
| price_bucket | price_30k_70k | no_clear_edge | - | - | - | - | False | avg_down_wait | insufficient_sample |
| price_bucket | price_gte_70k | no_clear_edge | -0.6657 | - | 7 | 0.2857 | False | avg_down_wait,pyramid_wait | candidate_weight_source |
| price_bucket | price_lt_10k | no_clear_edge | -0.7509 | - | 7 | 0.1429 | False | avg_down_wait,pyramid_wait | candidate_weight_source |
| volume_bucket | volume_2m_10m | no_clear_edge | -0.6325 | - | 9 | 0.1111 | False | avg_down_wait,pyramid_wait | candidate_weight_source |
| volume_bucket | volume_500k_2m | no_clear_edge | 0.041 | - | 11 | 0.2727 | True | - | candidate_weight_source |
| volume_bucket | volume_gte_10m | no_clear_edge | -1.5375 | - | 5 | 0.4 | False | avg_down_wait,pyramid_wait | candidate_weight_source |
| volume_bucket | volume_lt_500k | no_clear_edge | -0.6376 | - | 13 | 0.3077 | False | avg_down_wait,pyramid_wait | candidate_weight_source |
...
| time_bucket | time_0930_1030 | no_clear_edge | -0.7185 | - | 9 | 0.3333 | False | avg_down_wait,pyramid_wait | candidate_weight_source |
| time_bucket | time_1030_1400 | no_clear_edge | 0.0111 | - | 22 | 0.1818 | True | - | candidate_weight_source |
| time_bucket | time_1400_1530 | no_clear_edge | -1.7476 | - | 9 | 0.5556 | False | avg_down_wait,pyramid_wait | candidate_weight_source |

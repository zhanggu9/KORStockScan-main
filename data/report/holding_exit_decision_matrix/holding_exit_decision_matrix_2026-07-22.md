# Holding/Exit Decision Matrix - 2026-07-22

## 판정

- matrix_version: `holding_exit_decision_matrix_v1_2026-07-22`
...
- per_action_samples: `{'exit_only': 126, 'avg_down_wait': 6, 'pyramid_wait': 0}`
- proxy_sample_snapshots: `1133`
- proxy_joined_candidates: `258`
- proxy_actions_present: `['hold_defer', 'exit_only', 'avg_down_wait', 'pyramid_wait']`
- proxy_missing_actions: `[]`
- proxy_per_action_samples: `{'hold_defer': 909, 'exit_only': 931, 'avg_down_wait': 844, 'pyramid_wait': 73}`
...
| --- | --- | --- | ---: | ---: | ---: | ---: | --- | --- | --- |
| price_bucket | price_10k_30k | no_clear_edge | -0.5038 | - | 19 | 0.3684 | False | avg_down_wait,pyramid_wait | candidate_weight_source |
| price_bucket | price_30k_70k | no_clear_edge | - | - | - | - | False | pyramid_wait | insufficient_sample |
| price_bucket | price_gte_70k | no_clear_edge | -1.6234 | - | 6 | 0.8333 | False | avg_down_wait,pyramid_wait | defensive_only_high_loss_rate |
| price_bucket | price_lt_10k | no_clear_edge | -0.2447 | - | 16 | 0.3125 | False | pyramid_wait | candidate_weight_source |
| volume_bucket | volume_2m_10m | no_clear_edge | -0.4719 | - | 12 | 0.25 | False | pyramid_wait | candidate_weight_source |
| volume_bucket | volume_500k_2m | no_clear_edge | -1.3279 | - | 10 | 0.5 | False | avg_down_wait,pyramid_wait | candidate_weight_source |
| volume_bucket | volume_gte_10m | no_clear_edge | -0.2956 | - | 7 | 0.4286 | False | pyramid_wait | candidate_weight_source |
| volume_bucket | volume_lt_500k | no_clear_edge | -0.698 | - | 13 | 0.4615 | False | avg_down_wait,pyramid_wait | candidate_weight_source |
| time_bucket | time_0900_0930 | no_clear_edge | - | - | - | - | False | avg_down_wait,pyramid_wait | insufficient_sample |
| time_bucket | time_0930_1030 | no_clear_edge | -0.6832 | - | 7 | 0.2857 | False | avg_down_wait,pyramid_wait | candidate_weight_source |
| time_bucket | time_1030_1400 | no_clear_edge | -0.3705 | - | 21 | 0.381 | False | pyramid_wait | candidate_weight_source |
| time_bucket | time_1400_1530 | no_clear_edge | - | - | - | - | False | avg_down_wait,pyramid_wait | insufficient_sample |
| time_bucket | time_outside_regular | no_clear_edge | -0.895 | - | 11 | 0.5455 | False | pyramid_wait | candidate_weight_source |

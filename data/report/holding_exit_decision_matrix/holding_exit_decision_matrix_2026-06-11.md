# Holding/Exit Decision Matrix - 2026-06-11

## 판정

- matrix_version: `holding_exit_decision_matrix_v1_2026-06-11`
...
- per_action_samples: `{'exit_only': 117, 'avg_down_wait': 0, 'pyramid_wait': 6}`
- proxy_sample_snapshots: `7053`
- proxy_joined_candidates: `33`
- proxy_actions_present: `['hold_defer', 'exit_only', 'avg_down_wait', 'pyramid_wait']`
- proxy_missing_actions: `[]`
- proxy_per_action_samples: `{'hold_defer': 6752, 'exit_only': 781, 'avg_down_wait': 4476, 'pyramid_wait': 1872}`
...
| --- | --- | --- | ---: | ---: | ---: | ---: | --- | --- | --- |
| price_bucket | price_10k_30k | no_clear_edge | -0.6594 | - | 6 | 0.3333 | False | avg_down_wait | candidate_weight_source |
| price_bucket | price_gte_70k | no_clear_edge | -0.6512 | - | 33 | 0.5152 | False | avg_down_wait | candidate_weight_source |
| volume_bucket | volume_2m_10m | no_clear_edge | -0.7953 | - | 18 | 0.5 | False | avg_down_wait,pyramid_wait | candidate_weight_source |
| volume_bucket | volume_500k_2m | no_clear_edge | -0.8891 | - | 10 | 0.5 | False | avg_down_wait | candidate_weight_source |
...
| volume_bucket | volume_unknown | no_clear_edge | -1.0024 | - | 5 | 0.6 | False | avg_down_wait | candidate_weight_source |
| time_bucket | time_0930_1030 | no_clear_edge | -0.6492 | - | 8 | 0.375 | False | avg_down_wait | candidate_weight_source |
| time_bucket | time_1030_1400 | no_clear_edge | -0.4988 | - | 26 | 0.5 | False | avg_down_wait | candidate_weight_source |
| time_bucket | time_1400_1530 | no_clear_edge | -1.1742 | - | 5 | 0.6 | False | avg_down_wait,pyramid_wait | candidate_weight_source |

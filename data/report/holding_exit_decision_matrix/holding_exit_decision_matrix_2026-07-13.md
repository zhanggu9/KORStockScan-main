# Holding/Exit Decision Matrix - 2026-07-13

## 판정

- matrix_version: `holding_exit_decision_matrix_v1_2026-07-13`
...
- per_action_samples: `{'exit_only': 174, 'avg_down_wait': 18, 'pyramid_wait': 3}`
- proxy_sample_snapshots: `532`
- proxy_joined_candidates: `120`
- proxy_actions_present: `['hold_defer', 'exit_only', 'avg_down_wait', 'pyramid_wait']`
- proxy_missing_actions: `[]`
- proxy_per_action_samples: `{'hold_defer': 364, 'exit_only': 9, 'avg_down_wait': 349, 'pyramid_wait': 22}`
...
| --- | --- | --- | ---: | ---: | ---: | ---: | --- | --- | --- |
| price_bucket | price_10k_30k | no_clear_edge | -2.0313 | - | 22 | 0.5909 | False | pyramid_wait | candidate_weight_source |
| price_bucket | price_30k_70k | no_clear_edge | -1.2382 | - | 11 | 0.2727 | False | pyramid_wait | candidate_weight_source |
| price_bucket | price_gte_70k | no_clear_edge | -1.1551 | - | 10 | 0.3 | True | - | candidate_weight_source |
| price_bucket | price_lt_10k | no_clear_edge | -1.6441 | - | 15 | 0.5333 | False | avg_down_wait,pyramid_wait | candidate_weight_source |
| volume_bucket | volume_2m_10m | no_clear_edge | -1.3264 | - | 7 | 0.4286 | False | pyramid_wait | candidate_weight_source |
| volume_bucket | volume_500k_2m | no_clear_edge | -1.4957 | - | 13 | 0.3846 | True | - | candidate_weight_source |
| volume_bucket | volume_gte_10m | no_clear_edge | -1.9375 | - | 10 | 0.5 | False | avg_down_wait,pyramid_wait | candidate_weight_source |
| volume_bucket | volume_lt_500k | no_clear_edge | -1.6002 | - | 19 | 0.5263 | False | pyramid_wait | candidate_weight_source |
| volume_bucket | volume_unknown | no_clear_edge | -2.4355 | - | 9 | 0.4444 | False | pyramid_wait | candidate_weight_source |
| time_bucket | time_0900_0930 | no_clear_edge | - | - | - | - | False | avg_down_wait,pyramid_wait | insufficient_sample |
| time_bucket | time_0930_1030 | no_clear_edge | -0.0812 | - | 7 | 0.1429 | False | avg_down_wait,pyramid_wait | candidate_weight_source |
| time_bucket | time_1030_1400 | no_clear_edge | -1.9644 | - | 23 | 0.5652 | True | - | candidate_weight_source |
| time_bucket | time_1400_1530 | no_clear_edge | -1.3118 | - | 6 | 0.5 | False | pyramid_wait | candidate_weight_source |
| time_bucket | time_outside_regular | no_clear_edge | -1.7526 | - | 20 | 0.45 | False | pyramid_wait | candidate_weight_source |

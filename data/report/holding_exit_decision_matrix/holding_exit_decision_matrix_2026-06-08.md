# Holding/Exit Decision Matrix - 2026-06-08

## 판정

- matrix_version: `holding_exit_decision_matrix_v1_2026-06-08`
...
- per_action_samples: `{'exit_only': 150, 'avg_down_wait': 0, 'pyramid_wait': 3}`
- proxy_sample_snapshots: `12849`
- proxy_joined_candidates: `1518`
- proxy_actions_present: `['hold_defer', 'exit_only', 'avg_down_wait', 'pyramid_wait']`
- proxy_missing_actions: `[]`
- proxy_per_action_samples: `{'hold_defer': 12461, 'exit_only': 1935, 'avg_down_wait': 7773, 'pyramid_wait': 3515}`
...
| --- | --- | --- | ---: | ---: | ---: | ---: | --- | --- | --- |
| price_bucket | price_10k_30k | no_clear_edge | -1.346 | - | 7 | 0.5714 | False | avg_down_wait | candidate_weight_source |
| price_bucket | price_30k_70k | no_clear_edge | - | - | - | - | False | avg_down_wait,pyramid_wait | insufficient_sample |
| price_bucket | price_gte_70k | no_clear_edge | -0.8423 | - | 42 | 0.5 | False | avg_down_wait,pyramid_wait | candidate_weight_source |
| volume_bucket | volume_2m_10m | no_clear_edge | -0.8944 | - | 26 | 0.5 | False | avg_down_wait,pyramid_wait | candidate_weight_source |
| volume_bucket | volume_500k_2m | no_clear_edge | -0.6787 | - | 14 | 0.3571 | False | avg_down_wait,pyramid_wait | candidate_weight_source |
| volume_bucket | volume_gte_10m | no_clear_edge | - | - | - | - | False | avg_down_wait | insufficient_sample |
...
| time_bucket | time_0930_1030 | no_clear_edge | -1.2751 | - | 10 | 0.5 | False | avg_down_wait,pyramid_wait | candidate_weight_source |
| time_bucket | time_1030_1400 | no_clear_edge | -0.7307 | - | 32 | 0.5 | False | avg_down_wait | candidate_weight_source |
| time_bucket | time_1400_1530 | no_clear_edge | -1.4572 | - | 8 | 0.625 | False | avg_down_wait,pyramid_wait | candidate_weight_source |

# Holding/Exit Decision Matrix - 2026-08-05

## 판정

- matrix_version: `holding_exit_decision_matrix_v1_2026-08-05`
...
- per_action_samples: `{'exit_only': 93, 'avg_down_wait': 6, 'pyramid_wait': 0}`
- proxy_sample_snapshots: `40`
- proxy_joined_candidates: `0`
- proxy_actions_present: `['hold_defer', 'exit_only', 'avg_down_wait', 'pyramid_wait']`
- proxy_missing_actions: `[]`
- proxy_per_action_samples: `{'hold_defer': 38, 'exit_only': 39, 'avg_down_wait': 33, 'pyramid_wait': 6}`
...
| --- | --- | --- | ---: | ---: | ---: | ---: | --- | --- | --- |
| price_bucket | price_10k_30k | no_clear_edge | -0.4274 | - | 12 | 0.3333 | False | pyramid_wait | candidate_weight_source |
| price_bucket | price_30k_70k | no_clear_edge | - | - | - | - | False | avg_down_wait,pyramid_wait | insufficient_sample |
| price_bucket | price_gte_70k | no_clear_edge | -0.3682 | - | 13 | 0.2308 | False | avg_down_wait,pyramid_wait | candidate_weight_source |
...
| volume_bucket | volume_500k_2m | no_clear_edge | -0.7717 | - | 15 | 0.4667 | False | avg_down_wait,pyramid_wait | candidate_weight_source |
| volume_bucket | volume_gte_10m | no_clear_edge | - | - | - | - | False | avg_down_wait,pyramid_wait | insufficient_sample |
| volume_bucket | volume_lt_500k | no_clear_edge | -0.0249 | - | 12 | 0.0833 | False | pyramid_wait | candidate_weight_source |
| time_bucket | time_0900_0930 | no_clear_edge | -0.9366 | - | 6 | 0.3333 | False | avg_down_wait,pyramid_wait | candidate_weight_source |
| time_bucket | time_0930_1030 | no_clear_edge | 0.1395 | - | 15 | 0.1333 | False | pyramid_wait | candidate_weight_source |
...
| time_bucket | time_outside_regular | no_clear_edge | -0.9034 | - | 7 | 0.4286 | False | avg_down_wait,pyramid_wait | candidate_weight_source |

# Holding/Exit Decision Matrix - 2026-07-29

## 판정

- matrix_version: `holding_exit_decision_matrix_v1_2026-07-29`
...
- per_action_samples: `{'exit_only': 96, 'avg_down_wait': 6, 'pyramid_wait': 0}`
- proxy_sample_snapshots: `147`
- proxy_joined_candidates: `77`
- proxy_actions_present: `['hold_defer', 'exit_only', 'avg_down_wait', 'pyramid_wait']`
- proxy_missing_actions: `[]`
- proxy_per_action_samples: `{'hold_defer': 145, 'exit_only': 146, 'avg_down_wait': 112, 'pyramid_wait': 34}`
...
| --- | --- | --- | ---: | ---: | ---: | ---: | --- | --- | --- |
| price_bucket | price_10k_30k | no_clear_edge | -0.8327 | - | 12 | 0.5 | False | pyramid_wait | candidate_weight_source |
| price_bucket | price_30k_70k | no_clear_edge | - | - | - | - | False | avg_down_wait,pyramid_wait | insufficient_sample |
| price_bucket | price_gte_70k | no_clear_edge | -0.3436 | - | 15 | 0.2 | False | avg_down_wait,pyramid_wait | candidate_weight_source |
| price_bucket | price_lt_10k | no_clear_edge | - | - | - | - | False | avg_down_wait,pyramid_wait | insufficient_sample |
| volume_bucket | volume_2m_10m | no_clear_edge | -0.6636 | - | 5 | 0.6 | False | avg_down_wait,pyramid_wait | candidate_weight_source |
| volume_bucket | volume_500k_2m | no_clear_edge | -0.4601 | - | 17 | 0.2941 | False | avg_down_wait,pyramid_wait | candidate_weight_source |
| volume_bucket | volume_gte_10m | no_clear_edge | - | - | - | - | False | pyramid_wait | insufficient_sample |
| volume_bucket | volume_lt_500k | no_clear_edge | -1.2394 | - | 7 | 0.5714 | False | pyramid_wait | candidate_weight_source |
...
| time_bucket | time_1030_1400 | no_clear_edge | -0.1398 | - | 9 | 0.3333 | False | avg_down_wait,pyramid_wait | candidate_weight_source |
| time_bucket | time_1400_1530 | no_clear_edge | - | - | - | - | False | avg_down_wait,pyramid_wait | insufficient_sample |
| time_bucket | time_outside_regular | no_clear_edge | -0.7517 | - | 19 | 0.3684 | False | pyramid_wait | candidate_weight_source |

# Holding/Exit Decision Matrix - 2026-06-16

## 판정

- matrix_version: `holding_exit_decision_matrix_v1_2026-06-16`
...
- per_action_samples: `{'exit_only': 51, 'avg_down_wait': 0, 'pyramid_wait': 6}`
- proxy_sample_snapshots: `9050`
- proxy_joined_candidates: `0`
- proxy_actions_present: `['hold_defer', 'exit_only', 'avg_down_wait', 'pyramid_wait']`
- proxy_missing_actions: `[]`
- proxy_per_action_samples: `{'hold_defer': 8894, 'exit_only': 1560, 'avg_down_wait': 6401, 'pyramid_wait': 1729}`
...
| --- | --- | --- | ---: | ---: | ---: | ---: | --- | --- | --- |
| price_bucket | price_10k_30k | no_clear_edge | -0.6023 | - | 7 | 0.5714 | False | avg_down_wait | candidate_weight_source |
| price_bucket | price_gte_70k | no_clear_edge | -0.8194 | - | 10 | 0.6 | False | avg_down_wait | candidate_weight_source |
| volume_bucket | volume_2m_10m | no_clear_edge | -0.8408 | - | 6 | 0.5 | False | avg_down_wait | candidate_weight_source |
| volume_bucket | volume_500k_2m | no_clear_edge | -0.5524 | - | 7 | 0.4286 | False | avg_down_wait,pyramid_wait | candidate_weight_source |
...
| time_bucket | time_0930_1030 | no_clear_edge | -0.2591 | - | 6 | 0.3333 | False | avg_down_wait | candidate_weight_source |
| time_bucket | time_1030_1400 | no_clear_edge | -0.7998 | - | 10 | 0.7 | False | avg_down_wait | defensive_only_high_loss_rate |

# Samsung machine entry tuning — 2026-08-24
...
|---|---|---|---:|---|---:|---:|---:|
| morning | two_leg_runtime | pass | 1 | HELD | 0 | 2 | 2 |
| morning_reentry | source_unavailable | gap | 0 | UNKNOWN | 0 | 0 | 0 |
| midday | two_leg_runtime | pass | 0 | NO_TRADE | 0 | 0 | 0 |
| afternoon | two_leg_runtime | pass | 1 | NO_TRADE | 0 | 0 | 0 |

## Cumulative decision

- morning: `inventory_or_order_unresolved`; complete episodes 4/20, clean-baseline cumulative equal-weight/weighted EV 0.187444/0.077269; rolling10/20 0.077269/0.077269; broker-priced legs 2/20.

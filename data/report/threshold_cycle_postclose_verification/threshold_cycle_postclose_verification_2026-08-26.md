...
- P2 `scalp_entry_adm_unknown_bucket_source_quality_gap` 판정: `pass_no_unknown_bucket_warning`
  - 근거: `{'status': 'pass', 'warnings': [], 'affected_rows': 0, 'affected_rate': 0.0, 'dimension_counts': {}, 'unknown_root_cause_counts': {}, 'stage_counts': {'latency_block': 52, 'scalp_entry_action_decision_snapshot': 347, 'blocked_ai_score': 40, 'scalp_sim_entry_ai_price_skip_order': 6, 'scalp_sim_pre_submit_overbought_guard_would_block': 1, 'entry_submit_revalidation_block': 1, 'scalp_sim_pre_submit_liquidity_guard_would_block': 3}, 'recommended_route': 'none', 'not_available_route': 'field_legitimately_unavailable_no_workorder', 'lookup_status_counts': {'matched_prior_bucket': 517, 'new_or_unseen_token_vs_prior_adm': 194}}`
...
- P4 `live_auto_ready_zero_breakdown` 판정: `warning_explained_no_live_auto_ready`
  - 근거: `{'live_auto_apply_ready_count': 0, 'state_counts': {'source_only_keep_collecting': 484, 'lifecycle_flow_sim_probe_candidate': 3}, 'source_bucket_kind_counts': {'taxonomy_provenance_gap': 28, 'source_only_observation': 456, 'lifecycle_flow_sim_probe_policy': 3}, 'runtime_gap_categories': {'runtime_blocked_contract_gap': 11, 'source_only_explicit_exclusion': 1}, 'source_contract_status': 'pass', 'source_contract_change_count': 0, 'ai_two_pass_review_status': 'parsed', 'positive_edge_source_quality_pass_count': 0, 'bridge_blocker_ledger_count': 12, 'runtime_uptake_rate_pct': 0.0, 'handoff_warnings': []}`
...
- status: `pass`
- ai_status: `parsed`
- provider_status: `{'provider': 'openai', 'status': 'success', 'new_provider_call': True, 'key_name': 'OPENAI_API_KEY', 'attempt_index': 1, 'model_index': 1, 'configured_key_count': 2, 'attempted_key_count': 1, 'attempted_keys': 1, 'attempted_key_names': ['OPENAI_API_KEY'], 'configured_model_count': 3, 'attempted_model_count': 1, 'attempted_models': ['gpt-5.5'], 'configured_models': ['gpt-5.5', 'gpt-5.4', 'gpt-5.4-mini'], 'model': 'gpt-5.5', 'schema_name': 'threshold_ai_correction_v1', 'reasoning_effort': 'high', 'prompt_chars': 118641, 'input_context_chars': 117231, 'input_context_hash': '44d46f07dd6d4339dfa7a94186bf03fe13da7767f52c5582c9f1d0fd846bea3e', 'elapsed_ms': 79116, 'output_chars': 14931, 'input_tokens': 34064, 'output_tokens': 7366, 'total_tokens': 41430, 'estimated_cost': 0.0, 'estimated_cost_usd': 0.0, 'cost_estimate_status': 'operator_zero_cost_default'}`
...
- diagnosed_repeated_input_ids: `['ldm_refinement_ebb928c920215e85', 'ldm_refinement_e967b370604fdac8', 'ldm_refinement_7493de8cbe5ba21a', 'ldm_refinement_a2fe26b282f63058']`
- runtime_authority_violation_input_ids: `[]`

## Active Sim Priority Handoff
- status: `pass`
- active_seed_ids: `['active_seed_831822171ccf2e6b']`
- observed_seed_ids: `['active_seed_622146bd0836773e']`
- missing: `[]`
- warnings: `[]`
- match_absence_diagnosis: `not_applicable`
- match_absence_reason: `active_priority_observed_or_no_active_priority`
- candidate_prefix_count: `143`
- top_candidate_prefixes: `[('{"entry_score_parent": "score_watch_recovery", "entry_source_parent": "entry_source_blocked_ai_score"}', 87), ('{"entry_score_parent": "score_watch_recovery", "entry_source_parent": "entry_source_wait6579"}', 32), ('{"entry_score_parent": "score_mid_recovery", "entry_source_parent": "entry_source_blocked_ai_score"}', 16), ('{"entry_score_parent": "score_mid_recovery", "entry_source_parent": "entry_source_wait6579"}', 8)]`

...
- P2 `scalp_entry_adm_unknown_bucket_source_quality_gap` 판정: `source_quality_followup_required`
  - 근거: `{'status': 'warning', 'warnings': ['unknown_bucket_source_quality_gap', 'ai_numeric_consistency_rows_excluded_from_aggregates'], 'affected_rows': 14, 'affected_rate': 0.0258, 'dimension_counts': {'risk_context_bucket': 13, 'price_resolution_bucket': 4, 'score_bucket': 1}, 'unknown_root_cause_counts': {'risk_context_bucket:post_submit_or_exit_not_required': 13, 'price_resolution_bucket:post_submit_or_exit_not_required': 4, 'score_bucket:source_score_missing': 1}, 'stage_counts': {'blocked_ai_score': 57, 'scalp_sim_pre_submit_liquidity_guard_would_block': 31, 'order_bundle_submitted': 9, 'pre_submit_liquidity_guard_block': 1, 'scalp_sim_sell_order_assumed_filled': 4, 'entry_submit_revalidation_block': 1}, 'recommended_route': 'source_quality_workorder', 'not_available_route': 'field_legitimately_unavailable_no_workorder', 'lookup_status_counts': {'new_or_unseen_token_vs_prior_adm': 76, 'matched_prior_bucket': 467}}`
...
- P4 `live_auto_ready_zero_breakdown` 판정: `warning_explained_no_live_auto_ready`
  - 근거: `{'live_auto_apply_ready_count': 0, 'state_counts': {'source_only_keep_collecting': 484, 'lifecycle_flow_sim_probe_candidate': 2, 'automation_handoff_gap': 1, 'sim_auto_approved': 5, 'entry_only_sim_auto_approved': 7, 'entry_only_source_candidate': 1}, 'source_bucket_kind_counts': {'source_only_observation': 438, 'taxonomy_provenance_gap': 47, 'lifecycle_flow_sim_probe_policy': 2, 'sim_auto_policy': 5, 'entry_only_sim_policy': 7, 'entry_only_source_candidate': 1}, 'runtime_gap_categories': {'code_patch_required': 8, 'runtime_blocked_contract_gap': 29, 'sim_auto_approved': 5, 'source_only_explicit_exclusion': 2, 'source_only_keep_collecting': 126, 'source_quality_blocker': 490, 'tier2_fail_closed_source_only': 33}, 'source_contract_status': 'warning', 'source_contract_change_count': 12, 'ai_two_pass_review_status': 'parsed', 'positive_edge_source_quality_pass_count': 44, 'bridge_blocker_ledger_count': 200, 'runtime_uptake_rate_pct': 0.0, 'handoff_warnings': ['lifecycle_bucket_discovery_source_contract_warning', 'source_contract_drift_warning']}`
...
- summary: `{'actionable_unknown_gap_count': 1, 'ai_review_retry_pending': False, 'ai_review_status': 'parsed', 'bridge_blocker_ledger_count': 200, 'candidate_count': 693, 'codex_directive_count': 1, 'conversion_blocker_rank_count': 200, 'critical_failure_count': 0, 'derived_review_category_counts': {'code_patch_required': 8, 'runtime_blocked_contract_gap': 29, 'sim_auto_approved': 5, 'source_only_explicit_exclusion': 2, 'source_only_keep_collecting': 126, 'source_quality_blocker': 490, 'tier2_fail_closed_source_only': 33}, 'positive_edge_source_quality_pass_count': 44, 'quiet_gap_codex_directive_count': 0, 'quiet_gap_count': 423, 'quiet_gap_rollup_count': 423, 'retry_queue_count': 0, 'runtime_uptake_rate_pct': 0.0, 'source_dimension_gap_count': 47, 'status': 'pass'}`
...
- attribution_present: `True`
- flow_count: `6094`
- complete_flow_count: `39`
- direct_sim_record_complete_flow_count: `0`
- adm_bridge_complete_flow_count: `39`
- fallback_complete_flow_count: `0`
- incomplete_flow_count: `6055`
...
- status: `pass`
- ai_status: `parsed`
- provider_status: `{'provider': 'openai', 'status': 'success', 'new_provider_call': True, 'key_name': 'OPENAI_API_KEY', 'attempt_index': 1, 'model_index': 1, 'configured_key_count': 2, 'attempted_key_count': 1, 'attempted_keys': 1, 'attempted_key_names': ['OPENAI_API_KEY'], 'configured_model_count': 3, 'attempted_model_count': 1, 'attempted_models': ['gpt-5.5'], 'configured_models': ['gpt-5.5', 'gpt-5.4', 'gpt-5.4-mini'], 'model': 'gpt-5.5', 'schema_name': 'threshold_ai_correction_v1', 'reasoning_effort': 'high', 'prompt_chars': 106523, 'input_context_chars': 105203, 'input_context_hash': '1eca757a678240d86029324f4881feb5de19cdf78b69f045b9793b3107a68b01', 'elapsed_ms': 106589, 'output_chars': 12042, 'input_tokens': 30714, 'output_tokens': 8574, 'total_tokens': 39288, 'estimated_cost': None, 'estimated_cost_usd': None, 'cost_estimate_status': 'missing_price_contract'}`
...
- status: `pass`
- expected_candidate_ids: `['entry_bucket_10', 'entry_bucket_11', 'entry_bucket_12', 'entry_bucket_13', 'entry_bucket_4', 'entry_bucket_5', 'entry_bucket_6', 'entry_bucket_7', 'entry_bucket_8', 'entry_bucket_9']`
...
- missing: `[]`
- warnings: `[]`
- contract_drift: `{'candidate_feature_event_count': 2290, 'recomputable_match_count': 2290, 'recomputable_hypothesis_ids': ['ldm_hypothesis_00d0b765311ad7aa', 'ldm_hypothesis_711caa66c89b3f51', 'ldm_hypothesis_92dfecb5a05caa64', 'ldm_hypothesis_e04e4d815fd8d0f9'], 'runtime_matched_event_count': 2290}`
- diagnosis_missing_warning_input_ids: `[]`
- diagnosis_missing_fail_input_ids: `[]`
- diagnosed_repeated_input_ids: `['ldm_refinement_839f6b70397c9a10', 'ldm_refinement_80ee96cf114a22e7', 'ldm_refinement_949359f21fde79c3', 'ldm_refinement_15d1aca10fdb4088']`
- runtime_authority_violation_input_ids: `[]`

## Active Sim Priority Handoff
- status: `warning`
- active_seed_ids: `['active_seed_03c539e6527cdda2', 'active_seed_136f942c5ddd1131', 'active_seed_1c218cd27c6c1e78', 'active_seed_6393d366e1ccae2f', 'active_seed_7cf1c198fc1e5246', 'active_seed_b99a2dea7aac2a83', 'active_seed_e777c33bed819112', 'active_seed_fe4874c1fcd31740']`

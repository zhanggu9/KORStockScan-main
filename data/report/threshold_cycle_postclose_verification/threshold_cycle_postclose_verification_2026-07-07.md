...
- P2 `scalp_entry_adm_unknown_bucket_source_quality_gap` 판정: `source_quality_followup_required`
  - 근거: `{'status': 'warning', 'warnings': ['joined_sample_below_sample_floor', 'unknown_bucket_source_quality_gap'], 'affected_rows': 36, 'affected_rate': 0.1132, 'dimension_counts': {'risk_context_bucket': 36, 'score_bucket': 1, 'price_resolution_bucket': 4}, 'unknown_root_cause_counts': {'risk_context_bucket:post_submit_or_exit_not_required': 36, 'score_bucket:source_score_missing': 1, 'price_resolution_bucket:post_submit_or_exit_not_required': 4}, 'stage_counts': {'order_bundle_submitted': 31, 'scalp_sim_pre_submit_liquidity_guard_would_block': 15, 'blocked_ai_score': 20, 'scalp_sim_buy_order_assumed_filled': 1, 'latency_block': 4, 'scalp_entry_action_decision_snapshot': 29, 'scalp_sim_sell_order_assumed_filled': 4}, 'recommended_route': 'source_quality_workorder', 'not_available_route': 'field_legitimately_unavailable_no_workorder', 'lookup_status_counts': {'matched_prior_bucket': 242, 'new_or_unseen_token_vs_prior_adm': 76}}`
...
- P4 `live_auto_ready_zero_breakdown` 판정: `warning_explained_no_live_auto_ready`
  - 근거: `{'live_auto_apply_ready_count': 0, 'state_counts': {'source_only_keep_collecting': 479, 'lifecycle_flow_sim_probe_candidate': 2, 'entry_only_sim_auto_approved': 1, 'sim_auto_approved': 5, 'new_bucket_candidate': 13}, 'source_bucket_kind_counts': {'taxonomy_provenance_gap': 62, 'source_only_observation': 430, 'lifecycle_flow_sim_probe_policy': 2, 'entry_only_sim_policy': 1, 'sim_auto_policy': 5}, 'runtime_gap_categories': {'code_patch_required': 1, 'runtime_blocked_contract_gap': 22, 'sim_auto_approved': 47, 'source_only_explicit_exclusion': 2, 'source_only_keep_collecting': 176, 'source_quality_blocker': 441, 'tier2_fail_closed_source_only': 28}, 'source_contract_status': 'warning', 'source_contract_change_count': 16, 'ai_two_pass_review_status': 'parsed', 'positive_edge_source_quality_pass_count': 70, 'bridge_blocker_ledger_count': 200, 'runtime_uptake_rate_pct': 0.0, 'handoff_warnings': ['lifecycle_bucket_discovery_source_contract_warning', 'source_contract_drift_warning']}`
...
- summary: `{'actionable_unknown_gap_count': 0, 'ai_review_retry_pending': False, 'ai_review_status': 'parsed', 'bridge_blocker_ledger_count': 200, 'candidate_count': 717, 'codex_directive_count': 0, 'conversion_blocker_rank_count': 200, 'critical_failure_count': 0, 'derived_review_category_counts': {'code_patch_required': 1, 'runtime_blocked_contract_gap': 22, 'sim_auto_approved': 47, 'source_only_explicit_exclusion': 2, 'source_only_keep_collecting': 176, 'source_quality_blocker': 441, 'tier2_fail_closed_source_only': 28}, 'positive_edge_source_quality_pass_count': 70, 'quiet_gap_codex_directive_count': 0, 'quiet_gap_count': 407, 'quiet_gap_rollup_count': 407, 'retry_queue_count': 0, 'runtime_uptake_rate_pct': 0.0, 'source_dimension_gap_count': 61, 'status': 'pass'}`
...
- adm_bridge_complete_flow_count: `14`
- fallback_complete_flow_count: `0`
- incomplete_flow_count: `3709`
...
- status: `pass`
- ai_status: `parsed`
- provider_status: `{'provider': 'openai', 'status': 'success', 'new_provider_call': True, 'key_name': 'OPENAI_API_KEY', 'attempt_index': 1, 'model_index': 1, 'configured_key_count': 2, 'attempted_key_count': 1, 'attempted_keys': 1, 'attempted_key_names': ['OPENAI_API_KEY'], 'configured_model_count': 3, 'attempted_model_count': 1, 'attempted_models': ['gpt-5.5'], 'configured_models': ['gpt-5.5', 'gpt-5.4', 'gpt-5.4-mini'], 'model': 'gpt-5.5', 'schema_name': 'threshold_ai_correction_v1', 'reasoning_effort': 'high', 'prompt_chars': 107339, 'input_context_chars': 106019, 'input_context_hash': '2ba40b6c16271f4b27a9282c6361d9146377403403c8641df55890c4c9539236', 'elapsed_ms': 156798, 'output_chars': 12502, 'input_tokens': 31019, 'output_tokens': 7914, 'total_tokens': 38933, 'estimated_cost': None, 'estimated_cost_usd': None, 'cost_estimate_status': 'missing_price_contract'}`
...
- missing: `[]`
- warnings: `[]`
- contract_drift: `{'candidate_feature_event_count': 1052, 'recomputable_match_count': 1052, 'recomputable_hypothesis_ids': ['ldm_hypothesis_00d0b765311ad7aa', 'ldm_hypothesis_92dfecb5a05caa64', 'ldm_hypothesis_e04e4d815fd8d0f9'], 'runtime_matched_event_count': 1052}`
- diagnosis_missing_warning_input_ids: `[]`
- diagnosis_missing_fail_input_ids: `[]`
- diagnosed_repeated_input_ids: `['ldm_refinement_3ae62ca322d29278', 'ldm_refinement_61e298cc0272bffc', 'ldm_refinement_884e283580cf527e']`
- runtime_authority_violation_input_ids: `[]`

## Active Sim Priority Handoff
- status: `warning`
- active_seed_ids: `['active_seed_1fc6245cf630af1c', 'active_seed_b99a2dea7aac2a83', 'active_seed_e616eff77dc91bad', 'active_seed_f2db9775052c4d8d']`
- observed_seed_ids: `[]`
- missing: `[]`
...
- candidate_prefix_count: `1052`
- top_candidate_prefixes: `[('{"entry_score_parent": "score_watch_recovery", "entry_source_parent": "entry_source_wait6579"}', 714), ('{"entry_score_parent": "score_watch_recovery", "entry_source_parent": "entry_source_blocked_ai_score"}', 324), ('{"entry_score_parent": "score_mid_recovery", "entry_source_parent": "entry_source_blocked_ai_score"}', 14)]`

## Lifecycle Bucket Windows
- status: `pass`
- checked: `True`
- windows: `{'rolling5d': {'available': True, 'source_contract_status': 'pass', 'parent_granularity_status': 'target_pass', 'parent_bucket_count': 58, 'window_role': 'rolling_confirmation'}, 'rolling10d': {'available': True, 'source_contract_status': 'pass', 'parent_granularity_status': 'target_pass', 'parent_bucket_count': 40, 'window_role': 'rolling_confirmation'}, 'mtd': {'available': True, 'source_contract_status': 'pass', 'parent_granularity_status': 'target_pass', 'parent_bucket_count': 30, 'window_role': 'promotion_confirmation'}}`
- missing: `[]`
- warnings: `[]`
...
## Workorder Snapshot
- generation_id: `2026-07-07-836932d7568a`
- source_hash: `836932d7568a30e70670627daf7d11608ecb41cd249b942b736d1b872992168c`
- snapshot_status: `source_changed_with_lineage`
- previous_generation_id: `2026-07-07-31f052a00ca0`
- previous_source_hash: `31f052a00ca0eca0a879e28990974b7fb7daf44e76e35c1166b173b5cacd285d`
- new_order_ids: `['order_conversion_lane_key_lineage_active_arm_1661ca30f0d594fd', 'order_conversion_lane_key_lineage_active_arm_167e2213662b0147', 'order_conversion_lane_key_lineage_active_arm_2c44a9b1dd392eb3', 'order_conversion_lane_key_lineage_active_arm_2d256010e69684c1', 'order_conversion_lane_key_lineage_active_arm_400bb07e38eb1ab2', 'order_conversion_lane_key_lineage_active_arm_431cb98e1d4adfce', 'order_conversion_lane_key_lineage_active_arm_518e85a70ac730e3', 'order_conversion_lane_key_lineage_active_arm_52e8c1f2d0e05882', 'order_conversion_lane_key_lineage_active_arm_5ed5448f4e3ccb60', 'order_conversion_lane_key_lineage_active_arm_665f8e1098e38541', 'order_conversion_lane_key_lineage_active_arm_82f4bc68bb168a83', 'order_conversion_lane_key_lineage_active_arm_888ade47545aacbc', 'order_conversion_lane_key_lineage_active_arm_89383c15a79e92ee', 'order_conversion_lane_key_lineage_active_arm_8ca13269eecf5f8e', 'order_conversion_lane_key_lineage_active_arm_8eb6698f81674caf', 'order_conversion_lane_key_lineage_active_arm_8f2ebfbbfc2b0593', 'order_conversion_lane_key_lineage_active_arm_a0d18f8d00f97208', 'order_conversion_lane_key_lineage_active_arm_af0dff677e6a12e4', 'order_conversion_lane_key_lineage_active_arm_b460665611c8fde0', 'order_conversion_lane_key_lineage_active_arm_ba238963f55dedbe']`
- removed_order_ids: `[]`

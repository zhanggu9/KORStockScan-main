...
- P2 `scalp_entry_adm_unknown_bucket_source_quality_gap` 판정: `source_quality_followup_required`
  - 근거: `{'status': 'warning', 'warnings': ['joined_sample_below_sample_floor', 'unknown_bucket_source_quality_gap', 'ai_numeric_consistency_rows_excluded_from_aggregates'], 'affected_rows': 48, 'affected_rate': 0.2182, 'dimension_counts': {'risk_context_bucket': 48, 'score_bucket': 1, 'price_resolution_bucket': 4}, 'unknown_root_cause_counts': {'risk_context_bucket:post_submit_or_exit_not_required': 42, 'score_bucket:source_score_missing': 1, 'risk_context_bucket:source_field_missing': 6, 'price_resolution_bucket:post_submit_or_exit_not_required': 4}, 'stage_counts': {'order_bundle_submitted': 37, 'scalp_sim_pre_submit_liquidity_guard_would_block': 15, 'blocked_ai_score': 21, 'scalp_sim_buy_order_assumed_filled': 1, 'latency_block': 3, 'scalp_entry_action_decision_snapshot': 27, 'scalp_sim_sell_order_assumed_filled': 4}, 'recommended_route': 'source_quality_workorder', 'not_available_route': 'field_legitimately_unavailable_no_workorder', 'lookup_status_counts': {'matched_prior_bucket': 146, 'new_or_unseen_token_vs_prior_adm': 74}}`
...
- P4 `live_auto_ready_zero_breakdown` 판정: `warning_explained_no_live_auto_ready`
  - 근거: `{'live_auto_apply_ready_count': 0, 'state_counts': {'source_only_keep_collecting': 490, 'lifecycle_flow_sim_probe_candidate': 3, 'automation_handoff_gap': 1, 'sim_auto_approved': 2, 'entry_only_sim_auto_approved': 4}, 'source_bucket_kind_counts': {'taxonomy_provenance_gap': 75, 'source_only_observation': 416, 'lifecycle_flow_sim_probe_policy': 3, 'sim_auto_policy': 2, 'entry_only_sim_policy': 4}, 'runtime_gap_categories': {'code_patch_required': 4, 'runtime_blocked_contract_gap': 29, 'sim_auto_approved': 38, 'source_only_explicit_exclusion': 2, 'source_only_keep_collecting': 161, 'source_quality_blocker': 448, 'tier2_fail_closed_source_only': 24}, 'source_contract_status': 'warning', 'source_contract_change_count': 14, 'ai_two_pass_review_status': 'parsed', 'positive_edge_source_quality_pass_count': 66, 'bridge_blocker_ledger_count': 200, 'runtime_uptake_rate_pct': 0.0, 'handoff_warnings': ['lifecycle_bucket_discovery_source_contract_warning', 'source_contract_drift_warning']}`
...
- summary: `{'actionable_unknown_gap_count': 0, 'ai_review_retry_pending': False, 'ai_review_status': 'parsed', 'bridge_blocker_ledger_count': 200, 'candidate_count': 706, 'codex_directive_count': 0, 'conversion_blocker_rank_count': 200, 'critical_failure_count': 0, 'derived_review_category_counts': {'code_patch_required': 4, 'runtime_blocked_contract_gap': 29, 'sim_auto_approved': 38, 'source_only_explicit_exclusion': 2, 'source_only_keep_collecting': 161, 'source_quality_blocker': 448, 'tier2_fail_closed_source_only': 24}, 'positive_edge_source_quality_pass_count': 66, 'quiet_gap_codex_directive_count': 0, 'quiet_gap_count': 395, 'quiet_gap_rollup_count': 395, 'retry_queue_count': 0, 'runtime_uptake_rate_pct': 0.0, 'source_dimension_gap_count': 74, 'status': 'pass'}`
...
- status: `pass`
- ai_status: `parsed`
- provider_status: `{'provider': 'openai', 'status': 'success', 'new_provider_call': True, 'key_name': 'OPENAI_API_KEY', 'attempt_index': 1, 'model_index': 1, 'configured_key_count': 2, 'attempted_key_count': 1, 'attempted_keys': 1, 'attempted_key_names': ['OPENAI_API_KEY'], 'configured_model_count': 3, 'attempted_model_count': 1, 'attempted_models': ['gpt-5.5'], 'configured_models': ['gpt-5.5', 'gpt-5.4', 'gpt-5.4-mini'], 'model': 'gpt-5.5', 'schema_name': 'threshold_ai_correction_v1', 'reasoning_effort': 'high', 'prompt_chars': 108476, 'input_context_chars': 107156, 'input_context_hash': 'dc66ecb52767dbdfbe4a85d4ce6043f97286778f0a3afcd28ab2ffda1f9499d3', 'elapsed_ms': 66957, 'output_chars': 12869, 'input_tokens': 31244, 'output_tokens': 5921, 'total_tokens': 37165, 'estimated_cost': None, 'estimated_cost_usd': None, 'cost_estimate_status': 'missing_price_contract'}`
- blocking_runtime_candidate_families: `['bad_entry_refined_canary', 'holding_exit_decision_matrix_advisory', 'lifecycle_decision_matrix_runtime', 'protect_trailing_smoothing', 'score65_74_recovery_probe']`
- parse_warnings: `[]`
...
- missing: `[]`
- warnings: `[]`
- contract_drift: `{'candidate_feature_event_count': 1557, 'recomputable_match_count': 1557, 'recomputable_hypothesis_ids': ['ldm_hypothesis_00d0b765311ad7aa', 'ldm_hypothesis_711caa66c89b3f51', 'ldm_hypothesis_92dfecb5a05caa64', 'ldm_hypothesis_e04e4d815fd8d0f9'], 'runtime_matched_event_count': 1557}`
- diagnosis_missing_warning_input_ids: `[]`
- diagnosis_missing_fail_input_ids: `[]`
- diagnosed_repeated_input_ids: `['ldm_refinement_2d862d4ae87e0c63', 'ldm_refinement_fca40344c6aa6247', 'ldm_refinement_f9a3b01fcd29432a', 'ldm_refinement_b94f60e7de93b066']`
- runtime_authority_violation_input_ids: `[]`

## Active Sim Priority Handoff
- status: `warning`
- active_seed_ids: `['active_seed_117652d76d63ff34', 'active_seed_1fc6245cf630af1c', 'active_seed_7cf1c198fc1e5246', 'active_seed_b99a2dea7aac2a83', 'active_seed_f59dd84c7dcc89c1', 'active_seed_f8f167383fabb79f']`
- observed_seed_ids: `['rising_missed_prior_e65574639530054b']`
- missing: `[]`
...
## Workorder Snapshot
- generation_id: `2026-07-03-451f88a095bc`
- source_hash: `451f88a095bc54a4792b8a258b3c921370880feefa3ab8e5a2d5adda6036dbe2`
- snapshot_status: `source_changed_with_lineage`
- previous_generation_id: `2026-07-03-a3568e4d0fe8`
- previous_source_hash: `a3568e4d0fe8732f4cd5eb603a11863041232c264299a87c0793d3137f424576`
- new_order_ids: `['order_conversion_lane_key_lineage_active_arm_1661ca30f0d594fd', 'order_conversion_lane_key_lineage_active_arm_167e2213662b0147', 'order_conversion_lane_key_lineage_active_arm_1b4fe07e5d46d526', 'order_conversion_lane_key_lineage_active_arm_2c44a9b1dd392eb3', 'order_conversion_lane_key_lineage_active_arm_2d256010e69684c1', 'order_conversion_lane_key_lineage_active_arm_400bb07e38eb1ab2', 'order_conversion_lane_key_lineage_active_arm_4010998406098b43', 'order_conversion_lane_key_lineage_active_arm_431cb98e1d4adfce', 'order_conversion_lane_key_lineage_active_arm_4696f498fbff4b98', 'order_conversion_lane_key_lineage_active_arm_4c9f4d53846d2b2a', 'order_conversion_lane_key_lineage_active_arm_518e85a70ac730e3', 'order_conversion_lane_key_lineage_active_arm_52e8c1f2d0e05882', 'order_conversion_lane_key_lineage_active_arm_5ed5448f4e3ccb60', 'order_conversion_lane_key_lineage_active_arm_665f8e1098e38541', 'order_conversion_lane_key_lineage_active_arm_82f4bc68bb168a83', 'order_conversion_lane_key_lineage_active_arm_888ade47545aacbc', 'order_conversion_lane_key_lineage_active_arm_89383c15a79e92ee', 'order_conversion_lane_key_lineage_active_arm_8ca13269eecf5f8e', 'order_conversion_lane_key_lineage_active_arm_8eb6698f81674caf', 'order_conversion_lane_key_lineage_active_arm_a0d18f8d00f97208']`
- removed_order_ids: `[]`

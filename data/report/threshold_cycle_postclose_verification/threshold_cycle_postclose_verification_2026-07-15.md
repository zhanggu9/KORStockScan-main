...
- P2 `scalp_entry_adm_unknown_bucket_source_quality_gap` 판정: `source_quality_followup_required`
  - 근거: `{'status': 'warning', 'warnings': ['joined_sample_below_sample_floor', 'unknown_bucket_source_quality_gap'], 'affected_rows': 37, 'affected_rate': 0.0934, 'dimension_counts': {'risk_context_bucket': 37, 'price_resolution_bucket': 1}, 'unknown_root_cause_counts': {'risk_context_bucket:source_field_missing': 36, 'risk_context_bucket:post_submit_or_exit_not_required': 1, 'price_resolution_bucket:post_submit_or_exit_not_required': 1}, 'stage_counts': {'latency_block': 29, 'scalp_entry_action_decision_snapshot': 122, 'blocked_ai_score': 28, 'scalp_sim_pre_submit_liquidity_guard_would_block': 7, 'order_bundle_submitted': 10, 'scalp_sim_sell_order_assumed_filled': 1}, 'recommended_route': 'source_quality_workorder', 'not_available_route': 'field_legitimately_unavailable_no_workorder', 'lookup_status_counts': {'new_or_unseen_token_vs_prior_adm': 131, 'matched_prior_bucket': 265}}`
...
- P4 `live_auto_ready_zero_breakdown` 판정: `warning_explained_no_live_auto_ready`
  - 근거: `{'live_auto_apply_ready_count': 0, 'state_counts': {'source_only_keep_collecting': 377, 'lifecycle_flow_sim_probe_candidate': 1, 'sim_auto_approved': 2, 'runtime_blocked_contract_gap': 1, 'new_bucket_candidate': 11}, 'source_bucket_kind_counts': {'taxonomy_provenance_gap': 35, 'source_only_observation': 353, 'lifecycle_flow_sim_probe_policy': 1, 'sim_auto_policy': 2, 'source_quality_gap': 1}, 'runtime_gap_categories': {'runtime_blocked_contract_gap': 16, 'sim_auto_approved': 40, 'source_only_explicit_exclusion': 2, 'source_only_keep_collecting': 203, 'source_quality_blocker': 408, 'tier2_fail_closed_source_only': 41}, 'source_contract_status': 'warning', 'source_contract_change_count': 12, 'ai_two_pass_review_status': 'parsed', 'positive_edge_source_quality_pass_count': 79, 'bridge_blocker_ledger_count': 200, 'runtime_uptake_rate_pct': 0.0, 'handoff_warnings': ['lifecycle_bucket_discovery_source_contract_warning', 'source_contract_drift_warning']}`
...
- summary: `{'actionable_unknown_gap_count': 0, 'ai_review_retry_pending': False, 'ai_review_status': 'parsed', 'bridge_blocker_ledger_count': 200, 'candidate_count': 710, 'codex_directive_count': 0, 'conversion_blocker_rank_count': 200, 'critical_failure_count': 0, 'derived_review_category_counts': {'runtime_blocked_contract_gap': 16, 'sim_auto_approved': 40, 'source_only_explicit_exclusion': 2, 'source_only_keep_collecting': 203, 'source_quality_blocker': 408, 'tier2_fail_closed_source_only': 41}, 'positive_edge_source_quality_pass_count': 79, 'quiet_gap_codex_directive_count': 0, 'quiet_gap_count': 309, 'quiet_gap_rollup_count': 309, 'retry_queue_count': 0, 'runtime_uptake_rate_pct': 0.0, 'source_dimension_gap_count': 32, 'status': 'pass'}`
...
- attribution_present: `True`
- flow_count: `750`
- complete_flow_count: `17`
- direct_sim_record_complete_flow_count: `0`
- adm_bridge_complete_flow_count: `17`
- fallback_complete_flow_count: `0`
- incomplete_flow_count: `733`
...
- status: `pass`
- ai_status: `parsed`
- provider_status: `{'provider': 'openai', 'status': 'success', 'new_provider_call': True, 'key_name': 'OPENAI_API_KEY', 'attempt_index': 1, 'model_index': 1, 'configured_key_count': 2, 'attempted_key_count': 1, 'attempted_keys': 1, 'attempted_key_names': ['OPENAI_API_KEY'], 'configured_model_count': 3, 'attempted_model_count': 1, 'attempted_models': ['gpt-5.5'], 'configured_models': ['gpt-5.5', 'gpt-5.4', 'gpt-5.4-mini'], 'model': 'gpt-5.5', 'schema_name': 'threshold_ai_correction_v1', 'reasoning_effort': 'high', 'prompt_chars': 111933, 'input_context_chars': 110613, 'input_context_hash': '0aca1ca370c47acbd0ca3fa963c2f5621706feab22fe11156d88b4d22baeb38a', 'elapsed_ms': 84484, 'output_chars': 10830, 'input_tokens': 31964, 'output_tokens': 7048, 'total_tokens': 39012, 'estimated_cost': None, 'estimated_cost_usd': None, 'cost_estimate_status': 'missing_price_contract'}`
...
- missing: `[]`
- warnings: `[]`
- contract_drift: `{'candidate_feature_event_count': 835, 'recomputable_match_count': 835, 'recomputable_hypothesis_ids': ['ldm_hypothesis_00d0b765311ad7aa', 'ldm_hypothesis_92dfecb5a05caa64', 'ldm_hypothesis_e04e4d815fd8d0f9'], 'runtime_matched_event_count': 835}`
- diagnosis_missing_warning_input_ids: `[]`
- diagnosis_missing_fail_input_ids: `[]`
- diagnosed_repeated_input_ids: `['ldm_refinement_d877588232febace', 'ldm_refinement_31f5544dabec6213', 'ldm_refinement_bd2ea409d98226bc']`

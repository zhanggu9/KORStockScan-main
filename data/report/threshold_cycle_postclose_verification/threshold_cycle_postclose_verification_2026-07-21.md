...
- P2 `scalp_entry_adm_unknown_bucket_source_quality_gap` 판정: `source_quality_followup_required`
  - 근거: `{'status': 'warning', 'warnings': ['joined_sample_below_sample_floor', 'unknown_bucket_source_quality_gap'], 'affected_rows': 53, 'affected_rate': 0.1672, 'dimension_counts': {'risk_context_bucket': 51, 'score_bucket': 2, 'price_resolution_bucket': 1}, 'unknown_root_cause_counts': {'risk_context_bucket:source_field_missing': 50, 'score_bucket:source_score_missing': 2, 'risk_context_bucket:post_submit_or_exit_not_required': 1, 'price_resolution_bucket:post_submit_or_exit_not_required': 1}, 'stage_counts': {'latency_block': 64, 'scalp_entry_action_decision_snapshot': 234, 'order_bundle_submitted': 7, 'entry_submit_revalidation_block': 2, 'blocked_ai_score': 1, 'scalp_sim_sell_order_assumed_filled': 1}, 'recommended_route': 'source_quality_workorder', 'not_available_route': 'field_legitimately_unavailable_no_workorder', 'lookup_status_counts': {'matched_prior_bucket': 284, 'new_or_unseen_token_vs_prior_adm': 33}}`
...
- P4 `live_auto_ready_zero_breakdown` 판정: `warning_explained_no_live_auto_ready`
  - 근거: `{'live_auto_apply_ready_count': 0, 'state_counts': {'source_only_keep_collecting': 181, 'sim_auto_approved': 1, 'new_bucket_candidate': 12}, 'source_bucket_kind_counts': {'taxonomy_provenance_gap': 27, 'source_only_observation': 166, 'sim_auto_policy': 1}, 'runtime_gap_categories': {'runtime_blocked_contract_gap': 9, 'sim_auto_approved': 40, 'source_only_explicit_exclusion': 2, 'source_only_keep_collecting': 248, 'source_quality_blocker': 355, 'tier2_fail_closed_source_only': 46}, 'source_contract_status': 'warning', 'source_contract_change_count': 12, 'ai_two_pass_review_status': 'parsed', 'positive_edge_source_quality_pass_count': 91, 'bridge_blocker_ledger_count': 200, 'runtime_uptake_rate_pct': 0.0, 'handoff_warnings': ['lifecycle_bucket_discovery_source_contract_warning', 'source_contract_drift_warning']}`
...
- summary: `{'actionable_unknown_gap_count': 0, 'ai_review_retry_pending': False, 'ai_review_status': 'parsed', 'bridge_blocker_ledger_count': 200, 'candidate_count': 700, 'codex_directive_count': 0, 'conversion_blocker_rank_count': 200, 'critical_failure_count': 0, 'derived_review_category_counts': {'runtime_blocked_contract_gap': 9, 'sim_auto_approved': 40, 'source_only_explicit_exclusion': 2, 'source_only_keep_collecting': 248, 'source_quality_blocker': 355, 'tier2_fail_closed_source_only': 46}, 'positive_edge_source_quality_pass_count': 91, 'quiet_gap_codex_directive_count': 0, 'quiet_gap_count': 133, 'quiet_gap_rollup_count': 133, 'retry_queue_count': 0, 'runtime_uptake_rate_pct': 0.0, 'source_dimension_gap_count': 25, 'status': 'pass'}`
...
- missing: `[]`
- warnings: `[]`
- contract_drift: `{'candidate_feature_event_count': 68, 'recomputable_match_count': 68, 'recomputable_hypothesis_ids': ['ldm_hypothesis_00d0b765311ad7aa'], 'runtime_matched_event_count': 68}`
- diagnosis_missing_warning_input_ids: `[]`
- diagnosis_missing_fail_input_ids: `[]`
- diagnosed_repeated_input_ids: `['ldm_refinement_b1f3815b0c6afa5d']`
...
- candidate_prefix_count: `68`
- top_candidate_prefixes: `[('{"entry_score_parent": "score_watch_recovery", "entry_source_parent": "entry_source_blocked_ai_score"}', 68)]`

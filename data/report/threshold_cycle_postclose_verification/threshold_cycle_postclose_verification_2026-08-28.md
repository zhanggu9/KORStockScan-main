...
- P2 `scalp_entry_adm_unknown_bucket_source_quality_gap` 판정: `pass_no_unknown_bucket_warning`
  - 근거: `{'status': 'pass', 'warnings': [], 'affected_rows': 0, 'affected_rate': 0.0, 'dimension_counts': {}, 'unknown_root_cause_counts': {}, 'stage_counts': {'scalp_entry_action_decision_snapshot': 277, 'latency_block': 33, 'blocked_ai_score': 29, 'scalp_sim_pre_submit_liquidity_guard_would_block': 2, 'order_bundle_submitted': 7, 'scalp_sim_entry_ai_price_skip_order': 9, 'entry_submit_revalidation_block': 1}, 'recommended_route': 'none', 'not_available_route': 'field_legitimately_unavailable_no_workorder', 'lookup_status_counts': {'new_or_unseen_token_vs_prior_adm': 177, 'matched_prior_bucket': 472}}`
...
- P4 `live_auto_ready_zero_breakdown` 판정: `warning_explained_no_live_auto_ready`
  - 근거: `{'live_auto_apply_ready_count': 0, 'state_counts': {'source_only_keep_collecting': 386, 'lifecycle_flow_sim_probe_candidate': 1}, 'source_bucket_kind_counts': {'taxonomy_provenance_gap': 34, 'source_only_observation': 352, 'lifecycle_flow_sim_probe_policy': 1}, 'runtime_gap_categories': {'code_patch_required': 1, 'runtime_blocked_contract_gap': 11, 'source_only_explicit_exclusion': 1}, 'source_contract_status': 'pass', 'source_contract_change_count': 0, 'ai_two_pass_review_status': 'parsed', 'positive_edge_source_quality_pass_count': 1, 'bridge_blocker_ledger_count': 13, 'runtime_uptake_rate_pct': 0.0, 'handoff_warnings': []}`
...
- summary: `{'actionable_unknown_gap_count': 0, 'ai_review_retry_pending': False, 'ai_review_status': 'parsed', 'bridge_blocker_ledger_count': 13, 'candidate_count': 13, 'codex_directive_count': 0, 'conversion_blocker_rank_count': 13, 'critical_failure_count': 0, 'derived_review_category_counts': {'code_patch_required': 1, 'runtime_blocked_contract_gap': 11, 'source_only_explicit_exclusion': 1}, 'positive_edge_source_quality_pass_count': 1, 'quiet_gap_codex_directive_count': 0, 'quiet_gap_count': 339, 'quiet_gap_rollup_count': 339, 'retry_queue_count': 0, 'runtime_uptake_rate_pct': 0.0, 'source_dimension_gap_count': 29, 'status': 'pass'}`
...
- status: `pass`
- ai_status: `parsed`
- provider_status: `{'provider': 'openai', 'status': 'reused_valid_artifact', 'new_provider_call': False, 'key_name': 'OPENAI_API_KEY', 'attempt_index': 1, 'model_index': 1, 'configured_key_count': 2, 'attempted_key_count': 1, 'attempted_keys': 1, 'attempted_key_names': ['OPENAI_API_KEY'], 'configured_model_count': 3, 'attempted_model_count': 1, 'attempted_models': ['gpt-5.5'], 'configured_models': ['gpt-5.5', 'gpt-5.4', 'gpt-5.4-mini'], 'model': 'gpt-5.5', 'schema_name': 'threshold_ai_correction_v1', 'reasoning_effort': 'high', 'prompt_chars': 119629, 'input_context_chars': 118219, 'input_context_hash': '79587939c08d183e94439fac5ab08cffd2191b7c78119754a0cb5ebb10ddc179', 'elapsed_ms': 103388, 'output_chars': 13807, 'input_tokens': 34342, 'output_tokens': 9406, 'total_tokens': 43748, 'estimated_cost': 0.0, 'estimated_cost_usd': 0.0, 'cost_estimate_status': 'operator_zero_cost_default', 'reuse_source_path': '/home/ubuntu/KORStockScan/data/report/threshold_cycle_ai_review/threshold_cycle_ai_review_2026-08-28_postclose.json', 'reused_at': '2026-08-28 21:44:44', 'estimated_incremental_cost': 0.0, 'estimated_incremental_cost_usd': 0.0, 'incremental_cost_status': 'reused_no_new_provider_call'}`
...
- diagnosed_repeated_input_ids: `['ldm_refinement_040aae256baffcb8', 'ldm_refinement_3dc65746d9484299', 'ldm_refinement_016c68f552bf25b1']`
- runtime_authority_violation_input_ids: `[]`

## Active Sim Priority Handoff
- status: `warning`
- active_seed_ids: `['active_seed_37c2c640b72a1f8e', 'active_seed_e616eff77dc91bad']`
- observed_seed_ids: `[]`
- missing: `[]`
...
- candidate_prefix_count: `166`
- top_candidate_prefixes: `[('{"entry_score_parent": "score_watch_recovery", "entry_source_parent": "entry_source_blocked_ai_score"}', 98), ('{"entry_score_parent": "score_mid_recovery", "entry_source_parent": "entry_source_blocked_ai_score"}', 51), ('{"entry_score_parent": "score_watch_recovery", "entry_source_parent": "entry_source_wait6579"}', 17)]`

## Lifecycle Bucket Windows
- status: `pass`
- checked: `True`
- windows: `{'rolling5d': {'available': True, 'source_contract_status': 'pass', 'parent_granularity_status': 'target_pass', 'parent_bucket_count': 44, 'window_role': 'rolling_confirmation'}, 'rolling10d': {'available': True, 'source_contract_status': 'pass', 'parent_granularity_status': 'target_pass', 'parent_bucket_count': 53, 'window_role': 'rolling_confirmation'}, 'mtd': {'available': True, 'source_contract_status': 'pass', 'parent_granularity_status': 'target_pass', 'parent_bucket_count': 35, 'window_role': 'promotion_confirmation'}}`
- missing: `[]`
- warnings: `[]`

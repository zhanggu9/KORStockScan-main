# Threshold Cycle Postclose Verification - 2026-07-24

- status: `warning`
- latest_start_marker: `[START] threshold-cycle postclose target_date=2026-07-24 max_iterations=80 started_at=2026-07-24T20:10:01+0900`
- latest_done_marker: `[DONE] threshold-cycle postclose target_date=2026-07-24 recovery_action=tail_repair_done_reconciliation full_wrapper_rerun=false finished_at=2026-07-24T21:57:39+0900`
...
- P2 `scalp_entry_adm_unknown_bucket_source_quality_gap` 판정: `source_quality_followup_required`
  - 근거: `{'status': 'warning', 'warnings': ['joined_sample_below_sample_floor', 'unknown_bucket_source_quality_gap'], 'affected_rows': 37, 'affected_rate': 0.2067, 'dimension_counts': {'risk_context_bucket': 37, 'price_resolution_bucket': 1}, 'unknown_root_cause_counts': {'risk_context_bucket:source_field_missing': 36, 'risk_context_bucket:post_submit_or_exit_not_required': 1, 'price_resolution_bucket:post_submit_or_exit_not_required': 1}, 'stage_counts': {'latency_block': 18, 'scalp_entry_action_decision_snapshot': 105, 'order_bundle_submitted': 1, 'scalp_sim_sell_order_assumed_filled': 1}, 'recommended_route': 'source_quality_workorder', 'not_available_route': 'field_legitimately_unavailable_no_workorder', 'lookup_status_counts': {'new_or_unseen_token_vs_prior_adm': 124, 'matched_prior_bucket': 55}}`
...
- P4 `live_auto_ready_zero_breakdown` 판정: `warning_explained_no_live_auto_ready`
  - 근거: `{'live_auto_apply_ready_count': 0, 'state_counts': {'source_only_keep_collecting': 132, 'runtime_blocked_contract_gap': 1, 'new_bucket_candidate': 11}, 'source_bucket_kind_counts': {'taxonomy_provenance_gap': 18, 'source_only_observation': 125, 'source_quality_gap': 1}, 'runtime_gap_categories': {'runtime_blocked_contract_gap': 7, 'sim_auto_approved': 58, 'source_only_explicit_exclusion': 2, 'source_only_keep_collecting': 217, 'source_quality_blocker': 354, 'tier2_fail_closed_source_only': 61}, 'source_contract_status': 'warning', 'source_contract_change_count': 12, 'ai_two_pass_review_status': 'parsed', 'positive_edge_source_quality_pass_count': 119, 'bridge_blocker_ledger_count': 200, 'runtime_uptake_rate_pct': 0.0, 'handoff_warnings': ['lifecycle_bucket_discovery_source_contract_warning', 'source_contract_drift_warning']}`
...
- summary: `{'actionable_unknown_gap_count': 0, 'ai_review_retry_pending': False, 'ai_review_status': 'parsed', 'bridge_blocker_ledger_count': 200, 'candidate_count': 699, 'codex_directive_count': 0, 'conversion_blocker_rank_count': 200, 'critical_failure_count': 0, 'derived_review_category_counts': {'runtime_blocked_contract_gap': 7, 'sim_auto_approved': 58, 'source_only_explicit_exclusion': 2, 'source_only_keep_collecting': 217, 'source_quality_blocker': 354, 'tier2_fail_closed_source_only': 61}, 'positive_edge_source_quality_pass_count': 119, 'quiet_gap_codex_directive_count': 0, 'quiet_gap_count': 101, 'quiet_gap_rollup_count': 101, 'retry_queue_count': 0, 'runtime_uptake_rate_pct': 0.0, 'source_dimension_gap_count': 16, 'status': 'pass'}`

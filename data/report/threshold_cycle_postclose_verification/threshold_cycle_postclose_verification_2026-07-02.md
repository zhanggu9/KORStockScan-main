...
- P2 `scalp_entry_adm_unknown_bucket_source_quality_gap` 판정: `source_quality_followup_required`
  - 근거: `{'status': 'warning', 'warnings': ['joined_sample_below_sample_floor', 'unknown_bucket_source_quality_gap', 'ai_numeric_consistency_rows_excluded_from_aggregates'], 'affected_rows': 46, 'affected_rate': 0.1661, 'dimension_counts': {'risk_context_bucket': 46, 'score_bucket': 2, 'price_resolution_bucket': 1}, 'unknown_root_cause_counts': {'risk_context_bucket:post_submit_or_exit_not_required': 45, 'score_bucket:source_score_missing': 2, 'price_resolution_bucket:post_submit_or_exit_not_required': 1, 'risk_context_bucket:source_field_missing': 1}, 'stage_counts': {'scalp_sim_sell_order_assumed_filled': 4, 'order_bundle_submitted': 39, 'blocked_ai_score': 22, 'scalp_sim_buy_order_assumed_filled': 2, 'scalp_sim_pre_submit_liquidity_guard_would_block': 29, 'pre_submit_liquidity_guard_block': 1, 'latency_block': 2, 'scalp_entry_action_decision_snapshot': 7}, 'recommended_route': 'source_quality_workorder', 'not_available_route': 'field_legitimately_unavailable_no_workorder', 'lookup_status_counts': {'new_or_unseen_token_vs_prior_adm': 99, 'matched_prior_bucket': 178}}`
...
- P4 `live_auto_ready_zero_breakdown` 판정: `warning_explained_no_live_auto_ready`
  - 근거: `{'live_auto_apply_ready_count': 0, 'state_counts': {'source_only_keep_collecting': 494, 'lifecycle_flow_sim_probe_candidate': 1, 'sim_auto_approved': 1, 'entry_only_sim_auto_approved': 4}, 'source_bucket_kind_counts': {'taxonomy_provenance_gap': 77, 'source_only_observation': 417, 'lifecycle_flow_sim_probe_policy': 1, 'sim_auto_policy': 1, 'entry_only_sim_policy': 4}, 'runtime_gap_categories': {'code_patch_required': 4, 'runtime_blocked_contract_gap': 30, 'sim_auto_approved': 28, 'source_only_explicit_exclusion': 2, 'source_only_keep_collecting': 150, 'source_quality_blocker': 464, 'tier2_fail_closed_source_only': 20}, 'source_contract_status': 'warning', 'source_contract_change_count': 14, 'ai_two_pass_review_status': 'parsed', 'positive_edge_source_quality_pass_count': 52, 'bridge_blocker_ledger_count': 200, 'runtime_uptake_rate_pct': 0.0, 'handoff_warnings': ['lifecycle_bucket_discovery_source_contract_warning', 'source_contract_drift_warning']}`
...
- summary: `{'actionable_unknown_gap_count': 0, 'ai_review_retry_pending': False, 'ai_review_status': 'parsed', 'bridge_blocker_ledger_count': 200, 'candidate_count': 698, 'codex_directive_count': 0, 'conversion_blocker_rank_count': 200, 'critical_failure_count': 0, 'derived_review_category_counts': {'code_patch_required': 4, 'runtime_blocked_contract_gap': 30, 'sim_auto_approved': 28, 'source_only_explicit_exclusion': 2, 'source_only_keep_collecting': 150, 'source_quality_blocker': 464, 'tier2_fail_closed_source_only': 20}, 'positive_edge_source_quality_pass_count': 52, 'quiet_gap_codex_directive_count': 0, 'quiet_gap_count': 397, 'quiet_gap_rollup_count': 397, 'retry_queue_count': 0, 'runtime_uptake_rate_pct': 0.0, 'source_dimension_gap_count': 76, 'status': 'pass'}`
...
- status: `pass`
- ai_status: `parsed`
- provider_status: `{'provider': 'openai', 'status': 'success', 'new_provider_call': True, 'key_name': 'OPENAI_API_KEY', 'attempt_index': 1, 'model_index': 1, 'configured_key_count': 2, 'attempted_key_count': 1, 'attempted_keys': 1, 'attempted_key_names': ['OPENAI_API_KEY'], 'configured_model_count': 3, 'attempted_model_count': 1, 'attempted_models': ['gpt-5.5'], 'configured_models': ['gpt-5.5', 'gpt-5.4', 'gpt-5.4-mini'], 'model': 'gpt-5.5', 'schema_name': 'threshold_ai_correction_v1', 'reasoning_effort': 'high', 'prompt_chars': 107702, 'input_context_chars': 106382, 'input_context_hash': 'ca8d4a5351af69ed52a39d3e722dc7b7f5bcaa1833aee1bc3b53440b97d05cbc', 'elapsed_ms': 70288, 'output_chars': 13226, 'input_tokens': 31048, 'output_tokens': 5981, 'total_tokens': 37029, 'estimated_cost': None, 'estimated_cost_usd': None, 'cost_estimate_status': 'missing_price_contract'}`
...
- closure_counts: `{'parent_refinement_candidate_created': 2, 'rare_observation_only_budget_capped': 2}`
- missing: `[]`
- warnings: `[]`
- contract_drift: `{'candidate_feature_event_count': 1736, 'recomputable_match_count': 1736, 'recomputable_hypothesis_ids': ['ldm_hypothesis_00d0b765311ad7aa', 'ldm_hypothesis_711caa66c89b3f51', 'ldm_hypothesis_92dfecb5a05caa64', 'ldm_hypothesis_e04e4d815fd8d0f9'], 'runtime_matched_event_count': 1736}`
- diagnosis_missing_warning_input_ids: `[]`
- diagnosis_missing_fail_input_ids: `[]`
- diagnosed_repeated_input_ids: `['ldm_refinement_4bc5b03bd050c12b', 'ldm_refinement_ea1e4590d4c9266b', 'ldm_refinement_a8de4ccbb98364f2', 'ldm_refinement_a5c40bee41c7a6ab']`
- runtime_authority_violation_input_ids: `[]`

## Active Sim Priority Handoff
- status: `warning`
- active_seed_ids: `['active_seed_78255c0d6b91747b', 'active_seed_7cf1c198fc1e5246', 'active_seed_b99a2dea7aac2a83', 'active_seed_f59dd84c7dcc89c1', 'active_seed_f8f167383fabb79f']`
...
- included: `True`
- source_rows: `40`
- selected_candidate_count: `39`
- arm_count: `117`
- persisted_candidate_count: `39`
- persisted_arm_count: `117`
- missing: `[]`
...
## Workorder Snapshot
- generation_id: `2026-07-02-87c29735ec33`
- source_hash: `87c29735ec335bf89a3353c9d01d4b935392b2a678770deeee7dc941b7992621`
- snapshot_status: `source_changed_with_lineage`
- previous_generation_id: `2026-07-02-43c5ceffcb11`
- previous_source_hash: `43c5ceffcb11fb0da2db9490ee663adbe84530108bdec04b26cef50484728ab5`
- new_order_ids: `[]`
- removed_order_ids: `['order_pattern_lab_ai_review_order_pattern_lab_ai_review_lifecycle_bucket_discovery', 'order_pattern_lab_ai_review_order_pattern_lab_ai_review_swing_lifecycle_bucket_discovery']`

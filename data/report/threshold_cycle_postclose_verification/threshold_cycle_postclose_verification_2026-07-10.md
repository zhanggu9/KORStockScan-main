...
- P2 `scalp_entry_adm_unknown_bucket_source_quality_gap` 판정: `source_quality_followup_required`
  - 근거: `{'status': 'warning', 'warnings': ['joined_sample_below_sample_floor', 'unknown_bucket_source_quality_gap'], 'affected_rows': 3, 'affected_rate': 0.0056, 'dimension_counts': {'risk_context_bucket': 2, 'price_resolution_bucket': 1, 'score_bucket': 1}, 'unknown_root_cause_counts': {'risk_context_bucket:post_submit_or_exit_not_required': 1, 'price_resolution_bucket:post_submit_or_exit_not_required': 1, 'score_bucket:source_score_missing': 1, 'risk_context_bucket:source_field_missing': 1}, 'stage_counts': {'scalp_entry_action_decision_snapshot': 174, 'latency_block': 24, 'order_bundle_submitted': 15, 'blocked_ai_score': 16, 'scalp_sim_pre_submit_liquidity_guard_would_block': 11, 'scalp_sim_sell_order_assumed_filled': 1, 'entry_submit_revalidation_block': 1}, 'recommended_route': 'source_quality_workorder', 'not_available_route': 'field_legitimately_unavailable_no_workorder', 'lookup_status_counts': {'matched_prior_bucket': 284, 'new_or_unseen_token_vs_prior_adm': 255}}`
...
- P4 `live_auto_ready_zero_breakdown` 판정: `warning_explained_no_live_auto_ready`
  - 근거: `{'live_auto_apply_ready_count': 0, 'state_counts': {'source_only_keep_collecting': 421, 'lifecycle_flow_sim_probe_candidate': 3, 'sim_auto_approved': 1, 'runtime_blocked_contract_gap': 1, 'new_bucket_candidate': 14}, 'source_bucket_kind_counts': {'taxonomy_provenance_gap': 62, 'lifecycle_flow_sim_probe_policy': 3, 'source_only_observation': 373, 'sim_auto_policy': 1, 'source_quality_gap': 1}, 'runtime_gap_categories': {'runtime_blocked_contract_gap': 19, 'sim_auto_approved': 42, 'source_only_explicit_exclusion': 2, 'source_only_keep_collecting': 189, 'source_quality_blocker': 426, 'tier2_fail_closed_source_only': 43}, 'source_contract_status': 'warning', 'source_contract_change_count': 16, 'ai_two_pass_review_status': 'parsed', 'positive_edge_source_quality_pass_count': 84, 'bridge_blocker_ledger_count': 200, 'runtime_uptake_rate_pct': 0.0, 'handoff_warnings': ['lifecycle_bucket_discovery_source_contract_warning', 'source_contract_drift_warning']}`
...
- summary: `{'actionable_unknown_gap_count': 4, 'ai_review_retry_pending': False, 'ai_review_status': 'parsed', 'bridge_blocker_ledger_count': 200, 'candidate_count': 721, 'codex_directive_count': 4, 'conversion_blocker_rank_count': 200, 'critical_failure_count': 0, 'derived_review_category_counts': {'runtime_blocked_contract_gap': 19, 'sim_auto_approved': 42, 'source_only_explicit_exclusion': 2, 'source_only_keep_collecting': 189, 'source_quality_blocker': 426, 'tier2_fail_closed_source_only': 43}, 'positive_edge_source_quality_pass_count': 84, 'quiet_gap_codex_directive_count': 0, 'quiet_gap_count': 339, 'quiet_gap_rollup_count': 339, 'retry_queue_count': 0, 'runtime_uptake_rate_pct': 0.0, 'source_dimension_gap_count': 60, 'status': 'pass'}`
...
- status: `pass`
- ai_status: `parsed`
- provider_status: `{'provider': 'openai', 'status': 'success', 'new_provider_call': True, 'key_name': 'OPENAI_API_KEY', 'attempt_index': 1, 'model_index': 1, 'configured_key_count': 2, 'attempted_key_count': 1, 'attempted_keys': 1, 'attempted_key_names': ['OPENAI_API_KEY'], 'configured_model_count': 3, 'attempted_model_count': 1, 'attempted_models': ['gpt-5.5'], 'configured_models': ['gpt-5.5', 'gpt-5.4', 'gpt-5.4-mini'], 'model': 'gpt-5.5', 'schema_name': 'threshold_ai_correction_v1', 'reasoning_effort': 'high', 'prompt_chars': 112550, 'input_context_chars': 111230, 'input_context_hash': '6b4550d365aaad92c8ca63dc91134839723d4659de23a115c7011ae33f9f12b0', 'elapsed_ms': 80346, 'output_chars': 13292, 'input_tokens': 32267, 'output_tokens': 7516, 'total_tokens': 39783, 'estimated_cost': None, 'estimated_cost_usd': None, 'cost_estimate_status': 'missing_price_contract'}`
...
- missing: `[]`
- warnings: `[]`
- contract_drift: `{'candidate_feature_event_count': 271, 'recomputable_match_count': 271, 'recomputable_hypothesis_ids': ['ldm_hypothesis_00d0b765311ad7aa', 'ldm_hypothesis_711caa66c89b3f51', 'ldm_hypothesis_92dfecb5a05caa64', 'ldm_hypothesis_e04e4d815fd8d0f9'], 'runtime_matched_event_count': 0}`
- diagnosis_missing_warning_input_ids: `[]`
- diagnosis_missing_fail_input_ids: `[]`
- diagnosed_repeated_input_ids: `['ldm_refinement_adb385f2127f33a6', 'ldm_refinement_09ba3a3d67ae620c', 'ldm_refinement_11b1580597a0c949', 'ldm_refinement_bbbd89ea527288ae']`
...
## Workorder Snapshot
- generation_id: `2026-07-10-2636ee189968`
- source_hash: `2636ee189968ac3a8fa754e9544cc18473e4e0d09595aba291ebd7a9f1120cbd`
- snapshot_status: `source_changed_with_lineage`
- previous_generation_id: `2026-07-10-12ccd1c66e57`
- previous_source_hash: `12ccd1c66e57c139f6e29b8b75cf2b58abca08fbeed702882d399a3e8b6a116f`
- new_order_ids: `[]`
- removed_order_ids: `['order_lifecycle_bucket_discovery_source_contract_source_contract_source_added_institutional_flow_context_5ffac855c5_ea33d1b2', 'order_lifecycle_source_dimension_gap_scale_in_peak_profit_band_scale_in_peak_profit_band_peak_unknown_ee5413c5e1_29ba4810', 'order_lifecycle_source_dimension_gap_scale_in_profit_band_scale_in_profit_band_profit_unknown_2fdf227ba6_c3f8e57e', 'order_lifecycle_source_dimension_gap_scale_in_supply_pass_bucket_scale_in_supply_pass_bucket_supply_pass_unknown_24ded756e7_cc4e7aea', 'order_lifecycle_source_dimension_gap_scale_in_time_bucket_scale_in_time_bucket_time_unknown_bcd649d08a_4580cfad', 'order_observation_source_quality_unknown_token_provenance_gap']`

...
- P2 `scalp_entry_adm_unknown_bucket_source_quality_gap` 판정: `pass_no_unknown_bucket_warning`
  - 근거: `{'status': 'warning', 'warnings': ['ai_numeric_consistency_rows_excluded_from_aggregates'], 'affected_rows': 24, 'affected_rate': 0.0429, 'dimension_counts': {'risk_context_bucket': 24, 'price_resolution_bucket': 9}, 'unknown_root_cause_counts': {'risk_context_bucket:post_submit_or_exit_not_required': 24, 'price_resolution_bucket:post_submit_or_exit_not_required': 9}, 'stage_counts': {'scalp_sim_sell_order_assumed_filled': 22, 'blocked_ai_score': 70, 'scalp_sim_pre_submit_liquidity_guard_would_block': 100, 'latency_block': 6, 'scalp_sim_pre_submit_overbought_guard_would_block': 1, 'scalp_sim_pre_submit_liquidity_guard_unknown': 1, 'pre_submit_liquidity_guard_block': 3, 'order_bundle_submitted': 2}, 'recommended_route': 'classified_not_applicable_no_workorder', 'not_available_route': 'field_legitimately_unavailable_no_workorder', 'lookup_status_counts': {'new_or_unseen_token_vs_prior_adm': 115, 'matched_prior_bucket': 445}}`
...
- P4 `live_auto_ready_zero_breakdown` 판정: `warning_explained_no_live_auto_ready`
  - 근거: `{'live_auto_apply_ready_count': 0, 'state_counts': {'source_only_keep_collecting': 484, 'lifecycle_flow_sim_probe_candidate': 6, 'sim_auto_approved': 2, 'entry_only_sim_auto_approved': 7, 'entry_only_source_candidate': 1}, 'source_bucket_kind_counts': {'taxonomy_provenance_gap': 61, 'source_only_observation': 423, 'lifecycle_flow_sim_probe_policy': 6, 'sim_auto_policy': 2, 'entry_only_sim_policy': 7, 'entry_only_source_candidate': 1}, 'runtime_gap_categories': {'code_patch_required': 9, 'runtime_blocked_contract_gap': 28, 'sim_auto_approved': 15, 'source_only_explicit_exclusion': 2, 'source_only_keep_collecting': 102, 'source_quality_blocker': 520, 'tier2_fail_closed_source_only': 34}, 'source_contract_status': 'warning', 'source_contract_change_count': 12, 'ai_two_pass_review_status': 'parsed', 'positive_edge_source_quality_pass_count': 54, 'bridge_blocker_ledger_count': 200, 'runtime_uptake_rate_pct': 0.0, 'handoff_warnings': ['lifecycle_bucket_discovery_source_contract_warning', 'source_contract_drift_warning']}`
...
- summary: `{'actionable_unknown_gap_count': 0, 'ai_review_retry_pending': False, 'ai_review_status': 'parsed', 'bridge_blocker_ledger_count': 200, 'candidate_count': 710, 'codex_directive_count': 0, 'conversion_blocker_rank_count': 200, 'critical_failure_count': 0, 'derived_review_category_counts': {'code_patch_required': 9, 'runtime_blocked_contract_gap': 28, 'sim_auto_approved': 15, 'source_only_explicit_exclusion': 2, 'source_only_keep_collecting': 102, 'source_quality_blocker': 520, 'tier2_fail_closed_source_only': 34}, 'positive_edge_source_quality_pass_count': 54, 'quiet_gap_codex_directive_count': 0, 'quiet_gap_count': 402, 'quiet_gap_rollup_count': 402, 'retry_queue_count': 0, 'runtime_uptake_rate_pct': 0.0, 'source_dimension_gap_count': 60, 'status': 'pass'}`
...
- status: `pass`
- ai_status: `parsed`
- provider_status: `{'provider': 'openai', 'status': 'success', 'new_provider_call': True, 'key_name': 'OPENAI_API_KEY', 'attempt_index': 1, 'model_index': 2, 'configured_key_count': 2, 'attempted_key_count': 3, 'attempted_keys': 3, 'attempted_key_names': ['OPENAI_API_KEY', 'OPENAI_API_KEY_2', 'OPENAI_API_KEY'], 'configured_model_count': 3, 'attempted_model_count': 2, 'attempted_models': ['gpt-5.5', 'gpt-5.4'], 'configured_models': ['gpt-5.5', 'gpt-5.4', 'gpt-5.4-mini'], 'model': 'gpt-5.4', 'schema_name': 'threshold_ai_correction_v1', 'reasoning_effort': 'high', 'prompt_chars': 106258, 'input_context_chars': 104938, 'input_context_hash': '4f046ba8c24cc7ba0b2468769376894e2a66ff50be333038b1fd7f4aacb3f1e5', 'elapsed_ms': 86870, 'output_chars': 7923, 'input_tokens': 30602, 'output_tokens': 9860, 'total_tokens': 40462, 'estimated_cost': None, 'estimated_cost_usd': None, 'cost_estimate_status': 'missing_price_contract'}`
...
- missing: `[]`
- warnings: `[]`
- contract_drift: `{'candidate_feature_event_count': 2992, 'recomputable_match_count': 2992, 'recomputable_hypothesis_ids': ['ldm_hypothesis_00d0b765311ad7aa', 'ldm_hypothesis_711caa66c89b3f51', 'ldm_hypothesis_92dfecb5a05caa64', 'ldm_hypothesis_e04e4d815fd8d0f9'], 'runtime_matched_event_count': 2992}`
- diagnosis_missing_warning_input_ids: `[]`
- diagnosis_missing_fail_input_ids: `[]`
- diagnosed_repeated_input_ids: `['ldm_refinement_276fb64250023ea0', 'ldm_refinement_541ebf133cf9d06d', 'ldm_refinement_fa4ef6017663bfc5', 'ldm_refinement_b5c03de1a9c25095']`
- runtime_authority_violation_input_ids: `[]`

## Active Sim Priority Handoff
- status: `warning`
- active_seed_ids: `['active_seed_03c539e6527cdda2', 'active_seed_136f942c5ddd1131', 'active_seed_29d916f232e7c84e', 'active_seed_62704d5ee63d94c3', 'active_seed_7cf1c198fc1e5246', 'active_seed_b99a2dea7aac2a83']`

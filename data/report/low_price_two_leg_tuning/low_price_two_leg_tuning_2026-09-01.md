# Low-price two-leg tuning — 2026-09-01
...
- Cost model: exact ka10073 only on unique identity match (matched=1, fallback=1); otherwise fixed 0.23%.
...
| kepco_afternoon | 015760 | afternoon | gap | 6 | 5 | 2/2 | 0 | -1.654074 |

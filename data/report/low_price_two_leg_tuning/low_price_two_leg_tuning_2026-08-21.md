# Low-price two-leg tuning — 2026-08-21
...
- Cost model: exact ka10073 only on unique identity match (matched=1, fallback=5); otherwise fixed 0.23%.
- Clean-baseline actual observations: 8/54 trading dates; missing dates are coverage only and are not imputed.
...
| kakao_morning | 035720 | morning | pass | 2 | 4 | 2 | 0.142875 |
...
| samsung_ea_late_morning | 028050 | late_morning | pass | 1 | 2 | 0 | -0.008008 |

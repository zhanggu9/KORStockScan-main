# Key Lineage Ledger - 2026-06-11

## Decision
- source keys: `382`
- runtime observation target date: `2026-06-11`
- runtime policy source date: `2026-06-10`
- postclose candidate source date: `2026-06-11`
- new postclose candidate due state: `not_due_until_next_preopen`
- same-key continuity pass: `8`
- positive EV runtime observed: `6`
- positive EV sample-floor blocked known floor: `33`
...
- active sim policy windows: events=`11731` zero_count=`0` positive_count=`11731` id_without_count=`0` loaded_for_effect=`True` zero_count_effect_excluded=`False`
- active sim taxonomy contracts: pending=`9` counts=`{'canonical': 57, 'new_axis_pending_taxonomy': 9, 'unknown': 19}`
- event IO guard: `{'mode': 'streaming_jsonl', 'untracked_value_limit_per_field': 200000, 'line_bytes_limit': 8000000, 'files_seen': 1, 'lines_read': 179471, 'json_decode_error_count': 0, 'file_read_error_count': 0, 'oversized_line_skipped_count': 0, 'truncated_untracked_value_count': 0, 'truncated_untracked_value_count_by_field': {}, 'truncated_panic_sim_record_id_count': 0, 'truncated_panic_no_match_sim_record_id_count': 0}`
...
- panic scale-in no-match: events=`2045` unique_sim_records=`103` missing_sim_record_id=`0` repeated_followup=`1942` status_counts=`{'no_match': 2045, 'matched': 5747}` source_stage_counts=`{'first_ai_wait': 818, 'blocked_ai_score': 475, 'scale_in': 752}`
- blockers: mismatch=`0`, catalog_missing=`0`, preopen_missing=`57`, not_instrumented=`0`

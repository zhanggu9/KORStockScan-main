# Key Lineage Ledger - 2026-07-24

## Decision
- source keys: `330`
- runtime observation target date: `2026-07-24`
- runtime policy source date: `2026-07-23`
- postclose candidate source date: `2026-07-24`
...
- event IO guard: `{'mode': 'streaming_jsonl', 'untracked_value_limit_per_field': 200000, 'line_bytes_limit': 8000000, 'files_seen': 1, 'lines_read': 60957, 'json_decode_error_count': 0, 'file_read_error_count': 0, 'oversized_line_skipped_count': 0, 'truncated_untracked_value_count': 0, 'truncated_untracked_value_count_by_field': {}, 'truncated_panic_sim_record_id_count': 0, 'truncated_panic_no_match_sim_record_id_count': 0}`
...
- blockers: mismatch=`0`, catalog_missing=`0`, preopen_missing=`226`, not_instrumented=`12`

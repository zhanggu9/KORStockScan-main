# Lifecycle Bucket Discovery - 2026-08-13_mtd
...
- lifecycle_flow_absorbed_children: child=`116` sample=`8260` conflict_parents=`1`
- ldm_refinement_pressure: input=`3` consumed=`3` closures=`{'new_parent_candidate_created': 3}`
- active_sim_priority: eligible=`4` active=`4` source_blocked=`8` parent_count_decoupled=`0`
...
### AI Review Shards
- `live_contract_review` status=`skipped_empty` candidates=`0` omitted=`0` context_chars=`41137`
- `lifecycle_flow_review` status=`parsed` candidates=`1` omitted=`115` context_chars=`47715`
- `sim_policy_review` status=`parsed` candidates=`1` omitted=`10` context_chars=`44638`
- `gap_workorder_review` status=`skipped_empty` candidates=`0` omitted=`0` context_chars=`41113`
- `taxonomy_discovery_review` status=`skipped_empty` candidates=`0` omitted=`0` context_chars=`41109`

### Source Dimension Gap Enrichment
- gap_count: `83` / actionable_unknown_gap_count: `0`

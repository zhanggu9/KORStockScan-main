# Lifecycle Bucket Discovery - 2026-08-11
...
- surfaced_candidate_count: `21`
- canonical/legacy buckets: `103` / `219`
- dual_proposals: deterministic=`228` ai=`1` hybrid_selected=`1`
- absorbed/source_quality_blocker: `136` / `0`
- lifecycle_flow_parent_granularity: `too_broad` level=`L2_default` parents=`12` target=`30-60`
- lifecycle_flow_absorbed_children: child=`21` sample=`146` conflict_parents=`0`
- ldm_refinement_pressure: input=`4` consumed=`4` closures=`{'new_parent_candidate_created': 4}`
- active_sim_priority: eligible=`0` active=`0` source_blocked=`9` parent_count_decoupled=`0`
...
- quiet_gap_count: `189` / sim_live_connected: `0`
...
### AI Review Shards
- `live_contract_review` status=`skipped_empty` candidates=`0` omitted=`0` context_chars=`31969`
- `lifecycle_flow_review` status=`parsed` candidates=`1` omitted=`20` context_chars=`37010`
- `sim_policy_review` status=`skipped_empty` candidates=`0` omitted=`0` context_chars=`31939`
- `gap_workorder_review` status=`skipped_empty` candidates=`0` omitted=`0` context_chars=`31945`
- `taxonomy_discovery_review` status=`skipped_empty` candidates=`0` omitted=`0` context_chars=`31941`

# Lifecycle Bucket Discovery - 2026-08-10_mtd
...
### AI Review Shards
- `live_contract_review` status=`skipped_empty` candidates=`0` omitted=`0` context_chars=`38981`
- `lifecycle_flow_review` status=`parsed` candidates=`1` omitted=`94` context_chars=`45558`
- `sim_policy_review` status=`parsed` candidates=`1` omitted=`7` context_chars=`42481`
- `gap_workorder_review` status=`skipped_empty` candidates=`0` omitted=`0` context_chars=`38957`
- `taxonomy_discovery_review` status=`skipped_empty` candidates=`0` omitted=`0` context_chars=`38953`

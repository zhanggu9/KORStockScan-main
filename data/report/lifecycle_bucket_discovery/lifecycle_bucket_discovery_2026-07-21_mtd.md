# Lifecycle Bucket Discovery - 2026-07-21_mtd
...
- surfaced_candidate_count: `318`
- canonical/legacy buckets: `47` / `500`
- dual_proposals: deterministic=`500` ai=`111` hybrid_selected=`67`
...
- lifecycle_flow_absorbed_children: child=`313` sample=`32577` conflict_parents=`13`
...
- source_dimension_gap_count: `197` / actionable_unknown_gap_count: `0`
- quiet_gap_count: `315` / sim_live_connected: `22`
...
### AI Review Shards
- `live_contract_review` status=`skipped_empty` candidates=`0` omitted=`0` context_chars=`41646`
- `lifecycle_flow_review` status=`parsed` candidates=`1` omitted=`199` context_chars=`48214`
- `sim_policy_review` status=`parsed` candidates=`1` omitted=`18` context_chars=`48198`
- `gap_workorder_review` status=`skipped_empty` candidates=`0` omitted=`0` context_chars=`41622`
- `taxonomy_discovery_review` status=`skipped_empty` candidates=`0` omitted=`0` context_chars=`41618`

### Source Dimension Gap Enrichment
- gap_count: `197` / actionable_unknown_gap_count: `0`

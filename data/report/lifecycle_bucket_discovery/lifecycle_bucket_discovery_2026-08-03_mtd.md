# Lifecycle Bucket Discovery - 2026-08-03_mtd
...
- canonical/legacy buckets: `104` / `321`
- dual_proposals: deterministic=`334` ai=`5` hybrid_selected=`5`
...
- source_dimension_gap_count: `49` / actionable_unknown_gap_count: `0`
...
### AI Review Shards
- `live_contract_review` status=`skipped_empty` candidates=`0` omitted=`0` context_chars=`36436`
- `lifecycle_flow_review` status=`parsed` candidates=`1` omitted=`45` context_chars=`43013`
- `sim_policy_review` status=`parsed` candidates=`1` omitted=`6` context_chars=`39936`
- `gap_workorder_review` status=`skipped_empty` candidates=`0` omitted=`0` context_chars=`36412`
- `taxonomy_discovery_review` status=`skipped_empty` candidates=`0` omitted=`0` context_chars=`36408`

### Source Dimension Gap Enrichment
- gap_count: `49` / actionable_unknown_gap_count: `0`

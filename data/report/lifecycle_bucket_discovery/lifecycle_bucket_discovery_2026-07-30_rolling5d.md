# Lifecycle Bucket Discovery - 2026-07-30_rolling5d
...
- canonical/legacy buckets: `162` / `275`
- dual_proposals: deterministic=`303` ai=`15` hybrid_selected=`15`
- absorbed/source_quality_blocker: `152` / `0`
- lifecycle_flow_parent_granularity: `too_broad` level=`L3_detailed` parents=`20` target=`30-60`
- lifecycle_flow_absorbed_children: child=`41` sample=`329` conflict_parents=`0`
...
- quiet_gap_count: `228` / sim_live_connected: `0`
...
### AI Review Shards
- `live_contract_review` status=`skipped_empty` candidates=`0` omitted=`0` context_chars=`33420`
- `lifecycle_flow_review` status=`parsed` candidates=`1` omitted=`40` context_chars=`39985`
- `sim_policy_review` status=`skipped_empty` candidates=`0` omitted=`0` context_chars=`33390`
- `gap_workorder_review` status=`skipped_empty` candidates=`0` omitted=`0` context_chars=`33396`
- `taxonomy_discovery_review` status=`skipped_empty` candidates=`0` omitted=`0` context_chars=`33392`

### Source Dimension Gap Enrichment
- gap_count: `46` / actionable_unknown_gap_count: `0`

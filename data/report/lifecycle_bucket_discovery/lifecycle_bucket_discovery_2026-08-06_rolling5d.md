# Lifecycle Bucket Discovery - 2026-08-06_rolling5d
...
- absorbed/source_quality_blocker: `369` / `0`
- lifecycle_flow_parent_granularity: `too_broad` level=`L2_default` parents=`29` target=`30-60`
- lifecycle_flow_absorbed_children: child=`78` sample=`3105` conflict_parents=`0`
- ldm_refinement_pressure: input=`4` consumed=`4` closures=`{'new_parent_candidate_created': 4}`
- active_sim_priority: eligible=`3` active=`3` source_blocked=`7` parent_count_decoupled=`3`
...
- quiet_gap_count: `400` / sim_live_connected: `0`
...
### AI Review Shards
- `live_contract_review` status=`skipped_empty` candidates=`0` omitted=`0` context_chars=`37409`
- `lifecycle_flow_review` status=`parsed` candidates=`1` omitted=`77` context_chars=`43986`
- `sim_policy_review` status=`parsed` candidates=`1` omitted=`6` context_chars=`40909`
- `gap_workorder_review` status=`skipped_empty` candidates=`0` omitted=`0` context_chars=`37385`
- `taxonomy_discovery_review` status=`skipped_empty` candidates=`0` omitted=`0` context_chars=`37381`

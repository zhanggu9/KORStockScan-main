# Lifecycle Bucket Discovery - 2026-07-15_mtd
...
- lifecycle_flow_absorbed_children: child=`283` sample=`30794` conflict_parents=`13`
...
- quiet_gap_count: `325` / sim_live_connected: `22`
- live_auto_apply_ready_count: `0`
- human_intervention_required: `False`
- warnings: `['ai_review_evidence_authority_violation:lifecycle_flow:combo_lifecycle_flow:entry_entry_combo_entry_spot_score_score_lt60_source_scalp_entry_action_decision_snapshot_stale_', 'ai_review_selected_evidence_authority_violation:lifecycle_flow:combo_lifecycle_flow:entry_entry_combo_entry_spot_score_score_lt60_source_scalp_entry_action_decision_snapshot_stale_', 'lifecycle_flow_review:ai_review_evidence_authority_violation:lifecycle_flow:combo_lifecycle_flow:entry_entry_combo_entry_spot_score_score_lt60_source_scalp_entry_action_decision_snapshot_stale_', 'lifecycle_flow_review:ai_review_selected_evidence_authority_violation:lifecycle_flow:combo_lifecycle_flow:entry_entry_combo_entry_spot_score_score_lt60_source_scalp_entry_action_decision_snapshot_stale_']`
...
### AI Review Shards
- `live_contract_review` status=`skipped_empty` candidates=`0` omitted=`0` context_chars=`41068`
- `lifecycle_flow_review` status=`parse_rejected` candidates=`1` omitted=`199` context_chars=`47636`
- `sim_policy_review` status=`parsed` candidates=`1` omitted=`17` context_chars=`47620`
- `gap_workorder_review` status=`skipped_empty` candidates=`0` omitted=`0` context_chars=`41044`
- `taxonomy_discovery_review` status=`skipped_empty` candidates=`0` omitted=`0` context_chars=`41040`

### Source Dimension Gap Enrichment
- gap_count: `185` / actionable_unknown_gap_count: `0`

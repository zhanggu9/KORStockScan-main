# Lifecycle Bucket Discovery - 2026-08-18_rolling10d
...
- canonical/legacy buckets: `135` / `489`
- dual_proposals: deterministic=`500` ai=`50` hybrid_selected=`50`
...
- lifecycle_flow_absorbed_children: child=`111` sample=`9618` conflict_parents=`4`
...
- quiet_gap_count: `390` / sim_live_connected: `4`
...
- resolution_states: `{'resolution_blocked_thin_sample': 4}`
...
### AI Review Shards
- `live_contract_review` status=`skipped_empty` candidates=`0` omitted=`0` context_chars=`37202`
- `lifecycle_flow_review` status=`parsed` candidates=`1` omitted=`110` context_chars=`43770`
- `sim_policy_review` status=`parsed` candidates=`1` omitted=`1` context_chars=`43732`
- `gap_workorder_review` status=`skipped_empty` candidates=`0` omitted=`0` context_chars=`37178`
- `taxonomy_discovery_review` status=`skipped_empty` candidates=`0` omitted=`0` context_chars=`37174`

### Source Dimension Gap Enrichment
- gap_count: `70` / actionable_unknown_gap_count: `0`

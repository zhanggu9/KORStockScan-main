# Lifecycle Bucket Discovery - 2026-07-13_rolling10d
...
- surfaced_candidate_count: `197`
- canonical/legacy buckets: `75` / `500`
- dual_proposals: deterministic=`500` ai=`68` hybrid_selected=`68`
- absorbed/source_quality_blocker: `434` / `0`
- lifecycle_flow_parent_granularity: `target_pass` level=`L1_broad` parents=`30` target=`30-60`
- lifecycle_flow_absorbed_children: child=`195` sample=`12339` conflict_parents=`10`
...
- source_dimension_gap_count: `130` / actionable_unknown_gap_count: `0`
- quiet_gap_count: `374` / sim_live_connected: `11`
...
### AI Review Shards
- `live_contract_review` status=`skipped_empty` candidates=`0` omitted=`0` context_chars=`40279`
- `lifecycle_flow_review` status=`parsed` candidates=`1` omitted=`194` context_chars=`46847`
- `sim_policy_review` status=`parsed` candidates=`1` omitted=`10` context_chars=`46831`
- `gap_workorder_review` status=`skipped_empty` candidates=`0` omitted=`0` context_chars=`40255`
- `taxonomy_discovery_review` status=`skipped_empty` candidates=`0` omitted=`0` context_chars=`40251`

### Source Dimension Gap Enrichment
- gap_count: `130` / actionable_unknown_gap_count: `0`

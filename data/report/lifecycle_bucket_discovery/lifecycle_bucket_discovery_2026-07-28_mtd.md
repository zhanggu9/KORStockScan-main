# Lifecycle Bucket Discovery - 2026-07-28_mtd
...
- surfaced_candidate_count: `241`
- canonical/legacy buckets: `46` / `500`
- dual_proposals: deterministic=`500` ai=`93` hybrid_selected=`93`
- absorbed/source_quality_blocker: `463` / `0`
- lifecycle_flow_parent_granularity: `target_pass` level=`L1_broad` parents=`37` target=`30-60`
- lifecycle_flow_absorbed_children: child=`240` sample=`12675` conflict_parents=`8`
- ldm_refinement_pressure: input=`0` consumed=`0` closures=`{}`
- sim_auto_approved_count: `0`
- lifecycle_flow_sim_probe_candidate_count: `12`
- source_dimension_gap_count: `154` / actionable_unknown_gap_count: `0`
- quiet_gap_count: `351` / sim_live_connected: `8`
...
### AI Review Shards
- `live_contract_review` status=`skipped_empty` candidates=`0` omitted=`0` context_chars=`39939`
- `lifecycle_flow_review` status=`parsed` candidates=`1` omitted=`199` context_chars=`46507`
- `sim_policy_review` status=`parsed` candidates=`1` omitted=`7` context_chars=`46490`
- `gap_workorder_review` status=`skipped_empty` candidates=`0` omitted=`0` context_chars=`39915`
- `taxonomy_discovery_review` status=`skipped_empty` candidates=`0` omitted=`0` context_chars=`39911`

### Source Dimension Gap Enrichment
- gap_count: `154` / actionable_unknown_gap_count: `0`

# Lifecycle Bucket Discovery - 2026-07-23_rolling5d
...
- canonical/legacy buckets: `180` / `392`
- dual_proposals: deterministic=`422` ai=`1` hybrid_selected=`1`
- absorbed/source_quality_blocker: `256` / `0`
- lifecycle_flow_parent_granularity: `too_broad` level=`L2_default` parents=`26` target=`30-60`
- lifecycle_flow_absorbed_children: child=`69` sample=`1025` conflict_parents=`0`
...
- quiet_gap_count: `327` / sim_live_connected: `0`
...
### AI Review Shards
- `live_contract_review` status=`skipped_empty` candidates=`0` omitted=`0` context_chars=`32842`
- `lifecycle_flow_review` status=`parsed` candidates=`1` omitted=`68` context_chars=`37910`
- `sim_policy_review` status=`skipped_empty` candidates=`0` omitted=`0` context_chars=`32812`
- `gap_workorder_review` status=`skipped_empty` candidates=`0` omitted=`0` context_chars=`32818`
- `taxonomy_discovery_review` status=`skipped_empty` candidates=`0` omitted=`0` context_chars=`32814`

# Lifecycle Bucket Discovery - 2026-07-23_rolling10d
...
- canonical/legacy buckets: `160` / `479`
- dual_proposals: deterministic=`500` ai=`15` hybrid_selected=`0`
- absorbed/source_quality_blocker: `352` / `0`
- lifecycle_flow_parent_granularity: `target_pass` level=`L2_default` parents=`41` target=`30-60`
- lifecycle_flow_absorbed_children: child=`105` sample=`2901` conflict_parents=`1`
...
- quiet_gap_count: `384` / sim_live_connected: `0`
...
- `lifecycle_flow_review` status=`parsed` candidates=`1` omitted=`104` context_chars=`40787`

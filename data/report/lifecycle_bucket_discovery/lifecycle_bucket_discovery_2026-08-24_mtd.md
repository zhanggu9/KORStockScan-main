# Lifecycle Bucket Discovery - 2026-08-24_mtd
...
- surfaced_candidate_count: `204`
- canonical/legacy buckets: `43` / `500`
- dual_proposals: deterministic=`500` ai=`74` hybrid_selected=`74`
...
- sim_policy_approved_total_count: `18` (direct=`1`, entry_only=`4`, lifecycle_flow=`13`)
- lifecycle_flow_sim_probe_candidate_count: `13`
- source_dimension_gap_count: `106` / actionable_unknown_gap_count: `0`
- quiet_gap_count: `363` / sim_live_connected: `6`
...
### AI Review Shards
- `live_contract_review` status=`skipped_empty` candidates=`0` omitted=`0` context_chars=`40534`
- `lifecycle_flow_review` status=`parsed` candidates=`1` omitted=`186` context_chars=`47102`
- `sim_policy_review` status=`parsed` candidates=`1` omitted=`8` context_chars=`44034`
- `gap_workorder_review` status=`skipped_empty` candidates=`0` omitted=`0` context_chars=`40510`
- `taxonomy_discovery_review` status=`skipped_empty` candidates=`0` omitted=`0` context_chars=`40506`

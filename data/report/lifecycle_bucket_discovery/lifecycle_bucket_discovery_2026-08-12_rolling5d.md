# Lifecycle Bucket Discovery - 2026-08-12_rolling5d
...
- surfaced_candidate_count: `45`
- canonical/legacy buckets: `155` / `475`
- dual_proposals: deterministic=`500` ai=`25` hybrid_selected=`25`
- absorbed/source_quality_blocker: `357` / `0`
- lifecycle_flow_parent_granularity: `too_broad` level=`L3_detailed` parents=`25` target=`30-60`
- lifecycle_flow_absorbed_children: child=`45` sample=`2390` conflict_parents=`0`
...
- source_dimension_gap_count: `34` / actionable_unknown_gap_count: `0`
- quiet_gap_count: `435` / sim_live_connected: `0`
...
### AI Review Shards
- `live_contract_review` status=`skipped_empty` candidates=`0` omitted=`0` context_chars=`33963`
- `lifecycle_flow_review` status=`parsed` candidates=`1` omitted=`44` context_chars=`40530`
- `sim_policy_review` status=`parsed` candidates=`1` omitted=`0` context_chars=`40495`
- `gap_workorder_review` status=`skipped_empty` candidates=`0` omitted=`0` context_chars=`33939`
- `taxonomy_discovery_review` status=`skipped_empty` candidates=`0` omitted=`0` context_chars=`33935`

### Source Dimension Gap Enrichment
- gap_count: `34` / actionable_unknown_gap_count: `0`

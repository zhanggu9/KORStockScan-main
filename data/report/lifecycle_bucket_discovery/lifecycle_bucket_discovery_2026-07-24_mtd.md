# Lifecycle Bucket Discovery - 2026-07-24_mtd
...
- lifecycle_flow_absorbed_children: child=`329` sample=`33333` conflict_parents=`13`
- ldm_refinement_pressure: input=`0` consumed=`0` closures=`{}`
- sim_auto_approved_count: `1`
- lifecycle_flow_sim_probe_candidate_count: `25`
- source_dimension_gap_count: `209` / actionable_unknown_gap_count: `0`
...
- conflict_parent=`lifecycle_flow:combo_lifecycle_flow:entry_score_parent=score_mid_recovery|submit` state=`resolution_complete` tag=`resolution_complete` ev_before=`1.681989` ev_after=`1.681989` children=`22` sq_gap=`0` strategy_reversal=`0` exclude=`0` collecting=`20` positive_thin=`0` sim_eligible=`False` live_blockers=`[]`
...
- gap_count: `209` / actionable_unknown_gap_count: `0`

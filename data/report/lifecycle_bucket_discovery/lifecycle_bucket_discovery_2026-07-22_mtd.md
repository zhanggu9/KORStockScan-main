# Lifecycle Bucket Discovery - 2026-07-22_mtd
...
- surfaced_candidate_count: `325`
- canonical/legacy buckets: `48` / `500`
- dual_proposals: deterministic=`500` ai=`115` hybrid_selected=`115`
...
- lifecycle_flow_absorbed_children: child=`320` sample=`33071` conflict_parents=`13`
...
- source_dimension_gap_count: `201` / actionable_unknown_gap_count: `0`
- quiet_gap_count: `312` / sim_live_connected: `22`
...
- conflict_parent=`lifecycle_flow:combo_lifecycle_flow:entry_score_parent=score_mid_recovery|submit` state=`resolution_complete` tag=`resolution_complete` ev_before=`1.681989` ev_after=`1.681989` children=`21` sq_gap=`0` strategy_reversal=`0` exclude=`0` collecting=`19` positive_thin=`0` sim_eligible=`False` live_blockers=`[]`
...
- gap_count: `201` / actionable_unknown_gap_count: `0`

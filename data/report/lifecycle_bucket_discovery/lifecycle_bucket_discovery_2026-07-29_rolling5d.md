# Lifecycle Bucket Discovery - 2026-07-29_rolling5d
...
- canonical/legacy buckets: `149` / `241`
- dual_proposals: deterministic=`267` ai=`13` hybrid_selected=`13`
- absorbed/source_quality_blocker: `129` / `0`
- lifecycle_flow_parent_granularity: `too_broad` level=`L2_default` parents=`17` target=`30-60`
- lifecycle_flow_absorbed_children: child=`37` sample=`237` conflict_parents=`0`
...
- quiet_gap_count: `198` / sim_live_connected: `0`
...
### AI Review Shards
- `live_contract_review` status=`skipped_empty` candidates=`0` omitted=`0` context_chars=`33314`
- `lifecycle_flow_review` status=`parsed` candidates=`1` omitted=`36` context_chars=`39879`
- `sim_policy_review` status=`skipped_empty` candidates=`0` omitted=`0` context_chars=`33284`
- `gap_workorder_review` status=`skipped_empty` candidates=`0` omitted=`0` context_chars=`33290`
- `taxonomy_discovery_review` status=`skipped_empty` candidates=`0` omitted=`0` context_chars=`33286`

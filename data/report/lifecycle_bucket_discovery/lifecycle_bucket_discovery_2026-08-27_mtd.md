# Lifecycle Bucket Discovery - 2026-08-27_mtd
...
- surfaced_candidate_count: `253`
- canonical/legacy buckets: `45` / `500`
- dual_proposals: deterministic=`500` ai=`120` hybrid_selected=`120`
...
- lifecycle_flow_absorbed_children: child=`236` sample=`25357` conflict_parents=`4`
...
- sim_policy_approved_total_count: `25` (direct=`2`, entry_only=`4`, lifecycle_flow=`20`)
- lifecycle_flow_sim_probe_candidate_count: `20`
- source_dimension_gap_count: `113` / actionable_unknown_gap_count: `0`
- quiet_gap_count: `357` / sim_live_connected: `14`
...
- conflict_parent=`lifecycle_flow:combo_lifecycle_flow:entry_score_parent=score_unobserved|submit_q` state=`resolution_blocked_thin_sample` tag=`sample 부족 keep collecting` ev_before=`-0.253856` ev_after=`-0.253856` children=`8` sq_gap=`0` strategy_reversal=`0` exclude=`0` collecting=`0` positive_thin=`6` sim_eligible=`False` live_blockers=`['parent_ev_not_positive', 'sample_below_live_floor']`
...
- `lifecycle_flow_review` status=`parsed` candidates=`1` omitted=`199` context_chars=`47701`
- `sim_policy_review` status=`parsed` candidates=`1` omitted=`5` context_chars=`47703`
...
- gap_count: `113` / actionable_unknown_gap_count: `0`

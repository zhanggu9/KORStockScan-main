# Lifecycle Bucket Discovery - 2026-07-20_rolling5d
...
- canonical/legacy buckets: `190` / `348`
- dual_proposals: deterministic=`382` ai=`1` hybrid_selected=`1`
- absorbed/source_quality_blocker: `205` / `0`
- lifecycle_flow_parent_granularity: `too_broad` level=`L3_detailed` parents=`26` target=`30-60`
- lifecycle_flow_absorbed_children: child=`47` sample=`873` conflict_parents=`0`
...
### AI Review Shards
- `live_contract_review` status=`skipped_empty` candidates=`0` omitted=`0` context_chars=`32948`
- `lifecycle_flow_review` status=`parsed` candidates=`1` omitted=`46` context_chars=`38020`
- `sim_policy_review` status=`skipped_empty` candidates=`0` omitted=`0` context_chars=`32918`
- `gap_workorder_review` status=`skipped_empty` candidates=`0` omitted=`0` context_chars=`32924`
- `taxonomy_discovery_review` status=`skipped_empty` candidates=`0` omitted=`0` context_chars=`32920`

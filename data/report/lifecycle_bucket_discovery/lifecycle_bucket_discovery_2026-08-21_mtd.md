# Lifecycle Bucket Discovery - 2026-08-21_mtd
...
- surfaced_candidate_count: `194`
- canonical/legacy buckets: `43` / `500`
- dual_proposals: deterministic=`500` ai=`74` hybrid_selected=`1`
...
- lifecycle_flow_absorbed_children: child=`187` sample=`17431` conflict_parents=`4`
- ldm_refinement_pressure: input=`3` consumed=`3` closures=`{'new_parent_candidate_created': 2, 'rare_observation_only_budget_capped': 1}`
- active_sim_priority: eligible=`4` active=`5` source_blocked=`5` parent_count_decoupled=`0`
...
- sim_policy_approved_total_count: `20` (direct=`3`, entry_only=`4`, lifecycle_flow=`13`)
- lifecycle_flow_sim_probe_candidate_count: `13`
- source_dimension_gap_count: `106` / actionable_unknown_gap_count: `0`
- quiet_gap_count: `373` / sim_live_connected: `6`
...
### AI Review Shards
- `live_contract_review` status=`skipped_empty` candidates=`0` omitted=`0` context_chars=`40418`
- `lifecycle_flow_review` status=`parsed` candidates=`1` omitted=`186` context_chars=`46986`
- `sim_policy_review` status=`parsed` candidates=`1` omitted=`10` context_chars=`43919`
- `gap_workorder_review` status=`skipped_empty` candidates=`0` omitted=`0` context_chars=`40394`
- `taxonomy_discovery_review` status=`skipped_empty` candidates=`0` omitted=`0` context_chars=`40390`

### Source Dimension Gap Enrichment
- gap_count: `106` / actionable_unknown_gap_count: `0`

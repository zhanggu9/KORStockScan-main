# Lifecycle Bucket Discovery - 2026-07-27_mtd
...
- surfaced_candidate_count: `335`
- canonical/legacy buckets: `48` / `500`
- dual_proposals: deterministic=`500` ai=`118` hybrid_selected=`118`
...
- lifecycle_flow_absorbed_children: child=`330` sample=`33397` conflict_parents=`13`
- ldm_refinement_pressure: input=`0` consumed=`0` closures=`{}`
- sim_auto_approved_count: `1`
- lifecycle_flow_sim_probe_candidate_count: `25`
- source_dimension_gap_count: `210` / actionable_unknown_gap_count: `0`
- quiet_gap_count: `305` / sim_live_connected: `22`
...
- conflict_parent=`lifecycle_flow:combo_lifecycle_flow:entry_score_parent=score_mid_recovery|submit` state=`resolution_complete` tag=`resolution_complete` ev_before=`1.681989` ev_after=`1.681989` children=`23` sq_gap=`0` strategy_reversal=`0` exclude=`0` collecting=`21` positive_thin=`0` sim_eligible=`False` live_blockers=`[]`
...
### AI Review Shards
- `live_contract_review` status=`skipped_empty` candidates=`0` omitted=`0` context_chars=`41614`
- `lifecycle_flow_review` status=`parsed` candidates=`1` omitted=`199` context_chars=`48182`
- `sim_policy_review` status=`parsed` candidates=`1` omitted=`18` context_chars=`48166`
- `gap_workorder_review` status=`skipped_empty` candidates=`0` omitted=`0` context_chars=`41590`
- `taxonomy_discovery_review` status=`skipped_empty` candidates=`0` omitted=`0` context_chars=`41586`

### Source Dimension Gap Enrichment
- gap_count: `210` / actionable_unknown_gap_count: `0`

# Lifecycle Bucket Discovery - 2026-08-11_rolling10d
...
- canonical/legacy buckets: `91` / `495`
...
- lifecycle_flow_absorbed_children: child=`100` sample=`4907` conflict_parents=`1`
...
- quiet_gap_count: `400` / sim_live_connected: `1`
...
### AI Review Shards
- `live_contract_review` status=`skipped_empty` candidates=`0` omitted=`0` context_chars=`39013`
- `lifecycle_flow_review` status=`parsed` candidates=`1` omitted=`99` context_chars=`45590`
- `sim_policy_review` status=`parsed` candidates=`1` omitted=`7` context_chars=`42513`
- `gap_workorder_review` status=`skipped_empty` candidates=`0` omitted=`0` context_chars=`38989`
- `taxonomy_discovery_review` status=`skipped_empty` candidates=`0` omitted=`0` context_chars=`38985`

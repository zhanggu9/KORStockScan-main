# Lifecycle Bucket Discovery - 2026-07-28_rolling5d
...
- canonical/legacy buckets: `99` / `191`
- dual_proposals: deterministic=`210` ai=`1` hybrid_selected=`1`
- absorbed/source_quality_blocker: `122` / `0`
- lifecycle_flow_parent_granularity: `too_broad` level=`L2_default` parents=`12` target=`30-60`
- lifecycle_flow_absorbed_children: child=`34` sample=`162` conflict_parents=`0`
...
- quiet_gap_count: `157` / sim_live_connected: `0`
...
### AI Review Shards
- `live_contract_review` status=`skipped_empty` candidates=`0` omitted=`0` context_chars=`32102`
- `lifecycle_flow_review` status=`parsed` candidates=`1` omitted=`33` context_chars=`37167`
- `sim_policy_review` status=`skipped_empty` candidates=`0` omitted=`0` context_chars=`32072`
- `gap_workorder_review` status=`skipped_empty` candidates=`0` omitted=`0` context_chars=`32078`
- `taxonomy_discovery_review` status=`skipped_empty` candidates=`0` omitted=`0` context_chars=`32074`

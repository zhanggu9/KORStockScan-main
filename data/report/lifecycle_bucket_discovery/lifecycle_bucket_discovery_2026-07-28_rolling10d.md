# Lifecycle Bucket Discovery - 2026-07-28_rolling10d
...
- surfaced_candidate_count: `84`
- canonical/legacy buckets: `186` / `457`
- dual_proposals: deterministic=`489` ai=`1` hybrid_selected=`1`
- absorbed/source_quality_blocker: `317` / `0`
- lifecycle_flow_parent_granularity: `too_broad` level=`L2_default` parents=`28` target=`30-60`
- lifecycle_flow_absorbed_children: child=`84` sample=`1187` conflict_parents=`0`
- ldm_refinement_pressure: input=`0` consumed=`0` closures=`{}`
- sim_auto_approved_count: `0`
- lifecycle_flow_sim_probe_candidate_count: `0`
- source_dimension_gap_count: `80` / actionable_unknown_gap_count: `0`
- quiet_gap_count: `378` / sim_live_connected: `0`
...
### AI Review Shards
- `live_contract_review` status=`skipped_empty` candidates=`0` omitted=`0` context_chars=`32798`
- `lifecycle_flow_review` status=`parsed` candidates=`1` omitted=`83` context_chars=`37865`
- `sim_policy_review` status=`skipped_empty` candidates=`0` omitted=`0` context_chars=`32768`
- `gap_workorder_review` status=`skipped_empty` candidates=`0` omitted=`0` context_chars=`32774`
- `taxonomy_discovery_review` status=`skipped_empty` candidates=`0` omitted=`0` context_chars=`32770`

### Source Dimension Gap Enrichment
- gap_count: `80` / actionable_unknown_gap_count: `0`

# Lifecycle Bucket Discovery - 2026-08-12_mtd
...
### AI Review Shards
- `live_contract_review` status=`skipped_empty` candidates=`0` omitted=`0` context_chars=`38988`
- `lifecycle_flow_review` status=`parsed` candidates=`1` omitted=`101` context_chars=`45566`
- `sim_policy_review` status=`parsed` candidates=`1` omitted=`7` context_chars=`42488`
- `gap_workorder_review` status=`skipped_empty` candidates=`0` omitted=`0` context_chars=`38964`
- `taxonomy_discovery_review` status=`skipped_empty` candidates=`0` omitted=`0` context_chars=`38960`

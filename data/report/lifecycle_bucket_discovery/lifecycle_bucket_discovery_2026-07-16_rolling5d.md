# Lifecycle Bucket Discovery - 2026-07-16_rolling5d
...
- surfaced_candidate_count: `87`
- canonical/legacy buckets: `156` / `479`
...
- lifecycle_flow_absorbed_children: child=`87` sample=`2299` conflict_parents=`0`
...
- quiet_gap_count: `403` / sim_live_connected: `0`
...
### AI Review Shards
- `live_contract_review` status=`skipped_empty` candidates=`0` omitted=`0` context_chars=`33386`
- `lifecycle_flow_review` status=`parsed` candidates=`1` omitted=`86` context_chars=`39940`
- `sim_policy_review` status=`skipped_empty` candidates=`0` omitted=`0` context_chars=`33356`
- `gap_workorder_review` status=`skipped_empty` candidates=`0` omitted=`0` context_chars=`33362`
- `taxonomy_discovery_review` status=`skipped_empty` candidates=`0` omitted=`0` context_chars=`33358`

# Lifecycle Bucket Discovery - 2026-07-24_rolling5d
...
- surfaced_candidate_count: `75`
- canonical/legacy buckets: `184` / `417`
- dual_proposals: deterministic=`449` ai=`1` hybrid_selected=`1`
- absorbed/source_quality_blocker: `279` / `0`
- lifecycle_flow_parent_granularity: `too_broad` level=`L2_default` parents=`26` target=`30-60`
- lifecycle_flow_absorbed_children: child=`75` sample=`1084` conflict_parents=`0`
...
- quiet_gap_count: `347` / sim_live_connected: `0`
...
### AI Review Shards
- `live_contract_review` status=`skipped_empty` candidates=`0` omitted=`0` context_chars=`32809`
- `lifecycle_flow_review` status=`parsed` candidates=`1` omitted=`74` context_chars=`37878`
- `sim_policy_review` status=`skipped_empty` candidates=`0` omitted=`0` context_chars=`32779`
- `gap_workorder_review` status=`skipped_empty` candidates=`0` omitted=`0` context_chars=`32785`
- `taxonomy_discovery_review` status=`skipped_empty` candidates=`0` omitted=`0` context_chars=`32781`

# Lifecycle Bucket Discovery - 2026-08-07_mtd
...
### AI Review Shards
- `live_contract_review` status=`skipped_empty` candidates=`0` omitted=`0` context_chars=`37397`
- `lifecycle_flow_review` status=`parsed` candidates=`1` omitted=`83` context_chars=`43974`
- `sim_policy_review` status=`parsed` candidates=`1` omitted=`6` context_chars=`40897`
- `gap_workorder_review` status=`skipped_empty` candidates=`0` omitted=`0` context_chars=`37373`
- `taxonomy_discovery_review` status=`skipped_empty` candidates=`0` omitted=`0` context_chars=`37369`

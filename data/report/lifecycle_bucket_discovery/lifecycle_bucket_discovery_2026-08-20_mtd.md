# Lifecycle Bucket Discovery - 2026-08-20_mtd
...
- lifecycle_flow_absorbed_children: child=`172` sample=`15444` conflict_parents=`4`
...
- quiet_gap_count: `379` / sim_live_connected: `5`
...
### AI Review Shards
- `live_contract_review` status=`skipped_empty` candidates=`0` omitted=`0` context_chars=`40375`
- `lifecycle_flow_review` status=`parsed` candidates=`1` omitted=`171` context_chars=`46943`
- `sim_policy_review` status=`parsed` candidates=`1` omitted=`10` context_chars=`43876`
- `gap_workorder_review` status=`skipped_empty` candidates=`0` omitted=`0` context_chars=`40351`
- `taxonomy_discovery_review` status=`skipped_empty` candidates=`0` omitted=`0` context_chars=`40347`

### Source Dimension Gap Enrichment
- gap_count: `102` / actionable_unknown_gap_count: `0`

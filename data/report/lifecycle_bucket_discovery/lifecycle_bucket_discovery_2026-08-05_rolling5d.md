# Lifecycle Bucket Discovery - 2026-08-05_rolling5d
...
### AI Review Shards
- `live_contract_review` status=`skipped_empty` candidates=`0` omitted=`0` context_chars=`36930`
- `lifecycle_flow_review` status=`parsed` candidates=`1` omitted=`69` context_chars=`43507`
- `sim_policy_review` status=`parsed` candidates=`1` omitted=`7` context_chars=`40429`
- `gap_workorder_review` status=`skipped_empty` candidates=`0` omitted=`0` context_chars=`36906`
- `taxonomy_discovery_review` status=`skipped_empty` candidates=`0` omitted=`0` context_chars=`36902`

# Lifecycle Bucket Discovery - 2026-07-21_rolling5d
...
- canonical/legacy buckets: `159` / `245`
- dual_proposals: deterministic=`272` ai=`1` hybrid_selected=`1`
- absorbed/source_quality_blocker: `125` / `0`
- lifecycle_flow_parent_granularity: `too_broad` level=`L2_default` parents=`20` target=`30-60`
- lifecycle_flow_absorbed_children: child=`42` sample=`328` conflict_parents=`0`
- ldm_refinement_pressure: input=`1` consumed=`1` closures=`{'new_parent_candidate_created': 1}`
...
- quiet_gap_count: `203` / sim_live_connected: `0`
...
### AI Review Shards
- `live_contract_review` status=`skipped_empty` candidates=`0` omitted=`0` context_chars=`32837`
- `lifecycle_flow_review` status=`parsed` candidates=`1` omitted=`41` context_chars=`37904`
- `sim_policy_review` status=`skipped_empty` candidates=`0` omitted=`0` context_chars=`32807`
- `gap_workorder_review` status=`skipped_empty` candidates=`0` omitted=`0` context_chars=`32813`
- `taxonomy_discovery_review` status=`skipped_empty` candidates=`0` omitted=`0` context_chars=`32809`

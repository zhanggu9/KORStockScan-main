# Lifecycle Bucket Discovery - 2026-08-12_rolling10d
...
- surfaced_candidate_count: `109`
- canonical/legacy buckets: `77` / `500`
- dual_proposals: deterministic=`500` ai=`18` hybrid_selected=`17`
- absorbed/source_quality_blocker: `432` / `0`
- lifecycle_flow_parent_granularity: `target_pass` level=`L2_default` parents=`37` target=`30-60`
- lifecycle_flow_absorbed_children: child=`102` sample=`5865` conflict_parents=`1`
...
### AI Review Shards
- `live_contract_review` status=`skipped_empty` candidates=`0` omitted=`0` context_chars=`39016`
- `lifecycle_flow_review` status=`parsed` candidates=`1` omitted=`101` context_chars=`45594`
- `sim_policy_review` status=`parsed` candidates=`1` omitted=`7` context_chars=`42516`
- `gap_workorder_review` status=`skipped_empty` candidates=`0` omitted=`0` context_chars=`38992`
- `taxonomy_discovery_review` status=`skipped_empty` candidates=`0` omitted=`0` context_chars=`38988`

# Lifecycle Bucket Discovery - 2026-07-16_rolling10d
...
- surfaced_candidate_count: `209`
- canonical/legacy buckets: `66` / `500`
- dual_proposals: deterministic=`500` ai=`80` hybrid_selected=`80`
- absorbed/source_quality_blocker: `443` / `0`
- lifecycle_flow_parent_granularity: `target_pass` level=`L1_broad` parents=`36` target=`30-60`
- lifecycle_flow_absorbed_children: child=`208` sample=`11488` conflict_parents=`8`
...
- quiet_gap_count: `372` / sim_live_connected: `8`
...
### AI Review Shards
- `live_contract_review` status=`skipped_empty` candidates=`0` omitted=`0` context_chars=`39998`
- `lifecycle_flow_review` status=`parsed` candidates=`1` omitted=`199` context_chars=`46566`
- `sim_policy_review` status=`parsed` candidates=`1` omitted=`7` context_chars=`46549`
- `gap_workorder_review` status=`skipped_empty` candidates=`0` omitted=`0` context_chars=`39974`
- `taxonomy_discovery_review` status=`skipped_empty` candidates=`0` omitted=`0` context_chars=`39970`

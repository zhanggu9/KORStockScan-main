# Lifecycle Bucket Discovery - 2026-07-29_rolling10d
...
- surfaced_candidate_count: `91`
- canonical/legacy buckets: `177` / `480`
- dual_proposals: deterministic=`500` ai=`35` hybrid_selected=`35`
- absorbed/source_quality_blocker: `337` / `0`
- lifecycle_flow_parent_granularity: `target_pass` level=`L2_default` parents=`30` target=`30-60`
- lifecycle_flow_absorbed_children: child=`91` sample=`1321` conflict_parents=`0`
...
- quiet_gap_count: `381` / sim_live_connected: `0`
...
### AI Review Shards
- `live_contract_review` status=`skipped_empty` candidates=`0` omitted=`0` context_chars=`33335`
- `lifecycle_flow_review` status=`parsed` candidates=`1` omitted=`90` context_chars=`39900`
- `sim_policy_review` status=`skipped_empty` candidates=`0` omitted=`0` context_chars=`33305`
- `gap_workorder_review` status=`skipped_empty` candidates=`0` omitted=`0` context_chars=`33311`
- `taxonomy_discovery_review` status=`skipped_empty` candidates=`0` omitted=`0` context_chars=`33307`

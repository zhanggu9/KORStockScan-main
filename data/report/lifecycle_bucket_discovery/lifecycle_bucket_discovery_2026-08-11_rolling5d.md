# Lifecycle Bucket Discovery - 2026-08-11_rolling5d
...
- canonical/legacy buckets: `173` / `475`
- dual_proposals: deterministic=`500` ai=`25` hybrid_selected=`25`
- absorbed/source_quality_blocker: `339` / `0`
- lifecycle_flow_parent_granularity: `too_broad` level=`L3_detailed` parents=`28` target=`30-60`
- lifecycle_flow_absorbed_children: child=`53` sample=`1802` conflict_parents=`0`
...
- source_dimension_gap_count: `41` / actionable_unknown_gap_count: `0`
- quiet_gap_count: `425` / sim_live_connected: `0`
...
### AI Review Shards
- `live_contract_review` status=`skipped_empty` candidates=`0` omitted=`0` context_chars=`33948`
- `lifecycle_flow_review` status=`parsed` candidates=`1` omitted=`52` context_chars=`40515`
- `sim_policy_review` status=`parsed` candidates=`1` omitted=`0` context_chars=`40480`
- `gap_workorder_review` status=`skipped_empty` candidates=`0` omitted=`0` context_chars=`33924`
- `taxonomy_discovery_review` status=`skipped_empty` candidates=`0` omitted=`0` context_chars=`33920`

### Source Dimension Gap Enrichment
- gap_count: `41` / actionable_unknown_gap_count: `0`
...
- `lifecycle_flow:combo_lifecycle_flow:entry_entry_combo_entry_spot_score_score_63_65_source_scalp_sim_entry_ai_price_skip_order_stale_` stage=`lifecycle_flow` state=`source_only_keep_collecting` action=`tighten_or_exclude` relation=`existing_bucket_refinement` canonical=`lifecycle_flow:combo_lifecycle_flow:entry=score_watch_recovery|submit=submit_observed|holding=holding_observed|scale_in=scale_in_observed|exit=exit_observed` joined=`1` ev=`-0.904` ai_final=`-` taxonomy=`absorb_as_dimension`

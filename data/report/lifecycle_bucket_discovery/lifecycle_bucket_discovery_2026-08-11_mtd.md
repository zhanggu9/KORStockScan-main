# Lifecycle Bucket Discovery - 2026-08-11_mtd
...
### AI Review Shards
- `live_contract_review` status=`skipped_empty` candidates=`0` omitted=`0` context_chars=`38985`
- `lifecycle_flow_review` status=`parsed` candidates=`1` omitted=`99` context_chars=`45562`
- `sim_policy_review` status=`parsed` candidates=`1` omitted=`7` context_chars=`42485`
- `gap_workorder_review` status=`skipped_empty` candidates=`0` omitted=`0` context_chars=`38961`
- `taxonomy_discovery_review` status=`skipped_empty` candidates=`0` omitted=`0` context_chars=`38957`

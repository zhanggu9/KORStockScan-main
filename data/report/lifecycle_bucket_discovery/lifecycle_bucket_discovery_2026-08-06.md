# Lifecycle Bucket Discovery - 2026-08-06
...
- canonical/legacy buckets: `153` / `316`
- dual_proposals: deterministic=`338` ai=`1` hybrid_selected=`1`
- absorbed/source_quality_blocker: `198` / `0`
- lifecycle_flow_parent_granularity: `too_broad` level=`L2_default` parents=`14` target=`30-60`
- lifecycle_flow_absorbed_children: child=`33` sample=`589` conflict_parents=`0`
...
- quiet_gap_count: `277` / sim_live_connected: `0`
...
### AI Review Shards
- `live_contract_review` status=`skipped_empty` candidates=`0` omitted=`0` context_chars=`32753`
- `lifecycle_flow_review` status=`parsed` candidates=`1` omitted=`32` context_chars=`37796`
- `sim_policy_review` status=`skipped_empty` candidates=`0` omitted=`0` context_chars=`32723`
- `gap_workorder_review` status=`skipped_empty` candidates=`0` omitted=`0` context_chars=`32729`
- `taxonomy_discovery_review` status=`skipped_empty` candidates=`0` omitted=`0` context_chars=`32725`

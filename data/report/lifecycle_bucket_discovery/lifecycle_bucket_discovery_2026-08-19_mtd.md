# Lifecycle Bucket Discovery - 2026-08-19_mtd
...
- surfaced_candidate_count: `167`
- canonical/legacy buckets: `43` / `500`
- dual_proposals: deterministic=`500` ai=`64` hybrid_selected=`64`
- absorbed/source_quality_blocker: `466` / `0`
- lifecycle_flow_parent_granularity: `target_pass` level=`L2_default` parents=`55` target=`30-60`
- lifecycle_flow_absorbed_children: child=`160` sample=`13450` conflict_parents=`4`
- ldm_refinement_pressure: input=`3` consumed=`3` closures=`{'new_parent_candidate_created': 2, 'rejected_as_fragile': 1}`
- active_sim_priority: eligible=`4` active=`4` source_blocked=`10` parent_count_decoupled=`0`
...
- quiet_gap_count: `385` / sim_live_connected: `4`
...
### AI Review Shards
- `live_contract_review` status=`skipped_empty` candidates=`0` omitted=`0` context_chars=`41152`
- `lifecycle_flow_review` status=`parsed` candidates=`1` omitted=`159` context_chars=`47720`
- `sim_policy_review` status=`parsed` candidates=`1` omitted=`9` context_chars=`44652`
- `gap_workorder_review` status=`skipped_empty` candidates=`0` omitted=`0` context_chars=`41128`
- `taxonomy_discovery_review` status=`skipped_empty` candidates=`0` omitted=`0` context_chars=`41124`

### Source Dimension Gap Enrichment
- gap_count: `99` / actionable_unknown_gap_count: `0`

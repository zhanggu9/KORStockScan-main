# Lifecycle Bucket Discovery - 2026-08-06_rolling10d
...
- surfaced_candidate_count: `105`
- canonical/legacy buckets: `99` / `496`
- dual_proposals: deterministic=`500` ai=`13` hybrid_selected=`13`
- absorbed/source_quality_blocker: `410` / `0`
- lifecycle_flow_parent_granularity: `target_pass` level=`L2_default` parents=`38` target=`30-60`
- lifecycle_flow_absorbed_children: child=`102` sample=`4108` conflict_parents=`1`
...
- quiet_gap_count: `398` / sim_live_connected: `1`
...
### AI Review Shards
- `live_contract_review` status=`skipped_empty` candidates=`0` omitted=`0` context_chars=`36508`
- `lifecycle_flow_review` status=`parsed` candidates=`1` omitted=`101` context_chars=`43086`
- `sim_policy_review` status=`parsed` candidates=`1` omitted=`2` context_chars=`40008`
- `gap_workorder_review` status=`skipped_empty` candidates=`0` omitted=`0` context_chars=`36484`
- `taxonomy_discovery_review` status=`skipped_empty` candidates=`0` omitted=`0` context_chars=`36480`

# Lifecycle Bucket Discovery - 2026-08-04_rolling10d
...
- canonical/legacy buckets: `132` / `490`
...
- lifecycle_flow_absorbed_children: child=`96` sample=`3201` conflict_parents=`1`
...
- quiet_gap_count: `376` / sim_live_connected: `1`
...
### AI Review Shards
- `live_contract_review` status=`skipped_empty` candidates=`0` omitted=`0` context_chars=`36422`
- `lifecycle_flow_review` status=`parsed` candidates=`1` omitted=`95` context_chars=`42999`
- `sim_policy_review` status=`parsed` candidates=`1` omitted=`2` context_chars=`39922`
- `gap_workorder_review` status=`skipped_empty` candidates=`0` omitted=`0` context_chars=`36398`
- `taxonomy_discovery_review` status=`skipped_empty` candidates=`0` omitted=`0` context_chars=`36394`

### Source Dimension Gap Enrichment
- gap_count: `87` / actionable_unknown_gap_count: `0`

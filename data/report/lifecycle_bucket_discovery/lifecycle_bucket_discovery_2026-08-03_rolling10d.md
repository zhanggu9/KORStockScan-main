# Lifecycle Bucket Discovery - 2026-08-03_rolling10d
...
- canonical/legacy buckets: `154` / `484`
...
- lifecycle_flow_absorbed_children: child=`83` sample=`1798` conflict_parents=`1`
...
### AI Review Shards
- `live_contract_review` status=`skipped_empty` candidates=`0` omitted=`0` context_chars=`36809`
- `lifecycle_flow_review` status=`parsed` candidates=`1` omitted=`82` context_chars=`43386`
- `sim_policy_review` status=`parsed` candidates=`1` omitted=`3` context_chars=`40309`
- `gap_workorder_review` status=`skipped_empty` candidates=`0` omitted=`0` context_chars=`36785`
- `taxonomy_discovery_review` status=`skipped_empty` candidates=`0` omitted=`0` context_chars=`36781`

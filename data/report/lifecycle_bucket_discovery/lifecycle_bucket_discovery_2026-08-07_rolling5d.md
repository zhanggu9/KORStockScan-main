# Lifecycle Bucket Discovery - 2026-08-07_rolling5d
...
- canonical/legacy buckets: `132` / `487`
...
- lifecycle_flow_absorbed_children: child=`84` sample=`3475` conflict_parents=`0`
- ldm_refinement_pressure: input=`3` consumed=`3` closures=`{'new_parent_candidate_created': 3}`
- active_sim_priority: eligible=`3` active=`3` source_blocked=`7` parent_count_decoupled=`0`
...
### AI Review Shards
- `live_contract_review` status=`skipped_empty` candidates=`0` omitted=`0` context_chars=`37421`
- `lifecycle_flow_review` status=`parsed` candidates=`1` omitted=`83` context_chars=`43998`
- `sim_policy_review` status=`parsed` candidates=`1` omitted=`6` context_chars=`40921`
- `gap_workorder_review` status=`skipped_empty` candidates=`0` omitted=`0` context_chars=`37397`
- `taxonomy_discovery_review` status=`skipped_empty` candidates=`0` omitted=`0` context_chars=`37393`

# Lifecycle Bucket Discovery - 2026-08-06_mtd
...
### AI Review Shards
- `live_contract_review` status=`skipped_empty` candidates=`0` omitted=`0` context_chars=`37385`
- `lifecycle_flow_review` status=`parsed` candidates=`1` omitted=`77` context_chars=`43962`
- `sim_policy_review` status=`parsed` candidates=`1` omitted=`6` context_chars=`40885`
- `gap_workorder_review` status=`skipped_empty` candidates=`0` omitted=`0` context_chars=`37361`
- `taxonomy_discovery_review` status=`skipped_empty` candidates=`0` omitted=`0` context_chars=`37357`

# Lifecycle Bucket Discovery - 2026-08-20_rolling10d
...
- surfaced_candidate_count: `123`
- canonical/legacy buckets: `121` / `492`
- dual_proposals: deterministic=`500` ai=`63` hybrid_selected=`63`
- absorbed/source_quality_blocker: `388` / `0`
- lifecycle_flow_parent_granularity: `target_pass` level=`L2_default` parents=`50` target=`30-60`
- lifecycle_flow_absorbed_children: child=`123` sample=`10683` conflict_parents=`3`
...
- quiet_gap_count: `388` / sim_live_connected: `3`
...
### AI Review Shards
- `live_contract_review` status=`skipped_empty` candidates=`0` omitted=`0` context_chars=`38362`
- `lifecycle_flow_review` status=`parsed` candidates=`1` omitted=`122` context_chars=`44930`
- `sim_policy_review` status=`parsed` candidates=`1` omitted=`1` context_chars=`44892`
- `gap_workorder_review` status=`skipped_empty` candidates=`0` omitted=`0` context_chars=`38338`
- `taxonomy_discovery_review` status=`skipped_empty` candidates=`0` omitted=`0` context_chars=`38334`

### Source Dimension Gap Enrichment
- gap_count: `76` / actionable_unknown_gap_count: `0`

# Lifecycle Bucket Discovery - 2026-08-10_rolling10d
...
- surfaced_candidate_count: `102`
- canonical/legacy buckets: `109` / `492`
- dual_proposals: deterministic=`500` ai=`16` hybrid_selected=`16`
- absorbed/source_quality_blocker: `400` / `0`
- lifecycle_flow_parent_granularity: `target_pass` level=`L2_default` parents=`36` target=`30-60`
- lifecycle_flow_absorbed_children: child=`95` sample=`4761` conflict_parents=`1`
...
- quiet_gap_count: `393` / sim_live_connected: `1`
...
### AI Review Shards
- `live_contract_review` status=`skipped_empty` candidates=`0` omitted=`0` context_chars=`39009`
- `lifecycle_flow_review` status=`parsed` candidates=`1` omitted=`94` context_chars=`45586`
- `sim_policy_review` status=`parsed` candidates=`1` omitted=`7` context_chars=`42509`
- `gap_workorder_review` status=`skipped_empty` candidates=`0` omitted=`0` context_chars=`38985`
- `taxonomy_discovery_review` status=`skipped_empty` candidates=`0` omitted=`0` context_chars=`38981`

### Source Dimension Gap Enrichment
- gap_count: `74` / actionable_unknown_gap_count: `0`

# Swing Runtime Approval - 2026-06-12
...
| --- | --- | --- | ---: | ---: | --- |
| `swing_runtime_approval:2026-06-12:swing_gatekeeper_reject_cooldown` | `swing_gatekeeper_reject_cooldown` | `entry` | 0.955 | 24/5 | `ML_GATEKEEPER_REJECT_COOLDOWN` |
...
| --- | --- | --- | ---: |
| `swing_entry_ofi_qi_execution_quality` | `entry` | `entry_ofi_qi_invalid_micro_context` | 9100/23 |
| `swing_scale_in_ofi_qi_confirmation` | `scale_in` | `scale_in_ofi_qi_invalid_micro_context` | 200/2 |

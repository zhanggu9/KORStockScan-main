# Swing Runtime Approval - 2026-06-11
...
| --- | --- | ---: | --- |
| `swing_model_floor` | `hold_sample` | 0.3033 | `family_sample_floor_not_met, severe_downside_guard` |
| `swing_selection_top_k` | `hold_sample` | 0.3033 | `family_sample_floor_not_met, severe_downside_guard` |
...
| --- | --- | --- | ---: |
| `swing_entry_ofi_qi_execution_quality` | `entry` | `entry_ofi_qi_invalid_micro_context` | 16862/14 |
| `swing_scale_in_ofi_qi_confirmation` | `scale_in` | `scale_in_ofi_qi_invalid_micro_context` | 67/1 |

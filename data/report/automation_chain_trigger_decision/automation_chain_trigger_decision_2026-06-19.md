# Automation Chain Trigger Decision 2026-06-19
...
| `pattern_lab_ai_review` | `run` | upstream_artifact_newer, upstream_drift_signal |
...
| `ai_watching_score_smoothing_diagnostic` | `run` | upstream_artifact_newer, upstream_drift_signal |
| `codebase_performance_workorder` | `run` | upstream_artifact_newer |
| `producer_gap_discovery` | `run` | upstream_artifact_newer, upstream_drift_signal |
...
| `workorder_branch` | `run` | upstream_drift_signal |

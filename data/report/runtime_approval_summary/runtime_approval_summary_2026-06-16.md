# Runtime Approval Summary - 2026-06-16
...
- lifecycle_ai_context prompt/applied: `3` / `3183`
- swing_strategy_discovery_labeled/pending: `429` / `3698`
- swing_lifecycle_matrix_auto: `24`
- swing_lifecycle_bucket_auto: `24`
- institutional_flow_available/join_rate: `True` / `100.0`
- microstructure_reaction_available/ok: `True` / `7608`
...
- env_generated_at: `2026-06-16T08:21:15`
- first_bot_start_at: `2026-06-16T07:40:02`
- first_bot_start_after_env_at: `2026-06-16T08:21:39`
- pre_env_boot_gap: `True`

## Microstructure Reaction Context
- available: `True`
- authority: `entry_confidence_modifier_source_only`
- rows ok/missing: `7608` / `5895`
...
- avg_scores ask/hold/bid: `46.13` / `49.987` / `58.418`
...
- total/joined/floor: `22185` / `20266` / `20`
...
- context_artifact: `/home/ubuntu/KORStockScan/data/report/lifecycle_ai_context/lifecycle_ai_context_2026-06-16.json`
- context_version: `lifecycle_ai_context_v1_2026-06-16`
- prompt_stage_count: `3`
- attribution_artifact: `/home/ubuntu/KORStockScan/data/report/lifecycle_ai_context_attribution/lifecycle_ai_context_attribution_2026-06-16.json`
- attribution eligible/applied/skipped: `3183` / `3183` / `0`
...
| `swing_scale_in_ofi_qi_confirmation` | 스윙 추가매수 직전 OFI/QI 확인 신호가 유효한지 보는 축 | 스윙 dry-run/probe 관찰: 실주문 변경 없음 | `freeze` | `source_quality_contract_gap_scale_in_axis` | source-quality blocker close, then scale-in guard contract | 계측/DB/safety 문제로 runtime 변경을 금지한다 | 0.6524 | `-` | runtime guard 없음 |
...
- available: `True`
- candidate/arm/labeled: `768` / `4929` / `429`
...
- artifact: `/home/ubuntu/KORStockScan/data/report/swing_lifecycle_decision_matrix/swing_lifecycle_decision_matrix_2026-06-16.json`
- available: `True`
- total/probe/discovery: `76318` / `70531` / `5787`
...
- artifact: `/home/ubuntu/KORStockScan/data/report/swing_lifecycle_bucket_discovery/swing_lifecycle_bucket_discovery_2026-06-16.json`
- available: `True`
- source_contract_status: `pass`
- surfaced/sim_auto/code_patch: `609` / `24` / `54`
- runtime_effect: `False`
- warnings: `[]`
...
## Pattern Lab Audits
- currentness: status=`pass` fail=`0` artifact=`/home/ubuntu/KORStockScan/data/report/pattern_lab_currentness_audit/pattern_lab_currentness_audit_2026-06-16.json`
- ai_review: status=`pass` artifact=`/home/ubuntu/KORStockScan/data/report/pattern_lab_ai_review/pattern_lab_ai_review_2026-06-16.json`
- producer_gap_discovery: status=`pass` artifact=`/home/ubuntu/KORStockScan/data/report/producer_gap_discovery/producer_gap_discovery_2026-06-16.json`

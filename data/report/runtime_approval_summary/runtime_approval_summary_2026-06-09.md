# Runtime Approval Summary - 2026-06-09

- 목적: 스캘핑 threshold-cycle 판정과 스윙 runtime approval 판정을 한 화면에서 보는 읽기 전용 요약이다.
- runtime_mutation_allowed: `False`
- scalping_items/selected: `21` / `2`
- scalping_legacy_hard_gate_risk_counts: `{'approval_or_contract_required': 2, 'intentional_safety_guard': 4, 'manual_review_required': 2, 'no_unreviewed_hard_gate': 13}`
...
- lifecycle_ai_context prompt/applied: `3` / `3869`
- swing_strategy_discovery_labeled/pending: `187` / `1601`
- swing_lifecycle_matrix_auto: `0`
- swing_lifecycle_bucket_auto: `0`
- institutional_flow_available/join_rate: `True` / `100.0`
- microstructure_reaction_available/ok: `True` / `8587`
...
- env_generated_at: `2026-06-09T13:06:28`
- first_bot_start_at: `2026-06-09T07:40:02`
- first_bot_start_after_env_at: `2026-06-09T13:07:45`
- pre_env_boot_gap: `True`

## Microstructure Reaction Context
- available: `True`
- authority: `entry_confidence_modifier_source_only`
- rows ok/missing: `8587` / `10013`
...
- avg_scores ask/hold/bid: `46.14` / `50.069` / `56.887`
...
| `market_regime_continuous_thresholds` | 설명 미등록 | 관찰/리포트 only: runtime 변경 없음 | `hold_sample` | `not_classified` | manual runtime approval review | 축은 유지/관찰하지만 표본/소스 계약 미충족으로 runtime 변경은 하지 않는다 | 0.4 | `-` | 표본 부족 |
...
- total/joined/floor: `20862` / `19325` / `20`
...
- context_artifact: `/home/ubuntu/KORStockScan/data/report/lifecycle_ai_context/lifecycle_ai_context_2026-06-09.json`
- context_version: `lifecycle_ai_context_v1_2026-06-09`
- prompt_stage_count: `3`
- attribution_artifact: `/home/ubuntu/KORStockScan/data/report/lifecycle_ai_context_attribution/lifecycle_ai_context_attribution_2026-06-09.json`
- attribution eligible/applied/skipped: `3869` / `3869` / `0`
...
| `swing_entry_ofi_qi_execution_quality` | 스윙 진입 시 OFI/QI와 주문품질이 실제 성과에 도움이 되는지 보는 축 | 스윙 dry-run/probe 관찰: 실주문 변경 없음 | `freeze` | `sample_or_contract_gap_entry_quality_axis` | OFI/QI source-quality close, then approval/workorder | 계측/DB/safety 문제로 runtime 변경을 금지한다 | 0.955 | `-` | entry_ofi_qi_invalid_micro_context, runtime guard 없음 |
...
- available: `True`
- candidate/arm/labeled: `298` / `1903` / `187`
...
- artifact: `/home/ubuntu/KORStockScan/data/report/swing_lifecycle_decision_matrix/swing_lifecycle_decision_matrix_2026-06-09.json`
- available: `True`
- total/probe/discovery: `57420` / `55143` / `2277`
...
- artifact: `/home/ubuntu/KORStockScan/data/report/swing_lifecycle_bucket_discovery/swing_lifecycle_bucket_discovery_2026-06-09.json`
- available: `True`
...
## Pattern Lab Audits
- currentness: status=`pass` fail=`0` artifact=`/home/ubuntu/KORStockScan/data/report/pattern_lab_currentness_audit/pattern_lab_currentness_audit_2026-06-09.json`
- ai_review: status=`pass` artifact=`/home/ubuntu/KORStockScan/data/report/pattern_lab_ai_review/pattern_lab_ai_review_2026-06-09.json`
- producer_gap_discovery: status=`pass` artifact=`/home/ubuntu/KORStockScan/data/report/producer_gap_discovery/producer_gap_discovery_2026-06-09.json`

# Swing Daily Simulation - 2026-07-13
...
- source_signal_dates: `['2026-07-13']`
- simulated_count: `2`
- closed_count: `0`
...
- source: `/home/ubuntu/KORStockScan/data/pipeline_events/pipeline_events_2026-07-13.jsonl`
...
| --- | --- | --- | --- | --- | ---: | --- | --- | ---: | --- |
| `006400` | 삼성SDI | `daily_recommendations_v2_csv` | `PENDING_ENTRY` | `WAITING_FOR_NEXT_SESSION_QUOTE` | 0 |  |  |  |  |
| `100840` | SNT에너지 | `daily_recommendations_v2_csv` | `PENDING_ENTRY` | `WAITING_FOR_NEXT_SESSION_QUOTE` | 0 |  |  |  |  |

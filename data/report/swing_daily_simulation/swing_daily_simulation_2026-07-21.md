# Swing Daily Simulation - 2026-07-21
...
- source_signal_dates: `['2026-07-21']`
- simulated_count: `2`
- closed_count: `0`
...
- source: `/home/ubuntu/KORStockScan/data/pipeline_events/pipeline_events_2026-07-21.jsonl`
...
| --- | --- | --- | --- | --- | ---: | --- | --- | ---: | --- |
| `014820` | 동원시스템즈 | `daily_recommendations_v2_csv` | `PENDING_ENTRY` | `WAITING_FOR_NEXT_SESSION_QUOTE` | 0 |  |  |  |  |
| `128940` | 한미약품 | `daily_recommendations_v2_csv` | `PENDING_ENTRY` | `WAITING_FOR_NEXT_SESSION_QUOTE` | 0 |  |  |  |  |

# Swing Daily Simulation - 2026-07-22
...
- source_signal_dates: `['2026-07-22']`
- simulated_count: `2`
- closed_count: `0`
...
- source: `/home/ubuntu/KORStockScan/data/pipeline_events/pipeline_events_2026-07-22.jsonl`
...
| --- | --- | --- | --- | --- | ---: | --- | --- | ---: | --- |
| `229640` | LS에코에너지 | `daily_recommendations_v2_csv` | `PENDING_ENTRY` | `WAITING_FOR_NEXT_SESSION_QUOTE` | 0 |  |  |  |  |
| `365550` | ESR켄달스퀘어리츠 | `daily_recommendations_v2_csv` | `PENDING_ENTRY` | `WAITING_FOR_NEXT_SESSION_QUOTE` | 0 |  |  |  |  |

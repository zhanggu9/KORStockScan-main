# Swing Daily Simulation - 2026-07-24
...
- source_signal_dates: `['2026-07-24']`
- simulated_count: `2`
- closed_count: `0`
...
- source: `/home/ubuntu/KORStockScan/data/pipeline_events/pipeline_events_2026-07-24.jsonl`
...
| --- | --- | --- | --- | --- | ---: | --- | --- | ---: | --- |
| `003720` | 삼영 | `daily_recommendations_v2_csv` | `PENDING_ENTRY` | `WAITING_FOR_NEXT_SESSION_QUOTE` | 0 |  |  |  |  |
| `071050` | 한국금융지주 | `daily_recommendations_v2_csv` | `PENDING_ENTRY` | `WAITING_FOR_NEXT_SESSION_QUOTE` | 0 |  |  |  |  |

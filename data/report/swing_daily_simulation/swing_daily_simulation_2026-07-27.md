# Swing Daily Simulation - 2026-07-27
...
- source_signal_dates: `['2026-07-27']`
- simulated_count: `2`
- closed_count: `0`
...
- source: `/home/ubuntu/KORStockScan/data/pipeline_events/pipeline_events_2026-07-27.jsonl`
...
| --- | --- | --- | --- | --- | ---: | --- | --- | ---: | --- |
| `000500` | 가온전선 | `daily_recommendations_v2_csv` | `PENDING_ENTRY` | `WAITING_FOR_NEXT_SESSION_QUOTE` | 0 |  |  |  |  |
| `008730` | 율촌화학 | `daily_recommendations_v2_csv` | `PENDING_ENTRY` | `WAITING_FOR_NEXT_SESSION_QUOTE` | 0 |  |  |  |  |

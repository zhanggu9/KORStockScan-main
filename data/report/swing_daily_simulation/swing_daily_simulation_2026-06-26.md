# Swing Daily Simulation - 2026-06-26
...
- source_signal_dates: `['2026-06-26']`
- simulated_count: `2`
- closed_count: `0`
...
- source: `/home/ubuntu/KORStockScan/data/pipeline_events/pipeline_events_2026-06-26.jsonl.gz`
...
| --- | --- | --- | --- | --- | ---: | --- | --- | ---: | --- |
| `006340` | 대원전선 | `daily_recommendations_v2_csv` | `PENDING_ENTRY` | `WAITING_FOR_NEXT_SESSION_QUOTE` | 0 |  |  |  |  |
| `027410` | BGF | `daily_recommendations_v2_csv` | `PENDING_ENTRY` | `WAITING_FOR_NEXT_SESSION_QUOTE` | 0 |  |  |  |  |

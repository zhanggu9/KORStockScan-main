...
## Contract
- matrix_version: `lifecycle_decision_matrix_v1_2026-08-28`
...
## Summary
- total_rows: `1610`
- source_rows_total: `1811`
- retained_rows: `1610`
- dropped_rows_by_source: `{'dedupe': 201}`
- joined_rows: `940`
- policy_pass_count: `1`
...
- exit_bucket_count/workorders: `28` / `10`
...
- bucket_directed_sim_probe: `{'observed_row_count': 53, 'matched_row_count': 0, 'background_row_count': 53, 'matched_unique_source_bucket_count': 0, 'match_status_counts': {'no_match': 35, 'not_instrumented': 18}, 'matched_classification_state_counts': {}, 'primary_source': 'matched_bucket_directed_sim_probe_only', 'background_source': 'unmatched_or_policy_missing_sim_observation', 'runtime_effect': False, 'actual_order_submitted': False, 'broker_order_forbidden': True}`
...
| --- | ---: | ---: | ---: | ---: | --- | --- | --- |
| `entry` | 607 | 7 | -0.978 | 0.0081 | `hold_sample` | `WAIT_REQUOTE` | False |
| `submit` | 56 | 9 | -0.9576 | 0.1446 | `hold_sample` | `NO_CHANGE` | False |
| `holding` | 14 | 9 | -1.1447 | 0.5786 | `hold_sample` | `EXIT` | False |
| `scale_in` | 914 | 902 | -0.5957 | 1.0 | `pass` | `NO_CHANGE` | False |
| `exit` | 19 | 13 | -1.0765 | 0.8895 | `hold_sample` | `EXIT` | False |
...
- summary: `{'flow_count': 1055, 'complete_flow_count': 9, 'direct_sim_record_complete_flow_count': 0, 'adm_bridge_complete_flow_count': 9, 'fallback_complete_flow_count': 0, 'direct_flow_zero_diagnostic': {'direct_flow_zero_reason': 'no_direct_complete_but_adm_bridge_complete', 'direct_flow_zero_closure_status': 'closed_by_adm_bridge_complete', 'direct_flow_zero_followup_required': False, 'direct_sim_record_flow_count': 4, 'direct_sim_record_incomplete_flow_count': 4, 'direct_sim_record_stage_coverage_counts': {}, 'direct_sim_record_incomplete_reason_counts': {'missing_entry': 4, 'missing_submit': 4, 'missing_holding': 4, 'missing_exit': 4, 'sim_record_id_only': 4, 'scale_in_noise_only': 4}, 'runtime_effect': False, 'decision_authority': 'ldm_direct_flow_diagnostic_only'}, 'direct_flow_zero_reason': 'no_direct_complete_but_adm_bridge_complete', 'direct_flow_zero_closure_status': 'closed_by_adm_bridge_complete', 'direct_flow_zero_followup_required': False, 'incomplete_flow_count': 1046, 'fallback_identity_count': 0, 'identity_missing_count': 0, 'identity_present_count': 1610, 'identity_join_rate': 1.0, 'complete_flow_rate': 0.0085, 'complete_flow_conversion_denominator': 15, 'complete_flow_conversion_rate': 0.6, 'active_priority_incomplete_seed_count': 126, 'scale_in_followup_event_count': 914, 'scale_in_unique_flow_count': 699, 'scale_in_noise_flow_count': 914, 'denominator_exclusion_counts': {'scale_in_noise_flow_excluded': 914, 'active_priority_incomplete_seed_excluded': 126}, 'conversion_blocker_reason_counts': {'missing_entry': 6, 'missing_submit': 6, 'missing_holding': 6, 'candidate_id_only': 6, 'postclose_exit_without_entry': 6}, 'observation_seed_reason_counts': {'missing_submit': 997, 'missing_holding': 1038, 'missing_exit': 1040, 'missing_entry': 914, 'sim_record_id_only': 4, 'scale_in_noise_only': 914, 'candidate_id_only': 911}, 'join_contract_blocked': False, 'bundle_ev_tuning_state': 'ready_for_bundle_ev_tuning', 'top_incomplete_reason': 'missing_holding', 'stage_identity': {'entry': {'source_row_count': 607, 'identity_missing_count': 0, 'identity_quality_counts': {'entry_adm_bridge_key': 606, 'candidate_id': 1}, 'identity_join_rate': 1.0}, 'submit': {'source_row_count': 56, 'identity_missing_count': 0, 'identity_quality_counts': {'entry_adm_bridge_key': 56}, 'identity_join_rate': 1.0}, 'holding': {'source_row_count': 14, 'identity_missing_count': 0, 'identity_quality_counts': {'entry_adm_bridge_key': 14}, 'identity_join_rate': 1.0}, 'scale_in': {'source_row_count': 914, 'identity_missing_count': 0, 'identity_quality_counts': {'exact_sim_record_id': 4, 'candidate_id': 910}, 'identity_join_rate': 1.0}, 'exit': {'source_row_count': 19, 'identity_missing_count': 0, 'identity_quality_counts': {'entry_adm_bridge_key': 13, 'candidate_id': 6}, 'identity_join_rate': 1.0}}, 'required_stage_source_counts': {'entry': 607, 'submit': 56, 'holding': 14, 'exit': 19}, 'incomplete_flow_reason_counts': {'missing_submit': 1003, 'missing_holding': 1044, 'missing_exit': 1040, 'missing_entry': 920, 'sim_record_id_only': 4, 'scale_in_noise_only': 914, 'candidate_id_only': 917, 'postclose_exit_without_entry': 6}, 'bucket_count': 36, 'runtime_candidate_count': 0, 'workorder_count': 20}`
...
| `lifecycle_flow:combo_lifecycle_flow:entry_entry_combo_entry_spot_score_score_lt60_source_sca:0cb91a7ba6` | 1 | 1 | -0.82 | `candidate_tighten_or_exclude` | `pass` |
...
| `lifecycle_flow:combo_lifecycle_flow:entry_entry_combo_entry_spot_score_score_lt60_source_sca:dffbc00c52` | 1 | 1 | -0.7725 | `candidate_tighten_or_exclude` | `pass` |
| `lifecycle_flow:combo_lifecycle_flow:entry_entry_missing_submit_submit_missing_holding_holdin:8cd4f96ab3` | 797 | 785 | -0.7278 | `hold_sample` | `join_contract_blocked` |
| `lifecycle_flow:combo_lifecycle_flow:entry_entry_missing_submit_submit_missing_holding_holdin:7d607fe77a` | 117 | 117 | 0.2906 | `hold_sample` | `join_contract_blocked` |
...
| `lifecycle_flow:combo_lifecycle_flow:entry_entry_combo_entry_spot_score_score_lt60_source_blo:70a865069d` | 10 | 0 | None | `hold_sample` | `join_contract_blocked` |
| `lifecycle_flow:combo_lifecycle_flow:entry_entry_combo_entry_spot_score_score_lt60_source_sca:8b9d889a31` | 1 | 0 | None | `hold_sample` | `join_contract_blocked` |

## Entry Bucket Attribution

- decision_authority: `adm_ldm_entry_bucket_attribution_source_only`
- primary_decision_metric: `source_quality_adjusted_ev_pct`
- summary: `{'entry_rows': 607, 'bucket_count': 150, 'actionable_bucket_count': 0, 'source_quality_blocked_bucket_count': 0, 'runtime_candidate_count': 0, 'workorder_count': 0}`

| bucket_type | bucket_key | sample | joined | ev | avg_profit | win_rate | route |
| --- | --- | ---: | ---: | ---: | ---: | ---: | --- |
| `chosen_action` | `NO_BUY_AI` | 318 | 7 | -0.978 | -0.9443 | 0.2857 | `hold_sample` |
| `chosen_action` | `ALLOW_LEVEL1_RISK_OFF_ENTRY` | 1 | 0 | None | None | None | `hold_sample` |
| `chosen_action` | `BUY_DEFENSIVE` | 52 | 0 | None | None | None | `hold_sample` |
| `chosen_action` | `SKIP_PRE_SUBMIT_SAFETY` | 42 | 0 | None | None | None | `hold_sample` |
| `chosen_action` | `SKIP_SOURCE_QUALITY` | 4 | 0 | None | None | None | `hold_sample` |
| `chosen_action` | `SKIP_STALE` | 4 | 0 | None | None | None | `hold_sample` |
| `chosen_action` | `WAIT_REQUOTE` | 186 | 0 | None | None | None | `hold_sample` |
...
| `combo_entry_spot` | `score=score_70p|source=scalp_entry_action_decision_snapshot|stale=fresh|liquidity=liquidity_high|overbought=overbought_ok|time=time_1200_1400` | 4 | 1 | -4.6413 | 0.06 | 1.0 | `hold_sample` |
| `combo_entry_spot` | `score=score_70p|source=scalp_entry_action_decision_snapshot|stale=fresh|liquidity=liquidity_high|overbought=overbought_ok|time=time_1400_close` | 2 | 1 | -1.0626 | -1.03 | 0.0 | `hold_sample` |
...
| `combo_entry_spot` | `score=score_63_65|source=blocked_ai_score|stale=fresh|liquidity=liquidity_high|overbought=overbought_normal|time=time_1000_1200` | 2 | 0 | None | None | None | `hold_sample` |
...
| `combo_entry_spot` | `score=score_63_65|source=blocked_ai_score|stale=stale_watch|liquidity=liquidity_not_available|overbought=overbought_normal|time=time_1000_1200` | 2 | 0 | None | None | None | `hold_sample` |
| `combo_entry_spot` | `score=score_63_65|source=scalp_sim_entry_ai_price_skip_order|stale=stale_not_available|liquidity=liquidity_not_available|overbought=overbought_not_available|time=time_1000_1200` | 2 | 0 | None | None | None | `hold_sample` |
...
| `combo_entry_spot` | `score=score_63_65|source=scalp_sim_entry_ai_price_skip_order|stale=stale_not_available|liquidity=liquidity_not_available|overbought=overbought_not_available|time=time_1400_close` | 2 | 0 | None | None | None | `hold_sample` |
...
| `combo_submit_quality` | `source=scalp_sim_pre_submit_liquidity_guard_would_block|revalidation=ok_or_unflagged|quote_age=quote_age_10s_plus|liquidity=below_min_liquidity|liquidity_guard=would_block|overbought=overbought_ok|latency=simulated|refresh=sim_submit_path_not_applicable|fill=would_limit_fill_unknown|submitted=false` | 1 | 1 | 0.3532 | `source_quality_workorder` |
| `combo_submit_quality` | `source=scalp_sim_pre_submit_liquidity_guard_would_block|revalidation=ok_or_unflagged|quote_age=quote_age_3_10s|liquidity=below_min_liquidity|liquidity_guard=would_block|overbought=overbought_ok|latency=simulated|refresh=sim_submit_path_not_applicable|fill=would_limit_fill_unknown|submitted=false` | 1 | 1 | -2.1255 | `source_quality_workorder` |
| `latency_reason` | `scalp_live_simulator` | 15 | 9 | -0.9576 | `keep_collecting` |
...
| `latency_state` | `simulated` | 15 | 9 | -0.9576 | `keep_collecting` |
...
| `liquidity_bucket` | `liquidity_ok` | 13 | 7 | -0.978 | `keep_collecting` |
| `liquidity_bucket` | `below_min_liquidity` | 2 | 2 | -0.8862 | `keep_collecting` |
| `liquidity_guard_action` | `liquidity_guard_unknown` | 41 | 0 | None | `source_quality_workorder` |
| `liquidity_guard_action` | `would_pass` | 13 | 7 | -0.978 | `keep_collecting` |
| `liquidity_guard_action` | `would_block` | 2 | 2 | -0.8862 | `keep_collecting` |
| `overbought_bucket` | `overbought_not_available` | 41 | 0 | None | `keep_collecting` |
| `overbought_bucket` | `overbought_ok` | 14 | 9 | -0.9576 | `keep_collecting` |
...
| `overbought_guard_action` | `would_pass` | 15 | 9 | -0.9576 | `keep_collecting` |
...
- summary: `{'holding_rows': 14, 'source_row_count': 14, 'bucket_count': 13, 'joined_sample': 45, 'source_quality_adjusted_ev_pct': -1.1447, 'source_quality_gate': 'pass', 'unknown_reason_counts': {}, 'workorder_count': 5, 'runtime_candidate_count': 0}`

| bucket_type | bucket_key | sample | joined | ev | route |
| --- | --- | ---: | ---: | ---: | --- |
| `combo_holding_flow` | `source=scalp_sim_holding_started|action=WAIT|profit=profit_lt_neg070|held=held_not_applicable_at_start` | 7 | 7 | -1.1555 | `candidate_tighten_or_exclude` |
| `combo_holding_flow` | `source=scalp_sim_holding_started|action=WAIT|profit=profit_neg010_pos080|held=held_not_applicable_at_start` | 2 | 2 | -1.1069 | `hold_sample` |
...
| `held_bucket` | `held_not_applicable_at_start` | 13 | 9 | -1.1447 | `candidate_tighten_or_exclude` |
| `held_bucket` | `held_180_600s` | 1 | 0 | None | `hold_sample` |
| `holding_action` | `WAIT` | 13 | 9 | -1.1447 | `candidate_tighten_or_exclude` |
| `holding_action` | `SELL_TODAY` | 1 | 0 | None | `hold_sample` |
| `holding_source_stage` | `scalp_sim_holding_started` | 13 | 9 | -1.1447 | `candidate_tighten_or_exclude` |
| `holding_source_stage` | `scalp_sim_overnight_decision` | 1 | 0 | None | `hold_sample` |
| `profit_band` | `profit_lt_neg070` | 8 | 7 | -1.1555 | `candidate_tighten_or_exclude` |
| `profit_band` | `profit_neg010_pos080` | 2 | 2 | -1.1069 | `hold_sample` |
...
- primary_decision_metric: `source_quality_adjusted_ev_pct`
- allowed_runtime_apply: `False`
- summary: `{'exit_rows': 19, 'source_row_count': 19, 'bucket_count': 28, 'joined_sample': 65, 'source_quality_adjusted_ev_pct': -1.0765, 'source_quality_gate': 'pass', 'unknown_reason_counts': {}, 'workorder_count': 10, 'runtime_candidate_count': 0}`

| bucket_type | bucket_key | sample | joined | ev | route |
| --- | --- | ---: | ---: | ---: | --- |
| `combo_exit_result` | `source=scalp_sim_partial_sell_order_assumed_filled|rule=scalp_sim_panic_lifecycle_partial_exit|outcome=outcome_not_applicable_partial_exit|profit=profit_lt_neg070` | 3 | 3 | -0.9733 | `candidate_tighten_or_exclude` |
...
| `combo_exit_result` | `source=sim_post_sell_evaluation|rule=scalp_soft_stop_pct|outcome=NEUTRAL|profit=profit_lt_neg070` | 1 | 1 | -2.7606 | `hold_sample` |
| `combo_exit_result` | `source=sim_post_sell_evaluation|rule=scalp_trailing_take_profit|outcome=GOOD_EXIT|profit=profit_neg010_pos080` | 1 | 1 | -2.3901 | `hold_sample` |
| `combo_exit_result` | `source=sim_post_sell_evaluation|rule=scalp_trailing_take_profit|outcome=NEUTRAL|profit=profit_neg010_pos080` | 1 | 1 | 0.1763 | `hold_sample` |
| `combo_exit_result` | `source=scalp_sim_panic_context_warning|rule=scalp_sim_panic_context_warning_not_applicable|outcome=outcome_not_applicable_context_noop|profit=profit_not_applicable_context_noop` | 6 | 0 | None | `hold_sample` |
| `exit_outcome` | `GOOD_EXIT` | 4 | 4 | -1.5395 | `candidate_tighten_or_exclude` |
| `exit_outcome` | `MISSED_UPSIDE` | 3 | 3 | -0.5199 | `candidate_tighten_or_exclude` |
| `exit_outcome` | `outcome_not_applicable_partial_exit` | 3 | 3 | -0.9733 | `candidate_tighten_or_exclude` |
| `exit_outcome` | `NEUTRAL` | 2 | 2 | -1.2922 | `hold_sample` |
| `exit_outcome` | `COMPLETED` | 1 | 1 | -0.7725 | `hold_sample` |
| `exit_outcome` | `outcome_not_applicable_context_noop` | 6 | 0 | None | `hold_sample` |
| `exit_rule` | `scalp_preset_hard_stop_pct` | 5 | 5 | -0.8498 | `candidate_tighten_or_exclude` |
| `exit_rule` | `scalp_sim_panic_lifecycle_partial_exit` | 3 | 3 | -0.9733 | `candidate_tighten_or_exclude` |
| `exit_rule` | `scalp_sim_overnight_sell_today` | 2 | 2 | -0.9255 | `hold_sample` |
| `exit_rule` | `scalp_trailing_take_profit` | 2 | 2 | -1.1069 | `hold_sample` |
| `exit_rule` | `scalp_soft_stop_pct` | 1 | 1 | -2.7606 | `hold_sample` |
| `exit_rule` | `scalp_sim_panic_context_warning_not_applicable` | 6 | 0 | None | `hold_sample` |
| `exit_source_stage` | `sim_post_sell_evaluation` | 9 | 9 | -1.1447 | `candidate_tighten_or_exclude` |
| `exit_source_stage` | `scalp_sim_partial_sell_order_assumed_filled` | 3 | 3 | -0.9733 | `candidate_tighten_or_exclude` |
| `exit_source_stage` | `scalp_sim_overnight_sell_today` | 1 | 1 | -0.7725 | `hold_sample` |
| `exit_source_stage` | `scalp_sim_panic_context_warning` | 6 | 0 | None | `hold_sample` |
| `profit_band` | `profit_lt_neg070` | 11 | 11 | -1.071 | `candidate_tighten_or_exclude` |
| `profit_band` | `profit_neg010_pos080` | 2 | 2 | -1.1069 | `hold_sample` |
| `profit_band` | `profit_not_applicable_context_noop` | 6 | 0 | None | `hold_sample` |
...
- `exit_bucket_source_quality_2`: `combo_exit_result` / `source=sim_post_sell_evaluation|rule=scalp_preset_hard_stop_pct|outcome=MISSED_UPSIDE|profit=profit_lt_neg070` -> `exit_stage_bucket_needs_source_quality_or_lifecycle_flow_confirmation`
...
- `exit_bucket_source_quality_6`: `exit_rule` / `scalp_preset_hard_stop_pct` -> `exit_stage_bucket_needs_source_quality_or_lifecycle_flow_confirmation`
- `exit_bucket_source_quality_7`: `exit_rule` / `scalp_sim_panic_lifecycle_partial_exit` -> `exit_stage_bucket_needs_source_quality_or_lifecycle_flow_confirmation`
...
- summary: `{'scale_in_rows': 914, 'bucket_count': 140, 'edge_bucket_count': 0, 'actionable_bucket_count': 0, 'runtime_authority_blocked_count': 0, 'runtime_candidate_count': 0, 'workorder_count': 0, 'arm_counts': {'PYRAMID': 117, 'AVG_DOWN': 797}}`

| bucket_type | bucket_key | sample | joined | ev | avg_profit | win_rate | route |
| --- | --- | ---: | ---: | ---: | ---: | ---: | --- |
| `ai_score_band` | `score_lt60` | 901 | 901 | None | -0.6553 | 0.1287 | `hold_sample` |
| `ai_score_band` | `score_unknown` | 13 | 1 | None | None | None | `hold_sample` |
| `ai_score_source` | `neutral_unusable` | 545 | 545 | None | -0.5555 | 0.1633 | `hold_sample` |
| `ai_score_source` | `live` | 219 | 219 | None | -0.6571 | 0.1187 | `hold_sample` |
| `ai_score_source` | `not_evaluated_no_ai_score_source` | 73 | 73 | None | -0.7911 | 0.0 | `hold_sample` |
| `ai_score_source` | `holding_ai_not_called` | 49 | 49 | None | -1.2604 | 0.0204 | `hold_sample` |
| `ai_score_source` | `prior_valid` | 12 | 12 | None | -1.79 | 0.0 | `hold_sample` |
| `ai_score_source` | `score_field_backfilled` | 3 | 3 | None | -0.92 | 0.0 | `hold_sample` |
| `ai_score_source` | `sim_scale_in_source_not_scored` | 1 | 1 | None | None | None | `hold_sample` |
| `ai_score_source` | `stage_rule_backfilled` | 12 | 0 | None | None | None | `hold_sample` |
| `arm` | `AVG_DOWN` | 797 | 785 | None | -0.7921 | 0.0 | `hold_sample` |
| `arm` | `PYRAMID` | 117 | 117 | None | 0.2709 | 1.0 | `hold_sample` |
| `blocker_namespace` | `AVG_DOWN` | 793 | 781 | None | -0.7799 | 0.0 | `hold_sample` |
| `blocker_namespace` | `PYRAMID` | 117 | 117 | None | 0.2709 | 1.0 | `hold_sample` |
| `blocker_namespace` | `AVG_DOWN_ONLY` | 4 | 4 | None | -3.17 | 0.0 | `hold_sample` |
| `blocker_reason` | `profit_not_enough` | 111 | 111 | None | 0.2805 | 1.0 | `hold_sample` |
| `blocker_reason` | `pnl_out_of_range(-0.16)` | 71 | 71 | None | -0.16 | 0.0 | `hold_sample` |
| `blocker_reason` | `pnl_out_of_range(-0.23)` | 54 | 54 | None | -0.23 | 0.0 | `hold_sample` |
| `blocker_reason` | `pnl_out_of_range(-0.36)` | 40 | 40 | None | -0.36 | 0.0 | `hold_sample` |
| `blocker_reason` | `pnl_out_of_range(-0.10)` | 38 | 38 | None | -0.1 | 0.0 | `hold_sample` |
...
| `confidence_band` | `confidence_070p` | 2 | 1 | -0.7725 | -1.03 | 0.0 | `hold_sample` |
| `held_bucket` | `held_180_600s` | 2 | 1 | -0.7725 | -1.03 | 0.0 | `hold_sample` |
| `overnight_action` | `SELL_TODAY` | 2 | 1 | -0.7725 | -1.03 | 0.0 | `hold_sample` |
| `overnight_status` | `SELL_TODAY` | 1 | 1 | -0.7725 | -1.03 | 0.0 | `hold_sample` |
| `overnight_status` | `HOLD_OVERNIGHT` | 1 | 0 | None | None | None | `hold_sample` |
| `peak_profit_band` | `peak_lt_zero` | 2 | 1 | -0.7725 | -1.03 | 0.0 | `hold_sample` |
| `price_source` | `holding_price_samples_last` | 2 | 1 | -0.7725 | -1.03 | 0.0 | `hold_sample` |
| `profit_band` | `profit_lt_neg070` | 2 | 1 | -0.7725 | -1.03 | 0.0 | `hold_sample` |
| `source_quality_gate` | `overnight_decision_coverage` | 2 | 1 | -0.7725 | -1.03 | 0.0 | `hold_sample` |
| `source_stage` | `scalp_sim_overnight_sell_today` | 1 | 1 | -0.7725 | -1.03 | 0.0 | `hold_sample` |
| `source_stage` | `scalp_sim_overnight_decision` | 1 | 0 | None | None | None | `hold_sample` |
| `stage` | `exit` | 1 | 1 | -0.7725 | -1.03 | 0.0 | `hold_sample` |

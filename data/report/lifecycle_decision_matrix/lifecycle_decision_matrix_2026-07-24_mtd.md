...
## Contract
- matrix_version: `lifecycle_decision_matrix_v1_2026-07-24_mtd`
...
- lifecycle_flow_bucket_count: `329`
- lifecycle_flow_complete_count: `159`
...
| --- | ---: | ---: | ---: | ---: | --- | --- | --- |
| `entry` | 4139 | 140 | 0.771 | 0.1134 | `pass` | `NO_CHANGE` | False |
| `submit` | 1216 | 183 | -0.5456 | 0.4405 | `pass` | `NO_CHANGE` | False |
| `holding` | 604 | 183 | -1.1354 | 0.6556 | `pass` | `NO_CHANGE` | False |
| `scale_in` | 17165 | 16971 | -0.7309 | 0.9999 | `pass` | `NO_CHANGE` | False |
| `exit` | 14662 | 492 | -0.9792 | 0.2822 | `pass` | `EXIT` | False |
...
- summary: `{'bucket_count': 329, 'complete_flow_count': 159, 'incomplete_flow_count': 33174, 'runtime_candidate_count': 0, 'workorder_count': 0}`

| lifecycle_flow_bucket_id | sample | joined | ev | route | source_quality |
| --- | ---: | ---: | ---: | --- | --- |
| `lifecycle_flow:combo_lifecycle_flow:entry_entry_missing_submit_submit_missing_holding_holdin:8cd4f96ab3` | 14559 | 14400 | -0.9506 | `candidate_tighten_or_exclude` | `hold_sample_or_incomplete_flow` |
| `lifecycle_flow:combo_lifecycle_flow:entry_entry_missing_submit_submit_missing_holding_holdin:7d607fe77a` | 2376 | 2341 | 0.6355 | `candidate_recovery_or_relax` | `hold_sample_or_incomplete_flow` |
...
- primary_decision_metric: `None`
- summary: `{'bucket_count': 397, 'complete_flow_count': 0, 'incomplete_flow_count': 0, 'runtime_candidate_count': 0, 'workorder_count': 0}`

| bucket_type | bucket_key | sample | joined | ev | avg_profit | win_rate | route |
| --- | --- | ---: | ---: | ---: | ---: | ---: | --- |
| `liquidity_bucket` | `liquidity_high` | 1874 | 125 | 0.9744 | 0.8315 | 0.448 | `candidate_recovery_or_relax` |
| `overbought_bucket` | `overbought_normal` | 1795 | 104 | 0.4606 | -0.2678 | 0.4135 | `candidate_recovery_or_relax` |
| `source_stage` | `scalp_entry_action_decision_snapshot` | 2944 | 77 | -0.14 | -1.2991 | 0.4026 | `source_quality_workorder` |
| `chosen_action` | `WAIT_REQUOTE` | 1239 | 70 | 1.6338 | 2.8275 | 0.5857 | `candidate_recovery_or_relax` |
| `exit_rule` | `exit_unknown` | 4062 | 63 | 1.8844 | 3.1182 | 0.5555 | `source_quality_workorder` |
| `stale_bucket` | `fresh_or_unflagged` | 423 | 63 | 1.8844 | 3.1182 | 0.5555 | `candidate_recovery_or_relax` |
| `source_stage` | `wait6579_ev_cohort` | 63 | 63 | 1.8844 | 3.1182 | 0.5555 | `candidate_recovery_or_relax` |
| `chosen_action` | `NO_BUY_AI` | 2257 | 61 | 0.0676 | -1.5085 | 0.3279 | `hold_sample` |
| `score_band` | `score_70p` | 566 | 61 | 0.4727 | 0.6824 | 0.541 | `source_quality_workorder` |
| `time_bucket` | `time_1000_1200` | 1294 | 56 | 0.5148 | 0.482 | 0.4643 | `source_quality_workorder` |
| `strength_bucket` | `weak_strength_momentum` | 1501 | 56 | 0.2007 | -1.2103 | 0.3214 | `hold_sample` |
| `strength_bucket` | `strong_strength_momentum` | 342 | 50 | 2.1633 | 3.5002 | 0.6 | `candidate_recovery_or_relax` |
| `time_bucket` | `time_1200_1400` | 991 | 35 | 1.1243 | 2.245 | 0.5429 | `source_quality_workorder` |
| `stale_bucket` | `stale_high` | 1351 | 34 | -0.1958 | -0.8176 | 0.4412 | `hold_sample` |
| `exit_rule` | `scalp_soft_stop_pct` | 33 | 33 | 0.1957 | -3.6042 | 0.0 | `hold_sample` |
| `score_band` | `score_60_62` | 1036 | 33 | -0.0026 | -1.2879 | 0.3333 | `hold_sample` |
| `time_bucket` | `time_0900_1000` | 702 | 32 | 0.3831 | -1.385 | 0.2812 | `source_quality_workorder` |
| `stale_bucket` | `fresh` | 646 | 31 | 0.1197 | -2.319 | 0.2258 | `hold_sample` |
| `exit_rule` | `scalp_trailing_take_profit` | 31 | 31 | -0.5422 | 1.8265 | 1.0 | `source_quality_workorder` |
| `strength_bucket` | `neutral_strength_momentum` | 1552 | 29 | -0.2589 | -0.4585 | 0.4828 | `hold_sample` |
...
| --- | --- | ---: | ---: | ---: | --- |
| `actual_order_submitted` | `false` | 908 | 183 | -0.5456 | `keep_collecting` |
| `latency_reason` | `scalp_live_simulator` | 574 | 183 | -0.5456 | `keep_collecting` |
| `pre_submit_refresh_age_bucket` | `sim_submit_path_not_applicable` | 574 | 183 | -0.5456 | `keep_collecting` |
| `pre_submit_refresh_applied` | `sim_submit_path_not_applicable` | 574 | 183 | -0.5456 | `keep_collecting` |
| `pre_submit_refresh_attempted` | `sim_submit_path_not_applicable` | 574 | 183 | -0.5456 | `keep_collecting` |
| `pre_submit_refresh_reason` | `sim_submit_path_not_applicable` | 574 | 183 | -0.5456 | `keep_collecting` |
| `pre_submit_refresh_source` | `sim_submit_path_not_applicable` | 574 | 183 | -0.5456 | `keep_collecting` |
| `quote_freshness_resolution_state` | `sim_submit_path_not_applicable` | 574 | 183 | -0.5456 | `keep_collecting` |
| `latency_state` | `simulated` | 574 | 183 | -0.5456 | `keep_collecting` |
| `broker_order_forbidden` | `true` | 908 | 183 | -0.5456 | `keep_collecting` |
| `revalidation_state` | `ok_or_unflagged` | 1165 | 182 | -0.5486 | `keep_collecting` |
| `overbought_guard_action` | `would_pass` | 571 | 180 | -0.4898 | `keep_collecting` |
| `price_below_bid_bucket` | `not_below_bid` | 535 | 167 | -0.6085 | `keep_collecting` |
| `overbought_bucket` | `overbought_ok` | 483 | 137 | -0.5376 | `keep_collecting` |
| `liquidity_bucket` | `liquidity_ok` | 366 | 107 | -0.2215 | `keep_collecting` |
| `liquidity_guard_action` | `would_pass` | 366 | 107 | -0.2215 | `keep_collecting` |
| `price_resolution_bucket` | `price_resolution_unknown` | 361 | 106 | -0.2237 | `source_quality_workorder` |
| `quote_age_bucket` | `quote_age_unknown` | 683 | 106 | -0.2237 | `source_quality_workorder` |
| `submit_source_stage` | `scalp_sim_buy_order_assumed_filled` | 361 | 106 | -0.2237 | `keep_collecting` |
| `price_resolution_bucket` | `defensive_order_price` | 211 | 77 | -0.9886 | `keep_collecting` |
| `would_limit_fill` | `would_limit_fill_unknown` | 213 | 77 | -0.9886 | `source_quality_workorder` |
| `liquidity_bucket` | `below_min_liquidity` | 210 | 76 | -1.0018 | `keep_collecting` |
| `submit_source_stage` | `scalp_sim_pre_submit_liquidity_guard_would_block` | 208 | 76 | -1.0018 | `keep_collecting` |
| `liquidity_guard_action` | `would_block` | 208 | 76 | -1.0018 | `keep_collecting` |
| `would_limit_fill` | `false` | 835 | 54 | -0.1196 | `keep_collecting` |
| `would_limit_fill` | `true` | 168 | 52 | -0.3318 | `keep_collecting` |
| `quote_age_bucket` | `quote_age_3_10s` | 165 | 46 | -1.2485 | `keep_collecting` |
| `overbought_bucket` | `overbought_context_missing` | 89 | 43 | -0.3376 | `keep_collecting` |
| `combo_submit_quality` | `source=scalp_sim_buy_order_assumed_filled|revalidation=ok_or_unflagged|quote_age=quote_age_unknown|liquidity=liquidity_ok|liquidity_guard=would_pass|overbought=overbought_ok|latency=simulated|refresh=sim_submit_path_not_applicable|fill=false|submitted=false` | 172 | 42 | -0.1391 | `source_quality_workorder` |
...
| `combo_submit_quality` | `source=scalp_sim_buy_order_assumed_filled|revalidation=ok_or_unflagged|quote_age=quote_age_unknown|liquidity=liquidity_ok|liquidity_guard=would_pass|overbought=overbought_ok|latency=simulated|refresh=sim_submit_path_not_applicable|fill=true|submitted=false` | 138 | 35 | -0.1416 | `source_quality_workorder` |
| `quote_age_bucket` | `quote_age_10s_plus` | 93 | 25 | -0.6661 | `keep_collecting` |
| `combo_submit_quality` | `source=scalp_sim_pre_submit_liquidity_guard_would_block|revalidation=ok_or_unflagged|quote_age=quote_age_10s_plus|liquidity=below_min_liquidity|liquidity_guard=would_block|overbought=overbought_ok|latency=simulated|refresh=sim_submit_path_not_applicable|fill=would_limit_fill_unknown|submitted=false` | 76 | 19 | -0.6246 | `source_quality_workorder` |
| `combo_submit_quality` | `source=scalp_sim_buy_order_assumed_filled|revalidation=ok_or_unflagged|quote_age=quote_age_unknown|liquidity=liquidity_ok|liquidity_guard=would_pass|overbought=overbought_context_missing|latency=simulated|refresh=sim_submit_path_not_applicable|fill=true|submitted=false` | 30 | 17 | -0.7236 | `source_quality_workorder` |
...
| `quote_age_bucket` | `quote_age_1_3s` | 262 | 6 | -0.3409 | `keep_collecting` |
...
| bucket_type | bucket_key | sample | joined | ev | route |
| --- | --- | ---: | ---: | ---: | --- |
| `held_bucket` | `held_not_applicable_at_start` | 574 | 183 | -1.1354 | `hold_no_edge` |
| `holding_source_stage` | `scalp_sim_holding_started` | 574 | 183 | -1.1354 | `hold_no_edge` |
| `holding_action` | `WAIT` | 542 | 169 | -1.2141 | `hold_no_edge` |
...
| `profit_band` | `profit_neg070_neg010` | 18 | 4 | -0.3537 | `hold_sample` |
...
| `holding_action` | `SELL_TODAY` | 30 | 0 | None | `hold_sample` |
...
| `profit_band` | `profit_not_applicable_at_start` | 391 | 0 | None | `hold_sample` |
| `holding_source_stage` | `scalp_sim_overnight_decision` | 30 | 0 | None | `hold_sample` |
...
| `combo_holding_flow` | `source=scalp_sim_holding_started|action=WAIT|profit=profit_not_applicable_at_start|held=held_not_applicable_at_start` | 373 | 0 | None | `hold_sample` |
...
| bucket_type | bucket_key | sample | joined | ev | route |
| --- | --- | ---: | ---: | ---: | --- |
| `profit_band` | `profit_lt_neg070` | 329 | 329 | -1.4328 | `candidate_tighten_or_exclude` |
| `exit_outcome` | `outcome_not_applicable_partial_exit` | 307 | 307 | -0.9374 | `candidate_tighten_or_exclude` |
| `exit_rule` | `scalp_sim_panic_lifecycle_partial_exit` | 307 | 307 | -0.9374 | `candidate_tighten_or_exclude` |
| `exit_source_stage` | `scalp_sim_partial_sell_order_assumed_filled` | 307 | 307 | -0.9374 | `candidate_tighten_or_exclude` |
| `combo_exit_result` | `source=scalp_sim_partial_sell_order_assumed_filled|rule=scalp_sim_panic_lifecycle_partial_exit|outcome=outcome_not_applicable_partial_exit|profit=profit_lt_neg070` | 220 | 220 | -1.1781 | `candidate_tighten_or_exclude` |
| `exit_source_stage` | `sim_post_sell_evaluation` | 155 | 155 | -1.1755 | `hold_no_edge` |
| `profit_band` | `profit_neg070_neg010` | 90 | 90 | -0.4868 | `candidate_tighten_or_exclude` |
| `combo_exit_result` | `source=scalp_sim_partial_sell_order_assumed_filled|rule=scalp_sim_panic_lifecycle_partial_exit|outcome=outcome_not_applicable_partial_exit|profit=profit_neg070_neg010` | 76 | 76 | -0.5379 | `candidate_tighten_or_exclude` |
...
| `exit_rule` | `scalp_sim_overnight_sell_today` | 30 | 30 | -0.3925 | `candidate_tighten_or_exclude` |
| `exit_source_stage` | `scalp_sim_overnight_sell_today` | 30 | 30 | -0.3925 | `candidate_tighten_or_exclude` |
...
- primary_decision_metric: `stage_ev_composite_pct`
- summary: `{'bucket_count': 488, 'complete_flow_count': 0, 'incomplete_flow_count': 0, 'runtime_candidate_count': 0, 'workorder_count': 0}`

| bucket_type | bucket_key | sample | joined | ev | avg_profit | win_rate | route |
| --- | --- | ---: | ---: | ---: | ---: | ---: | --- |
| `arm` | `AVG_DOWN` | 14775 | 14616 | None | -1.0684 | 0.0 | `hold_sample` |
| `blocker_namespace` | `AVG_DOWN` | 14623 | 14464 | None | -1.0455 | 0.0 | `hold_sample` |
| `ai_score_source` | `score_field_backfilled` | 10463 | 10441 | None | -0.7541 | 0.152 | `hold_sample` |
| `ai_score_band` | `score_lt60` | 7622 | 7604 | None | -0.997 | 0.086 | `hold_sample` |
| `ai_score_source` | `live` | 4176 | 4176 | None | -1.0052 | 0.1142 | `hold_sample` |
| `ai_score_band` | `score_70p` | 3511 | 3510 | None | -0.7638 | 0.1769 | `hold_sample` |
| `price_guard_reason` | `price_guard_none` | 2983 | 2941 | None | -0.8612 | 0.0915 | `hold_sample` |
| `qty_reason` | `qty_none` | 2943 | 2941 | None | -0.8612 | 0.0915 | `hold_sample` |
| `time_bucket` | `time_unknown` | 2985 | 2941 | None | -0.8612 | 0.0915 | `hold_sample` |
| `supply_pass_bucket` | `supply_pass_unknown` | 2965 | 2921 | None | -0.8632 | 0.0922 | `hold_sample` |
...
| `arm` | `PYRAMID` | 2390 | 2355 | None | 0.5956 | 0.9838 | `hold_sample` |
| `blocker_namespace` | `PYRAMID` | 2390 | 2355 | None | 0.5956 | 0.9838 | `hold_sample` |
| `ai_score_source` | `neutral_unusable` | 2215 | 2215 | None | -0.9367 | 0.0926 | `hold_sample` |
...
| `profit_band` | `profit_lt_neg070` | 1675 | 1675 | None | -1.3668 | 0.0 | `hold_sample` |
...
| bucket_type | bucket_key | sample | joined | ev | avg_profit | win_rate | route |
| --- | --- | ---: | ---: | ---: | ---: | ---: | --- |
| `overnight_action` | `SELL_TODAY` | 60 | 30 | -0.3925 | -0.5233 | 0.1667 | `hold_sample` |
| `overnight_status` | `SELL_TODAY` | 30 | 30 | -0.3925 | -0.5233 | 0.1667 | `hold_sample` |
| `stage` | `exit` | 30 | 30 | -0.3925 | -0.5233 | 0.1667 | `hold_sample` |
| `source_quality_gate` | `overnight_decision_coverage` | 60 | 30 | -0.3925 | -0.5233 | 0.1667 | `hold_sample` |
| `source_stage` | `scalp_sim_overnight_sell_today` | 30 | 30 | -0.3925 | -0.5233 | 0.1667 | `hold_sample` |
| `confidence_band` | `confidence_070p` | 58 | 29 | -0.3665 | -0.4886 | 0.1724 | `hold_sample` |
| `peak_profit_band` | `peak_lt_zero` | 50 | 25 | -0.5511 | -0.7348 | 0.0 | `hold_sample` |
| `price_source` | `holding_price_samples_last` | 40 | 20 | -0.5025 | -0.67 | 0.25 | `hold_sample` |
| `held_bucket` | `held_600_1800s_plus` | 32 | 16 | -0.2363 | -0.315 | 0.3125 | `hold_sample` |
...
| `price_source` | `buy_price_fallback` | 20 | 10 | -0.1725 | -0.23 | 0.0 | `hold_sample` |
...
| `held_bucket` | `held_180_600s` | 6 | 3 | -0.3775 | -0.5033 | 0.0 | `hold_sample` |

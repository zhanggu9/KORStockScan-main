...
## Contract
- matrix_version: `lifecycle_decision_matrix_v1_2026-07-27_mtd`
...
- lifecycle_flow_bucket_count: `330`
...
| --- | ---: | ---: | ---: | ---: | --- | --- | --- |
| `entry` | 4286 | 140 | 0.771 | 0.1134 | `pass` | `NO_CHANGE` | False |
| `submit` | 1233 | 183 | -0.5456 | 0.4405 | `pass` | `NO_CHANGE` | False |
| `holding` | 605 | 183 | -1.1354 | 0.6556 | `pass` | `NO_CHANGE` | False |
| `scale_in` | 17167 | 16973 | -0.7309 | 0.9998 | `pass` | `NO_CHANGE` | False |
| `exit` | 14663 | 493 | -0.9776 | 0.2818 | `pass` | `EXIT` | False |
...
- summary: `{'bucket_count': 330, 'complete_flow_count': 159, 'incomplete_flow_count': 33238, 'runtime_candidate_count': 0, 'workorder_count': 0}`

| lifecycle_flow_bucket_id | sample | joined | ev | route | source_quality |
| --- | ---: | ---: | ---: | --- | --- |
| `lifecycle_flow:combo_lifecycle_flow:entry_entry_missing_submit_submit_missing_holding_holdin:8cd4f96ab3` | 14560 | 14401 | -0.9507 | `candidate_tighten_or_exclude` | `hold_sample_or_incomplete_flow` |
| `lifecycle_flow:combo_lifecycle_flow:entry_entry_missing_submit_submit_missing_holding_holdin:7d607fe77a` | 2377 | 2342 | 0.6352 | `candidate_recovery_or_relax` | `hold_sample_or_incomplete_flow` |
...
- primary_decision_metric: `None`
- summary: `{'bucket_count': 408, 'complete_flow_count': 0, 'incomplete_flow_count': 0, 'runtime_candidate_count': 0, 'workorder_count': 0}`

| bucket_type | bucket_key | sample | joined | ev | avg_profit | win_rate | route |
| --- | --- | ---: | ---: | ---: | ---: | ---: | --- |
| `liquidity_bucket` | `liquidity_high` | 1941 | 125 | 0.9744 | 0.8315 | 0.448 | `candidate_recovery_or_relax` |
| `overbought_bucket` | `overbought_normal` | 1820 | 104 | 0.4606 | -0.2678 | 0.4135 | `candidate_recovery_or_relax` |
| `source_stage` | `scalp_entry_action_decision_snapshot` | 3059 | 77 | -0.14 | -1.2991 | 0.4026 | `source_quality_workorder` |
| `chosen_action` | `WAIT_REQUOTE` | 1282 | 70 | 1.6338 | 2.8275 | 0.5857 | `candidate_recovery_or_relax` |
| `exit_rule` | `exit_unknown` | 4209 | 63 | 1.8844 | 3.1182 | 0.5555 | `source_quality_workorder` |
...
| `chosen_action` | `NO_BUY_AI` | 2348 | 61 | 0.0676 | -1.5085 | 0.3279 | `hold_sample` |
| `score_band` | `score_70p` | 587 | 61 | 0.4727 | 0.6824 | 0.541 | `source_quality_workorder` |
| `time_bucket` | `time_1000_1200` | 1313 | 56 | 0.5148 | 0.482 | 0.4643 | `source_quality_workorder` |
| `strength_bucket` | `weak_strength_momentum` | 1513 | 56 | 0.2007 | -1.2103 | 0.3214 | `hold_sample` |
| `strength_bucket` | `strong_strength_momentum` | 352 | 50 | 2.1633 | 3.5002 | 0.6 | `candidate_recovery_or_relax` |
| `time_bucket` | `time_1200_1400` | 1010 | 35 | 1.1243 | 2.245 | 0.5429 | `source_quality_workorder` |
| `stale_bucket` | `stale_high` | 1358 | 34 | -0.1958 | -0.8176 | 0.4412 | `hold_sample` |
| `exit_rule` | `scalp_soft_stop_pct` | 33 | 33 | 0.1957 | -3.6042 | 0.0 | `hold_sample` |
| `score_band` | `score_60_62` | 1040 | 33 | -0.0026 | -1.2879 | 0.3333 | `hold_sample` |
| `time_bucket` | `time_0900_1000` | 731 | 32 | 0.3831 | -1.385 | 0.2812 | `source_quality_workorder` |
| `stale_bucket` | `fresh` | 727 | 31 | 0.1197 | -2.319 | 0.2258 | `hold_sample` |
| `exit_rule` | `scalp_trailing_take_profit` | 31 | 31 | -0.5422 | 1.8265 | 1.0 | `source_quality_workorder` |
| `strength_bucket` | `neutral_strength_momentum` | 1658 | 29 | -0.2589 | -0.4585 | 0.4828 | `hold_sample` |
...
| --- | --- | ---: | ---: | ---: | --- |
| `actual_order_submitted` | `false` | 923 | 183 | -0.5456 | `keep_collecting` |
...
| `broker_order_forbidden` | `true` | 923 | 183 | -0.5456 | `keep_collecting` |
| `revalidation_state` | `ok_or_unflagged` | 1182 | 182 | -0.5486 | `keep_collecting` |
...
| `quote_age_bucket` | `quote_age_unknown` | 698 | 106 | -0.2237 | `source_quality_workorder` |
...
| `would_limit_fill` | `false` | 852 | 54 | -0.1196 | `keep_collecting` |
...
| `quote_age_bucket` | `quote_age_1_3s` | 264 | 6 | -0.3409 | `keep_collecting` |
...
| `profit_band` | `profit_neg070_neg010` | 19 | 4 | -0.3537 | `hold_sample` |
...
| `profit_band` | `profit_neg070_neg010` | 91 | 91 | -0.4833 | `candidate_tighten_or_exclude` |
...
| `exit_rule` | `scalp_sim_overnight_sell_today` | 31 | 31 | -0.3854 | `candidate_tighten_or_exclude` |
| `exit_source_stage` | `scalp_sim_overnight_sell_today` | 31 | 31 | -0.3854 | `candidate_tighten_or_exclude` |
...
- primary_decision_metric: `stage_ev_composite_pct`
- summary: `{'bucket_count': 489, 'complete_flow_count': 0, 'incomplete_flow_count': 0, 'runtime_candidate_count': 0, 'workorder_count': 0}`

| bucket_type | bucket_key | sample | joined | ev | avg_profit | win_rate | route |
| --- | --- | ---: | ---: | ---: | ---: | ---: | --- |
| `arm` | `AVG_DOWN` | 14776 | 14617 | None | -1.0686 | 0.0 | `hold_sample` |
| `blocker_namespace` | `AVG_DOWN` | 14624 | 14465 | None | -1.0457 | 0.0 | `hold_sample` |
| `ai_score_source` | `score_field_backfilled` | 10463 | 10441 | None | -0.7541 | 0.152 | `hold_sample` |
| `ai_score_band` | `score_lt60` | 7624 | 7606 | None | -0.9972 | 0.0861 | `hold_sample` |
...
| `price_guard_reason` | `price_guard_none` | 2985 | 2943 | None | -0.8619 | 0.0918 | `hold_sample` |
| `qty_reason` | `qty_none` | 2945 | 2943 | None | -0.8619 | 0.0918 | `hold_sample` |
| `time_bucket` | `time_unknown` | 2987 | 2943 | None | -0.8619 | 0.0918 | `hold_sample` |
| `supply_pass_bucket` | `supply_pass_unknown` | 2967 | 2923 | None | -0.8639 | 0.0924 | `hold_sample` |
...
| `arm` | `PYRAMID` | 2391 | 2356 | None | 0.5954 | 0.9838 | `hold_sample` |
| `blocker_namespace` | `PYRAMID` | 2391 | 2356 | None | 0.5954 | 0.9838 | `hold_sample` |
| `ai_score_source` | `neutral_unusable` | 2217 | 2217 | None | -0.9376 | 0.0929 | `hold_sample` |
| `blocker_reason` | `profit_not_enough` | 1931 | 1931 | None | 0.4313 | 0.9819 | `hold_sample` |
| `ai_score_band` | `score_60_62` | 1769 | 1766 | None | -0.6296 | 0.1967 | `hold_sample` |
| `profit_band` | `profit_lt_neg070` | 1676 | 1676 | None | -1.3682 | 0.0 | `hold_sample` |
...
| bucket_type | bucket_key | sample | joined | ev | avg_profit | win_rate | route |
| --- | --- | ---: | ---: | ---: | ---: | ---: | --- |
| `overnight_action` | `SELL_TODAY` | 62 | 31 | -0.3854 | -0.5139 | 0.1613 | `hold_sample` |
| `overnight_status` | `SELL_TODAY` | 31 | 31 | -0.3854 | -0.5139 | 0.1613 | `hold_sample` |
| `stage` | `exit` | 31 | 31 | -0.3854 | -0.5139 | 0.1613 | `hold_sample` |
| `source_quality_gate` | `overnight_decision_coverage` | 62 | 31 | -0.3854 | -0.5139 | 0.1613 | `hold_sample` |
| `source_stage` | `scalp_sim_overnight_sell_today` | 31 | 31 | -0.3854 | -0.5139 | 0.1613 | `hold_sample` |
| `confidence_band` | `confidence_070p` | 60 | 30 | -0.36 | -0.48 | 0.1667 | `hold_sample` |
| `peak_profit_band` | `peak_lt_zero` | 52 | 26 | -0.5365 | -0.7154 | 0.0 | `hold_sample` |
| `price_source` | `holding_price_samples_last` | 40 | 20 | -0.5025 | -0.67 | 0.25 | `hold_sample` |
| `held_bucket` | `held_600_1800s_plus` | 34 | 17 | -0.2325 | -0.31 | 0.2941 | `hold_sample` |

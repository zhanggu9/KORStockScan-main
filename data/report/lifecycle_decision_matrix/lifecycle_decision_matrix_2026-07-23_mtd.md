...
## Contract
- matrix_version: `lifecycle_decision_matrix_v1_2026-07-23_mtd`
...
- lifecycle_flow_bucket_count: `325`
...
| --- | ---: | ---: | ---: | ---: | --- | --- | --- |
| `entry` | 3980 | 140 | 0.771 | 0.1134 | `pass` | `NO_CHANGE` | False |
| `submit` | 1197 | 183 | -0.5456 | 0.4405 | `pass` | `NO_CHANGE` | False |
| `holding` | 603 | 183 | -1.1354 | 0.6556 | `pass` | `NO_CHANGE` | False |
| `scale_in` | 17162 | 16968 | -0.7308 | 1.0 | `pass` | `NO_CHANGE` | False |
| `exit` | 14661 | 491 | -0.9809 | 0.2826 | `pass` | `EXIT` | False |
...
- summary: `{'bucket_count': 325, 'complete_flow_count': 159, 'incomplete_flow_count': 33115, 'runtime_candidate_count': 0, 'workorder_count': 0}`

| lifecycle_flow_bucket_id | sample | joined | ev | route | source_quality |
| --- | ---: | ---: | ---: | --- | --- |
| `lifecycle_flow:combo_lifecycle_flow:entry_entry_missing_submit_submit_missing_holding_holdin:8cd4f96ab3` | 14556 | 14397 | -0.9505 | `candidate_tighten_or_exclude` | `hold_sample_or_incomplete_flow` |
...
| --- | --- | ---: | ---: | ---: | ---: | ---: | --- |
| `liquidity_bucket` | `liquidity_high` | 1820 | 125 | 0.9744 | 0.8315 | 0.448 | `candidate_recovery_or_relax` |
| `overbought_bucket` | `overbought_normal` | 1746 | 104 | 0.4606 | -0.2678 | 0.4135 | `candidate_recovery_or_relax` |
| `source_stage` | `scalp_entry_action_decision_snapshot` | 2810 | 77 | -0.14 | -1.2991 | 0.4026 | `source_quality_workorder` |
| `chosen_action` | `WAIT_REQUOTE` | 1177 | 70 | 1.6338 | 2.8275 | 0.5857 | `candidate_recovery_or_relax` |
| `exit_rule` | `exit_unknown` | 3903 | 63 | 1.8844 | 3.1182 | 0.5555 | `source_quality_workorder` |
...
| `chosen_action` | `NO_BUY_AI` | 2203 | 61 | 0.0676 | -1.5085 | 0.3279 | `hold_sample` |
| `score_band` | `score_70p` | 520 | 61 | 0.4727 | 0.6824 | 0.541 | `source_quality_workorder` |
| `time_bucket` | `time_1000_1200` | 1276 | 56 | 0.5148 | 0.482 | 0.4643 | `source_quality_workorder` |
| `strength_bucket` | `weak_strength_momentum` | 1486 | 56 | 0.2007 | -1.2103 | 0.3214 | `hold_sample` |
| `strength_bucket` | `strong_strength_momentum` | 336 | 50 | 2.1633 | 3.5002 | 0.6 | `candidate_recovery_or_relax` |
| `time_bucket` | `time_1200_1400` | 969 | 35 | 1.1243 | 2.245 | 0.5429 | `source_quality_workorder` |
| `stale_bucket` | `stale_high` | 1342 | 34 | -0.1958 | -0.8176 | 0.4412 | `hold_sample` |
...
| `time_bucket` | `time_0900_1000` | 679 | 32 | 0.3831 | -1.385 | 0.2812 | `source_quality_workorder` |
| `stale_bucket` | `fresh` | 600 | 31 | 0.1197 | -2.319 | 0.2258 | `hold_sample` |
| `exit_rule` | `scalp_trailing_take_profit` | 31 | 31 | -0.5422 | 1.8265 | 1.0 | `source_quality_workorder` |
| `strength_bucket` | `neutral_strength_momentum` | 1450 | 29 | -0.2589 | -0.4585 | 0.4828 | `hold_sample` |
...
| --- | --- | ---: | ---: | ---: | --- |
| `actual_order_submitted` | `false` | 890 | 183 | -0.5456 | `keep_collecting` |
...
| `broker_order_forbidden` | `true` | 890 | 183 | -0.5456 | `keep_collecting` |
| `revalidation_state` | `ok_or_unflagged` | 1147 | 182 | -0.5486 | `keep_collecting` |
...
| `quote_age_bucket` | `quote_age_unknown` | 665 | 106 | -0.2237 | `source_quality_workorder` |
...
| `would_limit_fill` | `false` | 816 | 54 | -0.1196 | `keep_collecting` |
...
| `quote_age_bucket` | `quote_age_1_3s` | 261 | 6 | -0.3409 | `keep_collecting` |
...
| `profit_band` | `profit_neg070_neg010` | 17 | 4 | -0.3537 | `hold_sample` |
...
| `profit_band` | `profit_neg070_neg010` | 89 | 89 | -0.4903 | `candidate_tighten_or_exclude` |
...
| `exit_rule` | `scalp_sim_overnight_sell_today` | 29 | 29 | -0.4001 | `candidate_tighten_or_exclude` |
| `exit_source_stage` | `scalp_sim_overnight_sell_today` | 29 | 29 | -0.4001 | `candidate_tighten_or_exclude` |
...
- primary_decision_metric: `stage_ev_composite_pct`
- summary: `{'bucket_count': 487, 'complete_flow_count': 0, 'incomplete_flow_count': 0, 'runtime_candidate_count': 0, 'workorder_count': 0}`

| bucket_type | bucket_key | sample | joined | ev | avg_profit | win_rate | route |
| --- | --- | ---: | ---: | ---: | ---: | ---: | --- |
| `arm` | `AVG_DOWN` | 14772 | 14613 | None | -1.0684 | 0.0 | `hold_sample` |
| `blocker_namespace` | `AVG_DOWN` | 14620 | 14461 | None | -1.0455 | 0.0 | `hold_sample` |
| `ai_score_source` | `score_field_backfilled` | 10463 | 10441 | None | -0.7541 | 0.152 | `hold_sample` |
| `ai_score_band` | `score_lt60` | 7619 | 7601 | None | -0.9969 | 0.0861 | `hold_sample` |
...
| `price_guard_reason` | `price_guard_none` | 2980 | 2938 | None | -0.8609 | 0.0916 | `hold_sample` |
| `qty_reason` | `qty_none` | 2940 | 2938 | None | -0.8609 | 0.0916 | `hold_sample` |
| `time_bucket` | `time_unknown` | 2982 | 2938 | None | -0.8609 | 0.0916 | `hold_sample` |
...
| `ai_score_source` | `neutral_unusable` | 2213 | 2213 | None | -0.9363 | 0.0926 | `hold_sample` |
...
| `profit_band` | `profit_lt_neg070` | 1674 | 1674 | None | -1.3661 | 0.0 | `hold_sample` |
| `held_bucket` | `held_600_1800s_plus` | 1452 | 1452 | None | -0.9586 | 0.1081 | `hold_sample` |
...
| bucket_type | bucket_key | sample | joined | ev | avg_profit | win_rate | route |
| --- | --- | ---: | ---: | ---: | ---: | ---: | --- |
| `overnight_action` | `SELL_TODAY` | 58 | 29 | -0.4001 | -0.5334 | 0.1724 | `hold_sample` |
| `overnight_status` | `SELL_TODAY` | 29 | 29 | -0.4001 | -0.5334 | 0.1724 | `hold_sample` |
| `stage` | `exit` | 29 | 29 | -0.4001 | -0.5334 | 0.1724 | `hold_sample` |
| `source_quality_gate` | `overnight_decision_coverage` | 58 | 29 | -0.4001 | -0.5334 | 0.1724 | `hold_sample` |
| `source_stage` | `scalp_sim_overnight_sell_today` | 29 | 29 | -0.4001 | -0.5334 | 0.1724 | `hold_sample` |
| `confidence_band` | `confidence_070p` | 56 | 28 | -0.3734 | -0.4979 | 0.1786 | `hold_sample` |
| `peak_profit_band` | `peak_lt_zero` | 48 | 24 | -0.5669 | -0.7558 | 0.0 | `hold_sample` |
...
| `combo_overnight_decision` | `action=SELL_TODAY|status=SELL_TODAY|confidence=confidence_070p|profit=profit_neg070_neg010` | 13 | 13 | -0.1731 | -0.2308 | 0.0 | `hold_sample` |
| `profit_band` | `profit_neg070_neg010` | 26 | 13 | -0.1731 | -0.2308 | 0.0 | `hold_sample` |

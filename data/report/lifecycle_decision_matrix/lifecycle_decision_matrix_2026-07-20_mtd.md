...
## Contract
- matrix_version: `lifecycle_decision_matrix_v1_2026-07-20_mtd`
...
- lifecycle_flow_complete_count: `142`
...
| --- | ---: | ---: | ---: | ---: | --- | --- | --- |
| `entry` | 3274 | 134 | 0.7896 | 0.1179 | `pass` | `NO_CHANGE` | False |
| `submit` | 998 | 176 | -0.5852 | 0.4556 | `pass` | `ALLOW_SUBMIT` | False |
| `holding` | 571 | 176 | -1.1544 | 0.6702 | `pass` | `EXIT` | False |
| `scale_in` | 16657 | 16463 | -0.7361 | 1.0 | `pass` | `NO_CHANGE` | False |
| `exit` | 14593 | 461 | -0.9969 | 0.2541 | `pass` | `EXIT` | False |
...
- summary: `{'bucket_count': 309, 'complete_flow_count': 142, 'incomplete_flow_count': 32275, 'runtime_candidate_count': 0, 'workorder_count': 0}`

| lifecycle_flow_bucket_id | sample | joined | ev | route | source_quality |
| --- | ---: | ---: | ---: | --- | --- |
| `lifecycle_flow:combo_lifecycle_flow:entry_entry_missing_submit_submit_missing_holding_holdin:8cd4f96ab3` | 14084 | 13925 | -0.9615 | `candidate_tighten_or_exclude` | `hold_sample_or_incomplete_flow` |
| `lifecycle_flow:combo_lifecycle_flow:entry_entry_missing_submit_submit_missing_holding_holdin:7d607fe77a` | 2343 | 2308 | 0.638 | `candidate_recovery_or_relax` | `hold_sample_or_incomplete_flow` |
...
| --- | --- | ---: | ---: | ---: | ---: | ---: | --- |
| `liquidity_bucket` | `liquidity_high` | 1709 | 120 | 0.9937 | 0.9279 | 0.4667 | `candidate_recovery_or_relax` |
| `overbought_bucket` | `overbought_normal` | 1620 | 98 | 0.467 | -0.1973 | 0.4388 | `candidate_recovery_or_relax` |
| `source_stage` | `scalp_entry_action_decision_snapshot` | 2185 | 72 | -0.1852 | -1.2864 | 0.4305 | `source_quality_workorder` |
| `chosen_action` | `WAIT_REQUOTE` | 758 | 69 | 1.6636 | 2.8845 | 0.5942 | `candidate_recovery_or_relax` |
| `exit_rule` | `exit_unknown` | 3202 | 62 | 1.9216 | 3.1863 | 0.5645 | `source_quality_workorder` |
| `stale_bucket` | `fresh_or_unflagged` | 395 | 62 | 1.9216 | 3.1863 | 0.5645 | `candidate_recovery_or_relax` |
| `source_stage` | `wait6579_ev_cohort` | 62 | 62 | 1.9216 | 3.1863 | 0.5645 | `candidate_recovery_or_relax` |
| `score_band` | `score_70p` | 482 | 61 | 0.4727 | 0.6824 | 0.541 | `source_quality_workorder` |
| `chosen_action` | `NO_BUY_AI` | 1984 | 56 | 0.0279 | -1.5109 | 0.3571 | `hold_sample` |
| `time_bucket` | `time_1000_1200` | 1017 | 54 | 0.5115 | 0.5548 | 0.4815 | `source_quality_workorder` |
| `strength_bucket` | `weak_strength_momentum` | 1393 | 53 | 0.1876 | -1.1946 | 0.3396 | `hold_sample` |
| `strength_bucket` | `strong_strength_momentum` | 281 | 49 | 2.2161 | 3.5942 | 0.6122 | `candidate_recovery_or_relax` |
| `time_bucket` | `time_1200_1400` | 815 | 35 | 1.1243 | 2.245 | 0.5429 | `source_quality_workorder` |
...
| `stale_bucket` | `fresh` | 579 | 30 | 0.1091 | -2.3477 | 0.2333 | `hold_sample` |
| `stale_bucket` | `stale_high` | 1203 | 30 | -0.2926 | -0.7283 | 0.5 | `hold_sample` |
| `time_bucket` | `time_0900_1000` | 562 | 28 | 0.4046 | -1.3848 | 0.3214 | `source_quality_workorder` |
| `strength_bucket` | `neutral_strength_momentum` | 1009 | 27 | -0.3249 | -0.3832 | 0.5185 | `hold_sample` |
...
| --- | --- | ---: | ---: | ---: | --- |
| `actual_order_submitted` | `false` | 732 | 176 | -0.5852 | `keep_collecting` |
| `latency_reason` | `scalp_live_simulator` | 545 | 176 | -0.5852 | `keep_collecting` |
| `pre_submit_refresh_age_bucket` | `sim_submit_path_not_applicable` | 545 | 176 | -0.5852 | `keep_collecting` |
| `pre_submit_refresh_applied` | `sim_submit_path_not_applicable` | 545 | 176 | -0.5852 | `keep_collecting` |
| `pre_submit_refresh_attempted` | `sim_submit_path_not_applicable` | 545 | 176 | -0.5852 | `keep_collecting` |
| `pre_submit_refresh_reason` | `sim_submit_path_not_applicable` | 545 | 176 | -0.5852 | `keep_collecting` |
| `pre_submit_refresh_source` | `sim_submit_path_not_applicable` | 545 | 176 | -0.5852 | `keep_collecting` |
| `quote_freshness_resolution_state` | `sim_submit_path_not_applicable` | 545 | 176 | -0.5852 | `keep_collecting` |
| `latency_state` | `simulated` | 545 | 176 | -0.5852 | `keep_collecting` |
| `broker_order_forbidden` | `true` | 732 | 176 | -0.5852 | `keep_collecting` |
| `revalidation_state` | `ok_or_unflagged` | 972 | 175 | -0.5886 | `keep_collecting` |
| `overbought_guard_action` | `would_pass` | 542 | 173 | -0.5279 | `keep_collecting` |
| `price_below_bid_bucket` | `not_below_bid` | 506 | 160 | -0.6548 | `keep_collecting` |
| `overbought_bucket` | `overbought_ok` | 458 | 132 | -0.5773 | `keep_collecting` |
| `liquidity_bucket` | `liquidity_ok` | 339 | 101 | -0.2644 | `keep_collecting` |
| `liquidity_guard_action` | `would_pass` | 339 | 101 | -0.2644 | `keep_collecting` |
| `price_resolution_bucket` | `price_resolution_unknown` | 334 | 100 | -0.2671 | `source_quality_workorder` |
| `quote_age_bucket` | `quote_age_unknown` | 516 | 100 | -0.2671 | `source_quality_workorder` |
| `submit_source_stage` | `scalp_sim_buy_order_assumed_filled` | 334 | 100 | -0.2671 | `keep_collecting` |
...
| `would_limit_fill` | `false` | 630 | 51 | -0.1512 | `keep_collecting` |
| `would_limit_fill` | `true` | 157 | 49 | -0.3878 | `keep_collecting` |
| `quote_age_bucket` | `quote_age_3_10s` | 150 | 46 | -1.2485 | `keep_collecting` |
| `overbought_bucket` | `overbought_context_missing` | 85 | 41 | -0.3688 | `keep_collecting` |
...
| `quote_age_bucket` | `quote_age_1_3s` | 231 | 6 | -0.3409 | `keep_collecting` |
...
| bucket_type | bucket_key | sample | joined | ev | route |
| --- | --- | ---: | ---: | ---: | --- |
| `held_bucket` | `held_not_applicable_at_start` | 545 | 176 | -1.1544 | `hold_no_edge` |
| `holding_source_stage` | `scalp_sim_holding_started` | 545 | 176 | -1.1544 | `hold_no_edge` |
| `holding_action` | `WAIT` | 514 | 163 | -1.2405 | `hold_no_edge` |
...
| `profit_band` | `profit_neg070_neg010` | 14 | 4 | -0.3537 | `hold_sample` |
...
| `profit_band` | `profit_not_applicable_at_start` | 369 | 0 | None | `hold_sample` |
...
| `combo_holding_flow` | `source=scalp_sim_holding_started|action=WAIT|profit=profit_not_applicable_at_start|held=held_not_applicable_at_start` | 351 | 0 | None | `hold_sample` |
...
| bucket_type | bucket_key | sample | joined | ev | route |
| --- | --- | ---: | ---: | ---: | --- |
| `profit_band` | `profit_lt_neg070` | 307 | 307 | -1.4742 | `candidate_tighten_or_exclude` |
| `exit_outcome` | `outcome_not_applicable_partial_exit` | 286 | 286 | -0.9453 | `candidate_tighten_or_exclude` |
| `exit_rule` | `scalp_sim_panic_lifecycle_partial_exit` | 286 | 286 | -0.9453 | `candidate_tighten_or_exclude` |
| `exit_source_stage` | `scalp_sim_partial_sell_order_assumed_filled` | 286 | 286 | -0.9453 | `candidate_tighten_or_exclude` |
| `combo_exit_result` | `source=scalp_sim_partial_sell_order_assumed_filled|rule=scalp_sim_panic_lifecycle_partial_exit|outcome=outcome_not_applicable_partial_exit|profit=profit_lt_neg070` | 204 | 204 | -1.1983 | `candidate_tighten_or_exclude` |
| `exit_source_stage` | `sim_post_sell_evaluation` | 149 | 149 | -1.1954 | `hold_no_edge` |
| `profit_band` | `profit_neg070_neg010` | 81 | 81 | -0.4987 | `candidate_tighten_or_exclude` |
...
| `exit_outcome` | `outcome_unknown` | 13065 | 26 | -0.4264 | `source_quality_workorder` |
| `exit_rule` | `scalp_sim_overnight_sell_today` | 26 | 26 | -0.4264 | `candidate_tighten_or_exclude` |
| `exit_source_stage` | `scalp_sim_overnight_sell_today` | 26 | 26 | -0.4264 | `candidate_tighten_or_exclude` |
...
| `combo_exit_result` | `source=scalp_sim_overnight_sell_today|rule=scalp_sim_overnight_sell_today|outcome=outcome_unknown|profit=profit_neg070_neg010` | 9 | 9 | -0.1842 | `source_quality_workorder` |
...
- primary_decision_metric: `stage_ev_composite_pct`
- summary: `{'bucket_count': 477, 'complete_flow_count': 0, 'incomplete_flow_count': 0, 'runtime_candidate_count': 0, 'workorder_count': 0}`

| bucket_type | bucket_key | sample | joined | ev | avg_profit | win_rate | route |
| --- | --- | ---: | ---: | ---: | ---: | ---: | --- |
| `arm` | `AVG_DOWN` | 14300 | 14141 | None | -1.0802 | 0.0 | `hold_sample` |
| `blocker_namespace` | `AVG_DOWN` | 14151 | 13992 | None | -1.0572 | 0.0 | `hold_sample` |
| `ai_score_source` | `score_field_backfilled` | 10398 | 10376 | None | -0.7545 | 0.1529 | `hold_sample` |
| `ai_score_band` | `score_lt60` | 7117 | 7099 | None | -1.0224 | 0.0875 | `hold_sample` |
| `ai_score_source` | `live` | 3911 | 3911 | None | -1.0321 | 0.1163 | `hold_sample` |
...
| `price_guard_reason` | `price_guard_none` | 2475 | 2433 | None | -0.9067 | 0.0971 | `hold_sample` |
| `qty_reason` | `qty_none` | 2435 | 2433 | None | -0.9067 | 0.0971 | `hold_sample` |
| `supply_pass_bucket` | `supply_pass_unknown` | 2477 | 2433 | None | -0.9067 | 0.0971 | `hold_sample` |
| `time_bucket` | `time_unknown` | 2477 | 2433 | None | -0.9067 | 0.0971 | `hold_sample` |
| `arm` | `PYRAMID` | 2357 | 2322 | None | 0.5982 | 0.9836 | `hold_sample` |
| `blocker_namespace` | `PYRAMID` | 2357 | 2322 | None | 0.5982 | 0.9836 | `hold_sample` |
| `peak_profit_band` | `peak_lt_zero` | 2301 | 2301 | None | -1.1635 | 0.0 | `hold_sample` |
| `ai_score_source` | `neutral_unusable` | 2065 | 2065 | None | -0.9536 | 0.0964 | `hold_sample` |
| `blocker_reason` | `profit_not_enough` | 1904 | 1904 | None | 0.4348 | 0.9816 | `hold_sample` |
| `ai_score_band` | `score_60_62` | 1768 | 1765 | None | -0.6279 | 0.1968 | `hold_sample` |
| `profit_band` | `profit_lt_neg070` | 1457 | 1457 | None | -1.4137 | 0.0 | `hold_sample` |
...
| bucket_type | bucket_key | sample | joined | ev | avg_profit | win_rate | route |
| --- | --- | ---: | ---: | ---: | ---: | ---: | --- |
| `overnight_action` | `SELL_TODAY` | 52 | 26 | -0.4264 | -0.5685 | 0.1923 | `hold_sample` |
| `overnight_status` | `SELL_TODAY` | 26 | 26 | -0.4264 | -0.5685 | 0.1923 | `hold_sample` |
| `stage` | `exit` | 26 | 26 | -0.4264 | -0.5685 | 0.1923 | `hold_sample` |
| `source_quality_gate` | `overnight_decision_coverage` | 52 | 26 | -0.4264 | -0.5685 | 0.1923 | `hold_sample` |
| `source_stage` | `scalp_sim_overnight_sell_today` | 26 | 26 | -0.4264 | -0.5685 | 0.1923 | `hold_sample` |
| `confidence_band` | `confidence_070p` | 50 | 25 | -0.3975 | -0.53 | 0.2 | `hold_sample` |
| `peak_profit_band` | `peak_lt_zero` | 42 | 21 | -0.6232 | -0.831 | 0.0 | `hold_sample` |
...
| `combo_overnight_decision` | `action=SELL_TODAY|status=SELL_TODAY|confidence=confidence_070p|profit=profit_neg070_neg010` | 10 | 10 | -0.1732 | -0.231 | 0.0 | `hold_sample` |
| `profit_band` | `profit_neg070_neg010` | 20 | 10 | -0.1732 | -0.231 | 0.0 | `hold_sample` |

...
## Contract
- matrix_version: `lifecycle_decision_matrix_v1_2026-07-28_rolling10d`
...
| --- | ---: | ---: | ---: | ---: | --- | --- | --- |
| `entry` | 1311 | 6 | 0.3563 | 0.0124 | `pass` | `NO_CHANGE` | False |
| `submit` | 341 | 10 | 0.4295 | 0.0473 | `pass` | `NO_CHANGE` | False |
| `holding` | 43 | 10 | -0.55 | 0.2355 | `pass` | `NO_CHANGE` | False |
| `scale_in` | 568 | 568 | -0.5531 | 0.9891 | `pass` | `NO_CHANGE` | False |
| `exit` | 91 | 40 | -0.7086 | 0.5901 | `pass` | `EXIT` | False |
...
- summary: `{'bucket_count': 84, 'complete_flow_count': 19, 'incomplete_flow_count': 1168, 'runtime_candidate_count': 0, 'workorder_count': 0}`

| lifecycle_flow_bucket_id | sample | joined | ev | route | source_quality |
| --- | ---: | ---: | ---: | --- | --- |
| `lifecycle_flow:combo_lifecycle_flow:entry_entry_missing_submit_submit_missing_holding_holdin:8cd4f96ab3` | 517 | 517 | -0.67 | `candidate_tighten_or_exclude` | `hold_sample_or_incomplete_flow` |
| `lifecycle_flow:combo_lifecycle_flow:entry_entry_missing_submit_submit_missing_holding_holdin:7d607fe77a` | 51 | 51 | 0.6311 | `candidate_recovery_or_relax` | `hold_sample_or_incomplete_flow` |
...
| `chosen_action` | `NO_BUY_AI` | 427 | 5 | 0.5119 | -1.482 | 0.0 | `source_quality_workorder` |
| `liquidity_bucket` | `liquidity_high` | 243 | 5 | 0.5119 | -1.482 | 0.0 | `hold_sample` |
| `source_stage` | `scalp_entry_action_decision_snapshot` | 1156 | 5 | 0.5119 | -1.482 | 0.0 | `source_quality_workorder` |
...
| `time_bucket` | `time_0900_1000` | 256 | 4 | 0.2325 | -1.386 | 0.0 | `source_quality_workorder` |
| `score_band` | `score_lt60` | 1141 | 3 | 0.5467 | -1.4867 | 0.0 | `source_quality_workorder` |
| `strength_bucket` | `weak_strength_momentum` | 140 | 3 | 0.4318 | -1.4867 | 0.0 | `hold_sample` |
| `strength_bucket` | `neutral_strength_momentum` | 853 | 2 | 0.6321 | -1.475 | 0.0 | `hold_sample` |
...
| `time_bucket` | `time_1000_1200` | 400 | 2 | 0.6038 | -1.485 | 0.0 | `source_quality_workorder` |
| `chosen_action` | `WAIT_REQUOTE` | 726 | 1 | -0.422 | -1.1039 | 0.0 | `hold_sample` |
| `exit_rule` | `exit_unknown` | 1306 | 1 | -0.422 | -1.1039 | 0.0 | `source_quality_workorder` |
| `stale_bucket` | `fresh` | 166 | 1 | 0.4374 | -1.46 | 0.0 | `hold_sample` |
...
| --- | --- | ---: | ---: | ---: | --- |
| `actual_order_submitted` | `false` | 267 | 10 | 0.4295 | `keep_collecting` |
| `price_below_bid_bucket` | `not_below_bid` | 36 | 10 | 0.4295 | `keep_collecting` |
| `revalidation_state` | `ok_or_unflagged` | 311 | 10 | 0.4295 | `keep_collecting` |
...
| `broker_order_forbidden` | `true` | 267 | 10 | 0.4295 | `keep_collecting` |
...
| `quote_age_bucket` | `quote_age_unknown` | 252 | 6 | 0.4995 | `source_quality_workorder` |
...
| `would_limit_fill` | `false` | 322 | 3 | 0.4169 | `keep_collecting` |
...
| `quote_age_bucket` | `quote_age_1_3s` | 54 | 1 | 4.1198 | `keep_collecting` |
...
| `latency_state` | `caution` | 37 | 0 | None | `keep_collecting` |
| `latency_reason` | `caution_normal_entry_allowed` | 37 | 0 | None | `keep_collecting` |
...
| `profit_band` | `profit_neg070_neg010` | 12 | 12 | -0.3281 | `hold_sample` |
...
- primary_decision_metric: `stage_ev_composite_pct`
- summary: `{'bucket_count': 159, 'complete_flow_count': 0, 'incomplete_flow_count': 0, 'runtime_candidate_count': 0, 'workorder_count': 0}`

| bucket_type | bucket_key | sample | joined | ev | avg_profit | win_rate | route |
| --- | --- | ---: | ---: | ---: | ---: | ---: | --- |
| `price_guard_reason` | `price_guard_none` | 568 | 568 | None | -0.6432 | 0.0898 | `hold_sample` |
| `qty_reason` | `qty_none` | 568 | 568 | None | -0.6432 | 0.0898 | `hold_sample` |
| `time_bucket` | `time_unknown` | 568 | 568 | None | -0.6432 | 0.0898 | `hold_sample` |
| `ai_score_band` | `score_lt60` | 564 | 564 | None | -0.6433 | 0.0886 | `hold_sample` |
| `supply_pass_bucket` | `supply_pass_unknown` | 545 | 545 | None | -0.6467 | 0.0936 | `hold_sample` |
| `arm` | `AVG_DOWN` | 517 | 517 | None | -0.766 | 0.0 | `hold_sample` |
| `blocker_namespace` | `AVG_DOWN` | 514 | 514 | None | -0.7509 | 0.0 | `hold_sample` |
...
| `profit_band` | `profit_neg070_neg010` | 259 | 259 | None | -0.4403 | 0.0 | `hold_sample` |
| `profit_band` | `profit_lt_neg070` | 246 | 246 | None | -1.144 | 0.0 | `hold_sample` |
| `held_bucket` | `held_600_1800s_plus` | 205 | 205 | None | -0.609 | 0.1268 | `hold_sample` |
| `ai_score_source` | `neutral_unusable` | 163 | 163 | None | -0.7801 | 0.0491 | `hold_sample` |
| `held_bucket` | `held_600_1800s` | 131 | 131 | None | -0.7367 | 0.0076 | `hold_sample` |
| `held_bucket` | `held_180_600s` | 113 | 113 | None | -0.7398 | 0.0708 | `hold_sample` |
| `held_bucket` | `held_020_180s` | 111 | 111 | None | -0.5348 | 0.1351 | `hold_sample` |
| `ai_score_source` | `score_field_backfilled` | 81 | 81 | None | -0.4968 | 0.1481 | `hold_sample` |
| `peak_profit_band` | `peak_zero_pos080` | 74 | 74 | None | -0.2338 | 0.4865 | `hold_sample` |
| `arm` | `PYRAMID` | 51 | 51 | None | 0.6022 | 1.0 | `hold_sample` |
| `blocker_namespace` | `PYRAMID` | 51 | 51 | None | 0.6022 | 1.0 | `hold_sample` |

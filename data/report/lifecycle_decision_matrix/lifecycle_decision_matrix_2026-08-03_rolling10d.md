...
## Contract
- matrix_version: `lifecycle_decision_matrix_v1_2026-08-03_rolling10d`
...
| --- | ---: | ---: | ---: | ---: | --- | --- | --- |
| `entry` | 2150 | 73 | 2.9351 | 0.3048 | `pass` | `BUY_DEFENSIVE` | False |
| `submit` | 182 | 10 | -0.2 | 0.034 | `pass` | `ALLOW_SUBMIT` | False |
| `holding` | 18 | 10 | -0.6167 | 0.1682 | `pass` | `HOLD` | False |
| `scale_in` | 629 | 623 | -0.7928 | 0.9934 | `pass` | `NO_CHANGE` | False |
| `exit` | 297 | 22 | -0.6221 | 0.193 | `pass` | `EXIT` | False |
...
- summary: `{'bucket_count': 83, 'complete_flow_count': 12, 'incomplete_flow_count': 1786, 'runtime_candidate_count': 0, 'workorder_count': 0}`

| lifecycle_flow_bucket_id | sample | joined | ev | route | source_quality |
| --- | ---: | ---: | ---: | --- | --- |
| `lifecycle_flow:combo_lifecycle_flow:entry_entry_missing_submit_submit_missing_holding_holdin:8cd4f96ab3` | 535 | 529 | -1.0065 | `candidate_tighten_or_exclude` | `hold_sample_or_incomplete_flow` |
| `lifecycle_flow:combo_lifecycle_flow:entry_entry_missing_submit_submit_missing_holding_holdin:7d607fe77a` | 94 | 94 | 0.4099 | `candidate_recovery_or_relax` | `hold_sample_or_incomplete_flow` |
...
| --- | --- | ---: | ---: | ---: | ---: | ---: | --- |
| `liquidity_bucket` | `liquidity_high` | 713 | 64 | 3.3424 | 5.1222 | 0.75 | `hold_sample` |
| `score_band` | `score_63_65` | 437 | 64 | 3.2004 | 4.8472 | 0.7031 | `hold_sample` |
| `chosen_action` | `WAIT_REQUOTE` | 635 | 63 | 3.4327 | 5.2779 | 0.746 | `hold_sample` |
| `exit_rule` | `exit_unknown` | 2140 | 63 | 3.4327 | 5.2779 | 0.746 | `source_quality_workorder` |
| `source_stage` | `wait6579_ev_cohort` | 63 | 63 | 3.4327 | 5.2779 | 0.746 | `candidate_recovery_or_relax` |
| `overbought_bucket` | `overbought_watch` | 543 | 42 | 2.5652 | 3.623 | 0.6905 | `hold_sample` |
...
| `chosen_action` | `SKIP_PRE_SUBMIT_SAFETY` | 235 | 8 | -0.4569 | -1.405 | 0.125 | `hold_sample` |
| `liquidity_bucket` | `liquidity_not_available` | 1202 | 8 | -0.4569 | -1.405 | 0.125 | `source_quality_workorder` |
| `overbought_bucket` | `overbought_not_available` | 944 | 8 | -0.4569 | -1.405 | 0.125 | `source_quality_workorder` |
| `source_stage` | `scalp_sim_entry_ai_price_skip_order` | 228 | 8 | -0.4569 | -1.405 | 0.125 | `hold_sample` |
| `overbought_bucket` | `overbought_normal` | 282 | 7 | 1.4519 | 1.4953 | 0.8571 | `hold_sample` |
...
| `overbought_bucket` | `overbought_chase_risk` | 69 | 5 | 6.2529 | 9.7913 | 1.0 | `hold_sample` |
| `exit_rule` | `scalp_preset_hard_stop_pct` | 5 | 5 | -0.0471 | -1.472 | 0.0 | `hold_sample` |
...
| --- | --- | ---: | ---: | ---: | --- |
| `actual_order_submitted` | `false` | 137 | 10 | -0.2 | `keep_collecting` |
| `price_below_bid_bucket` | `not_below_bid` | 13 | 10 | -0.2 | `keep_collecting` |
| `revalidation_state` | `ok_or_unflagged` | 180 | 10 | -0.2 | `keep_collecting` |
| `latency_reason` | `scalp_live_simulator` | 14 | 10 | -0.2 | `keep_collecting` |
| `pre_submit_refresh_age_bucket` | `sim_submit_path_not_applicable` | 14 | 10 | -0.2 | `keep_collecting` |
| `pre_submit_refresh_applied` | `sim_submit_path_not_applicable` | 14 | 10 | -0.2 | `keep_collecting` |
| `pre_submit_refresh_attempted` | `sim_submit_path_not_applicable` | 14 | 10 | -0.2 | `keep_collecting` |
| `pre_submit_refresh_reason` | `sim_submit_path_not_applicable` | 14 | 10 | -0.2 | `keep_collecting` |
| `pre_submit_refresh_source` | `sim_submit_path_not_applicable` | 14 | 10 | -0.2 | `keep_collecting` |
| `quote_freshness_resolution_state` | `sim_submit_path_not_applicable` | 14 | 10 | -0.2 | `keep_collecting` |
| `latency_state` | `simulated` | 14 | 10 | -0.2 | `keep_collecting` |
| `broker_order_forbidden` | `true` | 137 | 10 | -0.2 | `keep_collecting` |
| `overbought_guard_action` | `would_pass` | 14 | 10 | -0.2 | `keep_collecting` |
| `overbought_bucket` | `overbought_context_missing` | 11 | 8 | -0.4569 | `keep_collecting` |
| `liquidity_bucket` | `liquidity_ok` | 11 | 7 | -0.115 | `keep_collecting` |
| `price_resolution_bucket` | `price_resolution_unknown` | 11 | 7 | -0.115 | `source_quality_workorder` |
| `quote_age_bucket` | `quote_age_unknown` | 133 | 7 | -0.115 | `source_quality_workorder` |
| `submit_source_stage` | `scalp_sim_buy_order_assumed_filled` | 11 | 7 | -0.115 | `keep_collecting` |
| `liquidity_guard_action` | `would_pass` | 11 | 7 | -0.115 | `keep_collecting` |
| `would_limit_fill` | `false` | 176 | 5 | -0.5765 | `keep_collecting` |
...
| `latency_state` | `caution` | 36 | 0 | None | `keep_collecting` |
| `latency_reason` | `caution_normal_entry_allowed` | 36 | 0 | None | `keep_collecting` |
| `latency_state` | `danger` | 125 | 0 | None | `keep_collecting` |
...
| bucket_type | bucket_key | sample | joined | ev | route |
| --- | --- | ---: | ---: | ---: | --- |
| `held_bucket` | `held_not_applicable_at_start` | 14 | 10 | -0.6167 | `candidate_tighten_or_exclude` |
| `holding_source_stage` | `scalp_sim_holding_started` | 14 | 10 | -0.6167 | `candidate_tighten_or_exclude` |
| `holding_action` | `WAIT` | 12 | 9 | -0.7082 | `candidate_tighten_or_exclude` |
| `profit_band` | `profit_lt_neg070` | 6 | 6 | -1.0774 | `hold_sample` |
| `combo_holding_flow` | `source=scalp_sim_holding_started|action=WAIT|profit=profit_lt_neg070|held=held_not_applicable_at_start` | 6 | 6 | -1.0774 | `hold_sample` |
...
| bucket_type | bucket_key | sample | joined | ev | route |
| --- | --- | ---: | ---: | ---: | --- |
| `profit_band` | `profit_lt_neg070` | 12 | 12 | -1.0962 | `candidate_tighten_or_exclude` |
| `exit_source_stage` | `sim_post_sell_evaluation` | 10 | 10 | -0.6167 | `candidate_tighten_or_exclude` |
| `exit_outcome` | `outcome_not_applicable_partial_exit` | 8 | 8 | -0.8537 | `candidate_tighten_or_exclude` |
| `exit_rule` | `scalp_sim_panic_lifecycle_partial_exit` | 8 | 8 | -0.8537 | `candidate_tighten_or_exclude` |
| `exit_source_stage` | `scalp_sim_partial_sell_order_assumed_filled` | 8 | 8 | -0.8537 | `candidate_tighten_or_exclude` |
| `exit_outcome` | `MISSED_UPSIDE` | 7 | 7 | -0.5057 | `hold_sample` |
| `combo_exit_result` | `source=scalp_sim_partial_sell_order_assumed_filled|rule=scalp_sim_panic_lifecycle_partial_exit|outcome=outcome_not_applicable_partial_exit|profit=profit_lt_neg070` | 6 | 6 | -1.115 | `hold_sample` |
| `profit_band` | `profit_neg070_neg010` | 5 | 5 | -0.232 | `hold_sample` |
| `exit_rule` | `scalp_preset_hard_stop_pct` | 5 | 5 | -0.7774 | `hold_sample` |
...
| `exit_rule` | `scalp_trailing_take_profit` | 4 | 4 | 0.0744 | `hold_sample` |
...
| `exit_source_stage` | `scalp_sim_euphoria_context_noop` | 231 | 0 | None | `hold_sample` |
| `exit_rule` | `scalp_sim_euphoria_context_noop_not_applicable` | 231 | 0 | None | `hold_sample` |
...
| `combo_exit_result` | `source=scalp_sim_euphoria_context_noop|rule=scalp_sim_euphoria_context_noop_not_applicable|outcome=outcome_not_applicable_context_noop|profit=profit_not_applicable_context_noop` | 231 | 0 | None | `hold_sample` |
...
- primary_decision_metric: `stage_ev_composite_pct`
- summary: `{'bucket_count': 134, 'complete_flow_count': 0, 'incomplete_flow_count': 0, 'runtime_candidate_count': 0, 'workorder_count': 0}`

| bucket_type | bucket_key | sample | joined | ev | avg_profit | win_rate | route |
| --- | --- | ---: | ---: | ---: | ---: | ---: | --- |
| `price_guard_reason` | `price_guard_none` | 628 | 623 | None | -0.8887 | 0.1509 | `hold_sample` |
| `qty_reason` | `qty_none` | 624 | 623 | None | -0.8887 | 0.1509 | `hold_sample` |
| `ai_score_band` | `score_lt60` | 623 | 623 | None | -0.8887 | 0.1509 | `hold_sample` |
| `time_bucket` | `time_unknown` | 629 | 623 | None | -0.8887 | 0.1509 | `hold_sample` |
| `arm` | `AVG_DOWN` | 535 | 529 | None | -1.114 | 0.0 | `hold_sample` |
| `blocker_namespace` | `AVG_DOWN` | 531 | 525 | None | -1.0968 | 0.0 | `hold_sample` |
| `profit_band` | `profit_lt_neg070` | 376 | 376 | None | -1.4073 | 0.0 | `hold_sample` |
| `supply_pass_bucket` | `supply_pass_unknown` | 356 | 350 | None | -0.7395 | 0.2685 | `hold_sample` |
| `ai_score_source` | `live` | 310 | 310 | None | -1.1217 | 0.0613 | `hold_sample` |
| `peak_profit_band` | `peak_unknown` | 279 | 273 | None | -1.08 | 0.0 | `hold_sample` |
| `held_bucket` | `held_600_1800s` | 193 | 193 | None | -0.6894 | 0.2487 | `hold_sample` |
| `peak_profit_band` | `peak_zero_pos080` | 191 | 191 | None | -0.4438 | 0.4764 | `hold_sample` |
| `ai_score_source` | `neutral_unusable` | 185 | 185 | None | -0.5262 | 0.3784 | `hold_sample` |
| `peak_profit_band` | `peak_lt_zero` | 155 | 155 | None | -1.1416 | 0.0 | `hold_sample` |
| `held_bucket` | `held_180_600s` | 152 | 152 | None | -0.6016 | 0.2632 | `hold_sample` |
| `held_bucket` | `held_600_1800s_plus` | 147 | 147 | None | -1.5705 | 0.0 | `hold_sample` |
| `profit_band` | `profit_neg070_neg010` | 139 | 139 | None | -0.4246 | 0.0 | `hold_sample` |
| `ai_score_source` | `not_evaluated_no_ai_score_source` | 106 | 106 | None | -0.7698 | 0.0283 | `hold_sample` |
| `profit_band` | `profit_neg010_pos080` | 105 | 105 | None | 0.2979 | 0.8667 | `hold_sample` |
| `arm` | `PYRAMID` | 94 | 94 | None | 0.379 | 1.0 | `hold_sample` |

...
## Contract
- matrix_version: `lifecycle_decision_matrix_v1_2026-07-16_rolling5d`
...
| --- | ---: | ---: | ---: | ---: | --- | --- | --- |
| `entry` | 757 | 15 | -0.3755 | 0.0218 | `pass` | `NO_CHANGE` | False |
| `submit` | 158 | 20 | -0.3878 | 0.1674 | `pass` | `NO_CHANGE` | False |
| `holding` | 70 | 20 | -1.0202 | 0.3625 | `pass` | `EXIT` | False |
| `scale_in` | 1689 | 1686 | -0.9219 | 1.0 | `pass` | `NO_CHANGE` | False |
| `exit` | 355 | 80 | -0.9164 | 0.7485 | `pass` | `EXIT` | False |
...
- summary: `{'bucket_count': 87, 'complete_flow_count': 50, 'incomplete_flow_count': 2249, 'runtime_candidate_count': 0, 'workorder_count': 0}`

| lifecycle_flow_bucket_id | sample | joined | ev | route | source_quality |
| --- | ---: | ---: | ---: | --- | --- |
| `lifecycle_flow:combo_lifecycle_flow:entry_entry_missing_submit_submit_missing_holding_holdin:8cd4f96ab3` | 1565 | 1562 | -1.035 | `candidate_tighten_or_exclude` | `hold_sample_or_incomplete_flow` |
| `lifecycle_flow:combo_lifecycle_flow:entry_entry_missing_submit_submit_missing_holding_holdin:7d607fe77a` | 110 | 110 | 0.7064 | `candidate_recovery_or_relax` | `hold_sample_or_incomplete_flow` |
...
| --- | --- | ---: | ---: | ---: | ---: | ---: | --- |
| `source_stage` | `scalp_entry_action_decision_snapshot` | 556 | 15 | -0.3755 | -1.3873 | 0.4667 | `source_quality_workorder` |
| `chosen_action` | `NO_BUY_AI` | 446 | 10 | 0.0923 | -1.663 | 0.4 | `source_quality_workorder` |
| `liquidity_bucket` | `liquidity_high` | 322 | 10 | 0.0923 | -1.663 | 0.4 | `hold_sample` |
| `strength_bucket` | `weak_strength_momentum` | 269 | 10 | -0.0357 | -1.638 | 0.4 | `hold_sample` |
| `overbought_bucket` | `overbought_normal` | 358 | 9 | 0.1759 | -1.29 | 0.4444 | `hold_sample` |
| `stale_bucket` | `stale_high` | 301 | 9 | -0.4287 | -0.9744 | 0.5556 | `hold_sample` |
...
| `score_band` | `score_lt60` | 543 | 6 | 0.0924 | -1.2367 | 0.5 | `source_quality_workorder` |
| `time_bucket` | `time_0900_1000` | 71 | 6 | 0.2091 | -2.82 | 0.1666 | `hold_sample` |
| `time_bucket` | `time_1000_1200` | 235 | 6 | -0.3857 | -0.2633 | 0.6667 | `hold_sample` |
| `liquidity_bucket` | `liquidity_not_available` | 378 | 5 | -1.311 | -0.836 | 0.6 | `source_quality_workorder` |
| `overbought_bucket` | `overbought_not_available` | 329 | 5 | -1.311 | -0.836 | 0.6 | `source_quality_workorder` |
| `score_band` | `score_60_62` | 142 | 5 | -0.1864 | -1.586 | 0.4 | `hold_sample` |
| `score_band` | `score_70p` | 56 | 4 | -1.3137 | -1.365 | 0.5 | `hold_sample` |
| `stale_bucket` | `stale_watch` | 62 | 4 | -1.056 | -1.07 | 0.5 | `hold_sample` |
| `chosen_action` | `WAIT_REQUOTE` | 226 | 3 | -1.8904 | -0.6467 | 0.6667 | `hold_sample` |
| `strength_bucket` | `neutral_strength_momentum` | 299 | 3 | -1.8542 | 0.88 | 1.0 | `hold_sample` |
| `time_bucket` | `time_1200_1400` | 200 | 3 | -1.524 | -0.77 | 0.6667 | `source_quality_workorder` |
| `chosen_action` | `BUY_DEFENSIVE` | 16 | 2 | -0.4418 | -1.12 | 0.5 | `hold_sample` |
...
| --- | --- | ---: | ---: | ---: | --- |
| `actual_order_submitted` | `false` | 138 | 20 | -0.3878 | `keep_collecting` |
| `revalidation_state` | `ok_or_unflagged` | 148 | 20 | -0.3878 | `keep_collecting` |
| `latency_reason` | `scalp_live_simulator` | 66 | 20 | -0.3878 | `keep_collecting` |
| `pre_submit_refresh_age_bucket` | `sim_submit_path_not_applicable` | 66 | 20 | -0.3878 | `keep_collecting` |
| `pre_submit_refresh_applied` | `sim_submit_path_not_applicable` | 66 | 20 | -0.3878 | `keep_collecting` |
| `pre_submit_refresh_attempted` | `sim_submit_path_not_applicable` | 66 | 20 | -0.3878 | `keep_collecting` |
| `pre_submit_refresh_reason` | `sim_submit_path_not_applicable` | 66 | 20 | -0.3878 | `keep_collecting` |
| `pre_submit_refresh_source` | `sim_submit_path_not_applicable` | 66 | 20 | -0.3878 | `keep_collecting` |
| `quote_freshness_resolution_state` | `sim_submit_path_not_applicable` | 66 | 20 | -0.3878 | `keep_collecting` |
| `latency_state` | `simulated` | 66 | 20 | -0.3878 | `keep_collecting` |
| `broker_order_forbidden` | `true` | 138 | 20 | -0.3878 | `keep_collecting` |
| `overbought_guard_action` | `would_pass` | 66 | 20 | -0.3878 | `keep_collecting` |
| `price_below_bid_bucket` | `not_below_bid` | 63 | 18 | -0.5008 | `keep_collecting` |
| `liquidity_bucket` | `liquidity_ok` | 43 | 16 | -0.4314 | `keep_collecting` |
| `price_resolution_bucket` | `price_resolution_unknown` | 42 | 16 | -0.4314 | `source_quality_workorder` |
| `quote_age_bucket` | `quote_age_unknown` | 112 | 16 | -0.4314 | `source_quality_workorder` |
| `submit_source_stage` | `scalp_sim_buy_order_assumed_filled` | 42 | 16 | -0.4314 | `keep_collecting` |
| `liquidity_guard_action` | `would_pass` | 43 | 16 | -0.4314 | `keep_collecting` |
| `overbought_bucket` | `overbought_ok` | 59 | 15 | -0.2229 | `keep_collecting` |
| `would_limit_fill` | `false` | 117 | 10 | -0.085 | `keep_collecting` |
| `combo_submit_quality` | `source=scalp_sim_buy_order_assumed_filled|revalidation=ok_or_unflagged|quote_age=quote_age_unknown|liquidity=liquidity_ok|liquidity_guard=would_pass|overbought=overbought_ok|latency=simulated|refresh=sim_submit_path_not_applicable|fill=false|submitted=false` | 22 | 8 | -0.2634 | `source_quality_workorder` |
| `would_limit_fill` | `true` | 17 | 6 | -1.0087 | `keep_collecting` |
| `overbought_bucket` | `overbought_context_missing` | 7 | 5 | -0.8826 | `keep_collecting` |
| `liquidity_bucket` | `below_min_liquidity` | 23 | 4 | -0.2135 | `keep_collecting` |
| `price_resolution_bucket` | `defensive_order_price` | 23 | 4 | -0.2135 | `keep_collecting` |
| `submit_source_stage` | `scalp_sim_pre_submit_liquidity_guard_would_block` | 23 | 4 | -0.2135 | `keep_collecting` |
| `liquidity_guard_action` | `would_block` | 23 | 4 | -0.2135 | `keep_collecting` |
| `would_limit_fill` | `would_limit_fill_unknown` | 24 | 4 | -0.2135 | `source_quality_workorder` |
...
| `quote_age_bucket` | `quote_age_10s_plus` | 20 | 2 | -0.6668 | `keep_collecting` |
| `quote_age_bucket` | `quote_age_3_10s` | 11 | 2 | 0.2399 | `keep_collecting` |
| `combo_submit_quality` | `source=scalp_sim_buy_order_assumed_filled|revalidation=ok_or_unflagged|quote_age=quote_age_unknown|liquidity=liquidity_ok|liquidity_guard=would_pass|overbought=overbought_context_missing|latency=simulated|refresh=sim_submit_path_not_applicable|fill=false|submitted=false` | 3 | 2 | 0.629 | `source_quality_workorder` |
| `combo_submit_quality` | `source=scalp_sim_pre_submit_liquidity_guard_would_block|revalidation=ok_or_unflagged|quote_age=quote_age_10s_plus|liquidity=below_min_liquidity|liquidity_guard=would_block|overbought=overbought_ok|latency=simulated|refresh=sim_submit_path_not_applicable|fill=would_limit_fill_unknown|submitted=false` | 17 | 2 | -0.6668 | `source_quality_workorder` |
| `combo_submit_quality` | `source=scalp_sim_pre_submit_liquidity_guard_would_block|revalidation=ok_or_unflagged|quote_age=quote_age_3_10s|liquidity=below_min_liquidity|liquidity_guard=would_block|overbought=overbought_ok|latency=simulated|refresh=sim_submit_path_not_applicable|fill=would_limit_fill_unknown|submitted=false` | 5 | 2 | 0.2399 | `source_quality_workorder` |
| `latency_state` | `caution` | 10 | 0 | None | `keep_collecting` |
| `latency_reason` | `caution_normal_entry_allowed` | 10 | 0 | None | `keep_collecting` |
| `latency_state` | `danger` | 73 | 0 | None | `keep_collecting` |
...
| bucket_type | bucket_key | sample | joined | ev | route |
| --- | --- | ---: | ---: | ---: | --- |
| `held_bucket` | `held_not_applicable_at_start` | 66 | 20 | -1.0202 | `candidate_tighten_or_exclude` |
| `holding_source_stage` | `scalp_sim_holding_started` | 66 | 20 | -1.0202 | `candidate_tighten_or_exclude` |
| `holding_action` | `WAIT` | 64 | 19 | -1.0289 | `candidate_tighten_or_exclude` |
| `profit_band` | `profit_lt_neg070` | 13 | 12 | -1.6354 | `candidate_tighten_or_exclude` |
| `combo_holding_flow` | `source=scalp_sim_holding_started|action=WAIT|profit=profit_lt_neg070|held=held_not_applicable_at_start` | 11 | 11 | -1.7064 | `candidate_tighten_or_exclude` |
| `profit_band` | `profit_pos080_pos150` | 4 | 4 | 0.0122 | `hold_sample` |
| `combo_holding_flow` | `source=scalp_sim_holding_started|action=WAIT|profit=profit_pos080_pos150|held=held_not_applicable_at_start` | 4 | 4 | 0.0122 | `hold_sample` |
| `profit_band` | `profit_neg010_pos080` | 2 | 2 | -0.7457 | `hold_sample` |
| `combo_holding_flow` | `source=scalp_sim_holding_started|action=WAIT|profit=profit_neg010_pos080|held=held_not_applicable_at_start` | 2 | 2 | -0.7457 | `hold_sample` |
| `holding_action` | `holding_action_not_applicable_at_start` | 2 | 1 | -0.8553 | `hold_sample` |
| `profit_band` | `profit_neg070_neg010` | 4 | 1 | -0.5849 | `hold_sample` |
...
| bucket_type | bucket_key | sample | joined | ev | route |
| --- | --- | ---: | ---: | ---: | --- |
| `exit_outcome` | `outcome_not_applicable_partial_exit` | 57 | 57 | -0.9248 | `candidate_tighten_or_exclude` |
| `exit_rule` | `scalp_sim_panic_lifecycle_partial_exit` | 57 | 57 | -0.9248 | `candidate_tighten_or_exclude` |
| `exit_source_stage` | `scalp_sim_partial_sell_order_assumed_filled` | 57 | 57 | -0.9248 | `candidate_tighten_or_exclude` |
| `profit_band` | `profit_lt_neg070` | 52 | 52 | -1.2034 | `candidate_tighten_or_exclude` |
| `combo_exit_result` | `source=scalp_sim_partial_sell_order_assumed_filled|rule=scalp_sim_panic_lifecycle_partial_exit|outcome=outcome_not_applicable_partial_exit|profit=profit_lt_neg070` | 40 | 40 | -1.0817 | `candidate_tighten_or_exclude` |
| `profit_band` | `profit_neg070_neg010` | 20 | 20 | -0.5336 | `candidate_tighten_or_exclude` |
| `exit_source_stage` | `sim_post_sell_evaluation` | 19 | 19 | -1.0071 | `candidate_tighten_or_exclude` |
...
| `exit_rule` | `scalp_soft_stop_pct` | 9 | 9 | -1.634 | `candidate_tighten_or_exclude` |
| `exit_outcome` | `NEUTRAL` | 8 | 8 | -0.9553 | `candidate_tighten_or_exclude` |
| `exit_rule` | `scalp_trailing_take_profit` | 8 | 8 | -0.0974 | `hold_sample` |
| `exit_outcome` | `GOOD_EXIT` | 7 | 7 | -0.8277 | `candidate_tighten_or_exclude` |
| `exit_outcome` | `MISSED_UPSIDE` | 4 | 4 | -1.4246 | `hold_sample` |
| `exit_outcome` | `outcome_unknown` | 4 | 4 | -0.3675 | `source_quality_workorder` |
| `profit_band` | `profit_pos080_pos150` | 4 | 4 | 0.0122 | `hold_sample` |
| `exit_rule` | `scalp_sim_overnight_sell_today` | 4 | 4 | -0.3675 | `hold_sample` |
| `exit_source_stage` | `scalp_sim_overnight_sell_today` | 4 | 4 | -0.3675 | `hold_sample` |
...
| `profit_band` | `profit_neg010_pos080` | 3 | 3 | -0.4538 | `hold_sample` |
...
| `combo_exit_result` | `source=sim_post_sell_evaluation|rule=scalp_trailing_take_profit|outcome=GOOD_EXIT|profit=profit_pos080_pos150` | 3 | 3 | 0.134 | `hold_sample` |
| `exit_rule` | `scalp_preset_hard_stop_pct` | 2 | 2 | -1.8247 | `hold_sample` |
| `combo_exit_result` | `source=sim_post_sell_evaluation|rule=scalp_soft_stop_pct|outcome=MISSED_UPSIDE|profit=profit_lt_neg070` | 2 | 2 | -1.2235 | `hold_sample` |
| `profit_band` | `profit_pos150_pos300` | 1 | 1 | 1.2481 | `hold_sample` |
...
| `exit_outcome` | `outcome_not_applicable_context_noop` | 275 | 0 | None | `hold_sample` |
| `profit_band` | `profit_not_applicable_context_noop` | 275 | 0 | None | `hold_sample` |
| `exit_source_stage` | `scalp_sim_euphoria_context_noop` | 63 | 0 | None | `hold_sample` |
| `exit_rule` | `scalp_sim_euphoria_context_noop_not_applicable` | 63 | 0 | None | `hold_sample` |
| `exit_source_stage` | `scalp_sim_panic_context_warning` | 212 | 0 | None | `hold_sample` |
| `exit_rule` | `scalp_sim_panic_context_warning_not_applicable` | 212 | 0 | None | `hold_sample` |
...
- primary_decision_metric: `stage_ev_composite_pct`
- summary: `{'bucket_count': 284, 'complete_flow_count': 0, 'incomplete_flow_count': 0, 'runtime_candidate_count': 0, 'workorder_count': 0}`

| bucket_type | bucket_key | sample | joined | ev | avg_profit | win_rate | route |
| --- | --- | ---: | ---: | ---: | ---: | ---: | --- |
| `price_guard_reason` | `price_guard_none` | 1689 | 1686 | None | -1.074 | 0.0653 | `hold_sample` |
| `qty_reason` | `qty_none` | 1686 | 1686 | None | -1.074 | 0.0653 | `hold_sample` |
| `supply_pass_bucket` | `supply_pass_unknown` | 1689 | 1686 | None | -1.074 | 0.0653 | `hold_sample` |
| `time_bucket` | `time_unknown` | 1689 | 1686 | None | -1.074 | 0.0653 | `hold_sample` |
| `ai_score_band` | `score_lt60` | 1643 | 1643 | None | -1.1097 | 0.0481 | `hold_sample` |
| `arm` | `AVG_DOWN` | 1579 | 1576 | None | -1.1978 | 0.0 | `hold_sample` |
| `blocker_namespace` | `AVG_DOWN` | 1566 | 1563 | None | -1.1816 | 0.0 | `hold_sample` |
| `peak_profit_band` | `peak_lt_zero` | 1351 | 1351 | None | -1.2378 | 0.0 | `hold_sample` |
| `profit_band` | `profit_lt_neg070` | 1174 | 1174 | None | -1.4659 | 0.0 | `hold_sample` |
| `ai_score_source` | `live` | 944 | 944 | None | -1.0803 | 0.0826 | `hold_sample` |
| `held_bucket` | `held_600_1800s_plus` | 816 | 816 | None | -1.0165 | 0.1078 | `hold_sample` |
| `ai_score_source` | `neutral_unusable` | 553 | 553 | None | -1.1105 | 0.0416 | `hold_sample` |
| `held_bucket` | `held_600_1800s` | 499 | 499 | None | -1.2271 | 0.022 | `hold_sample` |
| `profit_band` | `profit_neg070_neg010` | 380 | 380 | None | -0.4354 | 0.0 | `hold_sample` |
| `peak_profit_band` | `peak_zero_pos080` | 294 | 294 | None | -0.6747 | 0.2381 | `hold_sample` |
| `held_bucket` | `held_180_600s` | 240 | 240 | None | -1.0998 | 0.0167 | `hold_sample` |
| `ai_score_source` | `score_field_backfilled` | 162 | 162 | None | -0.8616 | 0.0555 | `hold_sample` |
| `held_bucket` | `held_020_180s` | 126 | 126 | None | -0.8164 | 0.0556 | `hold_sample` |
| `arm` | `PYRAMID` | 110 | 110 | None | 0.6997 | 1.0 | `hold_sample` |
| `blocker_namespace` | `PYRAMID` | 110 | 110 | None | 0.6997 | 1.0 | `hold_sample` |
...
| bucket_type | bucket_key | sample | joined | ev | avg_profit | win_rate | route |
| --- | --- | ---: | ---: | ---: | ---: | ---: | --- |
| `overnight_action` | `SELL_TODAY` | 8 | 4 | -0.3675 | -0.49 | 0.0 | `hold_sample` |
| `overnight_status` | `SELL_TODAY` | 4 | 4 | -0.3675 | -0.49 | 0.0 | `hold_sample` |
| `confidence_band` | `confidence_070p` | 8 | 4 | -0.3675 | -0.49 | 0.0 | `hold_sample` |
| `stage` | `exit` | 4 | 4 | -0.3675 | -0.49 | 0.0 | `hold_sample` |
| `source_quality_gate` | `overnight_decision_coverage` | 8 | 4 | -0.3675 | -0.49 | 0.0 | `hold_sample` |
| `peak_profit_band` | `peak_lt_zero` | 8 | 4 | -0.3675 | -0.49 | 0.0 | `hold_sample` |
| `source_stage` | `scalp_sim_overnight_sell_today` | 4 | 4 | -0.3675 | -0.49 | 0.0 | `hold_sample` |

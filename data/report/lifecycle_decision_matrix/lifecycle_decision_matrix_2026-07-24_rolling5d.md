...
## Contract
- matrix_version: `lifecycle_decision_matrix_v1_2026-07-24_rolling5d`
...
| --- | ---: | ---: | ---: | ---: | --- | --- | --- |
| `entry` | 1113 | 6 | 0.3563 | 0.0124 | `pass` | `NO_CHANGE` | False |
| `submit` | 299 | 10 | 0.4295 | 0.0473 | `pass` | `NO_CHANGE` | False |
| `holding` | 41 | 10 | -0.55 | 0.2355 | `pass` | `NO_CHANGE` | False |
| `scale_in` | 561 | 561 | -0.548 | 0.9963 | `pass` | `NO_CHANGE` | False |
| `exit` | 89 | 38 | -0.7368 | 0.6159 | `pass` | `EXIT` | False |
...
- summary: `{'bucket_count': 75, 'complete_flow_count': 19, 'incomplete_flow_count': 1065, 'runtime_candidate_count': 0, 'workorder_count': 0}`

| lifecycle_flow_bucket_id | sample | joined | ev | route | source_quality |
| --- | ---: | ---: | ---: | --- | --- |
| `lifecycle_flow:combo_lifecycle_flow:entry_entry_missing_submit_submit_missing_holding_holdin:8cd4f96ab3` | 512 | 512 | -0.6619 | `candidate_tighten_or_exclude` | `hold_sample_or_incomplete_flow` |
...
| --- | --- | ---: | ---: | ---: | ---: | ---: | --- |
| `overbought_bucket` | `overbought_normal` | 182 | 6 | 0.3563 | -1.419 | 0.0 | `hold_sample` |
| `chosen_action` | `NO_BUY_AI` | 329 | 5 | 0.5119 | -1.482 | 0.0 | `source_quality_workorder` |
| `liquidity_bucket` | `liquidity_high` | 174 | 5 | 0.5119 | -1.482 | 0.0 | `hold_sample` |
| `source_stage` | `scalp_entry_action_decision_snapshot` | 991 | 5 | 0.5119 | -1.482 | 0.0 | `source_quality_workorder` |
| `exit_rule` | `scalp_preset_hard_stop_pct` | 5 | 5 | 0.5119 | -1.482 | 0.0 | `hold_sample` |
| `stale_bucket` | `stale_high` | 165 | 4 | 0.5305 | -1.4875 | 0.0 | `hold_sample` |
| `time_bucket` | `time_0900_1000` | 199 | 4 | 0.2325 | -1.386 | 0.0 | `source_quality_workorder` |
| `score_band` | `score_lt60` | 976 | 3 | 0.5467 | -1.4867 | 0.0 | `source_quality_workorder` |
| `strength_bucket` | `weak_strength_momentum` | 118 | 3 | 0.4318 | -1.4867 | 0.0 | `hold_sample` |
| `strength_bucket` | `neutral_strength_momentum` | 725 | 2 | 0.6321 | -1.475 | 0.0 | `hold_sample` |
...
| `time_bucket` | `time_1000_1200` | 361 | 2 | 0.6038 | -1.485 | 0.0 | `source_quality_workorder` |
| `chosen_action` | `WAIT_REQUOTE` | 650 | 1 | -0.422 | -1.1039 | 0.0 | `hold_sample` |
| `exit_rule` | `exit_unknown` | 1108 | 1 | -0.422 | -1.1039 | 0.0 | `source_quality_workorder` |
| `stale_bucket` | `fresh` | 80 | 1 | 0.4374 | -1.46 | 0.0 | `hold_sample` |
...
| --- | --- | ---: | ---: | ---: | --- |
| `actual_order_submitted` | `false` | 239 | 10 | 0.4295 | `keep_collecting` |
| `price_below_bid_bucket` | `not_below_bid` | 36 | 10 | 0.4295 | `keep_collecting` |
| `revalidation_state` | `ok_or_unflagged` | 269 | 10 | 0.4295 | `keep_collecting` |
...
| `broker_order_forbidden` | `true` | 239 | 10 | 0.4295 | `keep_collecting` |
...
| `quote_age_bucket` | `quote_age_unknown` | 224 | 6 | 0.4995 | `source_quality_workorder` |
...
| `would_limit_fill` | `false` | 280 | 3 | 0.4169 | `keep_collecting` |
...
| `quote_age_bucket` | `quote_age_1_3s` | 41 | 1 | 4.1198 | `keep_collecting` |
...
| `latency_state` | `danger` | 210 | 0 | None | `keep_collecting` |
...
| `profit_band` | `profit_neg070_neg010` | 5 | 0 | None | `hold_sample` |
...
| `profit_band` | `profit_neg070_neg010` | 10 | 10 | -0.3592 | `hold_sample` |
...
| `exit_rule` | `scalp_sim_overnight_sell_today` | 5 | 5 | -0.1725 | `hold_sample` |
| `exit_source_stage` | `scalp_sim_overnight_sell_today` | 5 | 5 | -0.1725 | `hold_sample` |
...
| bucket_type | bucket_key | sample | joined | ev | avg_profit | win_rate | route |
| --- | --- | ---: | ---: | ---: | ---: | ---: | --- |
| `price_guard_reason` | `price_guard_none` | 561 | 561 | None | -0.6364 | 0.0874 | `hold_sample` |
| `qty_reason` | `qty_none` | 561 | 561 | None | -0.6364 | 0.0874 | `hold_sample` |
| `time_bucket` | `time_unknown` | 561 | 561 | None | -0.6364 | 0.0874 | `hold_sample` |
| `ai_score_band` | `score_lt60` | 557 | 557 | None | -0.6365 | 0.0862 | `hold_sample` |
| `supply_pass_bucket` | `supply_pass_unknown` | 541 | 541 | None | -0.6393 | 0.0906 | `hold_sample` |
| `arm` | `AVG_DOWN` | 512 | 512 | None | -0.7559 | 0.0 | `hold_sample` |
| `blocker_namespace` | `AVG_DOWN` | 509 | 509 | None | -0.7406 | 0.0 | `hold_sample` |
...
| `profit_band` | `profit_lt_neg070` | 243 | 243 | None | -1.1246 | 0.0 | `hold_sample` |
| `held_bucket` | `held_600_1800s_plus` | 205 | 205 | None | -0.609 | 0.1268 | `hold_sample` |
| `ai_score_source` | `neutral_unusable` | 158 | 158 | None | -0.7498 | 0.0443 | `hold_sample` |
...
| `held_bucket` | `held_180_600s` | 110 | 110 | None | -0.6995 | 0.0636 | `hold_sample` |
...
| bucket_type | bucket_key | sample | joined | ev | avg_profit | win_rate | route |
| --- | --- | ---: | ---: | ---: | ---: | ---: | --- |
| `overnight_action` | `SELL_TODAY` | 10 | 5 | -0.1725 | -0.23 | 0.0 | `hold_sample` |
| `overnight_status` | `SELL_TODAY` | 5 | 5 | -0.1725 | -0.23 | 0.0 | `hold_sample` |
...
| `confidence_band` | `confidence_070p` | 10 | 5 | -0.1725 | -0.23 | 0.0 | `hold_sample` |
| `stage` | `exit` | 5 | 5 | -0.1725 | -0.23 | 0.0 | `hold_sample` |
| `source_quality_gate` | `overnight_decision_coverage` | 10 | 5 | -0.1725 | -0.23 | 0.0 | `hold_sample` |
| `peak_profit_band` | `peak_lt_zero` | 10 | 5 | -0.1725 | -0.23 | 0.0 | `hold_sample` |
| `profit_band` | `profit_neg070_neg010` | 10 | 5 | -0.1725 | -0.23 | 0.0 | `hold_sample` |
| `source_stage` | `scalp_sim_overnight_sell_today` | 5 | 5 | -0.1725 | -0.23 | 0.0 | `hold_sample` |

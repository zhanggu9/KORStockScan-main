...
## Contract
- matrix_version: `lifecycle_decision_matrix_v1_2026-07-30_rolling5d`
...
| --- | ---: | ---: | ---: | ---: | --- | --- | --- |
| `entry` | 307 | 5 | -0.2684 | 0.0119 | `pass` | `BUY_DEFENSIVE` | False |
| `submit` | 68 | 5 | -0.2684 | 0.0537 | `pass` | `ALLOW_SUBMIT` | False |
| `holding` | 10 | 5 | -0.5578 | 0.175 | `pass` | `EXIT` | False |
| `scale_in` | 157 | 156 | -0.2877 | 0.9737 | `pass` | `NO_CHANGE` | False |
| `exit` | 30 | 15 | -0.5626 | 0.2787 | `pass` | `EXIT` | False |
...
- summary: `{'bucket_count': 41, 'complete_flow_count': 6, 'incomplete_flow_count': 323, 'runtime_candidate_count': 0, 'workorder_count': 0}`

| lifecycle_flow_bucket_id | sample | joined | ev | route | source_quality |
| --- | ---: | ---: | ---: | --- | --- |
| `lifecycle_flow:combo_lifecycle_flow:entry_entry_missing_submit_submit_missing_holding_holdin:8cd4f96ab3` | 94 | 93 | -0.7581 | `candidate_tighten_or_exclude` | `hold_sample_or_incomplete_flow` |
| `lifecycle_flow:combo_lifecycle_flow:entry_entry_missing_submit_submit_missing_holding_holdin:7d607fe77a` | 63 | 63 | 0.4067 | `candidate_recovery_or_relax` | `hold_sample_or_incomplete_flow` |
...
| --- | --- | ---: | ---: | ---: | ---: | ---: | --- |
| `chosen_action` | `SKIP_PRE_SUBMIT_SAFETY` | 16 | 4 | -0.4224 | -1.0375 | 0.25 | `hold_sample` |
| `liquidity_bucket` | `liquidity_not_available` | 188 | 4 | -0.4224 | -1.0375 | 0.25 | `source_quality_workorder` |
| `overbought_bucket` | `overbought_not_available` | 174 | 4 | -0.4224 | -1.0375 | 0.25 | `source_quality_workorder` |
...
| `score_band` | `score_lt60` | 254 | 4 | -0.528 | -0.645 | 0.5 | `source_quality_workorder` |
| `stale_bucket` | `stale_not_available` | 63 | 4 | -0.4224 | -1.0375 | 0.25 | `source_quality_workorder` |
| `exit_rule` | `scalp_preset_hard_stop_pct` | 3 | 3 | -0.2022 | -1.44 | 0.0 | `hold_sample` |
| `time_bucket` | `time_1000_1200` | 85 | 3 | -0.2022 | -1.44 | 0.0 | `source_quality_workorder` |
...
| `time_bucket` | `time_0900_1000` | 101 | 2 | -0.3678 | 0.13 | 1.0 | `source_quality_workorder` |
| `chosen_action` | `NO_BUY_AI` | 141 | 1 | 0.3474 | 0.09 | 1.0 | `source_quality_workorder` |
| `stale_bucket` | `fresh` | 131 | 1 | 0.3474 | 0.09 | 1.0 | `hold_sample` |
| `liquidity_bucket` | `liquidity_high` | 99 | 1 | 0.3474 | 0.09 | 1.0 | `hold_sample` |
| `overbought_bucket` | `overbought_normal` | 65 | 1 | 0.3474 | 0.09 | 1.0 | `hold_sample` |
| `source_stage` | `scalp_entry_action_decision_snapshot` | 231 | 1 | 0.3474 | 0.09 | 1.0 | `source_quality_workorder` |
...
| `combo_entry_spot` | `score=score_lt60|source=scalp_entry_action_decision_snapshot|stale=fresh|liquidity=liquidity_high|overbought=overbought_normal|time=time_0900_1000` | 9 | 1 | 0.3474 | 0.09 | 1.0 | `hold_sample` |
| `combo_entry_spot` | `score=score_lt60|source=scalp_sim_entry_ai_price_skip_order|stale=stale_not_available|liquidity=liquidity_not_available|overbought=overbought_not_available|time=time_0900_1000` | 2 | 1 | -1.083 | 0.17 | 1.0 | `hold_sample` |
...
| --- | --- | ---: | ---: | ---: | --- |
| `actual_order_submitted` | `false` | 42 | 5 | -0.2684 | `keep_collecting` |
| `liquidity_bucket` | `liquidity_ok` | 6 | 5 | -0.2684 | `keep_collecting` |
| `price_below_bid_bucket` | `not_below_bid` | 5 | 5 | -0.2684 | `keep_collecting` |
| `revalidation_state` | `ok_or_unflagged` | 67 | 5 | -0.2684 | `keep_collecting` |
| `price_resolution_bucket` | `price_resolution_unknown` | 6 | 5 | -0.2684 | `source_quality_workorder` |
| `quote_age_bucket` | `quote_age_unknown` | 41 | 5 | -0.2684 | `source_quality_workorder` |
| `latency_reason` | `scalp_live_simulator` | 6 | 5 | -0.2684 | `keep_collecting` |
| `submit_source_stage` | `scalp_sim_buy_order_assumed_filled` | 6 | 5 | -0.2684 | `keep_collecting` |
| `pre_submit_refresh_age_bucket` | `sim_submit_path_not_applicable` | 6 | 5 | -0.2684 | `keep_collecting` |
| `pre_submit_refresh_applied` | `sim_submit_path_not_applicable` | 6 | 5 | -0.2684 | `keep_collecting` |
| `pre_submit_refresh_attempted` | `sim_submit_path_not_applicable` | 6 | 5 | -0.2684 | `keep_collecting` |
| `pre_submit_refresh_reason` | `sim_submit_path_not_applicable` | 6 | 5 | -0.2684 | `keep_collecting` |
| `pre_submit_refresh_source` | `sim_submit_path_not_applicable` | 6 | 5 | -0.2684 | `keep_collecting` |
| `quote_freshness_resolution_state` | `sim_submit_path_not_applicable` | 6 | 5 | -0.2684 | `keep_collecting` |
| `latency_state` | `simulated` | 6 | 5 | -0.2684 | `keep_collecting` |
| `broker_order_forbidden` | `true` | 42 | 5 | -0.2684 | `keep_collecting` |
| `liquidity_guard_action` | `would_pass` | 6 | 5 | -0.2684 | `keep_collecting` |
| `overbought_guard_action` | `would_pass` | 6 | 5 | -0.2684 | `keep_collecting` |
| `would_limit_fill` | `false` | 67 | 4 | -0.528 | `keep_collecting` |
| `overbought_bucket` | `overbought_context_missing` | 5 | 4 | -0.4224 | `keep_collecting` |
...
| `would_limit_fill` | `true` | 1 | 1 | 0.77 | `keep_collecting` |
| `price_below_bid_bucket` | `below_bid_20bps_plus` | 1 | 0 | None | `keep_collecting` |
| `latency_state` | `caution` | 21 | 0 | None | `keep_collecting` |
| `latency_reason` | `caution_normal_entry_allowed` | 21 | 0 | None | `keep_collecting` |
| `latency_state` | `danger` | 37 | 0 | None | `keep_collecting` |
| `price_resolution_bucket` | `defensive_limit` | 8 | 0 | None | `keep_collecting` |
| `submit_source_stage` | `entry_submit_revalidation_block` | 1 | 0 | None | `keep_collecting` |
| `broker_order_forbidden` | `false` | 26 | 0 | None | `keep_collecting` |
| `submit_source_stage` | `latency_block` | 35 | 0 | None | `keep_collecting` |
...
| bucket_type | bucket_key | sample | joined | ev | route |
| --- | --- | ---: | ---: | ---: | --- |
| `held_bucket` | `held_not_applicable_at_start` | 6 | 5 | -0.5578 | `candidate_tighten_or_exclude` |
| `holding_source_stage` | `scalp_sim_holding_started` | 6 | 5 | -0.5578 | `candidate_tighten_or_exclude` |
| `holding_action` | `WAIT` | 4 | 4 | -0.7489 | `candidate_tighten_or_exclude` |
| `profit_band` | `profit_lt_neg070` | 3 | 3 | -0.8378 | `hold_sample` |
| `combo_holding_flow` | `source=scalp_sim_holding_started|action=WAIT|profit=profit_lt_neg070|held=held_not_applicable_at_start` | 3 | 3 | -0.8378 | `hold_sample` |
...
| bucket_type | bucket_key | sample | joined | ev | route |
| --- | --- | ---: | ---: | ---: | --- |
| `profit_band` | `profit_lt_neg070` | 7 | 7 | -1.0476 | `candidate_tighten_or_exclude` |
...
| `exit_source_stage` | `sim_post_sell_evaluation` | 5 | 5 | -0.5578 | `candidate_tighten_or_exclude` |
...
| `exit_rule` | `scalp_preset_hard_stop_pct` | 3 | 3 | -0.8378 | `hold_sample` |
...
| `exit_outcome` | `outcome_not_applicable_context_noop` | 15 | 0 | None | `hold_sample` |
| `profit_band` | `profit_not_applicable_context_noop` | 15 | 0 | None | `hold_sample` |
...
| bucket_type | bucket_key | sample | joined | ev | avg_profit | win_rate | route |
| --- | --- | ---: | ---: | ---: | ---: | ---: | --- |
| `price_guard_reason` | `price_guard_none` | 157 | 156 | None | -0.3478 | 0.4038 | `hold_sample` |
| `qty_reason` | `qty_none` | 156 | 156 | None | -0.3478 | 0.4038 | `hold_sample` |
| `ai_score_band` | `score_lt60` | 156 | 156 | None | -0.3478 | 0.4038 | `hold_sample` |
| `time_bucket` | `time_unknown` | 157 | 156 | None | -0.3478 | 0.4038 | `hold_sample` |
| `supply_pass_bucket` | `supply_pass_unknown` | 110 | 109 | None | -0.1935 | 0.578 | `hold_sample` |
| `arm` | `AVG_DOWN` | 94 | 93 | None | -0.8357 | 0.0 | `hold_sample` |
| `blocker_namespace` | `AVG_DOWN` | 94 | 93 | None | -0.8357 | 0.0 | `hold_sample` |
| `ai_score_source` | `neutral_unusable` | 93 | 93 | None | -0.0917 | 0.6451 | `hold_sample` |
| `peak_profit_band` | `peak_zero_pos080` | 76 | 76 | None | 0.105 | 0.8289 | `hold_sample` |
| `arm` | `PYRAMID` | 63 | 63 | None | 0.3724 | 1.0 | `hold_sample` |
| `blocker_namespace` | `PYRAMID` | 63 | 63 | None | 0.3724 | 1.0 | `hold_sample` |
| `profit_band` | `profit_neg010_pos080` | 63 | 63 | None | 0.3724 | 1.0 | `hold_sample` |
| `blocker_reason` | `profit_not_enough` | 61 | 61 | None | 0.3711 | 1.0 | `hold_sample` |
| `held_bucket` | `held_180_600s` | 54 | 54 | None | -0.26 | 0.5185 | `hold_sample` |
| `ai_score_source` | `not_evaluated_no_ai_score_source` | 54 | 54 | None | -0.7376 | 0.037 | `hold_sample` |
| `profit_band` | `profit_lt_neg070` | 53 | 53 | None | -1.1628 | 0.0 | `hold_sample` |
| `peak_profit_band` | `peak_unknown` | 48 | 47 | None | -0.7058 | 0.0 | `hold_sample` |
| `profit_band` | `profit_neg070_neg010` | 40 | 40 | None | -0.4023 | 0.0 | `hold_sample` |
| `held_bucket` | `held_020_180s` | 39 | 39 | None | -0.7713 | 0.0256 | `hold_sample` |
| `held_bucket` | `held_600_1800s` | 39 | 39 | None | 0.2944 | 0.8718 | `hold_sample` |

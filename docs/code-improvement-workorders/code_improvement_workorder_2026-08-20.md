# Code Improvement Workorder - 2026-08-20
...
- pattern_lab_automation: `/home/ubuntu/KORStockScan/data/report/scalping_pattern_lab_automation/scalping_pattern_lab_automation_2026-08-20.json`
- swing_improvement_automation: `-`
- swing_pattern_lab_automation: `-`
- swing_strategy_discovery_ev: `-`
- swing_lifecycle_decision_matrix: `-`
- swing_lifecycle_bucket_discovery: `-`
- threshold_cycle_ev: `/home/ubuntu/KORStockScan/data/report/threshold_cycle_ev/threshold_cycle_ev_2026-08-20.json`
- lifecycle_decision_matrix: `/home/ubuntu/KORStockScan/data/report/lifecycle_decision_matrix/lifecycle_decision_matrix_2026-08-20.json`
- threshold_cycle_calibration: `/home/ubuntu/KORStockScan/data/report/threshold_cycle_calibration/threshold_cycle_calibration_2026-08-20_postclose.json`
- pipeline_event_verbosity: `/home/ubuntu/KORStockScan/data/report/pipeline_event_verbosity/pipeline_event_verbosity_2026-08-20.json`
- observation_source_quality_audit: `/home/ubuntu/KORStockScan/data/report/observation_source_quality_audit/observation_source_quality_audit_2026-08-20.json`
- ai_decision_action_outcome_calibration: `/home/ubuntu/KORStockScan/data/report/ai_decision_action_outcome_calibration/ai_decision_action_outcome_calibration_2026-08-20.json`
- codebase_performance_workorder: `-`
- pattern_lab_currentness_audit: `/home/ubuntu/KORStockScan/data/report/pattern_lab_currentness_audit/pattern_lab_currentness_audit_2026-08-20.json`
- pattern_lab_ai_review: `/home/ubuntu/KORStockScan/data/report/pattern_lab_ai_review/pattern_lab_ai_review_2026-08-20.json`
- producer_gap_discovery: `-`
- stage_hook_workorder_discovery: `-`
- stage_hook_runtime_scaffold: `-`
- buy_funnel_sentinel: `/home/ubuntu/KORStockScan/data/report/buy_funnel_sentinel/buy_funnel_sentinel_2026-08-20.json`
- microstructure_reaction_context: `/home/ubuntu/KORStockScan/data/report/microstructure_reaction_context/microstructure_reaction_context_2026-08-20.json`
- generated_at: `2026-08-20T21:29:08+09:00`
...
- selected_order_count: `61`
- non_selected_order_count: `17`
- operator_workload_summary: `{'implementation_required_count': 0, 'existing_family_attribution_count': 57, 'visibility_only_count': 4, 'other_selected_count': 0, 'root_cause_open_count': 6, 'selected_total_count': 61, 'category_count_reconciled': True, 'runtime_effect_true_count': 0}`
- source_decision_counts: `{'attach_existing_family': 73, 'design_family_candidate': 2, 'defer_evidence': 2, 'reject': 1}`
- selected_decision_counts: `{'attach_existing_family': 61}`
- selected_route_counts: `{'existing_family': 57, 'ai_review_coverage_review': 1, 'positive_source_only_review': 1, 'source_dimension_rollup': 1, 'join_gap_enrichment': 1}`
- selected_implement_now_route_count: `0`
- selected_runtime_effect_false_count: `61`
...
- root_cause_closure_status_counts: `{'handoff_closed_root_cause_open': 6, 'implementation_done': 1, 'root_cause_closed': 50}`
...
- non_selected_decision_counts: `{'attach_existing_family': 12, 'design_family_candidate': 2, 'defer_evidence': 2, 'reject': 1}`
...
- evidence: `ai_confirmed_unique=101`, `budget_pass_unique=133`, `latency_pass_unique=47`, `submitted_unique=14`, `submitted_to_ai_pct=13.9`, `submitted_to_budget_pct=10.5`, `blocker:blocked_strength_momentum:below_window_buy_value=571`, `blocker:blocked_strength_momentum:insufficient_history=554`, `blocker:latency_block:latency_state_danger=376`, `upstream:blocked_ai_score:ai_score_50_buy_hold_override=169`, `upstream:wait65_79_ev_candidate:score_70.0=49`, `upstream:blocked_ai_score:score_4.0=38`, `latency:latency_block:latency_state_danger=376`, `latency:latency_block:tp1_direct_recheck_expired=2`
- parity_contract: -
...
- implementation_provenance: `{"allowed_runtime_apply": false, "artifact_regeneration_required": false, "broker_order_submit_allowed": false, "forbidden_uses": ["intraday_threshold_mutation", "broker_guard_bypass", "provider_route_change", "bot_restart_trigger", "telegram_pre_submit_buy_alert"], "implementation_type": "source_only_report_provenance_handoff", "ldm_quote_freshness_attribution_present": true, "observation_axis_status": {"BROKER_RECEIPT": "no_current_signal", "BUDGET_PASS_COLLAPSE": "observed", "ECONOMIC_PARTICIPATION": "observed", "ENTRY_AI_AUTHORITY_REVALIDATION": "observed", "LATENCY_PRE_SUBMIT": "observed", "PRICE_REVALIDATION": "no_current_signal", "SIM_REAL_AUTHORITY": "observed", "SOURCE_TAXONOMY_LEAKAGE": "no_current_signal", "UPSTREAM_GATE": "observed"}, "observation_breakdown": {"allowed_runtime_apply": false, "axes": {"BROKER_RECEIPT": {"evidence": {"broker_submit_failure_unique": 0, "latency_pass_unique": 47, "order_bundle_submitted_unique": 14, "submitted_to_budget_unique_pct": 10.5}, "next_repair_action": "join post-submit broker receipt and fill provenance only when a broker submission or explicit submit failure exists", "observed_count": 0, "status": "no_current_signal"}, "BUDGET_PASS_COLLAPSE": {"evidence": {"ai_confirmed_unique": 101, "budget_ai_lineage": {"ai_attempt_result_unavailable_parent_not_expected_event_count": 9, "ai_trace_count": 362, "ai_trace_source_stage_counts": {"ai_confirmed": 327, "early_accel_strong_bundle_recheck_corrected": 11, "early_accel_strong_bundle_recheck_failed": 24}, "allowed_runtime_apply": false, "budget_or_block_event_count": 624, "exact_parent_trace_unresolved_event_count": 0, "lineage_contract_coverage_pct": 100.0, "lineage_contract_event_count": 624, "lineage_contract_missing_event_count": 0, "lineage_exact_trusted_count": 26, "lineage_field_present_count": 33, "lineage_join_coverage_denominator": "events_with_a_trusted_ai_result_expected; excludes_pre_ai_and_explicit_attempt_result_unavailable", "lineage_join_coverage_pct": 78.79, "lineage_join_eligible_event_count": 33, "lineage_joined_event_count": 26, "lineage_untrusted_or_stale_event_count": 7, "lineage_untrusted_or_stale_reason_counts": {"source_stale": 5, "trace_id_mismatch_and_source_stale": 2}, "linked_budget_block_trace_count": 1, "linked_budget_pass_trace_count": 21, "linked_stage_counts": {"blocked_zero_qty": 1, "budget_pass": 25}, "parent_attempt_without_trusted_result_event_count": 9, "parent_trace_missing_when_expected_event_count": 0, "parent_trace_missing_without_attempt_event_count": 0, "pipeline_stage_order_contract": "latest_watching_ai_to_budget_precheck_to_final_authority_revalidation", "pre_ai_parent_not_expected_event_count": 582, "raw_ai_budget_census_is_causal": false, "raw_event_lineage_join_coverage_pct": 4.17, "runtime_effect": false, "status": "explicit_ai_trace_budget_block_observed"}, "budget_pass_unique": 133, "budget_to_ai_unique_pct": 131.7, "legacy_stage_census_gap": 0, "legacy_stage_census_gap_is_causal": false}, "next_repair_action": "treat pre-AI budget events as expected no-parent observations; repair only missing lineage contracts or stale/untrusted post-AI parents, and keep causal EV attribution limited to exact joins", "observed_count": 1, "status": "observed"}, "ECONOMIC_PARTICIPATION": {"evidence": {"allowed_runtime_apply": false, "bundle_count": 9, "by_venue": {"KRX": {"bundle_count": 9, "full_submitted_bundle_count": 0, "partial_residual_bundle_count": 0, "probe_only_bundle_count": 9, "requested_notional_krw": 1089192, "requested_qty": 255, "submitted_notional_krw": 109048, "submitted_notional_to_requested_notional_pct": 10.0, "submitted_qty": 9, "submitted_qty_to_requested_qty_pct": 3.5}}, "decision_authority": "submit_drought_attribution_only", "forbidden_uses": ["broker_order_submit", "intraday_threshold_mutation", "quantity_cap_release", "live_auto_promotion", "bot_restart_trigger"], "full_submitted_bundle_count": 0, "metric_role": "funnel_count", "observed_bundle_count": 9, "partial_residual_bundle_count": 0, "primary_decision_metric": "submitted_notional_to_requested_notional_pct", "probe_only_bundle_count": 9, "requested_notional_krw": 1089192, "requested_qty": 255, "rows": [{"attempt_key": "id:33494", "bundle_state": "probe_only", "effective_venue": "KRX", "requested_notional_krw": 156900, "requested_qty": 10, "residual_submitted_qty": 0, "source_quality_valid": true, "stock_code": "006660", "submitted_notional_krw": 15670, "submitted_qty": 1, "venue_source_quality": "pass"}, {"attempt_key": "id:33629", "bundle_state": "probe_only", "effective_venue": "KRX", "requested_notional_krw": 169960, "requested_qty": 28, "residual_submitted_qty": 0, "source_quality_valid": true, "stock_code": "091590", "submitted_notional_krw": 6240, "submitted_qty": 1, "venue_source_quality": "pass"}, {"attempt_key": "id:33493", "bundle_state": "probe_only", "effective_venue": "KRX", "requested_notional_krw": 173052, "requested_qty": 92, "residual_submitted_qty": 0, "source_quality_valid": true, "stock_code": "299660", "submitted_notional_krw": 1883, "submitted_qty": 1, "venue_source_quality": "pass"}, {"attempt_key": "id:33703", "bundle_state": "probe_only", "effective_venue": "KRX", "requested_notional_krw": 173340, "requested_qty": 90, "residual_submitted_qty": 0, "source_quality_valid": true, "stock_code": "299660", "submitted_notional_krw": 1925, "submitted_qty": 1, "venue_source_quality": "pass"}, {"attempt_key": "id:33537", "bundle_state": "probe_only", "effective_venue": "KRX", "requested_notional_krw": 122320, "requested_qty": 8, "residual_submitted_qty": 0, "source_quality_valid": true, "stock_code": "002990", "submitted_notional_krw": 15310, "submitted_qty": 1, "venue_source_quality": "pass"}, {"attempt_key": "id:33470", "bundle_state": "probe_only", "effective_venue": "KRX", "requested_notional_krw": 77700, "requested_qty": 15, "residual_submitted_qty": 0, "source_quality_valid": true, "stock_code": "064260", "submitted_notional_krw": 5190, "submitted_qty": 1, "venue_source_quality": "pass"}, {"attempt_key": "id:33388", "bundle_state": "probe_only", "effective_venue": "KRX", "requested_notional_krw": 61100, "requested_qty": 2, "residual_submitted_qty": 0, "source_quality_valid": true, "stock_code": "124500", "submitted_notional_krw": 30650, "submitted_qty": 1, "venue_source_quality": "pass"}, {"attempt_key": "id:33389", "bundle_state": "probe_only", "effective_venue": "KRX", "requested_notional_krw": 75800, "requested_qty": 4, "residual_submitted_qty": 0, "source_quality_valid": true, "stock_code": "138610", "submitted_notional_krw": 18980, "submitted_qty": 1, "venue_source_quality": "pass"}, {"attempt_key": "id:33766", "bundle_state": "probe_only", "effective_venue": "KRX", "requested_notional_krw": 79020, "requested_qty": 6, "residual_submitted_qty": 0, "source_quality_valid": true, "stock_code": "387690", "submitted_notional_krw": 13200, "submitted_qty": 1, "venue_source_quality": "pass"}], "runtime_effect": false, "sample_floor": "1_explicit_venue_probe_bundle", "source_quality_blocked_bundle_count": 0, "source_quality_gate": "explicit_conflict_free_venue_and_positive_requested_submitted_qty_price", "source_quality_valid_bundle_count": 9, "submitted_notional_krw": 109048, "submitted_notional_to_requested_notional_pct": 10.0, "submitted_qty": 9, "submitted_qty_to_requested_qty_pct": 3.5, "window_policy": "same_session_probe_bundle_lifecycle"}, "next_repair_action": "attribute probe-only and residual-submitted quantity/notional by explicit venue before interpreting submit conversion", "observed_count": 9, "status": "observed"}, "ENTRY_AI_AUTHORITY_REVALIDATION": {"evidence": {"entry_ai_authority_guard_events": 51, "entry_ai_authority_guard_top": [{"count": 27, "label": "pre_submit_entry_ai_authority_guard_block:fresh_ai_drop_real_buy_veto"}, {"count": 15, "label": "pre_submit_entry_ai_authority_guard_block:fresh_ai_wait_observation_only_probe_veto"}, {"count": 9, "label": "pre_submit_entry_ai_authority_guard_block:entry_ai_result_stale_or_untrusted"}], "entry_ai_authority_guard_unique": 31, "latency_pass_unique": 47, "order_bundle_submitted_unique": 14}, "next_repair_action": "join exact AI authority reason, executable BBO, and target/adverse first-hit outcomes before proposing a bounded one-share probe", "observed_count": 31, "status": "observed"}, "LATENCY_PRE_SUBMIT": {"evidence": {"latency_blocker_top": [{"count": 376, "label": "latency_block:latency_state_danger"}, {"count": 2, "label": "latency_block:tp1_direct_recheck_expired"}], "latency_root_cause_counts": {"observer_unhealthy": 1, "quote_freshness_input_snapshot_noop": 227, "quote_stale": 191, "spread_microstructure_guard": 378, "spread_or_slippage_guard": 250}, "quote_freshness_attribution": {"decision_authority": "submit_drought_quote_freshness_attribution_only", "forbidden_uses": ["broker_order_submit", "adm_ldm_training_input", "general_threshold_ev_input", "live_auto_promotion"], "latency_pass_recovered_count": 16, "latency_pass_recovered_downstream_counts": {"budget_pass_no_submit_event": 4, "entry_ai_authority_revalidation": 9, "no_downstream_event": 1, "order_bundle_submitted": 2}, "latency_pass_recovered_downstream_stage_counts": {"budget_pass": 4, "order_bundle_submitted": 2, "pre_submit_entry_ai_authority_guard_block": 9}, "order_bundle_submitted_after_refresh_count": 2, "post_restart_window_policy": "event_provenance_only", "refresh_applied_count": 71, "refresh_attempted_count": 121, "refresh_block_subreason_counts": {"observer_quote_refresh_failed_stale": 1, "ws_snapshot_refresh_failed_input_snapshot_fresh": 227, "ws_snapshot_refresh_failed_invalid": 1, "ws_snapshot_refresh_failed_stale": 15}, "refresh_subreason_counts": {"observer_quote_refresh_failed_stale": 1, "ws_snapshot_refresh_failed_input_snapshot_fresh": 227, "ws_snapshot_refresh_failed_invalid": 1, "ws_snapshot_refresh_failed_stale": 15}, "runtime_effect": false, "still_latency_blocked_after_refresh_count": 88}, "unknown_latency_reason_count": 0, "unknown_latency_workorder_required": false}, "next_repair_action": "close unknown latency labels or route quote freshness gaps to LDM attribution", "observed_count": 378, "status": "observed"}, "PRICE_REVALIDATION": {"evidence": {"latency_pass_unique": 47, "order_bundle_submitted_unique": 14, "price_guard_events": 4, "price_guard_top": [{"count": 2, "label": "entry_ai_price_canary_fallback:pre_submit_price_guard"}, {"count": 1, "label": "entry_ai_price_canary_fallback:skip_low_confidence"}, {"count": 1, "label": "entry_ai_price_canary_skip_order:orderbook_micro is ready and micro_state is bearish, indicating unfavorable fill probability"}], "price_guard_unique": 4}, "next_repair_action": "join executable BBO and target/adverse first-hit outcomes to price revalidation blocks before proposing bounded exploration", "observed_count": 4, "status": "no_current_signal"}, "SIM_REAL_AUTHORITY": {"evidence": {"actual_order_submitted_authority": "not_granted_by_report", "broker_order_submit_allowed": false}, "next_repair_action": "keep attribution source-only until explicit runtime approval artifact exists", "observed_count": 1, "status": "observed"}, "SOURCE_TAXONOMY_LEAKAGE": {"evidence": {"blocker_top": [{"count": 571, "label": "blocked_strength_momentum:below_window_buy_value"}, {"count": 554, "label": "blocked_strength_momentum:insufficient_history"}, {"count": 376, "label": "latency_block:latency_state_danger"}, {"count": 315, "label": "blocked_overbought:-"}, {"count": 188, "label": "blocked_strength_momentum:below_strength_base"}, {"count": 169, "label": "blocked_ai_score:ai_score_50_buy_hold_override"}, {"count": 166, "label": "blocked_liquidity:-"}, {"count": 155, "label": "blocked_vpw:-"}, {"count": 64, "label": "blocked_zero_qty:-"}, {"count": 49, "label": "wait65_79_ev_candidate:score_70.0"}], "taxonomy_leakage_labels": []}, "next_repair_action": "separate swing/source taxonomy from entry-submit blocker labels", "observed_count": 0, "status": "no_current_signal"}, "UPSTREAM_GATE": {"evidence": {"ai_action_event_counts": {"DROP": 174, "NOT_EVALUATED": 1, "WAIT": 152}, "ai_action_unique_counts": {"DROP": 174, "NOT_EVALUATED": 1, "WAIT": 152}, "ai_terminal_reason_top": [{"count": 163, "label": "ai_terminal:entry_policy_no_buy_score_prior"}, {"count": 27, "label": "ai_terminal:first_ai_wait_big_bite_not_confirmed"}], "budget_to_ai_unique_pct": 131.7, "upstream_blocker_top": [{"count": 169, "label": "blocked_ai_score:ai_score_50_buy_hold_override"}, {"count": 49, "label": "wait65_79_ev_candidate:score_70.0"}, {"count": 38, "label": "blocked_ai_score:score_4.0"}, {"count": 37, "label": "blocked_ai_score:score_70.0"}, {"count": 27, "label": "first_ai_wait:-"}, {"count": 19, "label": "blocked_ai_score:score_7.0"}, {"count": 19, "label": "blocked_ai_score:score_0.0"}, {"count": 12, "label": "blocked_ai_score:score_6.0"}, {"count": 10, "label": "blocked_ai_score:score_11.0"}, {"count": 8, "label": "blocked_ai_score:score_3.0"}]}, "next_repair_action": "join upstream action/reason cohorts to executable BBO and first-hit outcomes; AI semantic tuning remains separately owned", "observed_count": 284, "status": "observed"}}, "axis_order": ["UPSTREAM_GATE", "BUDGET_PASS_COLLAPSE", "LATENCY_PRE_SUBMIT", "PRICE_REVALIDATION", "ENTRY_AI_AUTHORITY_REVALIDATION", "BROKER_RECEIPT", "ECONOMIC_PARTICIPATION", "SIM_REAL_AUTHORITY", "SOURCE_TAXONOMY_LEAKAGE"], "broker_order_submit_allowed": false, "causal_bottleneck_axes": ["UPSTREAM_GATE", "BUDGET_PASS_COLLAPSE", "LATENCY_PRE_SUBMIT", "ENTRY_AI_AUTHORITY_REVALIDATION", "ECONOMIC_PARTICIPATION"], "decision_authority": "submit_drought_attribution_only", "forbidden_uses": ["broker_order_submit", "runtime_apply_candidate", "intraday_threshold_mutation", "provider_route_change", "bot_restart_trigger", "live_auto_promotion"], "metric_role": "funnel_count", "no_current_signal_axes": ["PRICE_REVALIDATION", "BROKER_RECEIPT", "SOURCE_TAXONOMY_LEAKAGE"], "observation_only_axes": ["SIM_REAL_AUTHORITY"], "primary_decision_metric": "causal_bottleneck_axis_observed_count", "runtime_effect": false, "sample_floor": "one_explicit_attempt_per_axis", "source_quality_gate": "lossless_attempt_key_and_explicit_stage_provenance", "window_policy": "same_session_unique_attempt_submit_funnel"}, "quote_freshness_attribution_inconsistent": false, "quote_freshness_latency_pass_recovered_count": 16, "quote_freshness_refresh_applied_count": 71, "quote_freshness_refresh_attempted_count": 121, "required_downstream": ["code_improvement_workorder", "lifecycle_decision_matrix.submit_bucket_attribution", "threshold_cycle_ev_report", "runtime_approval_summary", "postclose_verifier"], "root_cause_closure_status_hint": "root_cause_closed", "root_cause_counts": {"observer_unhealthy": 1, "quote_freshness_input_snapshot_noop": 227, "quote_stale": 191, "spread_microstructure_guard": 378, "spread_or_slippage_guard": 250}, "root_cause_signal": "SUBMIT_DROUGHT_CRITICAL", "runtime_effect": false, "source_report_type": "buy_funnel_sentinel", "weak_contract_matches": ["BROKER_RECEIPT", "BUDGET_PASS_COLLAPSE", "ECONOMIC_PARTICIPATION", "ENTRY_AI_AUTHORITY_REVALIDATION", "FILL_QUALITY", "LATENCY_PRE_SUBMIT", "SIM_REAL_AUTHORITY", "TELEGRAM_POST_SUBMIT_ONLY", "UPSTREAM_GATE"]}`
...
- evidence: `ai_confirmed_unique=101`, `budget_pass_unique=133`, `latency_pass_unique=47`, `submitted_unique=14`, `submitted_to_ai_pct=13.9`, `submitted_to_budget_pct=10.5`, `blocker:blocked_strength_momentum:below_window_buy_value=571`, `blocker:blocked_strength_momentum:insufficient_history=554`, `blocker:latency_block:latency_state_danger=376`, `upstream:blocked_ai_score:ai_score_50_buy_hold_override=169`, `upstream:wait65_79_ev_candidate:score_70.0=49`, `upstream:blocked_ai_score:score_4.0=38`, `latency:latency_block:latency_state_danger=376`, `latency:latency_block:tp1_direct_recheck_expired=2`, `weak_contract_gap=broker_receipt_contract_gap`, `runtime_effect=false`, `allowed_runtime_apply=false`
- parity_contract: -
...
- tuning_axis_effect: `True`
- expected_ev_effect: none_direct_source_quality_only
- evidence: `ai_confirmed_unique=101`, `budget_pass_unique=133`, `latency_pass_unique=47`, `submitted_unique=14`, `submitted_to_ai_pct=13.9`, `submitted_to_budget_pct=10.5`, `blocker:blocked_strength_momentum:below_window_buy_value=571`, `blocker:blocked_strength_momentum:insufficient_history=554`, `blocker:latency_block:latency_state_danger=376`, `upstream:blocked_ai_score:ai_score_50_buy_hold_override=169`, `upstream:wait65_79_ev_candidate:score_70.0=49`, `upstream:blocked_ai_score:score_4.0=38`, `latency:latency_block:latency_state_danger=376`, `latency:latency_block:tp1_direct_recheck_expired=2`, `weak_contract_gap=fill_quality_contract_gap`, `runtime_effect=false`, `allowed_runtime_apply=false`
- parity_contract: -
- next_postclose_metric: Entry post-submit weak contracts remain source-only workorders with runtime_effect=false and allowed_runtime_apply=false until explicit implementation and verification.
- files_likely_touched: `src/engine/buy_funnel_sentinel.py`, `src/engine/lifecycle_decision_matrix.py`, `src/engine/build_code_improvement_workorder.py`, `src/engine/verify_threshold_cycle_postclose_chain.py`
- acceptance_tests: `PYTHONPATH=. .venv/bin/python -m pytest -q src/tests/test_buy_funnel_sentinel.py src/tests/test_build_code_improvement_workorder.py src/tests/test_verify_threshold_cycle_postclose_chain.py`
...
- tuning_axis_effect: `True`
- expected_ev_effect: none_direct_source_quality_only
- evidence: `ai_confirmed_unique=101`, `budget_pass_unique=133`, `latency_pass_unique=47`, `submitted_unique=14`, `submitted_to_ai_pct=13.9`, `submitted_to_budget_pct=10.5`, `blocker:blocked_strength_momentum:below_window_buy_value=571`, `blocker:blocked_strength_momentum:insufficient_history=554`, `blocker:latency_block:latency_state_danger=376`, `upstream:blocked_ai_score:ai_score_50_buy_hold_override=169`, `upstream:wait65_79_ev_candidate:score_70.0=49`, `upstream:blocked_ai_score:score_4.0=38`, `latency:latency_block:latency_state_danger=376`, `latency:latency_block:tp1_direct_recheck_expired=2`, `weak_contract_gap=post_submit_contract_gap`, `runtime_effect=false`, `allowed_runtime_apply=false`
- parity_contract: -
- next_postclose_metric: Entry post-submit weak contracts remain source-only workorders with runtime_effect=false and allowed_runtime_apply=false until explicit implementation and verification.
- files_likely_touched: `src/engine/buy_funnel_sentinel.py`, `src/engine/lifecycle_decision_matrix.py`, `src/engine/build_code_improvement_workorder.py`, `src/engine/verify_threshold_cycle_postclose_chain.py`
- acceptance_tests: `PYTHONPATH=. .venv/bin/python -m pytest -q src/tests/test_buy_funnel_sentinel.py src/tests/test_build_code_improvement_workorder.py src/tests/test_verify_threshold_cycle_postclose_chain.py`
...
- tuning_axis_effect: `True`
- expected_ev_effect: none_direct_source_quality_only
- evidence: `ai_confirmed_unique=101`, `budget_pass_unique=133`, `latency_pass_unique=47`, `submitted_unique=14`, `submitted_to_ai_pct=13.9`, `submitted_to_budget_pct=10.5`, `blocker:blocked_strength_momentum:below_window_buy_value=571`, `blocker:blocked_strength_momentum:insufficient_history=554`, `blocker:latency_block:latency_state_danger=376`, `upstream:blocked_ai_score:ai_score_50_buy_hold_override=169`, `upstream:wait65_79_ev_candidate:score_70.0=49`, `upstream:blocked_ai_score:score_4.0=38`, `latency:latency_block:latency_state_danger=376`, `latency:latency_block:tp1_direct_recheck_expired=2`, `weak_contract_gap=source_taxonomy_contract_gap`, `runtime_effect=false`, `allowed_runtime_apply=false`, `taxonomy_leakage_labels=[]`
- parity_contract: -
- next_postclose_metric: Entry post-submit weak contracts remain source-only workorders with runtime_effect=false and allowed_runtime_apply=false until explicit implementation and verification.
- files_likely_touched: `src/engine/buy_funnel_sentinel.py`, `src/engine/lifecycle_decision_matrix.py`, `src/engine/build_code_improvement_workorder.py`, `src/engine/verify_threshold_cycle_postclose_chain.py`
- acceptance_tests: `PYTHONPATH=. .venv/bin/python -m pytest -q src/tests/test_buy_funnel_sentinel.py src/tests/test_build_code_improvement_workorder.py src/tests/test_verify_threshold_cycle_postclose_chain.py`
...
- tuning_axis_effect: `True`
- expected_ev_effect: none_direct_source_quality_only
- evidence: `ai_confirmed_unique=101`, `budget_pass_unique=133`, `latency_pass_unique=47`, `submitted_unique=14`, `submitted_to_ai_pct=13.9`, `submitted_to_budget_pct=10.5`, `blocker:blocked_strength_momentum:below_window_buy_value=571`, `blocker:blocked_strength_momentum:insufficient_history=554`, `blocker:latency_block:latency_state_danger=376`, `upstream:blocked_ai_score:ai_score_50_buy_hold_override=169`, `upstream:wait65_79_ev_candidate:score_70.0=49`, `upstream:blocked_ai_score:score_4.0=38`, `latency:latency_block:latency_state_danger=376`, `latency:latency_block:tp1_direct_recheck_expired=2`, `weak_contract_gap=telegram_post_submit_contract_gap`, `runtime_effect=false`, `allowed_runtime_apply=false`
- parity_contract: -
- next_postclose_metric: Entry post-submit weak contracts remain source-only workorders with runtime_effect=false and allowed_runtime_apply=false until explicit implementation and verification.
- files_likely_touched: `src/engine/buy_funnel_sentinel.py`, `src/engine/lifecycle_decision_matrix.py`, `src/engine/build_code_improvement_workorder.py`, `src/engine/verify_threshold_cycle_postclose_chain.py`
- acceptance_tests: `PYTHONPATH=. .venv/bin/python -m pytest -q src/tests/test_buy_funnel_sentinel.py src/tests/test_build_code_improvement_workorder.py src/tests/test_verify_threshold_cycle_postclose_chain.py`
...
### 13. `order_lifecycle_flow_bucket_lifecycle_flow_bucket_incomplete_14_lifecycle_flow_combo_lifecycle_flow_entry_entry_combo_entry_spot_score_18fcaa75`

- title: LDM lifecycle flow bucket follow-up: lifecycle_flow:combo_lifecycle_flow:entry_entry_combo_entry_spot_score_score_lt60_source_sca:6980162032
- decision: `attach_existing_family`
- decision_reason: instrumentation/report/provenance implementation status is implemented; keep the order as existing-family source evidence instead of re-implementing
- source_report_type: `lifecycle_decision_matrix_lifecycle_flow_bucket_attribution`
- lifecycle_stage: `lifecycle_flow`
...
### 14. `order_lifecycle_flow_bucket_lifecycle_flow_bucket_incomplete_15_lifecycle_flow_combo_lifecycle_flow_entry_entry_combo_entry_spot_score_f12338ed`
...
- implementation_status: `implemented`
- root_cause_closure_status: `root_cause_closed`
- implementation_provenance: `{"recommended_resolution": "entry_label_not_applicable", "source_field_coverage": {"exit_rule": {"coverage_rate": 0.0, "present_count": 0, "sample_count": 726, "source_fields": ["labels.exit_rule"]}}, "unknown_dimension_counts": {"exit_rule": 1}, "unknown_reason_counts": {"entry_label_not_applicable": 1}}`
- repeat_unresolved_escalation: `-`
...
### 33. `order_lifecycle_exit_bucket_exit_rule_scalp_preset_hard_stop_pct`
...
### 34. `order_lifecycle_exit_bucket_exit_source_stage_sim_post_sell_evaluation`
...
### 35. `order_lifecycle_exit_bucket_profit_band_profit_lt_neg070`
...
### 39. `order_lifecycle_holding_bucket_held_bucket_held_not_applicable_at_start`
...
### 40. `order_lifecycle_holding_bucket_holding_action_holding_action_not_applicable_at_start`
...
### 43. `order_lifecycle_holding_bucket_profit_band_profit_lt_neg070`
...
### 44. `order_lifecycle_holding_bucket_profit_band_profit_neg010_pos080`
...
- evidence: `quiet_gap_count=293`, `rollup_required_count=293`, `sim_live_connected_quiet_gap_count=0`, `quiet_gap_type_counts={'positive_source_only_keep_collecting': 292, 'ai_review_parsed_low_coverage': 1}`, `ai_review_coverage={'status': 'parsed', 'shard_count': 5, 'parsed_shard_count': 2, 'reviewed_candidate_count': 2, 'low_coverage': True}`, `runtime_effect=false`, `allowed_runtime_apply=false`
- parity_contract: -
...
- evidence: `rollup_only_gap_count=33`, `unknown_source_dimensions=2`, `recommended_resolution_counts={'explicit_lifecycle_flow_source_only_blocker': 30, 'entry_label_not_applicable': 1, 'join_labels_before_bucket_decision': 1, 'source_quality_blocked_missing_runtime_features_ai_score': 1}`, `missing_dimension_key_counts={'entry': 8, 'exit': 56, 'holding': 54, 'submit': 30}`, `runtime_effect=false`, `allowed_runtime_apply=false`
- parity_contract: -
...
### 50. `order_conversion_lane_submit_drought_submit_drought_budget_pass_collapse`
...
### 51. `order_lifecycle_entry_bucket_chosen_action_skip_pre_submit_safety`
...
### 52. `order_lifecycle_entry_bucket_combo_entry_spot_score_score_lt60_source_scalp_entry_action_decision_snapshot_stale_stal_26669969`
...
### 53. `order_lifecycle_entry_bucket_combo_entry_spot_score_score_lt60_source_scalp_entry_action_decision_snapshot_stale_stal_3da5a749`
...
### 54. `order_lifecycle_entry_bucket_combo_entry_spot_score_score_lt60_source_scalp_entry_action_decision_snapshot_stale_stal_db7776dc`
...
### 55. `order_lifecycle_entry_bucket_combo_entry_spot_score_score_lt60_source_scalp_entry_action_decision_snapshot_stale_stal_de8ea321`
...
### 56. `order_lifecycle_entry_bucket_liquidity_bucket_liquidity_not_available`
...
### 57. `order_lifecycle_entry_bucket_overbought_bucket_overbought_not_available`
...
### 58. `order_lifecycle_entry_bucket_score_band_score_lt60`
...
### 59. `order_lifecycle_entry_bucket_source_stage_scalp_entry_action_decision_snapshot`
...
### 60. `order_conversion_lane_env_mapping_lifecycle_flow_combo_lifecycle_flow_entry_entry_combo_entry_6b8d2a8c`
...
### 61. `order_conversion_lane_env_mapping_lifecycle_flow_combo_lifecycle_flow_entry_entry_combo_entry_f146d89d`

- title: Conversion lane blocker follow-up: env_mapping lifecycle_flow:combo_lifecycle_flow:entry_entry_combo_entry_spot_score_score_70p_source_blocked_ai_score_stale_fresh_liquidity_liqui
- decision: `attach_existing_family`
- decision_reason: instrumentation/report/provenance implementation status is implemented; keep the order as existing-family source evidence instead of re-implementing
- source_report_type: `conversion_lane`
- lifecycle_stage: `conversion`
...
### N10. `order_partial_only_표류_전용_timeout_report_only`
...
### N11. `order_split_entry_rebase_수량_정합성_report_only_감사`
...
### N12. `order_동일_종목_split_entry_soft_stop_재진입_cooldown_report_only`
...
### N15. `order_ai_threshold_dominance`
...
### N16. `order_scalp_entry_adm_daily_tuning_coverage`
...
### N17. `order_partial_fallback_확대_직후_즉시_재평가_report_only`
...
- 구현 결과는 `2026-08-21` 이후 postclose `threshold_cycle`, `scalping_pattern_lab_automation`, `threshold_cycle_ev`가 자동으로 다시 읽는다.

# Intraday WS Freshness Postclose Workorder - 2026-07-27
...
- evidence: `['decision_stage_stale_backoff_count=64050']`
- files_likely_touched: `['src/engine/kiwoom_websocket.py', 'src/engine/sniper.py', 'src/engine/monitoring/intraday_ws_freshness_monitor.py', 'src/tests/test_intraday_ws_freshness_monitor.py']`
...
- evidence: `['both_ws_stale_count=1524']`
...
- evidence: `['pipeline_trade_tick_quiet_count=5161', 'fresh_0d_stale_0b_count=5159', 'snapshot_trade_tick_quiet_count=0']`

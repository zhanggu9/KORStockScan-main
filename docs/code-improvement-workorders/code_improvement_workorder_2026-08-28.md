# Code Improvement Workorder - 2026-08-28
...
- pattern_lab_automation: `/home/ubuntu/KORStockScan/data/report/scalping_pattern_lab_automation/scalping_pattern_lab_automation_2026-08-28.json`
- swing_improvement_automation: `-`
- swing_pattern_lab_automation: `-`
- swing_strategy_discovery_ev: `-`
- swing_lifecycle_decision_matrix: `-`
- swing_lifecycle_bucket_discovery: `-`
- threshold_cycle_ev: `/home/ubuntu/KORStockScan/data/report/threshold_cycle_ev/threshold_cycle_ev_2026-08-28.json`
- lifecycle_decision_matrix: `/home/ubuntu/KORStockScan/data/report/lifecycle_decision_matrix/lifecycle_decision_matrix_2026-08-28.json`
- threshold_cycle_calibration: `/home/ubuntu/KORStockScan/data/report/threshold_cycle_calibration/threshold_cycle_calibration_2026-08-28_postclose.json`
- pipeline_event_verbosity: `/home/ubuntu/KORStockScan/data/report/pipeline_event_verbosity/pipeline_event_verbosity_2026-08-28.json`
- observation_source_quality_audit: `/home/ubuntu/KORStockScan/data/report/observation_source_quality_audit/observation_source_quality_audit_2026-08-28.json`
- ai_decision_action_outcome_calibration: `/home/ubuntu/KORStockScan/data/report/ai_decision_action_outcome_calibration/ai_decision_action_outcome_calibration_2026-08-28.json`
- codebase_performance_workorder: `-`
- pattern_lab_currentness_audit: `/home/ubuntu/KORStockScan/data/report/pattern_lab_currentness_audit/pattern_lab_currentness_audit_2026-08-28.json`
- pattern_lab_ai_review: `/home/ubuntu/KORStockScan/data/report/pattern_lab_ai_review/pattern_lab_ai_review_2026-08-28.json`
- producer_gap_discovery: `-`
- stage_hook_workorder_discovery: `-`
- stage_hook_runtime_scaffold: `-`
- buy_funnel_sentinel: `/home/ubuntu/KORStockScan/data/report/buy_funnel_sentinel/buy_funnel_sentinel_2026-08-28.json`
- microstructure_reaction_context: `/home/ubuntu/KORStockScan/data/report/microstructure_reaction_context/microstructure_reaction_context_2026-08-28.json`
- generated_at: `2026-08-28T22:25:44+09:00`
- generation_id: `2026-08-28-632772bff0e4`
- source_hash: `632772bff0e4c4392792a55f0d57bfa7e33395e60509dcd22b11e84566cb413e`
...
- previous_generation_id: `2026-08-28-5f77f1d9fcf5`
- previous_source_hash: `5f77f1d9fcf5ff552bc5701541a8faf494518b8c0207a615b3d47a64b081aa12`
- new_order_ids: `[]`
- removed_order_ids: `[]`
...
- operator_workload_summary: `{'implementation_required_count': 0, 'existing_family_attribution_count': 46, 'visibility_only_count': 3, 'other_selected_count': 0, 'root_cause_open_count': 4, 'selected_total_count': 49, 'category_count_reconciled': True, 'runtime_effect_true_count': 0}`
...
- root_cause_closure_status_counts: `{'handoff_closed_root_cause_open': 4, 'implementation_done': 1, 'root_cause_closed': 41}`
...
- evidence: `ai_confirmed_unique=77`, `budget_pass_unique=79`, `latency_pass_unique=37`, `submitted_unique=5`, `submitted_to_ai_pct=6.5`, `submitted_to_budget_pct=6.3`, `blocker:blocked_strength_momentum:below_window_buy_value=395`, `blocker:latency_block:latency_state_danger=274`, `blocker:blocked_overbought:-=243`, `upstream:blocked_ai_score:ai_score_50_buy_hold_override=100`, `upstream:first_ai_wait:-=43`, `upstream:blocked_ai_score:score_0.0=27`, `latency:latency_block:latency_state_danger=274`, `latency:latency_block:tp1_direct_recheck_expired=4`
- parity_contract: -
...
- implementation_provenance: `{"allowed_runtime_apply": false, "artifact_regeneration_required": false, "broker_order_submit_allowed": false, "forbidden_uses": ["intraday_threshold_mutation", "broker_guard_bypass", "provider_route_change", "bot_restart_trigger", "telegram_pre_submit_buy_alert"], "implementation_type": "source_only_report_provenance_handoff", "ldm_quote_freshness_attribution_present": true, "observation_axis_status": {"BROKER_RECEIPT": "no_current_signal", "BUDGET_PASS_COLLAPSE": "observation_only", "ECONOMIC_PARTICIPATION": "observed", "ENTRY_AI_AUTHORITY_REVALIDATION": "observed", "LATENCY_PRE_SUBMIT": "observed", "PRICE_REVALIDATION": "no_current_signal", "SIM_REAL_AUTHORITY": "observed", "SOURCE_TAXONOMY_LEAKAGE": "no_current_signal", "UPSTREAM_GATE": "observed"}, "observation_breakdown": {"allowed_runtime_apply": false, "axes": {"BROKER_RECEIPT": {"evidence": {"broker_submit_failure_unique": 0, "latency_pass_unique": 37, "order_bundle_submitted_unique": 5, "submitted_to_budget_unique_pct": 6.3}, "next_repair_action": "join post-submit broker receipt and fill provenance only when a broker submission or explicit submit failure exists", "observed_count": 0, "status": "no_current_signal"}, "BUDGET_PASS_COLLAPSE": {"evidence": {"ai_confirmed_unique": 77, "budget_ai_lineage": {"ai_attempt_result_unavailable_parent_not_expected_event_count": 13, "ai_trace_count": 295, "ai_trace_source_stage_counts": {"ai_confirmed": 273, "early_accel_strong_bundle_recheck_corrected": 9, "early_accel_strong_bundle_recheck_failed": 13}, "allowed_runtime_apply": false, "budget_or_block_event_count": 673, "exact_parent_trace_unresolved_event_count": 0, "lineage_contract_coverage_pct": 100.0, "lineage_contract_event_count": 673, "lineage_contract_missing_event_count": 0, "lineage_exact_trusted_count": 75, "lineage_field_present_count": 98, "lineage_join_coverage_denominator": "events_with_a_trusted_ai_result_expected; excludes_pre_ai_and_explicit_attempt_result_unavailable", "lineage_join_coverage_pct": 76.53, "lineage_join_eligible_event_count": 98, "lineage_joined_event_count": 75, "lineage_untrusted_or_stale_event_count": 23, "lineage_untrusted_or_stale_reason_counts": {"source_stale": 23}, "linked_budget_block_trace_count": 0, "linked_budget_pass_trace_count": 30, "linked_stage_counts": {"budget_pass": 75}, "parent_attempt_without_trusted_result_event_count": 13, "parent_trace_missing_when_expected_event_count": 0, "parent_trace_missing_without_attempt_event_count": 0, "pipeline_stage_order_contract": "latest_watching_ai_to_budget_precheck_to_final_authority_revalidation", "pre_ai_parent_not_expected_event_count": 562, "raw_ai_budget_census_is_causal": false, "raw_event_lineage_join_coverage_pct": 11.14, "runtime_effect": false, "status": "explicit_ai_trace_budget_pass_only"}, "budget_pass_unique": 79, "budget_to_ai_unique_pct": 102.6, "legacy_stage_census_gap": 0, "legacy_stage_census_gap_is_causal": false}, "next_repair_action": "treat pre-AI budget events as expected no-parent observations; repair only missing lineage contracts or stale/untrusted post-AI parents, and keep causal EV attribution limited to exact joins", "observed_count": 0, "status": "observation_only"}, "ECONOMIC_PARTICIPATION": {"evidence": {"allowed_runtime_apply": false, "bundle_count": 5, "by_venue": {"KRX": {"bundle_count": 5, "full_submitted_bundle_count": 0, "partial_residual_bundle_count": 0, "probe_only_bundle_count": 5, "requested_notional_krw": 346680, "requested_qty": 5, "submitted_notional_krw": 346680, "submitted_notional_to_requested_notional_pct": 100.0, "submitted_qty": 5, "submitted_qty_to_requested_qty_pct": 100.0}}, "decision_authority": "submit_drought_attribution_only", "forbidden_uses": ["broker_order_submit", "intraday_threshold_mutation", "quantity_cap_release", "live_auto_promotion", "bot_restart_trigger"], "full_submitted_bundle_count": 0, "metric_role": "funnel_count", "observed_bundle_count": 5, "partial_residual_bundle_count": 0, "primary_decision_metric": "submitted_notional_to_requested_notional_pct", "probe_only_bundle_count": 5, "requested_notional_krw": 346680, "requested_qty": 5, "rows": [{"attempt_key": "attempt:SCANPROM-001820-1787879391889", "bundle_state": "probe_only", "effective_venue": "KRX", "probe_submission_source": "single_share_order_bundle", "requested_notional_krw": 114400, "requested_qty": 1, "residual_submitted_qty": 0, "source_quality_valid": true, "stock_code": "001820", "submitted_notional_krw": 114400, "submitted_qty": 1, "venue_source_quality": "pass"}, {"attempt_key": "attempt:SCANPROM-003350-1787880407201", "bundle_state": "probe_only", "effective_venue": "KRX", "probe_submission_source": "single_share_order_bundle", "requested_notional_krw": 14400, "requested_qty": 1, "residual_submitted_qty": 0, "source_quality_valid": true, "stock_code": "003350", "submitted_notional_krw": 14400, "submitted_qty": 1, "venue_source_quality": "pass"}, {"attempt_key": "attempt:SCANPROM-001820-1787882486959", "bundle_state": "probe_only", "effective_venue": "KRX", "probe_submission_source": "single_share_order_bundle", "requested_notional_krw": 115500, "requested_qty": 1, "residual_submitted_qty": 0, "source_quality_valid": true, "stock_code": "001820", "submitted_notional_krw": 115500, "submitted_qty": 1, "venue_source_quality": "pass"}, {"attempt_key": "attempt:SCANPROM-060250-1787877717078", "bundle_state": "probe_only", "effective_venue": "KRX", "probe_submission_source": "single_share_order_bundle", "requested_notional_krw": 15980, "requested_qty": 1, "residual_submitted_qty": 0, "source_quality_valid": true, "stock_code": "060250", "submitted_notional_krw": 15980, "submitted_qty": 1, "venue_source_quality": "pass"}, {"attempt_key": "attempt:SCANPROM-103140-1787884412596", "bundle_state": "probe_only", "effective_venue": "KRX", "probe_submission_source": "single_share_order_bundle", "requested_notional_krw": 86400, "requested_qty": 1, "residual_submitted_qty": 0, "source_quality_valid": true, "stock_code": "103140", "submitted_notional_krw": 86400, "submitted_qty": 1, "venue_source_quality": "pass"}], "runtime_effect": false, "sample_floor": "1_explicit_venue_split_probe_or_bounded_single_share_order_bundle", "source_quality_blocked_bundle_count": 0, "source_quality_gate": "explicit_conflict_free_venue_and_positive_requested_submitted_qty_price", "source_quality_valid_bundle_count": 5, "submitted_notional_krw": 346680, "submitted_notional_to_requested_notional_pct": 100.0, "submitted_qty": 5, "submitted_qty_to_requested_qty_pct": 100.0, "window_policy": "same_session_split_probe_or_bounded_single_share_lifecycle"}, "next_repair_action": "join venue-proven submitted probe receipts to fill and terminal outcomes; submission participation alone is not execution EV", "observed_count": 5, "status": "observed"}, "ENTRY_AI_AUTHORITY_REVALIDATION": {"evidence": {"entry_ai_authority_guard_events": 81, "entry_ai_authority_guard_top": [{"count": 51, "label": "pre_submit_entry_ai_authority_guard_block:fresh_ai_drop_real_buy_veto"}, {"count": 18, "label": "pre_submit_entry_ai_authority_guard_block:fresh_ai_wait_observation_only_probe_veto"}, {"count": 12, "label": "pre_submit_entry_ai_authority_guard_block:entry_ai_result_stale_or_untrusted"}], "entry_ai_authority_guard_unique": 34, "latency_pass_unique": 37, "order_bundle_submitted_unique": 5}, "next_repair_action": "join exact AI authority reason, executable BBO, and target/adverse first-hit outcomes before proposing a bounded one-share probe", "observed_count": 34, "status": "observed"}, "LATENCY_PRE_SUBMIT": {"evidence": {"budget_pass_missing_exact_attempt_key_events": 0, "latency_blocked_budget_events": 278, "latency_blocked_budget_unique": 63, "latency_blocker_top": [{"count": 274, "label": "latency_block:latency_state_danger"}, {"count": 4, "label": "latency_block:tp1_direct_recheck_expired"}], "latency_danger_missing_exact_attempt_key_events": 0, "latency_root_cause_counts": {"quote_freshness_input_snapshot_noop": 107, "quote_stale": 239, "spread_microstructure_guard": 278, "spread_or_slippage_guard": 189}, "latency_state_danger_events": 278, "latency_state_danger_unique": 63, "quote_freshness_attribution": {"decision_authority": "submit_drought_quote_freshness_attribution_only", "forbidden_uses": ["broker_order_submit", "adm_ldm_training_input", "general_threshold_ev_input", "live_auto_promotion"], "latency_pass_recovered_count": 29, "latency_pass_recovered_downstream_counts": {"budget_pass_no_submit_event": 5, "entry_ai_authority_revalidation": 23, "order_bundle_submitted": 1}, "latency_pass_recovered_downstream_stage_counts": {"budget_pass": 5, "order_bundle_submitted": 1, "pre_submit_entry_ai_authority_guard_block": 23}, "order_bundle_submitted_after_refresh_count": 1, "post_restart_window_policy": "event_provenance_only", "refresh_applied_count": 59, "refresh_attempted_count": 72, "refresh_block_subreason_counts": {"observer_quote_refresh_failed_stale": 29, "ws_snapshot_refresh_failed_input_snapshot_fresh": 107, "ws_snapshot_refresh_failed_stale": 33}, "refresh_subreason_counts": {"observer_quote_refresh_failed_stale": 29, "ws_snapshot_refresh_failed_input_snapshot_fresh": 107, "ws_snapshot_refresh_failed_stale": 33}, "runtime_effect": false, "still_latency_blocked_after_refresh_count": 44}, "unknown_latency_reason_count": 0, "unknown_latency_workorder_required": false}, "next_repair_action": "close unknown latency labels or route quote freshness gaps to LDM attribution", "observed_count": 63, "status": "observed"}, "PRICE_REVALIDATION": {"evidence": {"latency_pass_unique": 37, "order_bundle_submitted_unique": 5, "price_guard_events": 1, "price_guard_top": [{"count": 1, "label": "entry_ai_price_canary_fallback:skip_low_confidence"}], "price_guard_unique": 1}, "next_repair_action": "join executable BBO and target/adverse first-hit outcomes to price revalidation blocks before proposing bounded exploration", "observed_count": 1, "status": "no_current_signal"}, "SIM_REAL_AUTHORITY": {"evidence": {"actual_order_submitted_authority": "not_granted_by_report", "broker_order_submit_allowed": false}, "next_repair_action": "keep attribution source-only until explicit runtime approval artifact exists", "observed_count": 1, "status": "observed"}, "SOURCE_TAXONOMY_LEAKAGE": {"evidence": {"blocker_top": [{"count": 395, "label": "blocked_strength_momentum:below_window_buy_value"}, {"count": 274, "label": "latency_block:latency_state_danger"}, {"count": 243, "label": "blocked_overbought:-"}, {"count": 237, "label": "blocked_strength_momentum:insufficient_history"}, {"count": 153, "label": "blocked_strength_momentum:below_strength_base"}, {"count": 131, "label": "blocked_liquidity:-"}, {"count": 124, "label": "blocked_zero_qty:-"}, {"count": 107, "label": "blocked_vpw:-"}, {"count": 100, "label": "blocked_ai_score:ai_score_50_buy_hold_override"}, {"count": 51, "label": "pre_submit_entry_ai_authority_guard_block:fresh_ai_drop_real_buy_veto"}], "taxonomy_leakage_labels": []}, "next_repair_action": "separate swing/source taxonomy from entry-submit blocker labels", "observed_count": 0, "status": "no_current_signal"}, "UPSTREAM_GATE": {"evidence": {"ai_action_event_counts": {"DROP": 166, "NOT_EVALUATED": 1, "WAIT": 106}, "ai_action_unique_counts": {"DROP": 166, "NOT_EVALUATED": 1, "WAIT": 106}, "ai_terminal_reason_top": [{"count": 105, "label": "ai_terminal:entry_policy_no_buy_score_prior"}, {"count": 43, "label": "ai_terminal:first_ai_wait_big_bite_not_confirmed"}], "budget_to_ai_unique_pct": 102.6, "upstream_blocker_top": [{"count": 100, "label": "blocked_ai_score:ai_score_50_buy_hold_override"}, {"count": 43, "label": "first_ai_wait:-"}, {"count": 27, "label": "blocked_ai_score:score_0.0"}, {"count": 21, "label": "wait65_79_ev_candidate:score_70.0"}, {"count": 14, "label": "blocked_ai_score:score_4.0"}, {"count": 13, "label": "blocked_ai_score:score_70.0"}, {"count": 12, "label": "blocked_ai_score:score_11.0"}, {"count": 7, "label": "blocked_ai_score:score_64.0"}, {"count": 6, "label": "blocked_ai_score:score_7.0"}, {"count": 5, "label": "blocked_ai_score:score_19.0"}]}, "next_repair_action": "join upstream action/reason cohorts to executable BBO and first-hit outcomes; AI semantic tuning remains separately owned", "observed_count": 162, "status": "observed"}}, "axis_order": ["UPSTREAM_GATE", "BUDGET_PASS_COLLAPSE", "LATENCY_PRE_SUBMIT", "PRICE_REVALIDATION", "ENTRY_AI_AUTHORITY_REVALIDATION", "BROKER_RECEIPT", "ECONOMIC_PARTICIPATION", "SIM_REAL_AUTHORITY", "SOURCE_TAXONOMY_LEAKAGE"], "broker_order_submit_allowed": false, "causal_bottleneck_axes": ["UPSTREAM_GATE", "LATENCY_PRE_SUBMIT", "ENTRY_AI_AUTHORITY_REVALIDATION", "ECONOMIC_PARTICIPATION"], "decision_authority": "submit_drought_attribution_only", "forbidden_uses": ["broker_order_submit", "runtime_apply_candidate", "intraday_threshold_mutation", "provider_route_change", "bot_restart_trigger", "live_auto_promotion"], "metric_role": "funnel_count", "no_current_signal_axes": ["PRICE_REVALIDATION", "BROKER_RECEIPT", "SOURCE_TAXONOMY_LEAKAGE"], "observation_only_axes": ["BUDGET_PASS_COLLAPSE", "SIM_REAL_AUTHORITY"], "primary_decision_metric": "causal_bottleneck_axis_observed_count", "runtime_effect": false, "sample_floor": "one_explicit_attempt_per_axis", "source_quality_gate": "lossless_attempt_key_and_explicit_stage_provenance", "window_policy": "same_session_unique_attempt_submit_funnel"}, "quote_freshness_attribution_inconsistent": false, "quote_freshness_latency_pass_recovered_count": 29, "quote_freshness_refresh_applied_count": 59, "quote_freshness_refresh_attempted_count": 72, "required_downstream": ["code_improvement_workorder", "lifecycle_decision_matrix.submit_bucket_attribution", "threshold_cycle_ev_report", "runtime_approval_summary", "postclose_verifier"], "root_cause_closure_status_hint": "root_cause_closed", "root_cause_counts": {"quote_freshness_input_snapshot_noop": 107, "quote_stale": 239, "spread_microstructure_guard": 278, "spread_or_slippage_guard": 189}, "root_cause_signal": "SUBMIT_DROUGHT_CRITICAL", "runtime_effect": false, "source_report_type": "buy_funnel_sentinel", "weak_contract_matches": ["BROKER_RECEIPT", "BUDGET_PASS_COLLAPSE", "ECONOMIC_PARTICIPATION", "ENTRY_AI_AUTHORITY_REVALIDATION", "FILL_QUALITY", "LATENCY_PRE_SUBMIT", "SIM_REAL_AUTHORITY", "TELEGRAM_POST_SUBMIT_ONLY", "UPSTREAM_GATE"]}`
...
- evidence: `status=warning`, `event_count=250197`, `warning_stage_count=0`, `warning_stages=`, `high_volume_no_source_field_stage_count=0`, `unknown_token_stage_count=1`, `review_warning_count=1`, `decision_authority=source_quality_only`, `runtime_effect=false`, `raw_row_exclusion_manifest=/home/ubuntu/KORStockScan/data/source_quality/raw_row_exclusion/2026-08-28_20260828T201943843654+0900/manifest.json`, `excluded_row_count=1`, `stage_counts={"pre_submit_entry_ai_authority_guard_block": 1}`, `field_gap_counts={"missing_fields:entry_ai_submit_authority_result_source": 1}`, `exclusion_reasons={"not_evaluated_context": 1, "provenance_missing": 1, "required_field_missing": 1, "unknown_token": 1}`, `first_timestamp=2026-08-28T18:19:50.222964`, `last_timestamp=2026-08-28T18:19:50.222964`, `forbidden_uses=EV/rolling/MTD/cumulative tuning/live-auto promotion/runtime approval for excluded rows`, `required_action=fix producer provenance/source-quality cause or mark reviewed_not_available/waiting_sample_only explicitly`, `current_scan_hard_blocking_excluded_row_count=0`, `post_exclusion_hard_blocking_excluded_row_count=0`, `raw_row_exclusion_revalidation_required=false`, `revalidation_disposition=closed_preserved_manifest_audit_evidence`, `producer_hint:stage=pre_submit_entry_ai_authority_guard_block count=1 pipeline=ENTRY_PIPELINE subsystem=scalping_entry_or_sim_producer top_reasons=not_evaluated_context,provenance_missing,required_field_missing,unknown_token`, `sample_row:line_no=204201 stage=pre_submit_entry_ai_authority_guard_block record_id=36901 reasons=not_evaluated_context,provenance_missing,required_field_missing,unknown_token gap_fields={"missing_fields": ["entry_ai_submit_authority_result_source"]}`
- parity_contract: -
...
- evidence: `ai_confirmed_unique=77`, `budget_pass_unique=79`, `latency_pass_unique=37`, `submitted_unique=5`, `submitted_to_ai_pct=6.5`, `submitted_to_budget_pct=6.3`, `blocker:blocked_strength_momentum:below_window_buy_value=395`, `blocker:latency_block:latency_state_danger=274`, `blocker:blocked_overbought:-=243`, `upstream:blocked_ai_score:ai_score_50_buy_hold_override=100`, `upstream:first_ai_wait:-=43`, `upstream:blocked_ai_score:score_0.0=27`, `latency:latency_block:latency_state_danger=274`, `latency:latency_block:tp1_direct_recheck_expired=4`, `weak_contract_gap=broker_receipt_contract_gap`, `runtime_effect=false`, `allowed_runtime_apply=false`
- parity_contract: -
...
- tuning_axis_effect: `True`
- expected_ev_effect: none_direct_source_quality_only
- evidence: `ai_confirmed_unique=77`, `budget_pass_unique=79`, `latency_pass_unique=37`, `submitted_unique=5`, `submitted_to_ai_pct=6.5`, `submitted_to_budget_pct=6.3`, `blocker:blocked_strength_momentum:below_window_buy_value=395`, `blocker:latency_block:latency_state_danger=274`, `blocker:blocked_overbought:-=243`, `upstream:blocked_ai_score:ai_score_50_buy_hold_override=100`, `upstream:first_ai_wait:-=43`, `upstream:blocked_ai_score:score_0.0=27`, `latency:latency_block:latency_state_danger=274`, `latency:latency_block:tp1_direct_recheck_expired=4`, `weak_contract_gap=fill_quality_contract_gap`, `runtime_effect=false`, `allowed_runtime_apply=false`
- parity_contract: -
- next_postclose_metric: Entry post-submit weak contracts remain source-only workorders with runtime_effect=false and allowed_runtime_apply=false until explicit implementation and verification.
- files_likely_touched: `src/engine/buy_funnel_sentinel.py`, `src/engine/lifecycle_decision_matrix.py`, `src/engine/build_code_improvement_workorder.py`, `src/engine/verify_threshold_cycle_postclose_chain.py`
- acceptance_tests: `PYTHONPATH=. .venv/bin/python -m pytest -q src/tests/test_buy_funnel_sentinel.py src/tests/test_build_code_improvement_workorder.py src/tests/test_verify_threshold_cycle_postclose_chain.py`
...
- tuning_axis_effect: `True`
- expected_ev_effect: none_direct_source_quality_only
- evidence: `ai_confirmed_unique=77`, `budget_pass_unique=79`, `latency_pass_unique=37`, `submitted_unique=5`, `submitted_to_ai_pct=6.5`, `submitted_to_budget_pct=6.3`, `blocker:blocked_strength_momentum:below_window_buy_value=395`, `blocker:latency_block:latency_state_danger=274`, `blocker:blocked_overbought:-=243`, `upstream:blocked_ai_score:ai_score_50_buy_hold_override=100`, `upstream:first_ai_wait:-=43`, `upstream:blocked_ai_score:score_0.0=27`, `latency:latency_block:latency_state_danger=274`, `latency:latency_block:tp1_direct_recheck_expired=4`, `weak_contract_gap=post_submit_contract_gap`, `runtime_effect=false`, `allowed_runtime_apply=false`
- parity_contract: -
- next_postclose_metric: Entry post-submit weak contracts remain source-only workorders with runtime_effect=false and allowed_runtime_apply=false until explicit implementation and verification.
- files_likely_touched: `src/engine/buy_funnel_sentinel.py`, `src/engine/lifecycle_decision_matrix.py`, `src/engine/build_code_improvement_workorder.py`, `src/engine/verify_threshold_cycle_postclose_chain.py`
- acceptance_tests: `PYTHONPATH=. .venv/bin/python -m pytest -q src/tests/test_buy_funnel_sentinel.py src/tests/test_build_code_improvement_workorder.py src/tests/test_verify_threshold_cycle_postclose_chain.py`
...
- tuning_axis_effect: `True`
- expected_ev_effect: none_direct_source_quality_only
- evidence: `ai_confirmed_unique=77`, `budget_pass_unique=79`, `latency_pass_unique=37`, `submitted_unique=5`, `submitted_to_ai_pct=6.5`, `submitted_to_budget_pct=6.3`, `blocker:blocked_strength_momentum:below_window_buy_value=395`, `blocker:latency_block:latency_state_danger=274`, `blocker:blocked_overbought:-=243`, `upstream:blocked_ai_score:ai_score_50_buy_hold_override=100`, `upstream:first_ai_wait:-=43`, `upstream:blocked_ai_score:score_0.0=27`, `latency:latency_block:latency_state_danger=274`, `latency:latency_block:tp1_direct_recheck_expired=4`, `weak_contract_gap=source_taxonomy_contract_gap`, `runtime_effect=false`, `allowed_runtime_apply=false`, `taxonomy_leakage_labels=[]`
- parity_contract: -
- next_postclose_metric: Entry post-submit weak contracts remain source-only workorders with runtime_effect=false and allowed_runtime_apply=false until explicit implementation and verification.
- files_likely_touched: `src/engine/buy_funnel_sentinel.py`, `src/engine/lifecycle_decision_matrix.py`, `src/engine/build_code_improvement_workorder.py`, `src/engine/verify_threshold_cycle_postclose_chain.py`
- acceptance_tests: `PYTHONPATH=. .venv/bin/python -m pytest -q src/tests/test_buy_funnel_sentinel.py src/tests/test_build_code_improvement_workorder.py src/tests/test_verify_threshold_cycle_postclose_chain.py`
...
- tuning_axis_effect: `True`
- expected_ev_effect: none_direct_source_quality_only
- evidence: `ai_confirmed_unique=77`, `budget_pass_unique=79`, `latency_pass_unique=37`, `submitted_unique=5`, `submitted_to_ai_pct=6.5`, `submitted_to_budget_pct=6.3`, `blocker:blocked_strength_momentum:below_window_buy_value=395`, `blocker:latency_block:latency_state_danger=274`, `blocker:blocked_overbought:-=243`, `upstream:blocked_ai_score:ai_score_50_buy_hold_override=100`, `upstream:first_ai_wait:-=43`, `upstream:blocked_ai_score:score_0.0=27`, `latency:latency_block:latency_state_danger=274`, `latency:latency_block:tp1_direct_recheck_expired=4`, `weak_contract_gap=telegram_post_submit_contract_gap`, `runtime_effect=false`, `allowed_runtime_apply=false`
- parity_contract: -
- next_postclose_metric: Entry post-submit weak contracts remain source-only workorders with runtime_effect=false and allowed_runtime_apply=false until explicit implementation and verification.
- files_likely_touched: `src/engine/buy_funnel_sentinel.py`, `src/engine/lifecycle_decision_matrix.py`, `src/engine/build_code_improvement_workorder.py`, `src/engine/verify_threshold_cycle_postclose_chain.py`
- acceptance_tests: `PYTHONPATH=. .venv/bin/python -m pytest -q src/tests/test_buy_funnel_sentinel.py src/tests/test_build_code_improvement_workorder.py src/tests/test_verify_threshold_cycle_postclose_chain.py`
...
### 10. `order_lifecycle_flow_bucket_lifecycle_flow_bucket_incomplete_10_lifecycle_flow_combo_lifecycle_flow_entry_entry_combo_entry_spot_score_68bd6da4`
...
### 11. `order_lifecycle_flow_bucket_lifecycle_flow_bucket_incomplete_11_lifecycle_flow_combo_lifecycle_flow_entry_entry_combo_entry_spot_score_40d1ca2c`
...
### 15. `order_lifecycle_flow_bucket_lifecycle_flow_bucket_incomplete_15_lifecycle_flow_combo_lifecycle_flow_entry_entry_combo_entry_spot_score_68bd6da4`
...
### 20. `order_lifecycle_flow_bucket_lifecycle_flow_bucket_incomplete_1_lifecycle_flow_combo_lifecycle_flow_entry_entry_combo_entry_spot_score_2ad7fdfe`
...
### 21. `order_lifecycle_flow_bucket_lifecycle_flow_bucket_incomplete_20_lifecycle_flow_combo_lifecycle_flow_entry_entry_combo_entry_spot_score_0d98e7ec`
...
### 32. `order_lifecycle_exit_bucket_combo_exit_result_source_sim_post_sell_evaluation_rule_scalp_preset_hard_stop_pct_outcome_7a723e15`
...
- tuning_axis_effect: `False`
- expected_ev_effect: Keep exit stage buckets visible as child evidence while parent lifecycle flow owns promotion EV.
- evidence: `workorder_id=exit_bucket_source_quality_2`, `bucket_type=combo_exit_result`, `bucket_key=source=sim_post_sell_evaluation|rule=scalp_preset_hard_stop_pct|outcome=MISSED_UPSIDE|profit=profit_lt_neg070`, `reason=exit_stage_bucket_needs_source_quality_or_lifecycle_flow_confirmation`, `recommended_route=candidate_tighten_or_exclude`, `runtime_effect=false`, `allowed_runtime_apply=false`, `stage_only_live_promotion_forbidden=true`
- parity_contract: -
- next_postclose_metric: exit_bucket_attribution bucket/workorder counts, identity join rate, and complete lifecycle flow count remain visible in downstream reports.
- files_likely_touched: -
- acceptance_tests: -
...
### 33. `order_lifecycle_exit_bucket_exit_outcome_good_exit`
...
### 35. `order_lifecycle_exit_bucket_exit_outcome_outcome_not_applicable_partial_exit`
...
### 36. `order_lifecycle_exit_bucket_exit_rule_scalp_preset_hard_stop_pct`
...
- tuning_axis_effect: `False`
- expected_ev_effect: Keep exit stage buckets visible as child evidence while parent lifecycle flow owns promotion EV.
- evidence: `workorder_id=exit_bucket_source_quality_6`, `bucket_type=exit_rule`, `bucket_key=scalp_preset_hard_stop_pct`, `reason=exit_stage_bucket_needs_source_quality_or_lifecycle_flow_confirmation`, `recommended_route=candidate_tighten_or_exclude`, `runtime_effect=false`, `allowed_runtime_apply=false`, `stage_only_live_promotion_forbidden=true`
- parity_contract: -
- next_postclose_metric: exit_bucket_attribution bucket/workorder counts, identity join rate, and complete lifecycle flow count remain visible in downstream reports.
- files_likely_touched: -
- acceptance_tests: -
...
### 37. `order_lifecycle_exit_bucket_exit_rule_scalp_sim_panic_lifecycle_partial_exit`
...
- tuning_axis_effect: `False`
- expected_ev_effect: Keep exit stage buckets visible as child evidence while parent lifecycle flow owns promotion EV.
- evidence: `workorder_id=exit_bucket_source_quality_7`, `bucket_type=exit_rule`, `bucket_key=scalp_sim_panic_lifecycle_partial_exit`, `reason=exit_stage_bucket_needs_source_quality_or_lifecycle_flow_confirmation`, `recommended_route=candidate_tighten_or_exclude`, `runtime_effect=false`, `allowed_runtime_apply=false`, `stage_only_live_promotion_forbidden=true`
- parity_contract: -
- next_postclose_metric: exit_bucket_attribution bucket/workorder counts, identity join rate, and complete lifecycle flow count remain visible in downstream reports.
- files_likely_touched: -
- acceptance_tests: -
...
- evidence: `quiet_gap_count=339`, `rollup_required_count=339`, `sim_live_connected_quiet_gap_count=0`, `quiet_gap_type_counts={'positive_source_only_keep_collecting': 338, 'ai_review_parsed_low_coverage': 1}`, `ai_review_coverage={'status': 'parsed', 'shard_count': 5, 'parsed_shard_count': 1, 'reviewed_candidate_count': 1, 'low_coverage': True}`, `runtime_effect=false`, `allowed_runtime_apply=false`
- parity_contract: -
...
### 49. `order_conversion_lane_env_mapping_lifecycle_flow_combo_lifecycle_flow_entry_entry_combo_entry_9a149c1c`
...
- repeat_unresolved_escalation: `-`
- longstanding_non_implement_review: `{"history_window_days": 10, "previous_decision": "attach_existing_family", "previous_implementation_status": "implemented", "previous_route": "existing_family", "repeat_count": 7, "repeat_key": "sig:conversion_lane|sim_to_real_conversion_lineage|conversion|conversion_env_mapping_blocker|sim_to_real_conversion_lane|conversion_lane_blocker_follow_up_env_mapping_lifecycle_flow_combo_lifecycle_flo", "repeat_signature": "sig:conversion_lane|sim_to_real_conversion_lineage|conversion|conversion_env_mapping_blocker|sim_to_real_conversion_lane|conversion_lane_blocker_follow_up_env_mapping_lifecycle_flow_combo_lifecycle_flo", "review_disposition": "implemented_with_provenance"}`
- longstanding_non_implement_action: `-`
- structural_blocker_escalation: `-`
- automation_reentry: Next postclose workorder should preserve implementation_status=implemented and use the source metrics as provenance only.
...
- 구현 결과는 `2026-08-29` 이후 postclose `threshold_cycle`, `scalping_pattern_lab_automation`, `threshold_cycle_ev`가 자동으로 다시 읽는다.
